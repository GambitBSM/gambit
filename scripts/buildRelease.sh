...
rm -rf ./* && \
cmake -D EIGEN3_INCLUDE_DIR=/apps/eigen/3.3.7/include/eigen3/ -D CMAKE_CXX_COMPILER=g++ -D CMAKE_C_COMPILER=gcc -D CMAKE_Fortran_COMPILER=gfortran -D CMAKE_BUILD_TYPE=Release_O3 -D WITH_MPI=ON -D BUILD_FS_MODELS="THDM_I;THDM_II;THDM_LS;THDM_flipped" -D WITH_ROOT=ON -D WITH_RESTFRAMES=ON -D WITH_HEPMC=ON .. && \
