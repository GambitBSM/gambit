...
///  *********************************************
///
///  Translation functions for THDMII_higgs_hybridatQ
///
///  *********************************************
///
///  Authors
...
#include "gambit/Models/models/THDMII_higgs_hybridatQ.hpp"
...
void MODEL_NAMESPACE::THDMII_higgs_hybridatQ_to_THDMIIatQ(const ModelParameters &myP, ModelParameters &targetP)
{
  USE_MODEL_PIPE(FRIEND) // get pipe for "interpret as FRIEND" function
  logger()<<"Running interpret_as_FRIEND calculations for THDMII_higgs_hybridatQ --> THDMIIatQ"<<LogTags::info<<EOM;
  ...
  #ifdef THDM_DBUG
    std::cout << "THDMII_higgs_hybridatQ parameters:" << myP << std::endl;
