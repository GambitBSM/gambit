...
#define PARENT THDMI
void MODEL_NAMESPACE::TDHMI_physical_to_THDMI(const ModelParameters &myP, ModelParameters &targetP)
{
...
#define PARENT THDMIatQ
void MODEL_NAMESPACE::TDHMI_physicalatQ_to_THDMIatQ(const ModelParameters &myP, ModelParameters &targetP)
{
  USE_MODEL_PIPE(PARENT) // get pope for "interpret as PARENT" function
