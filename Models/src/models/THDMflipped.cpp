...
///  THDMflipped_hybrid_lambda1atQ --> THDMflippedatQ
///
///  THDMflipped_hybrid_lambda2 --> THDMflipped
///  THDMflipped_hybrid_lambda2atQ --> THDMflippedatQ
///
...
{
  USE_MODEL_PIPE(PARENT) // get pipe for "interpret as PARENT" function
  logger()<<"Running interpret_as_PARENT calculations for THDMflipped_hybrid_lambda1 --> THDMflipped"<<LogTags::info<<EOM;
