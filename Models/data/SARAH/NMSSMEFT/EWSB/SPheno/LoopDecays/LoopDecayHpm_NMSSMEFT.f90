...
Module OneLoopDecay_Hpm_NMSSMEFT
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_NMSSMEFT_HpmToHpmAh(cplAhHpmcHpm,MAh,MHpm,MAh2,             & 
& MHpm2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NMSSMEFT_HpmToHpmAh


Subroutine Gamma_Real_NMSSMEFT_HpmToHpmAh(MLambda,em,gs,cplAhHpmcHpm,MAh,             & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NMSSMEFT_HpmToHpmAh


Subroutine Amplitude_WAVE_NMSSMEFT_HpmToHpmAh(cplAhHpmcHpm,ctcplAhHpmcHpm,            & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSMEFT_HpmToHpmAh


Subroutine Amplitude_VERTEX_NMSSMEFT_HpmToHpmAh(MAh,MCha,MChi,MFd,MFe,MFu,            & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSMEFT_HpmToHpmAh


Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmToHpmAh(MAh,MCha,MChi,MFd,MFe,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmToHpmAh


Subroutine Amplitude_Tree_NMSSMEFT_HpmToAhVWm(cplAhcHpmVWm,MAh,MHpm,MVWm,             & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NMSSMEFT_HpmToAhVWm


Subroutine Gamma_Real_NMSSMEFT_HpmToAhVWm(MLambda,em,gs,cplAhcHpmVWm,MAh,             & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NMSSMEFT_HpmToAhVWm


Subroutine Amplitude_WAVE_NMSSMEFT_HpmToAhVWm(cplAhcHpmVWm,ctcplAhcHpmVWm,            & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSMEFT_HpmToAhVWm


Subroutine Amplitude_VERTEX_NMSSMEFT_HpmToAhVWm(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& Mhh,MHpm,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MVP2,MVWm2,           & 
& MVZ2,cplAhAhAh,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,        & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,               & 
& cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,             & 
...
& cplcFvFecHpmL(3,3,2),cplcFvFecHpmR(3,3,2),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),         & 
& cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplcgWpCgAcHpm(2),cplcgZgWmcHpm(2),cplcgAgWpCVWm,  & 
& cplcgZgWpCVWm,cplcgWmgZVWm,cplcgWpCgZcHpm(2),cplhhHpmcHpm(3,2,2),cplhhcHpmVWm(3,2),    & 
& cplhhcVWmVWm(3),cplHpmcHpmVP(2,2),cplHpmcHpmVZ(2,2),cplcHpmVPVWm(2),cplcVWmVPVWm,      & 
& cplcHpmVWmVZ(2),cplcVWmVWmVZ,cplAhAhcVWmVWm1(3,3),cplAhcHpmVPVWm1(3,2),cplAhcHpmVWmVZ1(3,2),& 
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSMEFT_HpmToAhVWm


Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmToAhVWm(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,Mhh,MHpm,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MVP2,             & 
& MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,               & 
& cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,              & 
& cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHpmcHpm,              & 
& cplAhHpmcVWm,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplcChaChiVWmL,cplcChaChiVWmR, & 
& cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFdFuVWmL,cplcFdFuVWmR,     & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplcgWpCgAcHpm,cplcgZgWmcHpm,cplcgAgWpCVWm,cplcgZgWpCVWm,    & 
& cplcgWmgZVWm,cplcgWpCgZcHpm,cplhhHpmcHpm,cplhhcHpmVWm,cplhhcVWmVWm,cplHpmcHpmVP,       & 
& cplHpmcHpmVZ,cplcHpmVPVWm,cplcVWmVPVWm,cplcHpmVWmVZ,cplcVWmVWmVZ,cplAhAhcVWmVWm1,      & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmToAhVWm


Subroutine Amplitude_Tree_NMSSMEFT_HpmToChiCha(cplChiChacHpmL,cplChiChacHpmR,         & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NMSSMEFT_HpmToChiCha


Subroutine Gamma_Real_NMSSMEFT_HpmToChiCha(MLambda,em,gs,cplChiChacHpmL,              & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NMSSMEFT_HpmToChiCha


Subroutine Amplitude_WAVE_NMSSMEFT_HpmToChiCha(cplChiChacHpmL,cplChiChacHpmR,         & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSMEFT_HpmToChiCha


Subroutine Amplitude_VERTEX_NMSSMEFT_HpmToChiCha(MAh,MCha,MChi,Mhh,MHpm,              & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSMEFT_HpmToChiCha


Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmToChiCha(MAh,MCha,MChi,Mhh,MHpm,           & 
& MVP,MVWm,MVZ,MAh2,MCha2,MChi2,Mhh2,MHpm2,MVP2,MVWm2,MVZ2,cplcChaChaAhL,cplcChaChaAhR,  & 
& cplChiChiAhL,cplChiChiAhR,cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,     & 
& cplChiChacVWmL,cplChiChacVWmR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,               & 
& cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,      & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmToChiCha


Subroutine Amplitude_Tree_NMSSMEFT_HpmTocFuFd(cplcFuFdcHpmL,cplcFuFdcHpmR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NMSSMEFT_HpmTocFuFd


Subroutine Gamma_Real_NMSSMEFT_HpmTocFuFd(MLambda,em,gs,cplcFuFdcHpmL,cplcFuFdcHpmR,  & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NMSSMEFT_HpmTocFuFd


Subroutine Amplitude_WAVE_NMSSMEFT_HpmTocFuFd(cplcFuFdcHpmL,cplcFuFdcHpmR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSMEFT_HpmTocFuFd


Subroutine Amplitude_VERTEX_NMSSMEFT_HpmTocFuFd(MAh,MFd,MFu,Mhh,MHpm,MVG,             & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSMEFT_HpmTocFuFd


Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmTocFuFd(MAh,MFd,MFu,Mhh,MHpm,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmTocFuFd


Subroutine Amplitude_Tree_NMSSMEFT_HpmTocFvFe(cplcFvFecHpmL,cplcFvFecHpmR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NMSSMEFT_HpmTocFvFe


Subroutine Gamma_Real_NMSSMEFT_HpmTocFvFe(MLambda,em,gs,cplcFvFecHpmL,cplcFvFecHpmR,  & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NMSSMEFT_HpmTocFvFe


Subroutine Amplitude_WAVE_NMSSMEFT_HpmTocFvFe(cplcFvFecHpmL,cplcFvFecHpmR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSMEFT_HpmTocFvFe


Subroutine Amplitude_VERTEX_NMSSMEFT_HpmTocFvFe(MAh,MFe,Mhh,MHpm,MVP,MVWm,            & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSMEFT_HpmTocFvFe


Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmTocFvFe(MAh,MFe,Mhh,MHpm,MVP,              & 
& MVWm,MVZ,MAh2,MFe2,Mhh2,MHpm2,MVP2,MVWm2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplAhHpmcHpm,    & 
& cplAhcHpmVWm,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
& cplcFeFeVZR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,       & 
& cplcFvFvVZR,cplhhHpmcHpm,cplhhcHpmVWm,cplHpmcHpmVP,cplHpmcHpmVZ,cplcHpmVPVWm,          & 
& cplcHpmVWmVZ,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmTocFvFe


Subroutine Amplitude_Tree_NMSSMEFT_HpmToHpmhh(cplhhHpmcHpm,Mhh,MHpm,Mhh2,             & 
& MHpm2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NMSSMEFT_HpmToHpmhh


Subroutine Gamma_Real_NMSSMEFT_HpmToHpmhh(MLambda,em,gs,cplhhHpmcHpm,Mhh,             & 
& MHpm,GammarealPhoton,GammarealGluon)
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NMSSMEFT_HpmToHpmhh


Subroutine Amplitude_WAVE_NMSSMEFT_HpmToHpmhh(cplhhHpmcHpm,ctcplhhHpmcHpm,            & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSMEFT_HpmToHpmhh


Subroutine Amplitude_VERTEX_NMSSMEFT_HpmToHpmhh(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& Mhh,MHpm,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MVP2,MVWm2,           & 
...
Amp(gt1, gt2, gt3) = Amp(gt1, gt2, gt3) + oo16pi2*(1._dp/2._dp)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSMEFT_HpmToHpmhh


Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmToHpmhh(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,Mhh,MHpm,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MVP2,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmToHpmhh


Subroutine Amplitude_Tree_NMSSMEFT_HpmTohhVWm(cplhhcHpmVWm,Mhh,MHpm,MVWm,             & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NMSSMEFT_HpmTohhVWm


Subroutine Gamma_Real_NMSSMEFT_HpmTohhVWm(MLambda,em,gs,cplhhcHpmVWm,Mhh,             & 
& MHpm,MVWm,GammarealPhoton,GammarealGluon)
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NMSSMEFT_HpmTohhVWm


Subroutine Amplitude_WAVE_NMSSMEFT_HpmTohhVWm(cplhhcHpmVWm,ctcplhhcHpmVWm,            & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSMEFT_HpmTohhVWm


Subroutine Amplitude_VERTEX_NMSSMEFT_HpmTohhVWm(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& Mhh,MHpm,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MVP2,MVWm2,           & 
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSMEFT_HpmTohhVWm


Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmTohhVWm(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,Mhh,MHpm,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MVP2,             & 
& MVWm2,MVZ2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,     & 
& cplChiChacHpmR,cplcChaChahhL,cplcChaChahhR,cplChiChihhL,cplChiChihhR,cplcChaChiVWmL,   & 
& cplcChaChiVWmR,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFeFehhL,        & 
& cplcFeFehhR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuVWmL,          & 
& cplcFdFuVWmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcgZgAhh,cplcgWpCgAcHpm,cplcgWmgWmhh,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmTohhVWm


Subroutine Amplitude_Tree_NMSSMEFT_HpmToHpmVZ(cplHpmcHpmVZ,MHpm,MVZ,MHpm2,MVZ2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NMSSMEFT_HpmToHpmVZ


Subroutine Gamma_Real_NMSSMEFT_HpmToHpmVZ(MLambda,em,gs,cplHpmcHpmVZ,MHpm,            & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NMSSMEFT_HpmToHpmVZ


Subroutine Amplitude_WAVE_NMSSMEFT_HpmToHpmVZ(cplHpmcHpmVP,cplHpmcHpmVZ,              & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSMEFT_HpmToHpmVZ


Subroutine Amplitude_VERTEX_NMSSMEFT_HpmToHpmVZ(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& Mhh,MHpm,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MVP2,MVWm2,           & 
...
& cplhhVZVZ(3),cplHpmcHpmVP(2,2),cplHpmcVWmVP(2),cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2),      & 
& cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcVWmVWmVZ,cplAhHpmcVWmVZ1(3,2),cplAhcHpmVWmVZ1(3,2),& 
& cplhhHpmcVWmVZ1(3,2),cplhhcHpmVWmVZ1(3,2),cplHpmcHpmVPVZ1(2,2),cplHpmcHpmVZVZ1(2,2)
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSMEFT_HpmToHpmVZ


Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmToHpmVZ(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,Mhh,MHpm,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MVP2,             & 
...
& cplhhHpmcVWm,cplhhcHpmVWm,cplhhVZVZ,cplHpmcHpmVP,cplHpmcVWmVP,cplHpmcHpmVZ,            & 
& cplHpmcVWmVZ,cplcHpmVPVWm,cplcHpmVWmVZ,cplcVWmVWmVZ,cplAhHpmcVWmVZ1,cplAhcHpmVWmVZ1,   & 
& cplhhHpmcVWmVZ1,cplhhcHpmVWmVZ1,cplHpmcHpmVPVZ1,cplHpmcHpmVZVZ1,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmToHpmVZ


Subroutine Amplitude_Tree_NMSSMEFT_HpmToVZVWm(cplcHpmVWmVZ,MHpm,MVWm,MVZ,             & 
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_Tree_NMSSMEFT_HpmToVZVWm


Subroutine Gamma_Real_NMSSMEFT_HpmToVZVWm(MLambda,em,gs,cplcHpmVWmVZ,MHpm,            & 
...
End if 
End Do
End Subroutine Gamma_Real_NMSSMEFT_HpmToVZVWm


Subroutine Amplitude_WAVE_NMSSMEFT_HpmToVZVWm(cplcHpmVPVWm,cplcHpmVWmVZ,              & 
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_WAVE_NMSSMEFT_HpmToVZVWm


Subroutine Amplitude_VERTEX_NMSSMEFT_HpmToVZVWm(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& Mhh,MHpm,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MVP2,MVWm2,           & 
...
& cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2),cplcHpmVPVWm(2),cplcVWmVPVWm,cplcHpmVWmVZ(2),        & 
& cplcVWmVWmVZ,cplAhcHpmVWmVZ1(3,2),cplhhcHpmVWmVZ1(3,2),cplHpmcHpmVPVZ1(2,2),           & 
& cplHpmcHpmcVWmVWm1(2,2),cplHpmcHpmVZVZ1(2,2),cplcVWmVPVWmVZ3Q,cplcVWmVPVWmVZ2Q,        & 
...
End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSMEFT_HpmToVZVWm


Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmToVZVWm(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,Mhh,MHpm,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MVP2,             & 
...
& cplhhHpmcHpm,cplhhcHpmVWm,cplhhcVWmVWm,cplhhVZVZ,cplHpmcHpmVP,cplHpmcHpmVZ,            & 
& cplHpmcVWmVZ,cplcHpmVPVWm,cplcVWmVPVWm,cplcHpmVWmVZ,cplcVWmVWmVZ,cplAhcHpmVWmVZ1,      & 
& cplhhcHpmVWmVZ1,cplHpmcHpmVPVZ1,cplHpmcHpmcVWmVWm1,cplHpmcHpmVZVZ1,cplcVWmVPVWmVZ3Q,   & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmToVZVWm


Subroutine Amplitude_WAVE_NMSSMEFT_HpmToHpmVP(cplHpmcHpmVP,cplHpmcHpmVZ,              & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSMEFT_HpmToHpmVP


Subroutine Amplitude_VERTEX_NMSSMEFT_HpmToHpmVP(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& Mhh,MHpm,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MVP2,MVWm2,           & 
...
& cplhhHpmcVWm(3,2),cplhhcHpmVWm(3,2),cplHpmcHpmVP(2,2),cplHpmcVWmVP(2),cplHpmcHpmVZ(2,2),& 
& cplHpmcVWmVZ(2),cplcHpmVPVWm(2),cplcVWmVPVWm,cplcHpmVWmVZ(2),cplAhHpmcVWmVP1(3,2),     & 
& cplAhcHpmVPVWm1(3,2),cplhhHpmcVWmVP1(3,2),cplhhcHpmVPVWm1(3,2),cplHpmcHpmVPVP1(2,2),   & 
& cplHpmcHpmVPVZ1(2,2)
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSMEFT_HpmToHpmVP


Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmToHpmVP(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,Mhh,MHpm,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MVP2,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmToHpmVP


Subroutine Amplitude_WAVE_NMSSMEFT_HpmToVPVWm(cplcHpmVPVWm,cplcHpmVWmVZ,              & 
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_WAVE_NMSSMEFT_HpmToVPVWm


Subroutine Amplitude_VERTEX_NMSSMEFT_HpmToVPVWm(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& Mhh,MHpm,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MVP2,MVWm2,           & 
...
End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSMEFT_HpmToVPVWm


Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmToVPVWm(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,Mhh,MHpm,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MVP2,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSMEFT_HpmToVPVWm



End Module OneLoopDecay_Hpm_NMSSMEFT
