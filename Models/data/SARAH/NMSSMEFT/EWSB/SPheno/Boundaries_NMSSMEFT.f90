...
& cplcUFdFdVGR,cplcUFdFdVPL,cplcUFdFdVPR,cplcUFdFdVZL,cplcUFdFdVZR,cplcUFdFuHpmL,        & 
& cplcUFdFuHpmR,cplcUFdFuVWmL,cplcUFdFuVWmR,sigR_d,sigL_d,sigSL_d,sigSR_d)
...
& cplcUFuFuVPL,cplcUFuFuVPR,cplcUFuFuVZL,cplcUFuFuVZR,sigR_u,sigL_u,sigSL_u,sigSR_u)
...
& ml2,mHd2,mHu2,md2,mu2,me2,ms2,M1,M2,M3,delta0,gMZ,kont)
...
& mHu2,md2,mu2,me2,ms2,M1,M2,M3,mGut,kont,WriteComment,niter)
...
Real(dp),Intent(out)::g1C(218),mGUT
Real(dp)::tz,dt,t_out 
Real(dp)::mudim,gGUT,gA_h(218),m_hi,m_lo
Real(dp)::g1B(218)
Real(dp)::g1S(218)
Logical :: FoundUnification, unified, greater 
...
End Module Boundaries_NMSSMEFT 
