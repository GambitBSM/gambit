...
If (i_c.Eq.0) MuEffinput= Cmplx(wert,Aimag(MuEffinput),dp) 
If (i_c.Eq.1) MuEffinput= Cmplx(Real(MuEffinput,dp),wert,dp) 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
...
Case(1003) 
  If (wert.ne.1) CalcLoopDecay_Hpm= .False. 
Case(1004) 
  If (wert.ne.1) CalcLoopDecay_Chi= .False. 
Case(1005) 
  If (wert.ne.1) CalcLoopDecay_Cha= .False. 
Case(1006) 
...
Complex(dp) :: PDGhh(3),PDGAh(3),PDGHpm(2),PDGVP,PDGVZ,PDGVG,PDGVWm,PDGgP,PDGgWm,PDGgWmC,            & 
& PDGgZ,PDGgG,PDGFd(3),PDGFu(3),PDGFe(3),PDGFv(3),PDGChi(5),PDGCha(2)
...
Character(len=30),Dimension(5):: NameParticleChi
...
Write(io_L,100) "# SUSY Les Houches Accord 2 - NMSSMEFT Spectrum + Decays + Flavor Observables"
...
If (Abs(Real(MuEffinput,dp)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
...
End if 
If (Abs(Real(MuEffinput,dp)).gt.0._dp) Then 
Write(io_L,101) 65, Real(MuEffinput,dp) ,"# MuEffinput"
End if 
End if 
WriteNextBlock = .false. 
...
If (Abs(Aimag(MuEffinput)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
...
End if 
If (Abs(Aimag(MuEffinput)).gt.0._dp) Then 
Write(io_L,101) 65, Aimag(MuEffinput) ,"# MuEffinput"
End if 
End if 
...
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block NMSSMRUN Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(lam,dp), "# lam" 
If (Abs(Aimag(lam)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 2,Real(kap,dp), "# kap" 
If (Abs(Aimag(kap)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 3,Real(Tlam,dp), "# Tlam" 
If (Abs(Aimag(Tlam)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 4,Real(Tk,dp), "# Tk" 
If (Abs(Aimag(Tk)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 10,Real(ms2,dp), "# ms2" 
Write(io_L,104) 5,Real(vS,dp), "# vS" 
Write(io_L,104) 5,Real(vS,dp), "# vS" 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMNMSSMRUN Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(lam), "# lam" 
Write(io_L,104) 2,Aimag(kap), "# kap" 
Write(io_L,104) 3,Aimag(Tlam), "# Tlam" 
Write(io_L,104) 4,Aimag(Tk), "# Tk" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block TREENMSSMRUN Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 10,Real(ms2Tree,dp), "# ms2" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block LOOPNMSSMRUN Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 10,Real(ms21L,dp), "# ms2" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
Write(io_L,106) "Block NMSSMRUNGUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(lamGUT,dp), "# lam" 
Write(io_L,104) 2,Real(kapGUT,dp), "# kap" 
Write(io_L,104) 3,Real(TlamGUT,dp), "# Tlam" 
Write(io_L,104) 4,Real(TkGUT,dp), "# Tk" 
Write(io_L,104) 10,Real(ms2GUT,dp), "# ms2" 
...
If (MassLSP(1).gt.Abs(MChi(5))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 1000045 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MChi(5))
Else 
If (MassLSP(2).gt.Abs(MChi(5))) Then 
PDGLSP(2) = 1000045 
MassLSP(2) = Abs(MChi(5))
End if 
End if 
...
Write(io_L,100) "Block DMASS  # Overall uncertainty"
 Write(io_L,102) INT(Abs(1000001)), Sqrt(mass_uncertainty_Q(1)**2+mass_uncertainty_Yt(1)**2),"# MSd(1) " 
 Write(io_L,102) INT(Abs(1000003)), Sqrt(mass_uncertainty_Q(2)**2+mass_uncertainty_Yt(2)**2),"# MSd(2) " 
 Write(io_L,102) INT(Abs(1000005)), Sqrt(mass_uncertainty_Q(3)**2+mass_uncertainty_Yt(3)**2),"# MSd(3) " 
 Write(io_L,102) INT(Abs(2000001)), Sqrt(mass_uncertainty_Q(4)**2+mass_uncertainty_Yt(4)**2),"# MSd(4) " 
 Write(io_L,102) INT(Abs(2000003)), Sqrt(mass_uncertainty_Q(5)**2+mass_uncertainty_Yt(5)**2),"# MSd(5) " 
 Write(io_L,102) INT(Abs(2000005)), Sqrt(mass_uncertainty_Q(6)**2+mass_uncertainty_Yt(6)**2),"# MSd(6) " 
 Write(io_L,102) INT(Abs(1000012)), Sqrt(mass_uncertainty_Q(7)**2+mass_uncertainty_Yt(7)**2),"# MSv(1) " 
 Write(io_L,102) INT(Abs(1000014)), Sqrt(mass_uncertainty_Q(8)**2+mass_uncertainty_Yt(8)**2),"# MSv(2) " 
 Write(io_L,102) INT(Abs(1000016)), Sqrt(mass_uncertainty_Q(9)**2+mass_uncertainty_Yt(9)**2),"# MSv(3) " 
 Write(io_L,102) INT(Abs(1000002)), Sqrt(mass_uncertainty_Q(10)**2+mass_uncertainty_Yt(10)**2),"# MSu(1) " 
 Write(io_L,102) INT(Abs(1000004)), Sqrt(mass_uncertainty_Q(11)**2+mass_uncertainty_Yt(11)**2),"# MSu(2) " 
 Write(io_L,102) INT(Abs(1000006)), Sqrt(mass_uncertainty_Q(12)**2+mass_uncertainty_Yt(12)**2),"# MSu(3) " 
 Write(io_L,102) INT(Abs(2000002)), Sqrt(mass_uncertainty_Q(13)**2+mass_uncertainty_Yt(13)**2),"# MSu(4) " 
 Write(io_L,102) INT(Abs(2000004)), Sqrt(mass_uncertainty_Q(14)**2+mass_uncertainty_Yt(14)**2),"# MSu(5) " 
 Write(io_L,102) INT(Abs(2000006)), Sqrt(mass_uncertainty_Q(15)**2+mass_uncertainty_Yt(15)**2),"# MSu(6) " 
 Write(io_L,102) INT(Abs(1000011)), Sqrt(mass_uncertainty_Q(16)**2+mass_uncertainty_Yt(16)**2),"# MSe(1) " 
 Write(io_L,102) INT(Abs(1000013)), Sqrt(mass_uncertainty_Q(17)**2+mass_uncertainty_Yt(17)**2),"# MSe(2) " 
 Write(io_L,102) INT(Abs(1000015)), Sqrt(mass_uncertainty_Q(18)**2+mass_uncertainty_Yt(18)**2),"# MSe(3) " 
 Write(io_L,102) INT(Abs(2000011)), Sqrt(mass_uncertainty_Q(19)**2+mass_uncertainty_Yt(19)**2),"# MSe(4) " 
 Write(io_L,102) INT(Abs(2000013)), Sqrt(mass_uncertainty_Q(20)**2+mass_uncertainty_Yt(20)**2),"# MSe(5) " 
 Write(io_L,102) INT(Abs(2000015)), Sqrt(mass_uncertainty_Q(21)**2+mass_uncertainty_Yt(21)**2),"# MSe(6) " 
 Write(io_L,102) INT(Abs(25)), Sqrt(mass_uncertainty_Q(22)**2+mass_uncertainty_Yt(22)**2),"# Mhh(1) " 
 Write(io_L,102) INT(Abs(35)), Sqrt(mass_uncertainty_Q(23)**2+mass_uncertainty_Yt(23)**2),"# Mhh(2) " 
 Write(io_L,102) INT(Abs(45)), Sqrt(mass_uncertainty_Q(24)**2+mass_uncertainty_Yt(24)**2),"# Mhh(3) " 
 Write(io_L,102) INT(Abs(36)), Sqrt(mass_uncertainty_Q(26)**2+mass_uncertainty_Yt(26)**2),"# MAh(2) " 
 Write(io_L,102) INT(Abs(46)), Sqrt(mass_uncertainty_Q(27)**2+mass_uncertainty_Yt(27)**2),"# MAh(3) " 
 Write(io_L,102) INT(Abs(-37)), Sqrt(mass_uncertainty_Q(29)**2+mass_uncertainty_Yt(29)**2),"# MHpm(2) " 
 Write(io_L,102) INT(Abs(1000022)), Sqrt(mass_uncertainty_Q(30)**2+mass_uncertainty_Yt(30)**2),"# MChi(1) " 
 Write(io_L,102) INT(Abs(1000023)), Sqrt(mass_uncertainty_Q(31)**2+mass_uncertainty_Yt(31)**2),"# MChi(2) " 
 Write(io_L,102) INT(Abs(1000025)), Sqrt(mass_uncertainty_Q(32)**2+mass_uncertainty_Yt(32)**2),"# MChi(3) " 
 Write(io_L,102) INT(Abs(1000035)), Sqrt(mass_uncertainty_Q(33)**2+mass_uncertainty_Yt(33)**2),"# MChi(4) " 
 Write(io_L,102) INT(Abs(1000045)), Sqrt(mass_uncertainty_Q(34)**2+mass_uncertainty_Yt(34)**2),"# MChi(5) " 
 Write(io_L,102) INT(Abs(-1000024)), Sqrt(mass_uncertainty_Q(35)**2+mass_uncertainty_Yt(35)**2),"# MCha(1) " 
 Write(io_L,102) INT(Abs(-1000037)), Sqrt(mass_uncertainty_Q(36)**2+mass_uncertainty_Yt(36)**2),"# MCha(2) " 
Write(io_L,100) "Block DMASSQ  # Scale uncertainty"
 Write(io_L,102) INT(Abs(1000001)), mass_uncertainty_Q(1),"# MSd(1) " 
 Write(io_L,102) INT(Abs(1000003)), mass_uncertainty_Q(2),"# MSd(2) " 
 Write(io_L,102) INT(Abs(1000005)), mass_uncertainty_Q(3),"# MSd(3) " 
 Write(io_L,102) INT(Abs(2000001)), mass_uncertainty_Q(4),"# MSd(4) " 
 Write(io_L,102) INT(Abs(2000003)), mass_uncertainty_Q(5),"# MSd(5) " 
 Write(io_L,102) INT(Abs(2000005)), mass_uncertainty_Q(6),"# MSd(6) " 
 Write(io_L,102) INT(Abs(1000012)), mass_uncertainty_Q(7),"# MSv(1) " 
 Write(io_L,102) INT(Abs(1000014)), mass_uncertainty_Q(8),"# MSv(2) " 
 Write(io_L,102) INT(Abs(1000016)), mass_uncertainty_Q(9),"# MSv(3) " 
 Write(io_L,102) INT(Abs(1000002)), mass_uncertainty_Q(10),"# MSu(1) " 
 Write(io_L,102) INT(Abs(1000004)), mass_uncertainty_Q(11),"# MSu(2) " 
 Write(io_L,102) INT(Abs(1000006)), mass_uncertainty_Q(12),"# MSu(3) " 
 Write(io_L,102) INT(Abs(2000002)), mass_uncertainty_Q(13),"# MSu(4) " 
 Write(io_L,102) INT(Abs(2000004)), mass_uncertainty_Q(14),"# MSu(5) " 
 Write(io_L,102) INT(Abs(2000006)), mass_uncertainty_Q(15),"# MSu(6) " 
 Write(io_L,102) INT(Abs(1000011)), mass_uncertainty_Q(16),"# MSe(1) " 
 Write(io_L,102) INT(Abs(1000013)), mass_uncertainty_Q(17),"# MSe(2) " 
 Write(io_L,102) INT(Abs(1000015)), mass_uncertainty_Q(18),"# MSe(3) " 
 Write(io_L,102) INT(Abs(2000011)), mass_uncertainty_Q(19),"# MSe(4) " 
 Write(io_L,102) INT(Abs(2000013)), mass_uncertainty_Q(20),"# MSe(5) " 
 Write(io_L,102) INT(Abs(2000015)), mass_uncertainty_Q(21),"# MSe(6) " 
 Write(io_L,102) INT(Abs(25)), mass_uncertainty_Q(22),"# Mhh(1) " 
 Write(io_L,102) INT(Abs(35)), mass_uncertainty_Q(23),"# Mhh(2) " 
 Write(io_L,102) INT(Abs(45)), mass_uncertainty_Q(24),"# Mhh(3) " 
 Write(io_L,102) INT(Abs(36)), mass_uncertainty_Q(26),"# MAh(2) " 
 Write(io_L,102) INT(Abs(46)), mass_uncertainty_Q(27),"# MAh(3) " 
 Write(io_L,102) INT(Abs(-37)), mass_uncertainty_Q(29),"# MHpm(2) " 
 Write(io_L,102) INT(Abs(1000022)), mass_uncertainty_Q(30),"# MChi(1) " 
 Write(io_L,102) INT(Abs(1000023)), mass_uncertainty_Q(31),"# MChi(2) " 
 Write(io_L,102) INT(Abs(1000025)), mass_uncertainty_Q(32),"# MChi(3) " 
 Write(io_L,102) INT(Abs(1000035)), mass_uncertainty_Q(33),"# MChi(4) " 
 Write(io_L,102) INT(Abs(1000045)), mass_uncertainty_Q(34),"# MChi(5) " 
 Write(io_L,102) INT(Abs(-1000024)), mass_uncertainty_Q(35),"# MCha(1) " 
 Write(io_L,102) INT(Abs(-1000037)), mass_uncertainty_Q(36),"# MCha(2) " 
Write(io_L,100) "Block DMASST  # Top Matching uncertainty"
 Write(io_L,102) INT(Abs(1000001)), mass_uncertainty_Yt(1),"# MSd(1) " 
 Write(io_L,102) INT(Abs(1000003)), mass_uncertainty_Yt(2),"# MSd(2) " 
 Write(io_L,102) INT(Abs(1000005)), mass_uncertainty_Yt(3),"# MSd(3) " 
 Write(io_L,102) INT(Abs(2000001)), mass_uncertainty_Yt(4),"# MSd(4) " 
 Write(io_L,102) INT(Abs(2000003)), mass_uncertainty_Yt(5),"# MSd(5) " 
 Write(io_L,102) INT(Abs(2000005)), mass_uncertainty_Yt(6),"# MSd(6) " 
 Write(io_L,102) INT(Abs(1000012)), mass_uncertainty_Yt(7),"# MSv(1) " 
 Write(io_L,102) INT(Abs(1000014)), mass_uncertainty_Yt(8),"# MSv(2) " 
 Write(io_L,102) INT(Abs(1000016)), mass_uncertainty_Yt(9),"# MSv(3) " 
 Write(io_L,102) INT(Abs(1000002)), mass_uncertainty_Yt(10),"# MSu(1) " 
 Write(io_L,102) INT(Abs(1000004)), mass_uncertainty_Yt(11),"# MSu(2) " 
 Write(io_L,102) INT(Abs(1000006)), mass_uncertainty_Yt(12),"# MSu(3) " 
 Write(io_L,102) INT(Abs(2000002)), mass_uncertainty_Yt(13),"# MSu(4) " 
 Write(io_L,102) INT(Abs(2000004)), mass_uncertainty_Yt(14),"# MSu(5) " 
 Write(io_L,102) INT(Abs(2000006)), mass_uncertainty_Yt(15),"# MSu(6) " 
 Write(io_L,102) INT(Abs(1000011)), mass_uncertainty_Yt(16),"# MSe(1) " 
 Write(io_L,102) INT(Abs(1000013)), mass_uncertainty_Yt(17),"# MSe(2) " 
 Write(io_L,102) INT(Abs(1000015)), mass_uncertainty_Yt(18),"# MSe(3) " 
 Write(io_L,102) INT(Abs(2000011)), mass_uncertainty_Yt(19),"# MSe(4) " 
 Write(io_L,102) INT(Abs(2000013)), mass_uncertainty_Yt(20),"# MSe(5) " 
 Write(io_L,102) INT(Abs(2000015)), mass_uncertainty_Yt(21),"# MSe(6) " 
 Write(io_L,102) INT(Abs(25)), mass_uncertainty_Yt(22),"# Mhh(1) " 
 Write(io_L,102) INT(Abs(35)), mass_uncertainty_Yt(23),"# Mhh(2) " 
 Write(io_L,102) INT(Abs(45)), mass_uncertainty_Yt(24),"# Mhh(3) " 
 Write(io_L,102) INT(Abs(36)), mass_uncertainty_Yt(26),"# MAh(2) " 
 Write(io_L,102) INT(Abs(46)), mass_uncertainty_Yt(27),"# MAh(3) " 
 Write(io_L,102) INT(Abs(-37)), mass_uncertainty_Yt(29),"# MHpm(2) " 
 Write(io_L,102) INT(Abs(1000022)), mass_uncertainty_Yt(30),"# MChi(1) " 
 Write(io_L,102) INT(Abs(1000023)), mass_uncertainty_Yt(31),"# MChi(2) " 
 Write(io_L,102) INT(Abs(1000025)), mass_uncertainty_Yt(32),"# MChi(3) " 
 Write(io_L,102) INT(Abs(1000035)), mass_uncertainty_Yt(33),"# MChi(4) " 
 Write(io_L,102) INT(Abs(1000045)), mass_uncertainty_Yt(34),"# MChi(5) " 
 Write(io_L,102) INT(Abs(-1000024)), mass_uncertainty_Yt(35),"# MCha(1) " 
 Write(io_L,102) INT(Abs(-1000037)), mass_uncertainty_Yt(36),"# MCha(2) " 
End if
...
Write(io_L,106) "Block NMHMIX Q=",Q,"# ()" 
...
Write(io_L,106) "Block NMAMIX Q=",Q,"# ()" 
...
Write(io_L,106) "Block NMNMIX Q=",Q,"# ()" 
...
Write(io_L,107)1,5,Real(ZN(1,5),dp), "# Real(ZN(1,5),dp)" 
...
Write(io_L,107)2,5,Real(ZN(2,5),dp), "# Real(ZN(2,5),dp)" 
...
Write(io_L,107)3,5,Real(ZN(3,5),dp), "# Real(ZN(3,5),dp)" 
...
Write(io_L,107)4,5,Real(ZN(4,5),dp), "# Real(ZN(4,5),dp)" 
Write(io_L,107)5,1,Real(ZN(5,1),dp), "# Real(ZN(5,1),dp)" 
Write(io_L,107)5,2,Real(ZN(5,2),dp), "# Real(ZN(5,2),dp)" 
Write(io_L,107)5,3,Real(ZN(5,3),dp), "# Real(ZN(5,3),dp)" 
Write(io_L,107)5,4,Real(ZN(5,4),dp), "# Real(ZN(5,4),dp)" 
Write(io_L,107)5,5,Real(ZN(5,5),dp), "# Real(ZN(5,5),dp)" 
If ((MaxVal(Abs(AImag(ZN))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMNMNMIX Q=",Q,"# ()" 
...
Write(io_L,107)1,5,Aimag(ZN(1,5)), "# Aimag(ZN(1,5))" 
...
Write(io_L,107)2,5,Aimag(ZN(2,5)), "# Aimag(ZN(2,5))" 
...
Write(io_L,107)3,5,Aimag(ZN(3,5)), "# Aimag(ZN(3,5))" 
...
Write(io_L,107)4,5,Aimag(ZN(4,5)), "# Aimag(ZN(4,5))" 
Write(io_L,107)5,1,Aimag(ZN(5,1)), "# Aimag(ZN(5,1))" 
Write(io_L,107)5,2,Aimag(ZN(5,2)), "# Aimag(ZN(5,2))" 
Write(io_L,107)5,3,Aimag(ZN(5,3)), "# Aimag(ZN(5,3))" 
Write(io_L,107)5,4,Aimag(ZN(5,4)), "# Aimag(ZN(5,4))" 
Write(io_L,107)5,5,Aimag(ZN(5,5)), "# Aimag(ZN(5,5))" 
End If 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRhh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(3))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRhh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(3))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRhh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(3))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRhh(3,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRhh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(3))//" -> "//Trim(NameParticleVZ)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
End if 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRAh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(3))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 2, 3
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRAh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(3))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRAh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(3))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRAh(3,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRAh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(3))//" -> "//Trim(NameParticleVZ)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
If (BRAh(3,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGVWm 
CurrentPDG2(2) = PDGVWm 
Write(io_L,201) BRAh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(3))//" -> "//Trim(NameParticleVWm)//"^* "//Trim(NameParticleVWm)//" "//")"
End if 
icount = icount +1 
If (BRAh(3,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVZ 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRAh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(3))//" -> "//Trim(NameParticleVZ)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
End if 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRHpm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(2))//"^* -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRHpm(2,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRHpm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(2))//"^* -> "//Trim(NameParticleVWm)//"^* "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
End if 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRChi(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(1))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRChi(1,40:400)).Gt.BRmin) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRChi(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(2))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRChi(2,40:400)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,5
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRChi(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(3))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRChi(3,40:400)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,5
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRChi(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(4))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRChi(4,40:400)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,5
  Do gt2=1,2
...
End if 
If ((gTChi(5).gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRChi(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(5))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRChi(5,40:400)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,5
  Do gt2=1,2
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRChi(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleChi(5))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRChi(5,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleChi(5))//" -> "//Trim(NameParticleCha(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFv(gt3))//" "//")"
Write(io_L,202) BRChi(5,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleChi(5))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFv(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRChi(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleChi(5))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleFv(gt2))//"^* "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRCha(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleCha(1))//"^* -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRCha(1,25:244)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,2
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRCha(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleCha(2))//"^* -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRCha(2,25:244)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,2
  Do gt2=1,2
...
icount = icount +1 
End if 
If(gT1Lhh(3).gt.MinWidth) Then 
Write(io_L,210) INT(PDGhh(3)),gT1Lhh(3),Trim(NameParticlehh(3)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
If (BR1Lhh(3,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVP 
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BR1Lhh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(3))//" -> "//Trim(NameParticleVP)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
If (BR1Lhh(3,icount).Gt.BrMin) Then 
...
CurrentPDG2(1) = PDGHpm(gt1) 
CurrentPDG2(2) = -PDGVWm 
Write(io_L,201) BR1Lhh(3,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticlehh(3))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVWm)//"^* "//")"
Write(io_L,201) BR1Lhh(3,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticlehh(3))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWm)//" "//")"
End if 
...
icount = icount +1 
End if 
If(gT1LAh(3).gt.MinWidth) Then 
Write(io_L,210) INT(PDGAh(3)),gT1LAh(3),Trim(NameParticleAh(3)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
If (BR1LAh(3,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVP 
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BR1LAh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(3))//" -> "//Trim(NameParticleVP)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
If (BR1LAh(3,icount).Gt.BrMin) Then 
...
CurrentPDG2(1) = PDGHpm(gt1) 
CurrentPDG2(2) = -PDGVWm 
Write(io_L,201) BR1LAh(3,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleAh(3))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVWm)//"^* "//")"
Write(io_L,201) BR1LAh(3,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleAh(3))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWm)//" "//")"
End if 
...
If(gT1LHpm(2).gt.MinWidth) Then 
Write(io_L,210) -INT(PDGHpm(2)),gT1LHpm(2),Trim(NameParticleHpm(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 2, 2
  Do gt2=2, 3
If (BR1LHpm(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGHpm(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LHpm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(2))//"^* -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
If(gT1LChi(1).gt.MinWidth) Then 
Write(io_L,210) INT(PDGChi(1)),gT1LChi(1),Trim(NameParticleChi(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 5
  Do gt2=2, 3
If (BR1LChi(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGChi(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LChi(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(1))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
CurrentPDG2(1) = PDGCha(gt1) 
CurrentPDG2(2) = -PDGHpm(gt2) 
Write(io_L,201) BR1LChi(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleChi(1))//" -> "//Trim(NameParticleCha(gt1))//" "//Trim(NameParticleHpm(gt2))//"^* "//")"
Write(io_L,201) BR1LChi(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleChi(1))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleHpm(gt2))//" "//")"
End if 
...
icount = icount +1 
  End Do 
End if 
If(gT1LChi(2).gt.MinWidth) Then 
Write(io_L,210) INT(PDGChi(2)),gT1LChi(2),Trim(NameParticleChi(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 5
  Do gt2=2, 3
If (BR1LChi(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGChi(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LChi(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(2))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
CurrentPDG2(1) = PDGCha(gt1) 
CurrentPDG2(2) = -PDGHpm(gt2) 
Write(io_L,201) BR1LChi(2,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleChi(2))//" -> "//Trim(NameParticleCha(gt1))//" "//Trim(NameParticleHpm(gt2))//"^* "//")"
Write(io_L,201) BR1LChi(2,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleChi(2))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleHpm(gt2))//" "//")"
End if 
...
icount = icount +1 
  End Do 
End if 
If(gT1LChi(3).gt.MinWidth) Then 
Write(io_L,210) INT(PDGChi(3)),gT1LChi(3),Trim(NameParticleChi(3)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 5
  Do gt2=2, 3
If (BR1LChi(3,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGChi(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LChi(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(3))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
CurrentPDG2(1) = PDGCha(gt1) 
CurrentPDG2(2) = -PDGHpm(gt2) 
Write(io_L,201) BR1LChi(3,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleChi(3))//" -> "//Trim(NameParticleCha(gt1))//" "//Trim(NameParticleHpm(gt2))//"^* "//")"
Write(io_L,201) BR1LChi(3,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleChi(3))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleHpm(gt2))//" "//")"
End if 
...
icount = icount +1 
  End Do 
End if 
If(gT1LChi(4).gt.MinWidth) Then 
Write(io_L,210) INT(PDGChi(4)),gT1LChi(4),Trim(NameParticleChi(4)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 5
  Do gt2=2, 3
If (BR1LChi(4,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGChi(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LChi(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(4))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
CurrentPDG2(1) = PDGCha(gt1) 
CurrentPDG2(2) = -PDGHpm(gt2) 
Write(io_L,201) BR1LChi(4,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleChi(4))//" -> "//Trim(NameParticleCha(gt1))//" "//Trim(NameParticleHpm(gt2))//"^* "//")"
Write(io_L,201) BR1LChi(4,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleChi(4))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleHpm(gt2))//" "//")"
End if 
...
icount = icount +1 
  End Do 
End if 
If(gT1LChi(5).gt.MinWidth) Then 
Write(io_L,210) INT(PDGChi(5)),gT1LChi(5),Trim(NameParticleChi(5)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 5
  Do gt2=2, 3
If (BR1LChi(5,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGChi(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LChi(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(5))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
CurrentPDG2(1) = PDGCha(gt1) 
CurrentPDG2(2) = -PDGHpm(gt2) 
Write(io_L,201) BR1LChi(5,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleChi(5))//" -> "//Trim(NameParticleCha(gt1))//" "//Trim(NameParticleHpm(gt2))//"^* "//")"
Write(io_L,201) BR1LChi(5,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleChi(5))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleHpm(gt2))//" "//")"
End if 
...
If(gT1LCha(1).gt.MinWidth) Then 
Write(io_L,210) -INT(PDGCha(1)),gT1LCha(1),Trim(NameParticleCha(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 2
  Do gt2=2, 3
If (BR1LCha(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGCha(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LCha(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleCha(1))//"^* -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LCha(2).gt.MinWidth) Then 
Write(io_L,210) -INT(PDGCha(2)),gT1LCha(2),Trim(NameParticleCha(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 2
  Do gt2=2, 3
If (BR1LCha(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGCha(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LCha(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleCha(2))//"^* -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.NMSSMEFT",status="unknown")
...
Write(123,*) "lam_r = ",Real(lam,dp) 
Write(123,*) "lam_i = ",AImag(lam) 
Write(123,*) "kap_r = ",Real(kap,dp) 
Write(123,*) "kap_i = ",AImag(kap) 
...
Write(123,*) "Tlam_r = ",Real(Tlam,dp) 
Write(123,*) "Tlam_i = ",AImag(Tlam) 
Write(123,*) "Tk_r = ",Real(Tk,dp) 
Write(123,*) "Tk_i = ",AImag(Tk) 
Write(123,*) "vS= ",vS
Write(123,*) "vS= ",vS
Write(123,*) "" 
Write(123,*) "" 
...
Write(123,*) "ZN15_r = ", Real(ZN(1,5),dp)
Write(123,*) "ZN15_i = ", AImag(ZN(1,5))
Else 
...
Write(123,*) "ZN15_i = ", Real(ZN(1,5),dp)
Write(123,*) "ZN15_r = ", -AImag(ZN(1,5))
End if 
...
Write(123,*) "ZN25_r = ", Real(ZN(2,5),dp)
Write(123,*) "ZN25_i = ", AImag(ZN(2,5))
Else 
...
Write(123,*) "ZN25_i = ", Real(ZN(2,5),dp)
Write(123,*) "ZN25_r = ", -AImag(ZN(2,5))
End if 
...
Write(123,*) "ZN35_r = ", Real(ZN(3,5),dp)
Write(123,*) "ZN35_i = ", AImag(ZN(3,5))
Else 
...
Write(123,*) "ZN35_i = ", Real(ZN(3,5),dp)
Write(123,*) "ZN35_r = ", -AImag(ZN(3,5))
End if 
...
Write(123,*) "ZN45_r = ", Real(ZN(4,5),dp)
Write(123,*) "ZN45_i = ", AImag(ZN(4,5))
Else 
...
Write(123,*) "ZN45_i = ", Real(ZN(4,5),dp)
Write(123,*) "ZN45_r = ", -AImag(ZN(4,5))
End if 
If (MChi(5).Gt.0._dp) Then 
Write(123,*) "ZN51_r = ", Real(ZN(5,1),dp)
Write(123,*) "ZN51_i = ", AImag(ZN(5,1))
Write(123,*) "ZN52_r = ", Real(ZN(5,2),dp)
Write(123,*) "ZN52_i = ", AImag(ZN(5,2))
Write(123,*) "ZN53_r = ", Real(ZN(5,3),dp)
Write(123,*) "ZN53_i = ", AImag(ZN(5,3))
Write(123,*) "ZN54_r = ", Real(ZN(5,4),dp)
Write(123,*) "ZN54_i = ", AImag(ZN(5,4))
Write(123,*) "ZN55_r = ", Real(ZN(5,5),dp)
Write(123,*) "ZN55_i = ", AImag(ZN(5,5))
Else 
Write(123,*) "ZN51_i = ", Real(ZN(5,1),dp)
Write(123,*) "ZN51_r = ", -AImag(ZN(5,1))
Write(123,*) "ZN52_i = ", Real(ZN(5,2),dp)
Write(123,*) "ZN52_r = ", -AImag(ZN(5,2))
Write(123,*) "ZN53_i = ", Real(ZN(5,3),dp)
Write(123,*) "ZN53_r = ", -AImag(ZN(5,3))
Write(123,*) "ZN54_i = ", Real(ZN(5,4),dp)
Write(123,*) "ZN54_r = ", -AImag(ZN(5,4))
Write(123,*) "ZN55_i = ", Real(ZN(5,5),dp)
Write(123,*) "ZN55_r = ", -AImag(ZN(5,5))
End if 
...
Subroutine WriteWCXF 
   Open(123,file="WC.NMSSMEFT_1.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
...
Write(123,*) "}"
    Close(123) 
   Open(123,file="WC.NMSSMEFT_2.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
Write(123,*) '  "basis": "FlavorKit",'
Write(123,*) '  "scale": "91.",'
...
Else If (i_par.Eq.2) Then 
If (i_c.Eq.0) kapIN= Cmplx(wert,Aimag(kapIN),dp) 
If (i_c.Eq.1) kapIN= Cmplx(Real(kapIN,dp),wert,dp) 
InputValueforkap= .True. 
Else If (i_par.Eq.3) Then 
If (i_c.Eq.0) TlamIN= Cmplx(wert,Aimag(TlamIN),dp) 
If (i_c.Eq.1) TlamIN= Cmplx(Real(TlamIN,dp),wert,dp) 
InputValueforTlam= .True. 
Else If (i_par.Eq.4) Then 
If (i_c.Eq.0) TkIN= Cmplx(wert,Aimag(TkIN),dp) 
If (i_c.Eq.1) TkIN= Cmplx(Real(TkIN,dp),wert,dp) 
...
End Module InputOutput_NMSSMEFT 
