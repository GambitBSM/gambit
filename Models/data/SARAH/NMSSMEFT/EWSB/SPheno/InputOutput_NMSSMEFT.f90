...
Write(io_L,100) "Block DMASS  # Overall uncertainty"
 ...
 Write(io_L,102) INT(Abs(-37)), Sqrt(mass_uncertainty_Q(8)**2+mass_uncertainty_Yt(8)**2),"# MHpm(2) " 
 Write(io_L,102) INT(Abs(1000022)), Sqrt(mass_uncertainty_Q(9)**2+mass_uncertainty_Yt(9)**2),"# MChi(1) " 
 Write(io_L,102) INT(Abs(1000023)), Sqrt(mass_uncertainty_Q(10)**2+mass_uncertainty_Yt(10)**2),"# MChi(2) " 
 Write(io_L,102) INT(Abs(1000025)), Sqrt(mass_uncertainty_Q(11)**2+mass_uncertainty_Yt(11)**2),"# MChi(3) " 
 Write(io_L,102) INT(Abs(1000035)), Sqrt(mass_uncertainty_Q(12)**2+mass_uncertainty_Yt(12)**2),"# MChi(4) " 
 Write(io_L,102) INT(Abs(1000045)), Sqrt(mass_uncertainty_Q(13)**2+mass_uncertainty_Yt(13)**2),"# MChi(5) " 
 Write(io_L,102) INT(Abs(-1000024)), Sqrt(mass_uncertainty_Q(14)**2+mass_uncertainty_Yt(14)**2),"# MCha(1) " 
 Write(io_L,102) INT(Abs(-1000037)), Sqrt(mass_uncertainty_Q(15)**2+mass_uncertainty_Yt(15)**2),"# MCha(2) " 
Write(io_L,100) "Block DMASSQ  # Scale uncertainty"
 ...
 Write(io_L,102) INT(Abs(-37)), mass_uncertainty_Q(8),"# MHpm(2) " 
 Write(io_L,102) INT(Abs(1000022)), mass_uncertainty_Q(9),"# MChi(1) " 
 Write(io_L,102) INT(Abs(1000023)), mass_uncertainty_Q(10),"# MChi(2) " 
 Write(io_L,102) INT(Abs(1000025)), mass_uncertainty_Q(11),"# MChi(3) " 
 Write(io_L,102) INT(Abs(1000035)), mass_uncertainty_Q(12),"# MChi(4) " 
 Write(io_L,102) INT(Abs(1000045)), mass_uncertainty_Q(13),"# MChi(5) " 
 Write(io_L,102) INT(Abs(-1000024)), mass_uncertainty_Q(14),"# MCha(1) " 
 Write(io_L,102) INT(Abs(-1000037)), mass_uncertainty_Q(15),"# MCha(2) " 
Write(io_L,100) "Block DMASST  # Top Matching uncertainty"
 ...
 Write(io_L,102) INT(Abs(-37)), mass_uncertainty_Yt(8),"# MHpm(2) " 
 Write(io_L,102) INT(Abs(1000022)), mass_uncertainty_Yt(9),"# MChi(1) " 
 Write(io_L,102) INT(Abs(1000023)), mass_uncertainty_Yt(10),"# MChi(2) " 
 Write(io_L,102) INT(Abs(1000025)), mass_uncertainty_Yt(11),"# MChi(3) " 
 Write(io_L,102) INT(Abs(1000035)), mass_uncertainty_Yt(12),"# MChi(4) " 
 Write(io_L,102) INT(Abs(1000045)), mass_uncertainty_Yt(13),"# MChi(5) " 
 Write(io_L,102) INT(Abs(-1000024)), mass_uncertainty_Yt(14),"# MCha(1) " 
 Write(io_L,102) INT(Abs(-1000037)), mass_uncertainty_Yt(15),"# MCha(2) " 
End if
