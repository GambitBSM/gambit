...
If (rMS.gt.0.5_dp) Then
AlphaSDR = AlphaSDR*(1._dp - oo4pi*AlphaSDR-5._dp/4._dp*(AlphaSDR/Pi)**2)
End if
...
DeltaAlpha = 0.5_dp
Do i1=1,3
 If (Abs(Mhh(i1)/mf_u(3)).gt.1._dp) Then
DeltaAlpha=DeltaAlpha-0*Log(Mhh(i1)/ Q)
 End If
End Do
Do i1=1,3
 If (Abs(MAh(i1)/mf_u(3)).gt.1._dp) Then
DeltaAlpha=DeltaAlpha-0*Log(MAh(i1)/ Q)
 End If
End Do
Do i1=1,2
 If (Abs(MHpm(i1)/mf_u(3)).gt.1._dp) Then
DeltaAlpha=DeltaAlpha-0*Log(MHpm(i1)/ Q)
 End If
End Do
Do i1=1,3
 If (Abs(0./mf_u(3)).gt.1._dp) Then
DeltaAlpha=DeltaAlpha
 End If
End Do
Do i1=1,5
 If (Abs(MChi(i1)/mf_u(3)).gt.1._dp) Then
DeltaAlpha=DeltaAlpha-0*Log(MChi(i1)/ Q)
 End If
End Do
!Do i1=1,2
! If (Abs(MCha(i1)/mf_u(3)).gt.1._dp) Then
!DeltaAlpha=DeltaAlpha-(4*SAxDynkin(fWm,color))/3._dp*Log(MCha(i1)/ Q)
! End If
!End Do
Do i1=1,3
 If (Abs(MFe(i1)/mf_u(3)).gt.1._dp) Then
DeltaAlpha=DeltaAlpha-0*Log(MFe(i1)/ Q)
 End If
End Do
Do i1=1,3
