...
& cplhhHpmcVWm,cplHpmcHpmVZ,cplHpmcVWmVZ,TSOdulvSLL,TSOdulvSRR,TSOdulvSRL,               & 
...
& cplcFeFehhR(3,3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFvHpmL(3,3,2),              & 
...
& cplcFvFecVWmR(3,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcHpmVWmVZ(2),cplcVWmVWmVZ,     & 
...
& cplcFuFuVZR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,       & 
& cplcFvFvVZR,cplcHpmVWmVZ,cplcVWmVWmVZ,cplhhcHpmVWm,cplhhcVWmVWm,cplhhHpmcHpm,          & 
& cplhhHpmcVWm,cplHpmcHpmVZ,cplHpmcVWmVZ,TVOdulvSLL,TVOdulvSRR,TVOdulvSRL,               & 
...
& cplHpmcVWmVP,OA2qSL,OA2qSR,OA2qVL,OA2qVR)
...
& cplcFuFuVPR(3,3),cplcHpmVPVWm(2),cplcVWmVPVWm,cplHpmcHpmVP(2,2),cplHpmcVWmVP(2)
...
Complex(dp),Intent(in) :: cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),          & 
& cplcFdFdVGL(3,3),cplcFdFdVGR(3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFdFuHpmL(3,3,2),& 
& cplcFdFuHpmR(3,3,2),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),cplcFuFdcHpmL(3,3,2),          & 
& cplcFuFdcHpmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplcFuFuVGL(3,3),           & 
& cplcFuFuVGR(3,3)
...
& cplhhHpmcHpm,cplhhHpmcVWm,cplhhVZVZ,OH2qSL,OH2qSR)
...
& cplcFdFuHpmL(3,3,2),cplcFdFuHpmR(3,3,2),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),           & 
& cplcFuFdcHpmL(3,3,2),cplcFuFdcHpmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),       & 
& cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),               & 
& cplhhhhhh(3,3,3),cplhhHpmcHpm(3,2,2),cplhhHpmcVWm(3,2),cplhhVZVZ(3)
...
End Function C1C2 
End Module FlavorKit_QFV_NMSSMEFT 
