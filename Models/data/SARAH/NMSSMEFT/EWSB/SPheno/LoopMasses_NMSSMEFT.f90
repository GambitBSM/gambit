...
Use Tadpoles_NMSSMEFT 
 Use EffectivePotential_NMSSMEFT 
 Use Pole2L_NMSSMEFT 
...
& cplcChaChaVPR(2,2),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplcChaUChiHpmL(2,5,2),       & 
...
& cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFuFdcUHpmL(3,3,2),& 
& cplcFuFdcUHpmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplcFuFuUAhL(3,3,3),       & 
...
& cplcgWmgWmUhh(3),cplcgWmgWmVP,cplcgWmgWmVZ,cplcgWmgZUHpm(2),cplcgWpCgAcVWm,            & 
& cplcgWpCgWpCUAh(3),cplcgWpCgWpCUhh(3),cplcgWpCgWpCVP,cplcgWpCgWpCVZ,cplcgWpCgZcUHpm(2),& 
& cplcgWpCgZcVWm,cplcgZgWmcUHpm(2),cplcgZgWmcVWm,cplcgZgWpCUHpm(2),cplcgZgZUhh(3),       & 
& cplChiChacUHpmL(5,2,2),cplChiChacUHpmR(5,2,2),cplChiChacVWmL(5,2),cplChiChacVWmR(5,2), & 
& cplChiChiUAhL(5,5,3),cplChiChiUAhR(5,5,3),cplChiChiUhhL(5,5,3),cplChiChiUhhR(5,5,3),   & 
& cplChiChiVZL(5,5),cplChiChiVZR(5,5),cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcUChaChaAhL(2,2,3),& 
...
& cplcUFuFuVPR(3,3),cplcUFuFuVZL(3,3),cplcUFuFuVZR(3,3),cplcUFvFecHpmL(3,3,2),           & 
...
Complex(dp) :: cplcVWmVPVWmVZ1,cplcVWmVPVWmVZ2,cplcVWmVPVWmVZ3,cplcVWmVWmVZ,cplcVWmVWmVZVZ1,          & 
...
& cplhhVZVZ(3),cplHpmcHpmcVWmVWm(2,2),cplHpmcHpmVP(2,2),cplHpmcHpmVPVP(2,2),             & 
& cplHpmcHpmVPVZ(2,2),cplHpmcHpmVZ(2,2),cplHpmcHpmVZVZ(2,2),cplHpmcUHpmVP(2,2),          & 
& cplHpmcUHpmVZ(2,2),cplHpmcVWmVP(2),cplHpmcVWmVZ(2),cplUAhAhAh(3,3,3),cplUAhAhhh(3,3,3),& 
& cplUAhhhhh(3,3,3),cplUAhhhVZ(3,3),cplUAhHpmcHpm(3,2,2),cplUAhHpmcVWm(3,2),             & 
& cplUAhUAhAhAh(3,3,3,3),cplUAhUAhcVWmVWm(3,3),cplUAhUAhhhhh(3,3,3,3),cplUAhUAhHpmcHpm(3,3,2,2),& 
...
& cplUChiChihhR(5,5,3),cplUChiChiVZL(5,5),cplUChiChiVZR(5,5),cplUhhcVWmVWm(3),           & 
& cplUhhhhhh(3,3,3),cplUhhHpmcHpm(3,2,2),cplUhhHpmcVWm(3,2),cplUhhUhhcVWmVWm(3,3),       & 
& cplUhhUhhhhhh(3,3,3,3),cplUhhUhhHpmcHpm(3,3,2,2),cplUhhUhhVZVZ(3,3),cplUhhVZVZ(3),     & 
& cplUHpmcUHpmcVWmVWm(2,2),cplUHpmcUHpmVPVP(2,2),cplUHpmcUHpmVZVZ(2,2),cplUHpmHpmcUHpmcHpm(2,2,2,2),& 
...
& cplcChaUChiHpmL,cplcChaUChiHpmR,cplcChaUChiVWmL,cplcChaUChiVWmR,cplcUChaChaAhL,        & 
...
& cplcUChaChiVWmR,cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeFehhL,cplcUFeFehhR,cplcUFeFeVPL,      & 
...
& cplcUFuFuVGR,cplcUFuFuVPL,cplcUFuFuVPR,cplcUFuFuVZL,cplcUFuFuVZR,cplcUFvFecHpmL,       & 
& cplcUFvFecHpmR,cplcUFvFecVWmL,cplcUFvFecVWmR,cplcUFvFvVZL,cplcUFvFvVZR,cplcFdFdVGL,    & 
& cplcFdFdVGR,cplcFuFuVGL,cplcFuFuVGR,cplcgGgGVG,cplVGVGVG,cplVGVGVGVG1,cplVGVGVGVG2,    & 
& cplVGVGVGVG3,cplcChaChaVPL,cplcChaChaVPR,cplcFdFdVPL,cplcFdFdVPR,cplcFeFeVPL,          & 
...
& cplUChiChiVZL,cplUChiChiVZR,cplcChaUChiHpmL,cplcChaUChiHpmR,cplcChaUChiVWmL,           & 
...
Call OneLoopFe(Ye,vd,MFe,MFe2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,MHpm,MHpm2,MVWm,             & 
...
Call OneLoopFd(Yd,vd,MFd,MFd2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,MHpm,MHpm2,MFu,              & 
& MFu2,MVWm,MVWm2,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,cplcUFdFdhhR,cplcUFdFdVGL,      & 
& cplcUFdFdVGR,cplcUFdFdVPL,cplcUFdFdVPR,cplcUFdFdVZL,cplcUFdFdVZR,cplcUFdFuHpmL,        & 
& cplcUFdFuHpmR,cplcUFdFuVWmL,cplcUFdFuVWmR,0.1_dp*delta_mass,MFd_1L,MFd2_1L,            & 
& ZDL_1L,ZDR_1L,kont)

Call OneLoopFu(Yu,vu,MFu,MFu2,MAh,MAh2,MHpm,MHpm2,MFd,MFd2,MVWm,MVWm2,Mhh,            & 
...
& MFd2,MFe,MFe2,MFu,MFu2,MVZ,MVZ2,MHpm,MHpm2,MVWm,MVWm2,cplUAhAhAh,cplUAhAhhh,           & 
...
& cplUAhhhhh,cplUAhhhVZ,cplUAhHpmcHpm,cplUAhHpmcVWm,cplUAhUAhAhAh,cplUAhUAhhhhh,         & 
& cplUAhUAhHpmcHpm,cplUAhUAhcVWmVWm,cplUAhUAhVZVZ,kont,res)
...
& cplUChiChihhR,cplUChiChiVZL,cplUChiChiVZR,cplcChaUChiHpmL,cplcChaUChiHpmR,             & 
& cplcChaUChiVWmL,cplcChaUChiVWmR,delta,MChi_1L,MChi2_1L,ZN_1L,ierr)
...
& cplUChiChiVZL(5,5),cplUChiChiVZR(5,5),cplcChaUChiHpmL(2,5,2),cplcChaUChiHpmR(2,5,2),   & 
...
& MVWm,MVWm2,Mhh,Mhh2,MVZ,MVZ2,cplUChiChiAhL,cplUChiChiAhR,cplUChiChacHpmL,              & 
& cplUChiChacHpmR,cplUChiChacVWmL,cplUChiChacVWmR,cplUChiChihhL,cplUChiChihhR,           & 
& cplUChiChiVZL,cplUChiChiVZR,cplcChaUChiHpmL,cplcChaUChiHpmR,cplcChaUChiVWmL,           & 
...
& cplcUChaChiHpmR,cplcUChaChiVWmL,cplcUChaChiVWmR,sigL,sigR,sigSL,sigSR)
...
& cplcUChaChahhR,cplcUChaChaVPL,cplcUChaChaVPR,cplcUChaChaVZL,cplcUChaChaVZR,            & 
& cplcUChaChiHpmL,cplcUChaChiHpmR,cplcUChaChiVWmL,cplcUChaChiVWmR,sigL,sigR,             & 
& sigSL,sigSR)
...
Subroutine DerSigma1LoopFe(p2,MFe,MFe2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,MHpm,               & 
& MHpm2,MVWm,MVWm2,cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeFehhL,cplcUFeFehhR,cplcUFeFeVPL,     & 
& cplcUFeFeVPR,cplcUFeFeVZL,cplcUFeFeVZR,cplcUFeFvHpmL,cplcUFeFvHpmR,cplcUFeFvVWmL,      & 
& cplcUFeFvVWmR,sigL,sigR,sigSL,sigSR)
...
& MFu2,MVWm,MVWm2,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,cplcUFdFdhhR,cplcUFdFdVGL,      & 
& cplcUFdFdVGR,cplcUFdFdVPL,cplcUFdFdVPR,cplcUFdFdVZL,cplcUFdFdVZR,cplcUFdFuHpmL,        & 
& cplcUFdFuHpmR,cplcUFdFuVWmL,cplcUFdFuVWmR,sigL,sigR,sigSL,sigSR)
...
& MFu,MFu2,MVWm,MVWm2,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,cplcUFdFdhhR,               & 
& cplcUFdFdVGL,cplcUFdFdVGR,cplcUFdFdVPL,cplcUFdFdVPR,cplcUFdFdVZL,cplcUFdFdVZR,         & 
& cplcUFdFuHpmL,cplcUFdFuHpmR,cplcUFdFuVWmL,cplcUFdFuVWmR,sigL,sigR,sigSL,sigSR)
...
Subroutine DerSigma1LoopFd(p2,MFd,MFd2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,MHpm,               & 
& MHpm2,MFu,MFu2,MVWm,MVWm2,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,cplcUFdFdhhR,         & 
& cplcUFdFdVGL,cplcUFdFdVGR,cplcUFdFdVPL,cplcUFdFdVPR,cplcUFdFdVZL,cplcUFdFdVZR,         & 
& cplcUFdFuHpmL,cplcUFdFuHpmR,cplcUFdFuVWmL,cplcUFdFuVWmR,sigL,sigR,sigSL,sigSR)
...
Subroutine DerSigma1LoopFu(p2,MFu,MFu2,MAh,MAh2,MHpm,MHpm2,MFd,MFd2,MVWm,             & 
...
Subroutine Sigma1LoopFv(p2,MHpm,MHpm2,MFe,MFe2,MVWm,MVWm2,MVZ,MVZ2,cplcUFvFecHpmL,    & 
& cplcUFvFecHpmR,cplcUFvFecVWmL,cplcUFvFecVWmR,cplcUFvFvVZL,cplcUFvFvVZR,sigL,           & 
& sigR,sigSL,sigSR)

Implicit None 
Real(dp), Intent(in) :: MHpm(2),MHpm2(2),MFe(3),MFe2(3),MVWm,MVWm2,MVZ,MVZ2

Complex(dp), Intent(in) :: cplcUFvFecHpmL(3,3,2),cplcUFvFecHpmR(3,3,2),cplcUFvFecVWmL(3,3),cplcUFvFecVWmR(3,3),  & 
...
Subroutine DerSigma1LoopFv(p2,MHpm,MHpm2,MFe,MFe2,MVWm,MVWm2,MVZ,MVZ2,cplcUFvFecHpmL, & 
& cplcUFvFecHpmR,cplcUFvFecVWmL,cplcUFvFecVWmR,cplcUFvFvVZL,cplcUFvFvVZR,sigL,           & 
& sigR,sigSL,sigSR)
...
& MVWm,MVWm2,cplcChaChaVPL,cplcChaChaVPR,cplcFdFdVPL,cplcFdFdVPR,cplcFeFeVPL,            & 
& cplcFeFeVPR,cplcFuFuVPL,cplcFuFuVPR,cplcgWmgWmVP,cplcgWpCgWpCVP,cplHpmcHpmVP,          & 
& cplHpmcVWmVP,cplcVWmVPVWm,cplHpmcHpmVPVP,cplcVWmVPVPVWm3,cplcVWmVPVPVWm1,              & 
& cplcVWmVPVPVWm2,kont,res)
...
& MFd2,MFe,MFe2,MFu,MFu2,MVZ,MVZ2,MHpm,MHpm2,MVWm,MVWm2,cplAhhhVZ,cplcChaChaVZL,         & 
& cplcChaChaVZR,cplChiChiVZL,cplChiChiVZR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,           & 
& cplcFeFeVZR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFvVZL,cplcFvFvVZR,cplcgWmgWmVZ,              & 
& cplcgWpCgWpCVZ,cplhhVZVZ,cplHpmcHpmVZ,cplHpmcVWmVZ,cplcVWmVWmVZ,cplAhAhVZVZ,           & 
& cplhhhhVZVZ,cplHpmcHpmVZVZ,cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,kont,res)
...
& cplHpmcHpmVPVZ,cplHpmcHpmVZ,cplHpmcVWmVP,cplHpmcVWmVZ,kont,res)
...
& cplHpmcHpmVZ(2,2),cplHpmcVWmVP(2),cplHpmcVWmVZ(2)
...
& MHpm2,MVWm,MVWm2,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,              & 
...
& cplcgWmgWmVP,cplcgWmgWmVZ,cplcgWpCgWpCVP,cplcgWpCgWpCVZ,cplcHpmVPVWm,cplcHpmVWmVZ,     & 
& cplcVWmVPVWm,cplcVWmVPVWmVZ1,cplcVWmVPVWmVZ2,cplcVWmVPVWmVZ3,cplcVWmVWmVZ,             & 
& cplHpmcHpmVP,cplHpmcHpmVPVZ,cplHpmcHpmVZ,cplHpmcVWmVP,cplHpmcVWmVZ,kont,res)
...
& cplHpmcVWmVZ,kont,res)

Implicit None 
Real(dp), Intent(in) :: MAh(3),MAh2(3),MCha(2),MCha2(2),MChi(5),MChi2(5),MFd(3),MFd2(3),MFe(3),               & 
& MFe2(3),MFu(3),MFu2(3),Mhh(3),Mhh2(3),MHpm(2),MHpm2(2),MVWm,MVWm2
...
& cplhhHpmcHpm(3,2,2),cplhhHpmcVWm(3,2),cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2)
...
& MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWm,MVWm2,cplAhhhhh,cplAhhhVZ,cplcChaChahhL,        & 
& cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,         & 
& cplcFdFdVZR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuhhL,               & 
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcgWmgWmhh,cplcgWmgWmVZ,cplcgWpCgWpChh,          & 
& cplcgWpCgWpCVZ,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,cplcHpmVWmVZ,       & 
...
& cplhhVZVZ(3),cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2)
...
& MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhhh,cplAhcHpmVWm,          & 
& cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplcChaChaAhL,cplcChaChaAhR,cplcChaChaVZL,         & 
& cplcChaChaVZR,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeAhL,             & 
& cplcFeFeAhR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuVZL,               & 
& cplcFuFuVZR,cplcgWmgWmAh,cplcgWmgWmVZ,cplcgWpCgWpCAh,cplcgWpCgWpCVZ,cplChiChiAhL,      & 
...
& MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWm,MVWm2,MVZ,MVZ2,cplAhcHpmVWm,cplAhHpmcHpm,       & 
...
& cplhhcVWmVWm,cplhhHpmcHpm,cplHpmcHpmVP,cplHpmcHpmVZ,kont,res)
...
& cplhhHpmcHpm(3,2,2),cplHpmcHpmVP(2,2),cplHpmcHpmVZ(2,2)
...
& MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWm,MVWm2,MVZ,MVZ2,cplAhcHpmVWm,cplAhHpmcHpm,   & 
& cplcChaChiVWmL,cplcChaChiVWmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFeFvVWmL,cplcFeFvVWmR,     & 
& cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFvFecHpmL,cplcFvFecHpmR,cplcgAgWpCVWm,cplcgWmgZVWm,    & 
& cplcgWpCgAcHpm,cplcgWpCgZcHpm,cplcgZgWmcHpm,cplcgZgWpCVWm,cplChiChacHpmL,              & 
& cplChiChacHpmR,cplcHpmVPVWm,cplcHpmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHpmVWm,       & 
...
End Module LoopMasses_NMSSMEFT 
