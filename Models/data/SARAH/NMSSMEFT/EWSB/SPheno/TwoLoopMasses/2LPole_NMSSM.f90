...
if(nonzerocoupling) then 
 funcvalue= 1._dp/6._dp*TfSSS(MAh2(i1),MAh2(i2),MAh2(i3),Qscale)
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*TfSSS(MAh2(i1),Mhh2(i2),Mhh2(i3),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*TfSS(MAh2(i1),Mhh2(i2),MAh2(i3),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*TfSS(MAh2(i1),Mhh2(i2),Mhh2(i3),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 1._dp*TfSS(MAh2(i1),Mhh2(i2),MHpm2(i3),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,3
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhAhAh(i1,i3,i4)
coup3 = cplAhAhAh(i2,i3,i4)
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -1._dp/4._dp*TfSSSS(MAh2(i1),MAh2(i2),MAh2(i3),MAh2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,3
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhhhhh(i1,i3,i4)
coup3 = cplAhhhhh(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -1._dp/4._dp*TfSSSS(MAh2(i1),MAh2(i2),Mhh2(i3),Mhh2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*TfSSSS(MAh2(i1),Mhh2(i2),MAh2(i3),MAh2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -1._dp*TfSSSS(MAh2(i1),Mhh2(i2),MAh2(i3),Mhh2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*TfSSSS(MAh2(i1),Mhh2(i2),Mhh2(i3),Mhh2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -1._dp*TfSSSS(MAh2(i1),Mhh2(i2),MHpm2(i3),MHpm2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*TfSSSS(Mhh2(i1),Mhh2(i2),MAh2(i3),Mhh2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -1._dp*TfSSFF(MAh2(i1),Mhh2(i2),MCha2(i3),MCha2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
if((MCha(i3) .gt. epsfmass) .and. (MCha(i4) .gt. epsfmass)) then 
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MCha(i3)*MCha(i4)*TfSSFbFb(MAh2(i1),Mhh2(i2),MCha2(i3),MCha2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*TfSSFF(MAh2(i1),Mhh2(i2),MChi2(i3),MChi2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
if((MChi(i3) .gt. epsfmass) .and. (MChi(i4) .gt. epsfmass)) then 
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= MChi(i3)*MChi(i4)*TfSSFbFb(MAh2(i1),Mhh2(i2),MChi2(i3),MChi2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -3._dp*TfSSFF(MAh2(i1),Mhh2(i2),MFd2(i3),MFd2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
if((MFd(i3) .gt. epsfmass) .and. (MFd(i4) .gt. epsfmass)) then 
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 6._dp*MFd(i3)*MFd(i4)*TfSSFbFb(MAh2(i1),Mhh2(i2),MFd2(i3),MFd2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -1._dp*TfSSFF(MAh2(i1),Mhh2(i2),MFe2(i3),MFe2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
if((MFe(i3) .gt. epsfmass) .and. (MFe(i4) .gt. epsfmass)) then 
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MFe(i3)*MFe(i4)*TfSSFbFb(MAh2(i1),Mhh2(i2),MFe2(i3),MFe2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -3._dp*TfSSFF(MAh2(i1),Mhh2(i2),MFu2(i3),MFu2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
if((MFu(i3) .gt. epsfmass) .and. (MFu(i4) .gt. epsfmass)) then 
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 6._dp*MFu(i3)*MFu(i4)*TfSSFbFb(MAh2(i1),Mhh2(i2),MFu2(i3),MFu2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end if
...
if((MCha(i1) .gt. epsfmass) .and. (MCha(i3) .gt. epsfmass) .and. (MCha(i2) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
coup1L = cplcChaChahhL(i2,i1,gE1)
coup1R = cplcChaChahhR(i2,i1,gE1)
...
if((MCha(i1) .gt. epsfmass) .and. (MChi(i3) .gt. epsfmass) .and. (MCha(i2) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
coup1L = cplcChaChahhL(i2,i1,gE1)
coup1R = cplcChaChahhR(i2,i1,gE1)
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/4._dp*WfSSSS(p2,MAh2(i1),MAh2(i2),MAh2(i3),MAh2(i4),Qscale)
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/4._dp*WfSSSS(p2,MAh2(i1),MAh2(i2),Mhh2(i3),Mhh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*WfSSSS(p2,MAh2(i1),Mhh2(i2),MAh2(i3),MAh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*WfSSSS(p2,MAh2(i1),Mhh2(i2),MAh2(i3),Mhh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*WfSSSS(p2,MAh2(i1),Mhh2(i2),Mhh2(i3),Mhh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*WfSSSS(p2,Mhh2(i1),Mhh2(i2),MAh2(i3),Mhh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhhhhh(i1,gE2,i3)
coup3 = cplAhAhAhhh(i2,i4,i4,i3)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*YfSSSS(p2,MAh2(i1),MAh2(i2),Mhh2(i3),MAh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*YfSSSS(p2,MAh2(i1),MAh2(i2),Mhh2(i3),Mhh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*YfSSSS(p2,MAh2(i1),MAh2(i2),Mhh2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1 = cplAhhhhh(i2,gE1,i1)
coup2 = cplAhhhhh(i3,gE2,i1)
coup3 = cplAhAhAhAh(i2,i3,i4,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*YfSSSS(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),MAh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*YfSSSS(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),Mhh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*YfSSSS(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhhhhh(i3,gE2,i4)
coup3 = cplAhAhAhhh(i1,i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*ZfSSSS(p2,MAh2(i1),MAh2(i2),MAh2(i3),Mhh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*ZfSSSS(p2,MAh2(i1),Mhh2(i2),Mhh2(i3),Mhh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhAhAhhh(i1,i3,i4,gE2)
coup3 = cplAhAhAh(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*UfSSSS(p2,MAh2(i1),MAh2(i2),MAh2(i3),MAh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhhhhhhh(i1,gE2,i3,i4)
coup3 = cplAhhhhh(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*UfSSSS(p2,MAh2(i1),MAh2(i2),Mhh2(i3),Mhh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*UfSSSS(p2,MAh2(i1),Mhh2(i2),MAh2(i3),Mhh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*UfSSSS(p2,Mhh2(i1),MAh2(i2),MAh2(i3),MAh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1 = cplAhhhhh(i2,gE1,i1)
coup2 = cplAhhhhhhh(i3,gE2,i1,i4)
coup3 = cplAhAhhh(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*UfSSSS(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),Mhh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*UfSSSS(p2,Mhh2(i1),Mhh2(i2),MAh2(i3),Mhh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhAhhh(i1,i3,gE2)
coup3 = cplAhAhAh(i2,i4,i5)
coup4 = cplAhAhAh(i3,i4,i5)
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*VfSSSSS(p2,MAh2(i1),MAh2(i2),MAh2(i3),MAh2(i4),MAh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhAhhh(i1,i3,gE2)
coup3 = cplAhhhhh(i2,i4,i5)
coup4 = cplAhhhhh(i3,i4,i5)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*VfSSSSS(p2,MAh2(i1),MAh2(i2),MAh2(i3),Mhh2(i4),Mhh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*VfSSSSS(p2,MAh2(i1),MAh2(i2),Mhh2(i3),MAh2(i4),MAh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*VfSSSSS(p2,MAh2(i1),MAh2(i2),Mhh2(i3),MAh2(i4),Mhh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*VfSSSSS(p2,MAh2(i1),MAh2(i2),Mhh2(i3),Mhh2(i4),Mhh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*VfSSSSS(p2,MAh2(i1),MAh2(i2),Mhh2(i3),MHpm2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*VfSSSSS(p2,MAh2(i1),Mhh2(i2),Mhh2(i3),MAh2(i4),Mhh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*VfSSSSS(p2,Mhh2(i1),MAh2(i2),MAh2(i3),MAh2(i4),MAh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*VfSSSSS(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),MAh2(i4),MAh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*VfSSSSS(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),MAh2(i4),Mhh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*VfSSSSS(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),Mhh2(i4),Mhh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*VfSSSSS(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),MHpm2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*VfSSSSS(p2,Mhh2(i1),Mhh2(i2),Mhh2(i3),MAh2(i4),Mhh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*MfSSSSS(p2,MAh2(i1),MAh2(i2),MAh2(i3),MAh2(i4),MAh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MfSSSSS(p2,MAh2(i1),MAh2(i2),MAh2(i3),Mhh2(i4),MAh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MfSSSSS(p2,MAh2(i1),MAh2(i2),MAh2(i3),Mhh2(i4),Mhh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*MfSSSSS(p2,MAh2(i1),Mhh2(i2),MAh2(i3),Mhh2(i4),Mhh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1 = cplAhhhhh(i1,gE1,i3)
coup2 = cplAhhhhh(i2,gE2,i4)
coup3 = cplAhAhAh(i1,i2,i5)
coup4 = cplAhhhhh(i5,i3,i4)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MfSSSSS(p2,MAh2(i1),MAh2(i2),Mhh2(i3),Mhh2(i4),MAh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MfSSSSS(p2,MAh2(i1),MAh2(i2),Mhh2(i3),Mhh2(i4),Mhh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MfSSSSS(p2,MAh2(i1),Mhh2(i2),Mhh2(i3),Mhh2(i4),MAh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MfSSSSS(p2,MAh2(i1),Mhh2(i2),Mhh2(i3),Mhh2(i4),Mhh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*MfSSSSS(p2,Mhh2(i1),Mhh2(i2),Mhh2(i3),Mhh2(i4),MAh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
Do i4=1,5
Do i5=1,2
if((MCha(i1) .gt. epsfmass) .and. (MChi(i2) .gt. epsfmass) .and. (MChi(i4) .gt. epsfmass) .and. (MCha(i3) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
...
if((MChi(i2) .gt. epsfmass) .and. (MCha(i3) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1L = cplcChaChahhL(i3,i1,gE1)
...
if((MChi(i4) .gt. epsfmass) .and. (MCha(i3) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1L = cplcChaChahhL(i3,i1,gE1)
...
Do i4=1,2
Do i5=1,3
if((MCha(i1) .gt. epsfmass) .and. (MCha(i4) .gt. epsfmass) .and. (MCha(i2) .gt. epsfmass) .and. (MCha(i3) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1L = cplcChaChahhL(i3,i1,gE1)
...
if((MCha(i4) .gt. epsfmass) .and. (MCha(i2) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1L = cplcChaChahhL(i3,i1,gE1)
...
if((MCha(i4) .gt. epsfmass) .and. (MCha(i3) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1L = cplcChaChahhL(i3,i1,gE1)
...
Do i4=1,2
Do i5=1,2
if((MCha(i2) .gt. epsfmass) .and. (MChi(i1) .gt. epsfmass) .and. (MChi(i3) .gt. epsfmass) .and. (MCha(i4) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
...
if((MChi(i3) .gt. epsfmass) .and. (MCha(i4) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1L = cplChiChihhL(i1,i3,gE1)
...
Do i4=1,2
Do i5=1,2
if((MCha(i2) .gt. epsfmass) .and. (MCha(i5) .gt. epsfmass) .and. (MCha(i4) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1 = cplAhAhhh(i1,i3,gE1)
...
Do i4=1,2
Do i5=1,5
if((MCha(i4) .gt. epsfmass) .and. (MChi(i5) .gt. epsfmass) .and. (MCha(i2) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1 = cplhhHpmcHpm(gE1,i1,i3)
...
Do i4=1,3
Do i5=1,3
if((MFd(i4) .gt. epsfmass) .and. (MFd(i2) .gt. epsfmass) .and. (MFu(i5) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1 = cplhhHpmcHpm(gE1,i1,i3)
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MCha(i4)*MCha(i5)*VfSSSFbFb(p2,MAh2(i1),MAh2(i2),Mhh2(i3),MCha2(i4),MCha2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*VfSSSFF(p2,MAh2(i1),MAh2(i2),Mhh2(i3),MCha2(i4),MCha2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= MChi(i4)*MChi(i5)*VfSSSFbFb(p2,MAh2(i1),MAh2(i2),Mhh2(i3),MChi2(i4),MChi2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*VfSSSFF(p2,MAh2(i1),MAh2(i2),Mhh2(i3),MChi2(i4),MChi2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 6._dp*MFd(i4)*MFd(i5)*VfSSSFbFb(p2,MAh2(i1),MAh2(i2),Mhh2(i3),MFd2(i4),MFd2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 6._dp*VfSSSFF(p2,MAh2(i1),MAh2(i2),Mhh2(i3),MFd2(i4),MFd2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MFe(i4)*MFe(i5)*VfSSSFbFb(p2,MAh2(i1),MAh2(i2),Mhh2(i3),MFe2(i4),MFe2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*VfSSSFF(p2,MAh2(i1),MAh2(i2),Mhh2(i3),MFe2(i4),MFe2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 6._dp*MFu(i4)*MFu(i5)*VfSSSFbFb(p2,MAh2(i1),MAh2(i2),Mhh2(i3),MFu2(i4),MFu2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 6._dp*VfSSSFF(p2,MAh2(i1),MAh2(i2),Mhh2(i3),MFu2(i4),MFu2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MCha(i4)*MCha(i5)*VfSSSFbFb(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),MCha2(i4),MCha2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*VfSSSFF(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),MCha2(i4),MCha2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= MChi(i4)*MChi(i5)*VfSSSFbFb(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),MChi2(i4),MChi2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*VfSSSFF(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),MChi2(i4),MChi2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 6._dp*MFd(i4)*MFd(i5)*VfSSSFbFb(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),MFd2(i4),MFd2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 6._dp*VfSSSFF(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),MFd2(i4),MFd2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MFe(i4)*MFe(i5)*VfSSSFbFb(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),MFe2(i4),MFe2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*VfSSSFF(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),MFe2(i4),MFe2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 6._dp*MFu(i4)*MFu(i5)*VfSSSFbFb(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),MFu2(i4),MFu2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 6._dp*VfSSSFF(p2,Mhh2(i1),MAh2(i2),Mhh2(i3),MFu2(i4),MFu2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
Do i4=1,5
Do i5=1,2
if((MChi(i4) .gt. epsfmass) .and. (MCha(i5) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1 = cplhhHpmcHpm(gE1,i1,i2)
...
Do i4=1,3
Do i5=1,3
if((MFu(i4) .gt. epsfmass) .and. (MFd(i5) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1 = cplhhHpmcHpm(gE1,i1,i2)
...
Do i4=1,2
Do i5=1,3
if((MCha(i1) .gt. epsfmass) .and. (MCha(i3) .gt. epsfmass) .and. (MCha(i2) .gt. epsfmass) .and. (MCha(i4) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1L = cplcChaChahhL(i2,i1,gE1)
...
if((MCha(i3) .gt. epsfmass) .and. (MCha(i2) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1L = cplcChaChahhL(i2,i1,gE1)
...
Do i4=1,5
Do i5=1,2
if((MCha(i1) .gt. epsfmass) .and. (MCha(i3) .gt. epsfmass) .and. (MChi(i4) .gt. epsfmass) .and. (MCha(i2) .gt. epsfmass)) then 
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1L = cplcChaChahhL(i2,i1,gE1)
...
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1 = cplAhAhAh(gE1,i1,i2)
coup2 = cplAhAhAhhh(gE2,i1,i3,i4)
coup3 = cplAhAhhh(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1 = cplAhAhhh(gE1,i2,i1)
coup2 = cplAhAhAhhh(gE2,i3,i4,i1)
coup3 = cplAhAhAh(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1 = cplAhAhhh(gE1,i2,i1)
coup2 = cplAhhhhhhh(gE2,i1,i3,i4)
coup3 = cplAhhhhh(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,3
   Do gE2=1,3
coup1 = cplAhAhAh(gE1,i1,i3)
coup2 = cplAhAhAh(gE2,i2,i4)
coup3 = cplAhAhAh(i1,i2,i5)
coup4 = cplAhAhAh(i3,i4,i5)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
