...
& Mhhinput(3),Mhh2input(3),MHpminput(2),MHpm2input(2),MSdinput(1),MSd2input(1),          & 
& MSeinput(1),MSe2input(1),MSuinput(1),MSu2input(1),MSvinput(1),MSv2input(1),            & 
& MVWminput,MVWm2input,MVZinput,MVZ2input,TWinput,vinput,ZAinput(3,3),ZHinput(3,3),      & 
& ZPinput(2,2),ZZinput(2,2),betaHinput

Complex(dp),Intent(in) :: pGinput,UMinput(2,2),UPinput(2,2),ZDinput(1,1),ZDLinput(3,3),ZDRinput(3,3),           & 
& ZEinput(1,1),ZELinput(3,3),ZERinput(3,3),ZNinput(5,5),ZUinput(1,1),ZULinput(3,3),      & 
& ZURinput(3,3),ZVinput(1,1),ZWinput(2,2)
...
ratioPPP(i1) = Abs(cplPseudoHiggsPP(i1)/(coup*oo4pi*(1._dp-mW2/mZ2)*g2**2))**2 
  gNLO = -1._dp 
...
coup = coup*Sqrt(1._dp + NLOqcd+NNLOqcd+NNNLOqcd) 
ratioPGG(i1) = Abs(cplPseudoHiggsGG(i1)/(coup*AlphaSQ))**2 
