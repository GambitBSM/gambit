...
Real(dp), Intent(out) :: MSd(1), MSd2(1)
Complex(dp), Intent(out) :: ZD(1,1)
...
Integer :: i1,i2,i3,i4, ierr
Integer :: j1,j2,j3,j4, pos
Real(dp), Intent(out) :: MSv(1), MSv2(1)
Complex(dp), Intent(out) :: ZV(1,1)
...
Integer :: i1,i2,i3,i4, ierr
Integer :: j1,j2,j3,j4, pos
Real(dp), Intent(out) :: MSu(1), MSu2(1)
Complex(dp), Intent(out) :: ZU(1,1)
...
Integer :: i1,i2,i3,i4, ierr
Integer :: j1,j2,j3,j4, pos
Real(dp), Intent(out) :: MSe(1), MSe2(1)
Complex(dp), Intent(out) :: ZE(1,1)
...
Real(dp) :: MSd2temp(1), Q2
Complex(dp) :: ZDtemp(1,1), ZDtemp2(1,1)
...
Real(dp) :: MSv2temp(1), Q2
Complex(dp) :: ZVtemp(1,1), ZVtemp2(1,1)
...
Real(dp) :: MSu2temp(1), Q2
Complex(dp) :: ZUtemp(1,1), ZUtemp2(1,1)
...
Real(dp) :: MSe2temp(1), Q2
Complex(dp) :: ZEtemp(1,1), ZEtemp2(1,1)
...
End Module TreeLevelMasses_NMSSM
