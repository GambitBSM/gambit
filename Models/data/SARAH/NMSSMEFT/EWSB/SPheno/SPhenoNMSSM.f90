...
! ------------------------------------------------------------------------------
! File created at 14:17 on 19.10.2018
! ----------------------------------------------------------------------
...
Use RunSM_NMSSM
Use LowEnergy_NMSSM
Use FlavorKit_LFV_NMSSM
Use FlavorKit_QFV_NMSSM
Use FlavorKit_Observables_NMSSM
Use Mathematics
Use Model_Data_NMSSM
Use Tadpoles_NMSSM
 Use RGEs_NMSSM
!Use StandardModel
Use Boundaries_NMSSM
 Use HiggsCS_NMSSM
Use TreeLevelMasses_NMSSM
Use LoopMasses_NMSSM

Use BranchingRatios_NMSSM
...
& MChi,MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,           &
& MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,pG,TW,UM,UP,v,ZA,ZD,ZDL,ZDR,ZE,ZEL,              &
& ZER,ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,ZW,ZZ,betaH,vdMZ,vuMZ,vS,g1,g2,g3,Yd,Ye,lam,kap,            &
& Yu,Td,Te,Tlam,Tk,Tu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,ms2,M1,M2,M3,gPhh,gThh,              &
& BRhh,gPAh,gTAh,BRAh,gPHpm,gTHpm,BRHpm,gPChi,gTChi,BRChi,gPCha,gTCha,BRCha,             &
& gPFu,gTFu,BRFu)
...
& Tk,Tu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,ms2,M1,M2,M3,vd,vu,vS,ae,amu,atau,EDMe,            &
...
& M1input,M2input,M3input,vdinput,vuinput,vSinput,ae,amu,atau,EDMe,EDMmu,EDMtau,         &
...
Complex(dp) :: pG,UM(2,2),UP(2,2),ZD(1,1),ZDL(3,3),ZDR(3,3),ZE(1,1),ZEL(3,3),ZER(3,3),               &
& ZN(5,5),ZU(1,1),ZUL(3,3),ZUR(3,3),ZV(1,1),ZW(2,2)
...
& cplcgWpCgAcVWm,cplcgWpCgWpCVZ,cplcgWpCgZcVWm,cplcgZgWmcVWm,cplChiChacHpmL(5,2,2),      &
...
& cplChiChiVZR(5,5),cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,&
& cplcVWmcVWmVWmVWm3,cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,cplcVWmVPVWm,       &
& cplcVWmVWmVZ,cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplhhcHpmVWm(3,2),        &
& cplhhcVWmVWm(3),cplhhhhcVWmVWm(3,3),cplhhhhhh(3,3,3),cplhhhhVZVZ(3,3),cplhhHpmcHpm(3,2,2),&
& cplhhHpmcVWm(3,2),cplhhVZVZ(3),cplHpmcHpmcVWmVWm(2,2),cplHpmcHpmVP(2,2),               &
& cplHpmcHpmVZ(2,2),cplHpmcHpmVZVZ(2,2),cplHpmcVWmVP(2),cplHpmcVWmVZ(2),cplVGVGVG
...
& TVO4lTRRcross(3,3,3,3),OA2lSL(3,3),OA2lSR(3,3),OA1L(3,3),OA1R(3,3),OH2lSL(3,3,3),      &
...
& OAh2qSLSM(3,3,3),OAh2qSRSM(3,3,3),TSOdulvSLLSM(3,3,3,3),TSOdulvSRRSM(3,3,3,3),         &
...
& OA2qVLSM(3,3),OA2qVRSM(3,3),OG2qSLSM(3,3),OG2qSRSM(3,3),OH2qSLSM(3,3,3),               &
& OH2qSRSM(3,3,3)
...
& TVO4dTRR(3,3,3,3),OAh2qSL(3,3,3),OAh2qSR(3,3,3),TSOdulvSLL(3,3,3,3),TSOdulvSRR(3,3,3,3),&
...
& OA2qVR(3,3),OG2qSL(3,3),OG2qSR(3,3),OH2qSL(3,3,3),OH2qSR(3,3,3)
...
& TVO4dTLRcheck(3,3,3,3),TVO4dTRLcheck(3,3,3,3),TVO4dTRRcheck(3,3,3,3),OAh2qSLcheck(3,3,3),&
& OAh2qSRcheck(3,3,3),TSOdulvSLLcheck(3,3,3,3),TSOdulvSRRcheck(3,3,3,3),TSOdulvSRLcheck(3,3,3,3)
...
& OA2qVRcheck(3,3),OG2qSLcheck(3,3),OG2qSRcheck(3,3),OH2qSLcheck(3,3,3),OH2qSRcheck(3,3,3)
...
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               &
& cplcFdFdVZR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcHpmL,         &
& cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuAhL,cplcFuFuAhR,OAh2qSL(gt1,gt2,gt3) &
& ,OAh2qSR(gt1,gt2,gt3))
...
& cplAhHpmcVWm,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,              &
...
& cplcFvFvVZR,cplcHpmVPVWm,cplcHpmVWmVZ,cplcVWmVWmVZ,cplhhcHpmVWm,cplhhcVWmVWm,          &
...
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               &
& cplcFdFdVZR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcHpmL,         &
& cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVPL,cplcFuFuVPR,cplcHpmVPVWm,        &
& cplcVWmVPVWm,cplHpmcHpmVP,cplHpmcVWmVP,OA2qSL(gt1,gt2),OA2qSR(gt1,gt2),OA2qVL(gt1,gt2) &
& ,OA2qVR(gt1,gt2))
...
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               &
& cplcFdFdVZR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcHpmL,         &
& cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVGL,cplcFuFuVGR,OG2qSL(gt1,gt2)      &
& ,OG2qSR(gt1,gt2))
...
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWmL,            &
& cplcFdFuVWmR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,      &
& cplcFuFuhhR,cplhhcHpmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,             &
...
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               &
& cplcFdFdVZR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcHpmL,         &
& cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuAhL,cplcFuFuAhR,OAh2qSLSM(gt1,gt2,gt3)&
...
& cplcFdFdVZR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcHpmL,         &
& cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVPL,cplcFuFuVPR,cplcHpmVPVWm,        &
& cplcVWmVPVWm,cplHpmcHpmVP,cplHpmcVWmVP,OA2qSLSM(gt1,gt2),OA2qSRSM(gt1,gt2)             &
& ,OA2qVLSM(gt1,gt2),OA2qVRSM(gt1,gt2))
...
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               &
& cplcFdFdVZR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcHpmL,         &
& cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVGL,cplcFuFuVGR,OG2qSLSM(gt1,gt2)    &
& ,OG2qSRSM(gt1,gt2))
...
& cplcFvFecVWmL,cplcFvFecVWmR,cplhhcHpmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHpmcHpm,          &
& cplhhHpmcVWm,cplhhVZVZ,OH2lSL(gt1,gt2,gt3),OH2lSR(gt1,gt2,gt3))
...
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,     &
& cplcFvFvVZL,cplcFvFvVZR,cplcHpmVWmVZ,cplcVWmVWmVZ,cplhhVZVZ,cplHpmcHpmVZ,              &
& cplHpmcVWmVZ,OZ2lSL(gt1,gt2),OZ2lSR(gt1,gt2),OZ2lVL(gt1,gt2),OZ2lVR(gt1,gt2))
