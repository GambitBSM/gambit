...
(* ----------------------------------------------------------------------------- *) 
(* File created at 17:33 on 22.10.2018  *) 
(* ---------------------------------------------------------------------- *) 
...
(*VZ*) 
{{VZ},chargefactor -> 1,{coup1L -> Cp[bar[Fe], Fe, Ah][L][gt2,gt1,iProp],coup1R -> Cp[bar[Fe], Fe, Ah][R][gt2,gt1,iProp],coup2L -> Cp[bar[Fe], Fe, Ah][L][gt4,gt3,iProp],coup2R -> Cp[bar[Fe], Fe, Ah][R][gt4,gt3,iProp]},{MP -> M[Ah][iProp]}  {TSO4lSLLcross,coup1L*coup2L*IMP2},   {TSO4lSRRcross,coup1R*coup2R*IMP2},   {TSO4lSRLcross,coup1R*coup2L*IMP2},   {TSO4lSLRcross,coup1L*coup2R*IMP2}   {TSO4lVRRcross,0}   {TSO4lVLLcross,0}   {TSO4lVRLcross,0}   {TSO4lVLRcross,0}   {TSO4lTLLcross,0}   {TSO4lTLRcross,0}   {TSO4lTRLcross,0}   {TSO4lTRRcross,0} },
(*VZ*) 
{{VZ},chargefactor -> 1,{coup1L -> Cp[bar[Fe], Fe, Ah][L][gt4,gt1,iProp],coup1R -> Cp[bar[Fe], Fe, Ah][R][gt4,gt1,iProp],coup2L -> Cp[bar[Fe], Fe, Ah][L][gt2,gt3,iProp],coup2R -> Cp[bar[Fe], Fe, Ah][R][gt2,gt3,iProp]},{MP -> M[Ah][iProp]}  {TSO4lSLLcross,-(coup1L*coup2L*IMP2)/2},   {TSO4lSRRcross,-(coup1R*coup2R*IMP2)/2},   {TSO4lSRLcross,0},   {TSO4lSLRcross,0}   {TSO4lVRRcross,0}   {TSO4lVLLcross,0}   {TSO4lVRLcross,-(coup1R*coup2L*IMP2)/2}   {TSO4lVLRcross,-(coup1L*coup2R*IMP2)/2}   {TSO4lTLLcross,(coup1L*coup2L*IMP2)/8}   {TSO4lTLRcross,0}   {TSO4lTRLcross,0}   {TSO4lTRRcross,(coup1R*coup2R*IMP2)/8} }
};