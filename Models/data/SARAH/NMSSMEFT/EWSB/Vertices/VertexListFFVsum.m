{{{Chi[{gt1}], Cha[{gt2}], conj[VWm[{lt3}]]}, 
 ...
 {{bar[Cha[{gt1}]], Chi[{gt2}], VWm[{lt3}]}, 
  ...
  {(-I/2)*g2*(2*conj[UP[gt1, 1]]*ZN[gt2, 2] - Sqrt[2]*conj[UP[gt1, 2]]*
      ZN[gt2, 4]), LorentzProduct[gamma[lt3], PR]}}, 
 ...
 {{bar[Fd[{gt1, ct1}]], Fd[{gt2, ct2}], VZ[{lt3}]}, 
  {(I/6)*Delta[ct1, ct2]*(3*g2*Cos[ThetaW] + g1*Sin[ThetaW])*
    sumExp[j1, 1, 3, conj[ZDL[gt2, j1]]*ZDL[gt1, j1]], 
   LorentzProduct[gamma[lt3], PL]}, {(-I/3)*g1*Delta[ct1, ct2]*Sin[ThetaW]*
    sumExp[j1, 1, 3, conj[ZDR[gt1, j1]]*ZDR[gt2, j1]], 
   LorentzProduct[gamma[lt3], PR]}}, 
 ...
 {{bar[Fe[{gt1}]], Fe[{gt2}], VP[{lt3}]}, 
  {(I/2)*(g1*Cos[ThetaW] + g2*Sin[ThetaW])*sumExp[j1, 1, 3, 
     conj[ZEL[gt2, j1]]*ZEL[gt1, j1]], LorentzProduct[gamma[lt3], PL]}, 
  {I*g1*Cos[ThetaW]*sumExp[j1, 1, 3, conj[ZER[gt1, j1]]*ZER[gt2, j1]], 
   LorentzProduct[gamma[lt3], PR]}}, {{bar[Fe[{gt1}]], Fe[{gt2}], VZ[{lt3}]}, 
  {(I/2)*(g2*Cos[ThetaW] - g1*Sin[ThetaW])*sumExp[j1, 1, 3, 
     conj[ZEL[gt2, j1]]*ZEL[gt1, j1]], LorentzProduct[gamma[lt3], PL]}, 
  {(-I)*g1*Sin[ThetaW]*sumExp[j1, 1, 3, conj[ZER[gt1, j1]]*ZER[gt2, j1]], 
   LorentzProduct[gamma[lt3], PR]}}, 
 ...
 {{bar[Fu[{gt1, ct1}]], Fu[{gt2, ct2}], VZ[{lt3}]}, 
  {(-I/6)*Delta[ct1, ct2]*(3*g2*Cos[ThetaW] - g1*Sin[ThetaW])*
    sumExp[j1, 1, 3, conj[ZUL[gt2, j1]]*ZUL[gt1, j1]], 
   LorentzProduct[gamma[lt3], PL]}, {((2*I)/3)*g1*Delta[ct1, ct2]*Sin[ThetaW]*
    sumExp[j1, 1, 3, conj[ZUR[gt1, j1]]*ZUR[gt2, j1]], 
   LorentzProduct[gamma[lt3], PR]}}, 
