...
& mq2,ml2,mHd2,mHu2,md2,mu2,me2,ms2,M1,M2,M3,vd,vu,vS,gSeAhChaFv,gSeAhChiFe,             & 
& gSeSvChaChi,gSeChaFecHpm,gSeSeChacCha,gSeSeChiChi,gSehhChiFe,gSeHpmChiFv,              & 
& gSeFeFdcSd,gSeFeFecSe,gSeFeFucSu,gSeFvFecSv,gSeHpmFecCha,gSeFeSdcFd,gSeSeFecFe,        & 
& gSeFeSucFu,gSeSvFecFv,gSehhChaFv,gSeFvFdcSu,gSeFvSdcFu,gSeSeFvcFv,gSeSeFdcFd,          & 
...
Complex(dp) :: cplAhSecSe(3,6,6),cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplcChacFvSeL(2,3,6),     & 
...
Real(dp),Intent(inout) :: gSeAhChaFv(6,3,2,3),gSeAhChiFe(6,3,5,3),gSeSvChaChi(6,3,2,5),gSeChaFecHpm(6,2,3,2),   & 
& gSeSeChacCha(6,6,2,2),gSeSeChiChi(6,6,5,5),gSehhChiFe(6,3,5,3),gSeHpmChiFv(6,2,5,3),   & 
...
& gSeSvFecFv(6,3,3,3),gSehhChaFv(6,3,2,3),gSeFvFdcSu(6,3,3,6),gSeFvSdcFu(6,3,6,3),       & 
& gSeSeFvcFv(6,6,3,3),gSeSeFdcFd(6,6,3,3),gSeSeFucFu(6,6,3,3),gSeSvFdcFu(6,3,3,3)

Real(dp) :: gSeAhChaFvi(3,2,3),gSeAhChiFei(3,5,3),gSeSvChaChii(3,2,5),gSeChaFecHpmi(2,3,2),       & 
& gSeSeChacChai(6,2,2),gSeSeChiChii(6,5,5),gSehhChiFei(3,5,3),gSeHpmChiFvi(2,5,3),       & 
...
& gSeSvFecFvi(3,3,3),gSehhChaFvi(3,2,3),gSeFvFdcSui(3,3,6),gSeFvSdcFui(3,6,3),           & 
...
& Td,Te,Tlam,Tk,Tu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,ms2,M1,M2,M3,vd,vu,vS,cplAhSecSe,       & 
...
Real(dp),Intent(in) :: MAh(3),MCha(2),MSe(6)

Complex(dp),Intent(in) :: cplAhSecSe(3,6,6),cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplChaFvcSeL(2,3,6),      & 
& cplChaFvcSeR(2,3,6)
...
Real(dp),Intent(in) :: MSv(3),MCha(2),MChi(5),MVWm,MHpm(2),MFe(3),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvcSe(2,3,6),cplSvcSeVWm(3,6),cplcFeChaSvL(3,2,3),cplcFeChaSvR(3,2,3),          & 
& cplcFvChiSvL(3,5,3),cplcFvChiSvR(3,5,3),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),       & 
...
Real(dp),Intent(in) :: MCha(2),MFe(3),MHpm(2),MChi(5),MSe(6)
...
Real(dp),Intent(in) :: MSe(6),MCha(2),MVZ,MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplAhSecSe(3,6,6),cplhhSecSe(3,6,6),cplSecSeVZ(6,6),cplcChacFvSeL(2,3,6),             & 
& cplcChacFvSeR(2,3,6),cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplcChaChahhL(2,2,3),   & 
& cplcChaChahhR(2,2,3),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplChaFvcSeL(2,3,6),        & 
& cplChaFvcSeR(2,3,6)
...
Real(dp),Intent(in) :: MHpm(2),MChi(5),MSv(3),MFe(3),MCha(2),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvcSe(2,3,6),cplcChaChiHpmL(2,5,2),cplcChaChiHpmR(2,5,2),cplcFeFvHpmL(3,3,2),   & 
& cplcFeFvHpmR(3,3,2),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),cplChiFecSeL(5,3,6),       & 
...
Real(dp),Intent(in) :: MFe(3),MSv(3),MCha(2),MChi(5),MSe(6)
...
Real(dp),Intent(in) :: MHpm(2),MFe(3),MCha(2),MSv(3),MChi(5),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvcSe(2,3,6),cplcChaChiHpmL(2,5,2),cplcChaChiHpmR(2,5,2),cplcChaFecSvL(2,3,3),  & 
& cplcChaFecSvR(2,3,3),cplChiFecSeL(5,3,6),cplChiFecSeR(5,3,6)
...
Real(dp),Intent(in) :: MSv(3),MFe(3),MVWm,MHpm(2),MChi(5),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvcSe(2,3,6),cplSvcSeVWm(3,6),cplcFvChiSvL(3,5,3),cplcFvChiSvR(3,5,3),          & 
...
Real(dp),Intent(in) :: Mhh(3),MCha(2),MSe(6)

Complex(dp),Intent(in) :: cplhhSecSe(3,6,6),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),cplChaFvcSeL(2,3,6),      & 
& cplChaFvcSeR(2,3,6)
