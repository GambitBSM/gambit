...
& mq2,ml2,mHd2,mHu2,md2,mu2,me2,ms2,M1,M2,M3,vd,vu,vS,gTAh,gThh,gTHpm,gTSd,              & 
& gTSe,gTSu,gTSv,gTVWm,gTVZ,gChiChicChaCha,gChiChiChiChi,gChiChicFdFd,gChiChicFeFe,      & 
& gChiChicFuFu,gChiChacFdFu,gChiChacFeFv,gChiChicFvFv,gChiFdcFdGlu,gChiFucFuGlu,         & 
...
Real(dp),Intent(in) :: gTAh(3),gThh(3),gTHpm(2),gTSd(6),gTSe(6),gTSu(6),gTSv(3),gTVWm,gTVZ
...
& Td,Te,Tlam,Tk,Tu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,ms2,M1,M2,M3,vd,vu,vS,cplcChaChaAhL,    & 
...
Real(dp),Intent(in) :: MCha(2),MFe(3),MVWm,MHpm(2),MSv(3),MSe(6),MChi(5)

Complex(dp),Intent(in) :: cplcFeChaSvL(3,2,3),cplcFeChaSvR(3,2,3),cplcFeChiSeL(3,5,6),cplcFeChiSeR(3,5,6),      & 
& cplcFeFvHpmL(3,3,2),cplcFeFvHpmR(3,3,2),cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),           & 
& cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),cplChiChacHpmL(5,2,2),cplChiChacHpmR(5,2,2),   & 
& cplChiChacVWmL(5,2),cplChiChacVWmR(5,2),cplChiFvcSvL(5,3,3),cplChiFvcSvR(5,3,3)
...
Real(dp),Intent(in) :: MChi(5),MVZ,MSv(3)

Complex(dp),Intent(in) :: cplcFvChiSvL(3,5,3),cplcFvChiSvR(3,5,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),            & 
