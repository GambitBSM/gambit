...
! ------------------------------------------------------------------------------  
! File created at 13:20 on 24.9.2018   
! ----------------------------------------------------------------------  
 
 
Module Sv3Decays_NMSSM 
...
& mq2,ml2,mHd2,mHu2,md2,mu2,me2,ms2,M1,M2,M3,vd,vu,vS,gSvSvChiChi,gSvcHpmChiFe,          & 
& gSvSeChicCha,gSvFeAhcCha,gSvFeFucSd,gSvFeFvcSe,gSvhhFecCha,gSvFeSucFd,gSvSvFecFe,      & 
& gSvFvAhChi,gSvcHpmChaFv,gSvhhChiFv,gSvFvFdcSd,gSvFvFucSu,gSvFvFvcSv,gSvcChaFvHpm,      & 
...
Real(dp),Intent(inout) :: gSvSvChiChi(3,3,5,5),gSvcHpmChiFe(3,2,5,3),gSvSeChicCha(3,6,5,2),gSvFeAhcCha(3,3,3,2),& 
& gSvFeFucSd(3,3,3,6),gSvFeFvcSe(3,3,3,6),gSvhhFecCha(3,3,3,2),gSvFeSucFd(3,3,6,3),      & 
& gSvSvFecFe(3,3,3,3),gSvFvAhChi(3,3,3,5),gSvcHpmChaFv(3,2,2,3),gSvhhChiFv(3,3,5,3),     & 
...
Real(dp) :: gSvSvChiChii(3,5,5),gSvcHpmChiFei(2,5,3),gSvSeChicChai(6,5,2),gSvFeAhcChai(3,3,2),    & 
& gSvFeFucSdi(3,3,6),gSvFeFvcSei(3,3,6),gSvhhFecChai(3,3,2),gSvFeSucFdi(3,6,3),          & 
& gSvSvFecFei(3,3,3),gSvFvAhChii(3,3,5),gSvcHpmChaFvi(2,2,3),gSvhhChiFvi(3,5,3),         & 
...
& ZE,ZEL,ZER,ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,ZW,ZZ,betaH,g1,g2,g3,Yd,Ye,lam,kap,Yu,               & 
& Td,Te,Tlam,Tk,Tu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,ms2,M1,M2,M3,vd,vu,vS,cplcChacFvSeL,    & 
...
Real(dp),Intent(in) :: MSv(3),MChi(5),MVZ,Mhh(3)

Complex(dp),Intent(in) :: cplhhSvcSv(3,3,3),cplSvcSvVZ(3,3),cplcFvChiSvL(3,5,3),cplcFvChiSvR(3,5,3),            & 
& cplChiChihhL(5,5,3),cplChiChihhR(5,5,3),cplChiChiVZL(5,5),cplChiChiVZR(5,5),           & 
...
Real(dp),Intent(in) :: MHpm(2),MChi(5),MFe(3),MSe(6),MCha(2),MSv(3)

Complex(dp),Intent(in) :: cplSecHpmcSv(6,2,3),cplcChaFecSvL(2,3,3),cplcChaFecSvR(2,3,3),cplcFvFecHpmL(3,3,2),   & 
& cplcFvFecHpmR(3,3,2),cplChiChacHpmL(5,2,2),cplChiChacHpmR(5,2,2),cplChiFecSeL(5,3,6),  & 
& cplChiFecSeR(5,3,6),cplChiFvcSvL(5,3,3),cplChiFvcSvR(5,3,3)
...
Real(dp),Intent(in) :: MSe(6),MChi(5),MCha(2),MVWm,MHpm(2),MFe(3),MSv(3)

Complex(dp),Intent(in) :: cplSecHpmcSv(6,2,3),cplSecSvcVWm(6,3),cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),      & 
& cplcChaChiHpmL(2,5,2),cplcChaChiHpmR(2,5,2),cplcChaChiVWmL(2,5),cplcChaChiVWmR(2,5),   & 
& cplcChaFecSvL(2,3,3),cplcChaFecSvR(2,3,3),cplcFeChiSeL(3,5,6),cplcFeChiSeR(3,5,6),     & 
& cplChiFvcSvL(5,3,3),cplChiFvcSvR(5,3,3)
...
Real(dp),Intent(in) :: MFe(3),MSe(6),MCha(2),MChi(5),MSv(3)

Complex(dp),Intent(in) :: cplcChaFecSvL(2,3,3),cplcChaFecSvR(2,3,3),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),    & 
& cplChiFecSeL(5,3,6),cplChiFecSeR(5,3,6),cplChiFvcSvL(5,3,3),cplChiFvcSvR(5,3,3)
...
Real(dp),Intent(in) :: MSv(3),MFe(3),MVZ,Mhh(3),MCha(2)

Complex(dp),Intent(in) :: cplhhSvcSv(3,3,3),cplSvcSvVZ(3,3),cplcChaFecSvL(2,3,3),cplcChaFecSvR(2,3,3),          & 
& cplcFeChaSvL(3,2,3),cplcFeChaSvR(3,2,3),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),         & 
...
Real(dp),Intent(in) :: MAh(3),MChi(5),MSv(3)

Complex(dp),Intent(in) :: cplChiChiAhL(5,5,3),cplChiChiAhR(5,5,3),cplChiFvcSvL(5,3,3),cplChiFvcSvR(5,3,3)
...
Real(dp),Intent(in) :: MHpm(2),MCha(2),MSe(6),MChi(5),MSv(3)

Complex(dp),Intent(in) :: cplSecHpmcSv(6,2,3),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),cplChiChacHpmL(5,2,2),    & 
& cplChiChacHpmR(5,2,2),cplChiFvcSvL(5,3,3),cplChiFvcSvR(5,3,3)
...
Real(dp),Intent(in) :: Mhh(3),MChi(5),MSv(3)

Complex(dp),Intent(in) :: cplhhSvcSv(3,3,3),cplChiChihhL(5,5,3),cplChiChihhR(5,5,3),cplChiFvcSvL(5,3,3),        & 
& cplChiFvcSvR(5,3,3)
...
Real(dp),Intent(in) :: MFd(3),MSd(6),MChi(5),MSv(3)

Complex(dp),Intent(in) :: cplChiFdcSdL(5,3,6),cplChiFdcSdR(5,3,6),cplChiFvcSvL(5,3,3),cplChiFvcSvR(5,3,3)
...
Real(dp),Intent(in) :: MFu(3),MSu(6),MChi(5),MSv(3)

Complex(dp),Intent(in) :: cplChiFucSuL(5,3,6),cplChiFucSuR(5,3,6),cplChiFvcSvL(5,3,3),cplChiFvcSvR(5,3,3)
...
Real(dp),Intent(in) :: MSv(3),MChi(5)
...
Real(dp),Intent(in) :: MCha(2),MHpm(2),MFe(3),MChi(5),MSv(3)

Complex(dp),Intent(in) :: cplcChaChiHpmL(2,5,2),cplcChaChiHpmR(2,5,2),cplcChaFecSvL(2,3,3),cplcChaFecSvR(2,3,3),& 
& cplcFeFvHpmL(3,3,2),cplcFeFvHpmR(3,3,2),cplChiFvcSvL(5,3,3),cplChiFvcSvR(5,3,3)
...
Real(dp),Intent(in) :: MSd(6),MFd(3),MChi(5),MSv(3)

Complex(dp),Intent(in) :: cplcFdChiSdL(3,5,6),cplcFdChiSdR(3,5,6),cplChiFvcSvL(5,3,3),cplChiFvcSvR(5,3,3)
...
Real(dp),Intent(in) :: MSe(6),MFe(3),MVWm,MHpm(2),MChi(5),MSv(3)

Complex(dp),Intent(in) :: cplSecHpmcSv(6,2,3),cplSecSvcVWm(6,3),cplcFeChiSeL(3,5,6),cplcFeChiSeR(3,5,6),        & 
& cplcFeFvHpmL(3,3,2),cplcFeFvHpmR(3,3,2),cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),           & 
& cplChiFvcSvL(5,3,3),cplChiFvcSvR(5,3,3)
...
Real(dp),Intent(in) :: MSu(6),MFu(3),MChi(5),MSv(3)

Complex(dp),Intent(in) :: cplcFuChiSuL(3,5,6),cplcFuChiSuR(3,5,6),cplChiFvcSvL(5,3,3),cplChiFvcSvR(5,3,3)
...
Real(dp),Intent(in) :: MSv(3),MVZ,MChi(5)

Complex(dp),Intent(in) :: cplSvcSvVZ(3,3),cplcFvChiSvL(3,5,3),cplcFvChiSvR(3,5,3),cplcFvFvVZL(3,3),             & 
& cplcFvFvVZR(3,3),cplChiFvcSvL(5,3,3),cplChiFvcSvR(5,3,3)
...
Real(dp),Intent(in) :: MSv(3),MCha(2),MVZ,Mhh(3),MFe(3)

Complex(dp),Intent(in) :: cplhhSvcSv(3,3,3),cplSvcSvVZ(3,3),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),          & 
...
Real(dp),Intent(in) :: MSv(3),MFd(3),MVZ,Mhh(3)

Complex(dp),Intent(in) :: cplhhSvcSv(3,3,3),cplSvcSvVZ(3,3),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),              & 
...
Real(dp),Intent(in) :: MSv(3),MFu(3),MVZ,Mhh(3)

Complex(dp),Intent(in) :: cplhhSvcSv(3,3,3),cplSvcSvVZ(3,3),cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),              & 
