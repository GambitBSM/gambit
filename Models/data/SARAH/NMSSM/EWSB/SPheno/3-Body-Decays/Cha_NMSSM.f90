...
& Td,Te,Tlam,Tk,Tu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,ms2,M1,M2,M3,vd,vu,vS,cplcChacFuSdL,    & 
...
Real(dp),Intent(in) :: MCha(2),MFe(3),MVZ,MSv(3),MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),  & 
& cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplcChaFecSvL(2,3,3),cplcChaFecSvR(2,3,3),       & 
& cplcFeChaSvL(3,2,3),cplcFeChaSvR(3,2,3),cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),         & 
...
Real(dp),Intent(inout) :: gTVZ,gTSv(3),gTAh(3),gThh(3)
...
Real(dp),Intent(in) :: MChi(5),MFe(3),MVWm,MHpm(2),MSv(3),MSe(6),MCha(2)

Complex(dp),Intent(in) :: cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),cplcChaChiHpmL(2,5,2),cplcChaChiHpmR(2,5,2),& 
...
& cplcFvFecVWmL(3,3),cplcFvFecVWmR(3,3),cplChiFecSeL(5,3,6),cplChiFecSeR(5,3,6)
