...
! ------------------------------------------------------------------------------  
! File created at 13:18 on 24.9.2018   
! ----------------------------------------------------------------------  
 
 
Module LoopCouplings_NMSSM 
...
Implicit None 
Real(dp),Intent(in) :: MAh(3),MCha(2),MChi(5),MFe(3),Mhh(3),MHpm(2),MSe(6),MSv(3),MVWm,g1,g2,vd,             & 
& vu,ZA(3,3),ZH(3,3),ZP(2,2)

Complex(dp),Intent(in) :: UM(2,2),UP(2,2),Ye(3,3),ZE(6,6),ZEL(3,3),ZER(3,3),ZN(5,5),ZV(3,3)

Real(dp) :: MAh2(3),MCha2(2),MChi2(5),MFe2(3),Mhh2(3),MHpm2(2),MSe2(6),MSv2(3),MVWm2

Complex(dp) :: cplAhcHpmVWm(3,2),cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),cplcChaChiVWmL(2,5),      & 
& cplcChaChiVWmR(2,5),cplcChaFecSvL(2,3,3),cplcChaFecSvR(2,3,3),cplcFeChaSvL(3,2,3),     & 
& cplcFeChaSvR(3,2,3),cplcFeChiSeL(3,5,6),cplcFeChiSeR(3,5,6),cplcFeFeAhL(3,3,3),        & 
& cplcFeFeAhR(3,3,3),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),cplcFeFvHpmL(3,3,2),          & 
& cplcFeFvHpmR(3,3,2),cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplcFvChiSvL(3,5,3),           & 
& cplcFvChiSvR(3,5,3),cplcFvFecHpmL(3,3,2),cplcFvFecHpmR(3,3,2),cplChaFvcSeL(2,3,6),     & 
& cplChaFvcSeR(2,3,6),cplChiFecSeL(5,3,6),cplChiFecSeR(5,3,6),cplChiFvcSvL(5,3,3),       & 
& cplChiFvcSvR(5,3,3),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplSvcSeVWm(3,6)
...
End Module LoopCouplings_NMSSM 
