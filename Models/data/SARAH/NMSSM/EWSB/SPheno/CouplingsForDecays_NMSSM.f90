...
Module CouplingsForDecays_NMSSM
...
& ZUinput,ZULinput,ZURinput,ZVinput,ZWinput,ZZinput,betaHinput,g1input,g2input,          & 
...
& me2input,ms2input,M1input,M2input,M3input,vdinput,vuinput,vSinput,cplAhSdcSd,          & 
...
& MGluinput,MGlu2input,Mhhinput(3),Mhh2input(3),MHpminput(2),MHpm2input(2),              & 
...
& vinput,ZAinput(3,3),ZHinput(3,3),ZPinput(2,2),ZZinput(2,2),betaHinput

Complex(dp),Intent(in) :: pGinput,UMinput(2,2),UPinput(2,2),ZDinput(6,6),ZDLinput(3,3),ZDRinput(3,3),           & 
& ZEinput(6,6),ZELinput(3,3),ZERinput(3,3),ZNinput(5,5),ZUinput(6,6),ZULinput(3,3),      & 
...
& g3input,Ydinput,Yeinput,laminput,kapinput,Yuinput,Tdinput,Teinput,Tlaminput,           & 
& Tkinput,Tuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,mu2input,               & 
& me2input,ms2input,M1input,M2input,M3input,vdinput,vuinput,vSinput,cplAhSucSu,          & 
...
& g3input,Ydinput,Yeinput,laminput,kapinput,Yuinput,Tdinput,Teinput,Tlaminput,           & 
& Tkinput,Tuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,mu2input,               & 
& me2input,ms2input,M1input,M2input,M3input,vdinput,vuinput,vSinput,cplAhSecSe,          & 
...
Complex(dp),Intent(out) :: cplAhSecSe(3,6,6),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),cplChiFecSeL(5,3,6),        & 
& cplChiFecSeR(5,3,6),cplhhSecSe(3,6,6),cplHpmSvcSe(2,3,6),cplSecSeVZ(6,6),              & 
& cplSvcSeVWm(3,6)
...
Do gt1 = 1, 2
 Do gt2 = 1, 3
  Do gt3 = 1, 6
Call CouplingHpmSvcSeT(gt1,gt2,gt3,g2,Ye,Te,lam,vd,vu,vS,ZV,ZE,ZP,cplHpmSvcSe(gt1,gt2,gt3))
...
& g3input,Ydinput,Yeinput,laminput,kapinput,Yuinput,Tdinput,Teinput,Tlaminput,           & 
& Tkinput,Tuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,mu2input,               & 
& me2input,ms2input,M1input,M2input,M3input,vdinput,vuinput,vSinput,cplChiFvcSvL,        & 
...
Complex(dp),Intent(out) :: cplChiFvcSvL(5,3,3),cplChiFvcSvR(5,3,3),cplcChaFecSvL(2,3,3),cplcChaFecSvR(2,3,3),    & 
...
Do gt1 = 1, 6
 Do gt2 = 1, 2
  Do gt3 = 1, 3
Call CouplingSecHpmcSvT(gt1,gt2,gt3,g2,Ye,Te,lam,vd,vu,vS,ZV,ZE,ZP,cplSecHpmcSv(gt1,gt2,gt3))
...
& g3input,Ydinput,Yeinput,laminput,kapinput,Yuinput,Tdinput,Teinput,Tlaminput,           & 
& Tkinput,Tuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,mu2input,               & 
& me2input,ms2input,M1input,M2input,M3input,vdinput,vuinput,vSinput,cplHiggsPP,          & 
& cplHiggsGG,cplHiggsZZvirt,cplHiggsWWvirt,cplAhAhhh,cplAhhhhh,cplAhhhVZ,cplcChaChahhL,  & 
...
& cplhhSecSe(3,6,6),cplhhSucSu(3,6,6),cplhhSvcSv(3,3,3),cplhhcVWmVWm(3),cplhhVZVZ(3)
...
& g3input,Ydinput,Yeinput,laminput,kapinput,Yuinput,Tdinput,Teinput,Tlaminput,           & 
& Tkinput,Tuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,mu2input,               & 
& me2input,ms2input,M1input,M2input,M3input,vdinput,vuinput,vSinput,cplPseudoHiggsPP,    & 
...
& g3input,Ydinput,Yeinput,laminput,kapinput,Yuinput,Tdinput,Teinput,Tlaminput,           & 
& Tkinput,Tuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,mu2input,               & 
& me2input,ms2input,M1input,M2input,M3input,vdinput,vuinput,vSinput,cplAhHpmcHpm,        & 
...
& g3input,Ydinput,Yeinput,laminput,kapinput,Yuinput,Tdinput,Teinput,Tlaminput,           & 
& Tkinput,Tuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,mu2input,               & 
& me2input,ms2input,M1input,M2input,M3input,vdinput,vuinput,vSinput,cplGluFdcSdL,        & 
...
& g3input,Ydinput,Yeinput,laminput,kapinput,Yuinput,Tdinput,Teinput,Tlaminput,           & 
& Tkinput,Tuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,mu2input,               & 
& me2input,ms2input,M1input,M2input,M3input,vdinput,vuinput,vSinput,cplChiChiAhL,        & 
...
& cplChiFecSeL,cplChiFecSeR,cplChiFucSuL,cplChiFucSuR,cplChiFvcSvL,cplChiFvcSvR,deltaM)
...
& cplChiFvcSvL(5,3,3),cplChiFvcSvR(5,3,3)
...
& g3input,Ydinput,Yeinput,laminput,kapinput,Yuinput,Tdinput,Teinput,Tlaminput,           & 
& Tkinput,Tuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,mu2input,               & 
& me2input,ms2input,M1input,M2input,M3input,vdinput,vuinput,vSinput,cplcChaChaAhL,       & 
...
& cplcChaFecSvL,cplcChaFecSvR,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,deltaM)
...
& g3input,Ydinput,Yeinput,laminput,kapinput,Yuinput,Tdinput,Teinput,Tlaminput,           & 
& Tkinput,Tuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,mu2input,               & 
& me2input,ms2input,M1input,M2input,M3input,vdinput,vuinput,vSinput,cplcFuFuAhL,         & 
& cplcFuFuAhR,cplcFuChiSuL,cplcFuChiSuR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWmL,       & 
& cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcFuGluSuL,            & 
...
Complex(dp),Intent(out) :: cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),cplcFuChiSuL(3,5,6),cplcFuChiSuR(3,5,6),        & 
...
& g3input,Ydinput,Yeinput,laminput,kapinput,Yuinput,Tdinput,Teinput,Tlaminput,           & 
& Tkinput,Tuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,mu2input,               & 
& me2input,ms2input,M1input,M2input,M3input,vdinput,vuinput,vSinput,cplcChacFuSdL,       & 
& cplcChacFuSdR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChiSdL,cplcFdChiSdR,cplcFdGluSdL,      & 
& cplcFdGluSdR,cplcFuChiSuL,cplcFuChiSuR,cplcFuGluSuL,cplcFuGluSuR,cplChiFdcSdL,         & 
...
& cplcFuChiSuL(3,5,6),cplcFuChiSuR(3,5,6),cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),         & 
& cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),               & 
& cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplcFvChiSvL(3,5,3),cplcFvChiSvR(3,5,3),           & 
& cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),             & 
& cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),cplChiChacHpmL(5,2,2),cplChiChacHpmR(5,2,2),   & 
...
& cplChiFecSeR(5,3,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6)
...
Complex(dp),Intent(out) :: cplAhSdcSd(3,6,6),cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplcChacFvSeL(2,3,6),     & 
& cplcChacFvSeR(2,3,6),cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplcChaChahhL(2,2,3),   & 
& cplcChaChahhR(2,2,3),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplcChaChiHpmL(2,5,2),      & 
& cplcChaChiHpmR(2,5,2),cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),cplcChaFecSvL(2,3,3),  & 
...
& cplcFdFuHpmR(3,3,2),cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),cplcFeChiSeL(3,5,6),           & 
& cplcFeChiSeR(3,5,6),cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplcFeFehhL(3,3,3),          & 
& cplcFeFehhR(3,3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFuChiSuL(3,5,6),              & 
...
& cplcFvChiSvL(3,5,3),cplcFvChiSvR(3,5,3),cplcFvFecHpmL(3,3,2),cplcFvFecHpmR(3,3,2),     & 
...
& cplChiFucSuL(5,3,6),cplChiFucSuR(5,3,6),cplChiFvcSvL(5,3,3),cplChiFvcSvR(5,3,3),       & 
& cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplGluFucSuL(3,6),cplGluFucSuR(3,6),               & 
& cplhhSdcSd(3,6,6),cplHpmSucSd(2,6,6),cplSdcSdVZ(6,6),cplSucSdVWm(6,6)
...
& cplcFuFuVZR,cplcFuGluSuL,cplcFuGluSuR,cplcFvChiSvL,cplcFvChiSvR,cplcFvFvVZL,           & 
& cplcFvFvVZR,cplChaFucSdL,cplChaFucSdR,cplChaFvcSeL,cplChaFvcSeR,cplChiChacHpmL,        & 
& cplChiChacHpmR,cplChiChiAhL,cplChiChiAhR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,       & 
& cplChiChiVZR,cplChiFdcSdL,cplChiFdcSdR,cplChiFecSeL,cplChiFecSeR,cplChiFucSuL,         & 
& cplChiFucSuR,cplChiFvcSvL,cplChiFvcSvR,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,         & 
...
& cplcFuFdcHpmR(3,3,2),cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),cplcFuFuhhL(3,3,3),         & 
& cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),& 
& cplcFvChiSvL(3,5,3),cplcFvChiSvR(3,5,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),             & 
& cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),       & 
& cplChiChacHpmL(5,2,2),cplChiChacHpmR(5,2,2),cplChiChiAhL(5,5,3),cplChiChiAhR(5,5,3),   & 
& cplChiChihhL(5,5,3),cplChiChihhR(5,5,3),cplChiChiVZL(5,5),cplChiChiVZR(5,5),           & 
& cplChiFdcSdL(5,3,6),cplChiFdcSdR(5,3,6),cplChiFecSeL(5,3,6),cplChiFecSeR(5,3,6),       & 
& cplChiFucSuL(5,3,6),cplChiFucSuR(5,3,6),cplChiFvcSvL(5,3,3),cplChiFvcSvR(5,3,3),       & 
& cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplGluFucSuL(3,6),cplGluFucSuR(3,6),               & 
& cplhhSucSu(3,6,6),cplSdcHpmcSu(6,2,6),cplSdcSucVWm(6,6),cplSucSuVZ(6,6)
...
Complex(dp),Intent(out) :: cplAhSecSe(3,6,6),cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplcChacFvSeL(2,3,6),     & 
& cplcChacFvSeR(2,3,6),cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplcChaChahhL(2,2,3),   & 
& cplcChaChahhR(2,2,3),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplcChaChiHpmL(2,5,2),      & 
& cplcChaChiHpmR(2,5,2),cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),cplcChaFecSvL(2,3,3),  & 
& cplcChaFecSvR(2,3,3),cplcFdChiSdL(3,5,6),cplcFdChiSdR(3,5,6),cplcFdFdAhL(3,3,3),       & 
& cplcFdFdAhR(3,3,3),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),cplcFdFdVZL(3,3),             & 
& cplcFdFdVZR(3,3),cplcFeChaSvL(3,2,3),cplcFeChaSvR(3,2,3),cplcFeChiSeL(3,5,6),          & 
& cplcFeChiSeR(3,5,6),cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplcFeFehhL(3,3,3),          & 
& cplcFeFehhR(3,3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFvHpmL(3,3,2),              & 
& cplcFeFvHpmR(3,3,2),cplcFuChiSuL(3,5,6),cplcFuChiSuR(3,5,6),cplcFuFdcHpmL(3,3,2),      & 
...
& cplcFuFuVZR(3,3),cplcFvChiSvL(3,5,3),cplcFvChiSvR(3,5,3),cplcFvFecHpmL(3,3,2),         & 
& cplcFvFecHpmR(3,3,2),cplcFvFecVWmL(3,3),cplcFvFecVWmR(3,3),cplcFvFvVZL(3,3),           & 
& cplcFvFvVZR(3,3),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),cplChiChacHpmL(5,2,2),        & 
& cplChiChacHpmR(5,2,2),cplChiChacVWmL(5,2),cplChiChacVWmR(5,2),cplChiChiAhL(5,5,3),     & 
& cplChiChiAhR(5,5,3),cplChiChihhL(5,5,3),cplChiChihhR(5,5,3),cplChiChiVZL(5,5),         & 
& cplChiChiVZR(5,5),cplChiFdcSdL(5,3,6),cplChiFdcSdR(5,3,6),cplChiFecSeL(5,3,6),         & 
& cplChiFecSeR(5,3,6),cplChiFucSuL(5,3,6),cplChiFucSuR(5,3,6),cplChiFvcSvL(5,3,3),       & 
& cplChiFvcSvR(5,3,3),cplhhSecSe(3,6,6),cplHpmSvcSe(2,3,6),cplSecSeVZ(6,6),              & 
& cplSvcSeVWm(3,6)
...
& g3input,Ydinput,Yeinput,laminput,kapinput,Yuinput,Tdinput,Teinput,Tlaminput,           & 
& Tkinput,Tuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,mu2input,               & 
& me2input,ms2input,M1input,M2input,M3input,vdinput,vuinput,vSinput,cplcChacFvSeL,       & 
...
Complex(dp),Intent(out) :: cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),  & 
...
& cplcChaFecSvL(2,3,3),cplcChaFecSvR(2,3,3),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),     & 
& cplcFdChiSdL(3,5,6),cplcFdChiSdR(3,5,6),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),         & 
...
& cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),               & 
& cplcFeFvHpmL(3,3,2),cplcFeFvHpmR(3,3,2),cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),           & 
& cplcFuChiSuL(3,5,6),cplcFuChiSuR(3,5,6),cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),         & 
...
End Module CouplingsForDecays_NMSSM
