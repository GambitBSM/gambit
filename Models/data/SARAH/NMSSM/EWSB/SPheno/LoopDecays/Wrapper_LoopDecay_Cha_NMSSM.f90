...
Module Wrapper_OneLoopDecay_Cha_NMSSM
Use Model_Data_NMSSM 
Use Kinematics 
Use OneLoopDecay_Cha_NMSSM 
Use Control 
Use Settings 
...
& cplSucSuVZ(6,6),cplSvcSeVWm(3,6),cplSvcSvVZ(3,3),ctcplcChacFuSdL(2,3,6),               & 
& ctcplcChacFuSdR(2,3,6),ctcplcChacFvSeL(2,3,6),ctcplcChacFvSeR(2,3,6),ctcplcChaChaAhL(2,2,3)

Complex(dp),Intent(in) :: ctcplcChaChaAhR(2,2,3),ctcplcChaChahhL(2,2,3),ctcplcChaChahhR(2,2,3),ctcplcChaChaVPL(2,2),& 
& ctcplcChaChaVPR(2,2),ctcplcChaChaVZL(2,2),ctcplcChaChaVZR(2,2),ctcplcChaChiHpmL(2,5,2),& 
& ctcplcChaChiHpmR(2,5,2),ctcplcChaChiVWmL(2,5),ctcplcChaChiVWmR(2,5),ctcplcChaFdcSuL(2,3,6),& 
& ctcplcChaFdcSuR(2,3,6),ctcplcChaFecSvL(2,3,3),ctcplcChaFecSvR(2,3,3),GcplcChaChiHpmL(2,5,2),& 
...
& ZcplcChacFuSdR(2,3,6),ZcplcChacFvSeL(2,3,6),ZcplcChacFvSeR(2,3,6),ZcplcChaChaAhL(2,2,3),& 
...
& ZcplcChaChiHpmR(2,5,2),ZcplcChaChiVWmL(2,5),ZcplcChaChiVWmR(2,5),ZcplcChaFdcSuL(2,3,6),& 
& ZcplcChaFdcSuR(2,3,6),ZcplcChaFecSvL(2,3,3),ZcplcChaFecSvR(2,3,3),ZcplcFdChaSuL(3,2,6),& 
& ZcplcFdChaSuR(3,2,6),ZcplcFdFdVPL(3,3),ZcplcFdFdVPR(3,3),ZcplcFeChaSvL(3,2,3),         & 
& ZcplcFeChaSvR(3,2,3),ZcplcFeFeVPL(3,3),ZcplcFeFeVPR(3,3),ZcplcFuFuVPL(3,3),            & 
& ZcplcFuFuVPR(3,3),ZcplChaFucSdL(2,3,6),ZcplChaFucSdR(2,3,6),ZcplChaFvcSeL(2,3,6),      & 
& ZcplChaFvcSeR(2,3,6),ZcplChiChacHpmL(5,2,2),ZcplChiChacHpmR(5,2,2),ZcplChiChacVWmL(5,2),& 
& ZcplChiChacVWmR(5,2),ZcplcHpmVPVWm(2),ZcplcVWmVPVWm,ZcplHpmcHpmVP(2,2),ZcplHpmcVWmVP(2),& 
...
Call Amplitude_Tree_NMSSM_ChaToChaAh(cplcChaChaAhL,cplcChaChaAhR,MAh,MCha,            & 
& MAh2,MCha2,AmpTreeChaToChaAh)

  Else 
Call Amplitude_Tree_NMSSM_ChaToChaAh(ZcplcChaChaAhL,ZcplcChaChaAhR,MAh,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NMSSM_ChaToChaAh(MLambda,em,gs,cplcChaChaAhL,cplcChaChaAhR,           & 
& MAhOS,MChaOS,MRPChaToChaAh,MRGChaToChaAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NMSSM_ChaToChaAh(MLambda,em,gs,ZcplcChaChaAhL,ZcplcChaChaAhR,         & 
& MAhOS,MChaOS,MRPChaToChaAh,MRGChaToChaAh)
...
Call Amplitude_WAVE_NMSSM_ChaToChaAh(cplcChaChaAhL,cplcChaChaAhR,ctcplcChaChaAhL,     & 
& ctcplcChaChaAhR,MAh,MAh2,MCha,MCha2,ZfAh,ZfLm,ZfLp,AmpWaveChaToChaAh)



!Vertex Corrections 
Call Amplitude_VERTEX_NMSSM_ChaToChaAh(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,MHpm,            & 
...
& cplcChaChiVWmL,cplcChaChiVWmR,cplcChaFdcSuL,cplcChaFdcSuR,cplcChaFecSvL,               & 
& cplcChaFecSvR,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,AmpVertexChaToChaAh)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NMSSM_ChaToChaAh(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,              & 
...
& cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,cplcChaChiHpmL,cplcChaChiHpmR,               & 
& cplcChaChiVWmL,cplcChaChiVWmR,cplcChaFdcSuL,cplcChaFdcSuR,cplcChaFecSvL,               & 
& cplcChaFecSvR,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,AmpVertexIRdrChaToChaAh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NMSSM_ChaToChaAh(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,            & 
...
& cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,cplcChaChiHpmL,cplcChaChiHpmR,               & 
& cplcChaChiVWmL,cplcChaChiVWmR,cplcChaFdcSuL,cplcChaFdcSuR,cplcChaFecSvL,               & 
& cplcChaFecSvR,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,AmpVertexIRosChaToChaAh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NMSSM_ChaToChahh(cplcChaChahhL,cplcChaChahhR,MCha,Mhh,            & 
& MCha2,Mhh2,AmpTreeChaToChahh)

  Else 
Call Amplitude_Tree_NMSSM_ChaToChahh(ZcplcChaChahhL,ZcplcChaChahhR,MCha,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NMSSM_ChaToChahh(MLambda,em,gs,cplcChaChahhL,cplcChaChahhR,           & 
& MChaOS,MhhOS,MRPChaToChahh,MRGChaToChahh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NMSSM_ChaToChahh(MLambda,em,gs,ZcplcChaChahhL,ZcplcChaChahhR,         & 
& MChaOS,MhhOS,MRPChaToChahh,MRGChaToChahh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NMSSM_ChaToChahh(cplcChaChahhL,cplcChaChahhR,ctcplcChaChahhL,     & 
& ctcplcChaChahhR,MCha,MCha2,Mhh,Mhh2,Zfhh,ZfLm,ZfLp,AmpWaveChaToChahh)



!Vertex Corrections 
Call Amplitude_VERTEX_NMSSM_ChaToChahh(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,MHpm,            & 
& MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,               & 
...
& cplcChacFvSeR,AmpVertexChaToChahh)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NMSSM_ChaToChahh(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,              & 
& MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,          & 
& MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,             & 
& cplAhhhhh,cplAhhhVZ,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,       & 
& cplChaFucSdL,cplChaFucSdR,cplChaFvcSeL,cplChaFvcSeR,cplcChaChahhL,cplcChaChahhR,       & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,       & 
& cplhhcHpmVWm,cplhhcVWmVWm,cplhhVZVZ,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,         & 
& cplcChacFvSeR,AmpVertexIRdrChaToChahh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NMSSM_ChaToChahh(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,            & 
& MFuOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSe2OS,MSu2OS,MSv2OS,               & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,       & 
& cplhhcHpmVWm,cplhhcVWmVWm,cplhhVZVZ,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,         & 
& cplcChacFvSeR,AmpVertexIRosChaToChahh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NMSSM_ChaToChaVZ(cplcChaChaVZL,cplcChaChaVZR,MCha,MVZ,            & 
& MCha2,MVZ2,AmpTreeChaToChaVZ)

  Else 
Call Amplitude_Tree_NMSSM_ChaToChaVZ(ZcplcChaChaVZL,ZcplcChaChaVZR,MCha,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NMSSM_ChaToChaVZ(MLambda,em,gs,cplcChaChaVZL,cplcChaChaVZR,           & 
& MChaOS,MVZOS,MRPChaToChaVZ,MRGChaToChaVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NMSSM_ChaToChaVZ(MLambda,em,gs,ZcplcChaChaVZL,ZcplcChaChaVZR,         & 
& MChaOS,MVZOS,MRPChaToChaVZ,MRGChaToChaVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NMSSM_ChaToChaVZ(cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,       & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NMSSM_ChaToChaVZ(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,MHpm,            & 
& MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NMSSM_ChaToChaVZ(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,              & 
& MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,          & 
& MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,cplcChaChaAhL,cplcChaChaAhR,cplAhhhVZ,             & 
& cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,cplChaFucSdL,              & 
& cplChaFucSdR,cplChaFvcSeL,cplChaFvcSeR,cplcChaChahhL,cplcChaChahhR,cplcFdChaSuL,       & 
...
& cplcHpmVWmVZ,cplcVWmVWmVZ,AmpVertexIRdrChaToChaVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NMSSM_ChaToChaVZ(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,            & 
& MFuOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSe2OS,MSu2OS,MSv2OS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NMSSM_ChaToChiHpm(cplcChaChiHpmL,cplcChaChiHpmR,MCha,             & 
& MChi,MHpm,MCha2,MChi2,MHpm2,AmpTreeChaToChiHpm)

  Else 
Call Amplitude_Tree_NMSSM_ChaToChiHpm(ZcplcChaChiHpmL,ZcplcChaChiHpmR,MCha,           & 
& MChi,MHpm,MCha2,MChi2,MHpm2,AmpTreeChaToChiHpm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NMSSM_ChaToChiHpm(MLambda,em,gs,cplcChaChiHpmL,cplcChaChiHpmR,        & 
& MChaOS,MChiOS,MHpmOS,MRPChaToChiHpm,MRGChaToChiHpm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NMSSM_ChaToChiHpm(MLambda,em,gs,ZcplcChaChiHpmL,ZcplcChaChiHpmR,      & 
& MChaOS,MChiOS,MHpmOS,MRPChaToChiHpm,MRGChaToChiHpm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NMSSM_ChaToChiHpm(cplcChaChiHpmL,cplcChaChiHpmR,ctcplcChaChiHpmL, & 
& ctcplcChaChiHpmR,MCha,MCha2,MChi,MChi2,MHpm,MHpm2,ZfHpm,ZfL0,ZfLm,ZfLp,AmpWaveChaToChiHpm)



!Vertex Corrections 
Call Amplitude_VERTEX_NMSSM_ChaToChiHpm(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,MHpm,           & 
& MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NMSSM_ChaToChiHpm(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,             & 
& MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,          & 
& MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,          & 
& cplChiChiAhR,cplAhHpmcHpm,cplAhHpmcVWm,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,   & 
& cplChiChacVWmR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,  & 
...
& cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,AmpVertexIRdrChaToChiHpm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NMSSM_ChaToChiHpm(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,           & 
& MFuOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSe2OS,MSu2OS,MSv2OS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NMSSM_ChaToChiVWm(cplcChaChiVWmL,cplcChaChiVWmR,MCha,             & 
& MChi,MVWm,MCha2,MChi2,MVWm2,AmpTreeChaToChiVWm)

  Else 
Call Amplitude_Tree_NMSSM_ChaToChiVWm(ZcplcChaChiVWmL,ZcplcChaChiVWmR,MCha,           & 
& MChi,MVWm,MCha2,MChi2,MVWm2,AmpTreeChaToChiVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NMSSM_ChaToChiVWm(MLambda,em,gs,cplcChaChiVWmL,cplcChaChiVWmR,        & 
& MChaOS,MChiOS,MVWmOS,MRPChaToChiVWm,MRGChaToChiVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NMSSM_ChaToChiVWm(MLambda,em,gs,ZcplcChaChiVWmL,ZcplcChaChiVWmR,      & 
& MChaOS,MChiOS,MVWmOS,MRPChaToChiVWm,MRGChaToChiVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NMSSM_ChaToChiVWm(cplcChaChiVWmL,cplcChaChiVWmR,ctcplcChaChiVWmL, & 
& ctcplcChaChiVWmR,MCha,MCha2,MChi,MChi2,MVWm,MVWm2,ZfL0,ZfLm,ZfLp,ZfVWm,AmpWaveChaToChiVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_NMSSM_ChaToChiVWm(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,MHpm,           & 
& MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,               & 
& MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,          & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NMSSM_ChaToChiVWm(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,             & 
& MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,          & 
& MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,          & 
& cplChiChiAhR,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR, & 
& cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,   & 
...
& cplcHpmVWmVZ,cplcVWmVWmVZ,AmpVertexIRdrChaToChiVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NMSSM_ChaToChiVWm(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,           & 
& MFuOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSe2OS,MSu2OS,MSv2OS,               & 
& MVP2,MVWm2OS,MVZ2OS,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NMSSM_ChaToFdcSu(cplcChaFdcSuL,cplcChaFdcSuR,MCha,MFd,            & 
& MSu,MCha2,MFd2,MSu2,AmpTreeChaToFdcSu)

  Else 
Call Amplitude_Tree_NMSSM_ChaToFdcSu(ZcplcChaFdcSuL,ZcplcChaFdcSuR,MCha,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NMSSM_ChaToFdcSu(MLambda,em,gs,cplcChaFdcSuL,cplcChaFdcSuR,           & 
& MChaOS,MFdOS,MSuOS,MRPChaToFdcSu,MRGChaToFdcSu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NMSSM_ChaToFdcSu(MLambda,em,gs,ZcplcChaFdcSuL,ZcplcChaFdcSuR,         & 
& MChaOS,MFdOS,MSuOS,MRPChaToFdcSu,MRGChaToFdcSu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NMSSM_ChaToFdcSu(cplcChaFdcSuL,cplcChaFdcSuR,ctcplcChaFdcSuL,     & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NMSSM_ChaToFdcSu(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,MHpm,           & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NMSSM_ChaToFdcSu(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             & 
...
& cplSdcHpmcSu,cplSdcSucVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,AmpVertexIRdrChaToFdcSu)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NMSSM_ChaToFdcSu(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NMSSM_ChaToFecSv(cplcChaFecSvL,cplcChaFecSvR,MCha,MFe,            & 
& MSv,MCha2,MFe2,MSv2,AmpTreeChaToFecSv)

  Else 
Call Amplitude_Tree_NMSSM_ChaToFecSv(ZcplcChaFecSvL,ZcplcChaFecSvR,MCha,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NMSSM_ChaToFecSv(MLambda,em,gs,cplcChaFecSvL,cplcChaFecSvR,           & 
& MChaOS,MFeOS,MSvOS,MRPChaToFecSv,MRGChaToFecSv)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NMSSM_ChaToFecSv(MLambda,em,gs,ZcplcChaFecSvL,ZcplcChaFecSvR,         & 
& MChaOS,MFeOS,MSvOS,MRPChaToFecSv,MRGChaToFecSv)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NMSSM_ChaToFecSv(cplcChaFecSvL,cplcChaFecSvR,ctcplcChaFecSvL,     & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NMSSM_ChaToFecSv(MAh,MCha,MChi,MFe,Mhh,MHpm,MSe,MSv,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NMSSM_ChaToFecSv(MAh,MCha,MChi,MFe,Mhh,MHpm,MSe,             & 
...
& AmpVertexIRdrChaToFecSv)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NMSSM_ChaToFecSv(MAhOS,MChaOS,MChiOS,MFeOS,MhhOS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NMSSM_ChaTocFuSd(cplcChacFuSdL,cplcChacFuSdR,MCha,MFu,            & 
& MSd,MCha2,MFu2,MSd2,AmpTreeChaTocFuSd)

  Else 
Call Amplitude_Tree_NMSSM_ChaTocFuSd(ZcplcChacFuSdL,ZcplcChacFuSdR,MCha,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NMSSM_ChaTocFuSd(MLambda,em,gs,cplcChacFuSdL,cplcChacFuSdR,           & 
& MChaOS,MFuOS,MSdOS,MRPChaTocFuSd,MRGChaTocFuSd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NMSSM_ChaTocFuSd(MLambda,em,gs,ZcplcChacFuSdL,ZcplcChacFuSdR,         & 
& MChaOS,MFuOS,MSdOS,MRPChaTocFuSd,MRGChaTocFuSd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NMSSM_ChaTocFuSd(cplcChacFuSdL,cplcChacFuSdR,ctcplcChacFuSdL,     & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NMSSM_ChaTocFuSd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,MHpm,           & 
& MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,MSd2,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NMSSM_ChaTocFuSd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
...
& cplSdcSdVZ,cplcChacFuSdL,cplcChacFuSdR,cplSdcHpmcSu,cplSdcSucVWm,AmpVertexIRdrChaTocFuSd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NMSSM_ChaTocFuSd(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,            & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,MChi2OS,           & 
& MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NMSSM_ChaTocFvSe(cplcChacFvSeL,cplcChacFvSeR,MCha,MSe,            & 
& MCha2,MSe2,AmpTreeChaTocFvSe)

  Else 
Call Amplitude_Tree_NMSSM_ChaTocFvSe(ZcplcChacFvSeL,ZcplcChacFvSeR,MCha,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NMSSM_ChaTocFvSe(MLambda,em,gs,cplcChacFvSeL,cplcChacFvSeR,           & 
& MChaOS,MSeOS,MRPChaTocFvSe,MRGChaTocFvSe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NMSSM_ChaTocFvSe(MLambda,em,gs,ZcplcChacFvSeL,ZcplcChacFvSeR,         & 
& MChaOS,MSeOS,MRPChaTocFvSe,MRGChaTocFvSe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NMSSM_ChaTocFvSe(cplcChacFvSeL,cplcChacFvSeR,ctcplcChacFvSeL,     & 
& ctcplcChacFvSeR,MCha,MCha2,MSe,MSe2,ZfFvL,ZfLm,ZfLp,ZfSe,AmpWaveChaTocFvSe)



!Vertex Corrections 
Call Amplitude_VERTEX_NMSSM_ChaTocFvSe(MAh,MCha,MChi,MFe,Mhh,MHpm,MSe,MSv,            & 
& MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,Mhh2,MHpm2,MSe2,MSv2,MVP2,MVWm2,MVZ2,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NMSSM_ChaTocFvSe(MAh,MCha,MChi,MFe,Mhh,MHpm,MSe,             & 
& MSv,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,Mhh2,MHpm2,MSe2,MSv2,MVP2,MVWm2,MVZ2,           & 
& cplcChaChaAhL,cplcChaChaAhR,cplAhSecSe,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,      & 
& cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,cplcChaChiHpmL,cplcChaChiHpmR,               & 
& cplcFeChiSeL,cplcFeChiSeR,cplcFvChiSvL,cplcFvChiSvR,cplcChaChiVWmL,cplcChaChiVWmR,     & 
...
& cplSecHpmcSv,cplSecSvcVWm,AmpVertexIRdrChaTocFvSe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NMSSM_ChaTocFvSe(MAhOS,MChaOS,MChiOS,MFeOS,MhhOS,            & 
& MHpmOS,MSeOS,MSvOS,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,MChi2OS,MFe2OS,Mhh2OS,              & 
...
i4 = isave 
  Do gt2=1,3
    Do gt3=1,6
If (((OSkinematics).and.(Abs(MChaOS(gt1)).gt.(Abs(0.)+Abs(MSeOS(gt3))))).or.((.not.OSkinematics).and.(Abs(MCha(gt1)).gt.(Abs(0.)+Abs(MSe(gt3)))))) Then 
 If (DebugLoopDecays) Then 
  Write(*,*) gt1, gt2, gt3 
  AmpSum2ChaTocFvSe = AmpTreeChaTocFvSe
If (OSkinematics) Then 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_NMSSM_ChaToChaVP(ZcplcChaChaVPL,ZcplcChaChaVPR,ZcplcChaChaVZL,    & 
...
& MChaOS,MCha2OS,MVP,MVP2,ZfLm,ZfLp,ZfVP,ZfVZVP,AmpWaveChaToChaVP)
 ...
 Else 
Call Amplitude_WAVE_NMSSM_ChaToChaVP(cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,       & 
& cplcChaChaVZR,ctcplcChaChaVPL,ctcplcChaChaVPR,ctcplcChaChaVZL,ctcplcChaChaVZR,         & 
& MChaOS,MCha2OS,MVP,MVP2,ZfLm,ZfLp,ZfVP,ZfVZVP,AmpWaveChaToChaVP)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NMSSM_ChaToChaVP(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,               & 
& MFuOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSe2OS,MSu2OS,MSv2OS,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NMSSM_ChaToChaVP(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,MHpm,            & 
& MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,               & 
...
End Module Wrapper_OneLoopDecay_Cha_NMSSM
