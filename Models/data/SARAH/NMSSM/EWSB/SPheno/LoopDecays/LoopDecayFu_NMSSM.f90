...
Subroutine Amplitude_Tree_NMSSM_FuToFuAh(cplcFuFuAhL,cplcFuFuAhR,MAh,MFu,             & 
& MAh2,MFu2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NMSSM_FuToFuAh


Subroutine Gamma_Real_NMSSM_FuToFuAh(MLambda,em,gs,cplcFuFuAhL,cplcFuFuAhR,           & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NMSSM_FuToFuAh


Subroutine Amplitude_WAVE_NMSSM_FuToFuAh(cplcFuFuAhL,cplcFuFuAhR,ctcplcFuFuAhL,       & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSM_FuToFuAh


Subroutine Amplitude_VERTEX_NMSSM_FuToFuAh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSM_FuToFuAh


Subroutine Amplitude_IR_VERTEX_NMSSM_FuToFuAh(MAh,MCha,MChi,MFd,MFu,MGlu,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSM_FuToFuAh


Subroutine Amplitude_Tree_NMSSM_FuToChiSu(cplcFuChiSuL,cplcFuChiSuR,MChi,             & 
...
Complex(dp), Intent(in) :: cplcFuChiSuL(3,5,6),cplcFuChiSuR(3,5,6)

Complex(dp) :: Amp(2,3,5,6) 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NMSSM_FuToChiSu


Subroutine Gamma_Real_NMSSM_FuToChiSu(MLambda,em,gs,cplcFuChiSuL,cplcFuChiSuR,        & 
...
Real(dp), Intent(out) :: GammarealPhoton(3,5,6), GammarealGluon(3,5,6) 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NMSSM_FuToChiSu


Subroutine Amplitude_WAVE_NMSSM_FuToChiSu(cplcFuChiSuL,cplcFuChiSuR,ctcplcFuChiSuL,   & 
...
Complex(dp), Intent(in) :: ctcplcFuChiSuL(3,5,6),ctcplcFuChiSuR(3,5,6)

Complex(dp), Intent(in) :: ZfFUL(3,3),ZfFUR(3,3),ZfL0(5,5),ZfSu(6,6)

Complex(dp), Intent(out) :: Amp(2,3,5,6) 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSM_FuToChiSu


Subroutine Amplitude_VERTEX_NMSSM_FuToChiSu(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
& cplChiChacVWmR(5,2),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),cplChiChihhL(5,5,3),       & 
...
& cplcFuChiSuR(3,5,6),cplcChaChiVWmL(2,5),cplcChaChiVWmR(2,5),cplcFuFdcHpmL(3,3,2),      & 
...
& cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplhhSucSu(3,6,6),& 
& cplHpmSucSd(2,6,6),cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplSucSuVG(6,6),          & 
& cplSucSuVP(6,6),cplSucSdVWm(6,6),cplSucSuVZ(6,6)
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSM_FuToChiSu


Subroutine Amplitude_IR_VERTEX_NMSSM_FuToChiSu(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplcFuFuAhL,            & 
& cplcFuFuAhR,cplAhSucSu,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,    & 
& cplcFdChaSuL,cplcFdChaSuR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSM_FuToChiSu


Subroutine Amplitude_Tree_NMSSM_FuToFdcHpm(cplcFuFdcHpmL,cplcFuFdcHpmR,               & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NMSSM_FuToFdcHpm


Subroutine Gamma_Real_NMSSM_FuToFdcHpm(MLambda,em,gs,cplcFuFdcHpmL,cplcFuFdcHpmR,     & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NMSSM_FuToFdcHpm


Subroutine Amplitude_WAVE_NMSSM_FuToFdcHpm(cplcFuFdcHpmL,cplcFuFdcHpmR,               & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSM_FuToFdcHpm


Subroutine Amplitude_VERTEX_NMSSM_FuToFdcHpm(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSM_FuToFdcHpm


Subroutine Amplitude_IR_VERTEX_NMSSM_FuToFdcHpm(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,              & 
& cplcFuFuAhR,cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplChiFdcSdL,      & 
& cplChiFdcSdR,cplcFuChiSuL,cplcFuChiSuR,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdhhL,          & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSM_FuToFdcHpm


Subroutine Amplitude_Tree_NMSSM_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,               & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NMSSM_FuToFdcVWm


Subroutine Gamma_Real_NMSSM_FuToFdcVWm(MLambda,em,gs,cplcFuFdcVWmL,cplcFuFdcVWmR,     & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NMSSM_FuToFdcVWm


Subroutine Amplitude_WAVE_NMSSM_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,               & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSM_FuToFdcVWm


Subroutine Amplitude_VERTEX_NMSSM_FuToFdcVWm(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,              & 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplcChacFuSdL,cplcChacFuSdR,cplSdcSucVWm,cplcVWmVPVWm,       & 
& cplcVWmVWmVZ,Amp)
...
Complex(dp), Intent(in) :: cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),          & 
& cplAhHpmcVWm(3,2),cplChiChacVWmL(5,2),cplChiChacVWmR(5,2),cplChiFdcSdL(5,3,6),         & 
& cplChiFdcSdR(5,3,6),cplcFuChiSuL(3,5,6),cplcFuChiSuR(3,5,6),cplGluFdcSdL(3,6),         & 
...
& cplcFuFuVZR(3,3),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplhhHpmcVWm(3,2),cplhhcVWmVWm(3),& 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSM_FuToFdcVWm


Subroutine Amplitude_IR_VERTEX_NMSSM_FuToFdcVWm(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,              & 
& cplcFuFuAhR,cplAhHpmcVWm,cplChiChacVWmL,cplChiChacVWmR,cplChiFdcSdL,cplChiFdcSdR,      & 
& cplcFuChiSuL,cplcFuChiSuR,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdhhL,cplcFdFdhhR,           & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSM_FuToFdcVWm


Subroutine Amplitude_Tree_NMSSM_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,             & 
& MFu2,Mhh2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NMSSM_FuToFuhh


Subroutine Gamma_Real_NMSSM_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,           & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NMSSM_FuToFuhh


Subroutine Amplitude_WAVE_NMSSM_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,       & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSM_FuToFuhh


Subroutine Amplitude_VERTEX_NMSSM_FuToFuhh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSM_FuToFuhh


Subroutine Amplitude_IR_VERTEX_NMSSM_FuToFuhh(MAh,MCha,MChi,MFd,MFu,MGlu,             & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSM_FuToFuhh


Subroutine Amplitude_Tree_NMSSM_FuToFuVZ(cplcFuFuVZL,cplcFuFuVZR,MFu,MVZ,             & 
& MFu2,MVZ2,Amp)
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NMSSM_FuToFuVZ


Subroutine Gamma_Real_NMSSM_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,           & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NMSSM_FuToFuVZ


Subroutine Amplitude_WAVE_NMSSM_FuToFuVZ(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,         & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSM_FuToFuVZ


Subroutine Amplitude_VERTEX_NMSSM_FuToFuVZ(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
...
Complex(dp), Intent(in) :: cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),cplAhhhVZ(3,3),cplChaFucSdL(2,3,6),             & 
& cplChaFucSdR(2,3,6),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplChiChiVZL(5,5),           & 
& cplChiChiVZR(5,5),cplChiFucSuL(5,3,6),cplChiFucSuR(5,3,6),cplcFuChiSuL(3,5,6),         & 
& cplcFuChiSuR(3,5,6),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFuFdcHpmL(3,3,2),            & 
...
& cplcFuGluSuR(3,6),cplhhVZVZ(3),cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2),cplSdcSdVZ(6,6),      & 
& cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplSucSuVZ(6,6),cplcHpmVWmVZ(2),             & 
& cplcVWmVWmVZ
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSM_FuToFuVZ


Subroutine Amplitude_IR_VERTEX_NMSSM_FuToFuVZ(MAh,MCha,MChi,MFd,MFu,MGlu,             & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSM_FuToFuVZ


Subroutine Amplitude_Tree_NMSSM_FuToGluSu(cplcFuGluSuL,cplcFuGluSuR,MFu,              & 
...
Amp(:,gt1, gt3) = AmpC 
    End Do
End Do
End Subroutine Amplitude_Tree_NMSSM_FuToGluSu


Subroutine Gamma_Real_NMSSM_FuToGluSu(MLambda,em,gs,cplcFuGluSuL,cplcFuGluSuR,        & 
...
End if 
    End Do
End Do
End Subroutine Gamma_Real_NMSSM_FuToGluSu


Subroutine Amplitude_WAVE_NMSSM_FuToGluSu(cplcFuGluSuL,cplcFuGluSuR,ctcplcFuGluSuL,   & 
...
Amp(:,gt1, gt3) = AmpC 
    End Do
End Do
End Subroutine Amplitude_WAVE_NMSSM_FuToGluSu


Subroutine Amplitude_VERTEX_NMSSM_FuToGluSu(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
& cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplGluFucSuL,cplGluFucSuR,     & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplcFuFuVZL,cplcFuFuVZR,cplGluGluVGL,cplGluGluVGR,cplcFdGluSdL,cplcFdGluSdR,           & 
& cplcFuGluSuL,cplcFuGluSuR,cplhhSucSu,cplHpmSucSd,cplcChacFuSdL,cplcChacFuSdR,          & 
& cplSucSuVG,cplSucSuVP,cplSucSdVWm,cplSucSuVZ,Amp)
...
Complex(dp), Intent(in) :: cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),cplAhSucSu(3,6,6),cplcFdChaSuL(3,2,6),          & 
& cplcFdChaSuR(3,2,6),cplcFuChiSuL(3,5,6),cplcFuChiSuR(3,5,6),cplGluFdcSdL(3,6),         & 
...
& cplcFdGluSdR(3,6),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplhhSucSu(3,6,6),               & 
& cplHpmSucSd(2,6,6),cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplSucSuVG(6,6),          & 
& cplSucSuVP(6,6),cplSucSdVWm(6,6),cplSucSuVZ(6,6)
...
Amp(:,gt1, gt3) = Amp(:,gt1, gt3) + oo16pi2*(-3._dp/2._dp*(0.,1._dp))*AmpC 
  End Do
    End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSM_FuToGluSu


Subroutine Amplitude_IR_VERTEX_NMSSM_FuToGluSu(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,cplAhSucSu,               & 
& cplcFdChaSuL,cplcFdChaSuR,cplcFuChiSuL,cplcFuChiSuR,cplGluFdcSdL,cplGluFdcSdR,         & 
& cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplGluFucSuL,cplGluFucSuR,     & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSM_FuToGluSu


Subroutine Amplitude_Tree_NMSSM_FuTocChaSd(cplcChacFuSdL,cplcChacFuSdR,               & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NMSSM_FuTocChaSd


Subroutine Gamma_Real_NMSSM_FuTocChaSd(MLambda,em,gs,cplcChacFuSdL,cplcChacFuSdR,     & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NMSSM_FuTocChaSd


Subroutine Amplitude_WAVE_NMSSM_FuTocChaSd(cplcChacFuSdL,cplcChacFuSdR,               & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSM_FuTocChaSd


Subroutine Amplitude_VERTEX_NMSSM_FuTocChaSd(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSM_FuTocChaSd


Subroutine Amplitude_IR_VERTEX_NMSSM_FuTocChaSd(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcChaChaAhL,cplcChaChaAhR,cplcFuFuAhL,          & 
& cplcFuFuAhR,cplAhSdcSd,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,        & 
& cplcChaChaVZL,cplcChaChaVZR,cplcChaChiHpmL,cplcChaChiHpmR,cplcFdChiSdL,cplcFdChiSdR,   & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSM_FuTocChaSd


Subroutine Amplitude_WAVE_NMSSM_FuToFuVG(cplcFuFuVGL,cplcFuFuVGR,ctcplcFuFuVGL,       & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSM_FuToFuVG


Subroutine Amplitude_VERTEX_NMSSM_FuToFuVG(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
& MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,cplChaFucSdL,cplChaFucSdR,      & 
...
& cplcChacFuSdR,cplSucSuVG,cplVGVGVG,Amp)
...
Complex(dp), Intent(in) :: cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),        & 
...
& cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplSdcSdVG(6,6),cplcChacFuSdL(2,3,6),              & 
& cplcChacFuSdR(2,3,6),cplSucSuVG(6,6),cplVGVGVG
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSM_FuToFuVG


Subroutine Amplitude_IR_VERTEX_NMSSM_FuToFuVG(MAh,MCha,MChi,MFd,MFu,MGlu,             & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
& cplcChacFuSdL,cplcChacFuSdR,cplSucSuVG,cplVGVGVG,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSM_FuToFuVG


Subroutine Amplitude_WAVE_NMSSM_FuToFuVP(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,         & 
& cplcFuFuVZR,ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFuFuVZL,ctcplcFuFuVZR,MFu,               & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NMSSM_FuToFuVP


Subroutine Amplitude_VERTEX_NMSSM_FuToFuVP(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
& MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,cplChaFucSdL,cplChaFucSdR,      & 
...
& cplSdcSdVP,cplcChacFuSdL,cplcChacFuSdR,cplSucSuVP,cplcHpmVPVWm,cplcVWmVPVWm,Amp)
...
Complex(dp), Intent(in) :: cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),        & 
& cplcChaChaVPL(2,2),cplcChaChaVPR(2,2),cplChiFucSuL(5,3,6),cplChiFucSuR(5,3,6),         & 
& cplcFuChiSuL(3,5,6),cplcFuChiSuR(3,5,6),cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),             & 
...
& cplcFuFuVZR(3,3),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplHpmcHpmVP(2,2),cplHpmcVWmVP(2),& 
& cplSdcSdVP(6,6),cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplSucSuVP(6,6),             & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NMSSM_FuToFuVP


Subroutine Amplitude_IR_VERTEX_NMSSM_FuToFuVP(MAh,MCha,MChi,MFd,MFu,MGlu,             & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,cplChaFucSdL,             & 
...
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplcFuGluSuL,cplcFuGluSuR,cplHpmcHpmVP,           & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NMSSM_FuToFuVP



End Module OneLoopDecay_Fu_NMSSM
