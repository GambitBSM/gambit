...
! ------------------------------------------------------------------------------  
! File created at 13:19 on 24.9.2018   
! ----------------------------------------------------------------------  
...
& cplAhAhUSvcUSv(3,3,3,3),cplAhAhVZVZ(3,3),cplAhcUHpmVWm(3,2),cplAhhhVZ(3,3),            & 
& cplAhHpmcUHpm(3,2,2),cplAhHpmcVWm(3,2),cplAhSdcUSd(3,6,6),cplAhSecUSe(3,6,6),          & 
& cplAhSucUSu(3,6,6),cplAhUhhhh(3,3,3),cplAhUhhVZ(3,3),cplcChaChaUAhL(2,2,3),            & 
& cplcChaChaUAhR(2,2,3),cplcChaChaUhhL(2,2,3),cplcChaChaUhhR(2,2,3),cplcChaChaVPL(2,2),  & 
& cplcChaChaVPR(2,2),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplcChacUFuSdL(2,3,6),        & 
& cplcChacUFuSdR(2,3,6),cplcChacUFvSeL(2,3,6),cplcChacUFvSeR(2,3,6),cplcChaFdcUSuL(2,3,6),& 
& cplcChaFdcUSuR(2,3,6),cplcChaFecUSvL(2,3,3),cplcChaFecUSvR(2,3,3),cplcChaUChiHpmL(2,5,2),& 
& cplcChaUChiHpmR(2,5,2),cplcChaUChiVWmL(2,5),cplcChaUChiVWmR(2,5),cplcFdFdUAhL(3,3,3),  & 
& cplcFdFdUAhR(3,3,3),cplcFdFdUhhL(3,3,3),cplcFdFdUhhR(3,3,3),cplcFdFdVGL(3,3),          & 
& cplcFdFdVGR(3,3),cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),  & 
& cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),cplcFdUChiSdL(3,5,6),cplcFdUChiSdR(3,5,6),         & 
& cplcFeFeUAhL(3,3,3),cplcFeFeUAhR(3,3,3),cplcFeFeUhhL(3,3,3),cplcFeFeUhhR(3,3,3),       & 
& cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeUChiSeL(3,5,6),& 
& cplcFeUChiSeR(3,5,6),cplcFuFdcUHpmL(3,3,2),cplcFuFdcUHpmR(3,3,2),cplcFuFdcVWmL(3,3),   & 
...
& cplcFuUChiSuR(3,5,6),cplcFvFecUHpmL(3,3,2),cplcFvFecUHpmR(3,3,2),cplcFvFecVWmL(3,3),   & 
& cplcFvFecVWmR(3,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcFvUChiSvL(3,5,3),             & 
& cplcFvUChiSvR(3,5,3),cplcgAgWmcVWm,cplcgGgGVG,cplcgWmgWmUAh(3),cplcgWmgWmUhh(3),       & 
...
& cplChaFucUSdR(2,3,6),cplChaFvcUSeL(2,3,6),cplChaFvcUSeR(2,3,6),cplChiChacUHpmL(5,2,2), & 
& cplChiChacUHpmR(5,2,2),cplChiChacVWmL(5,2),cplChiChacVWmR(5,2),cplChiChiUAhL(5,5,3),   & 
& cplChiChiUAhR(5,5,3),cplChiChiUhhL(5,5,3),cplChiChiUhhR(5,5,3),cplChiChiVZL(5,5),      & 
& cplChiChiVZR(5,5),cplChiFdcUSdL(5,3,6),cplChiFdcUSdR(5,3,6),cplChiFecUSeL(5,3,6),      & 
& cplChiFecUSeR(5,3,6),cplChiFucUSuL(5,3,6),cplChiFucUSuR(5,3,6),cplChiFvcUSvL(5,3,3),   & 
& cplChiFvcUSvR(5,3,3),cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcUChacFuSdL(2,3,6),            & 
& cplcUChacFuSdR(2,3,6),cplcUChacFvSeL(2,3,6),cplcUChacFvSeR(2,3,6),cplcUChaChaAhL(2,2,3),& 
...
& cplcUChaFdcSuR(2,3,6),cplcUChaFecSvL(2,3,3),cplcUChaFecSvR(2,3,3),cplcUFdChaSuL(3,2,6),& 
& cplcUFdChaSuR(3,2,6),cplcUFdChiSdL(3,5,6),cplcUFdChiSdR(3,5,6),cplcUFdFdAhL(3,3,3)

Complex(dp) :: cplcUFdFdAhR(3,3,3),cplcUFdFdhhL(3,3,3),cplcUFdFdhhR(3,3,3),cplcUFdFdVGL(3,3),         & 
...
& cplcUFdFuVWmR(3,3),cplcUFdGluSdL(3,6),cplcUFdGluSdR(3,6),cplcUFeChaSvL(3,2,3),         & 
& cplcUFeChaSvR(3,2,3),cplcUFeChiSeL(3,5,6),cplcUFeChiSeR(3,5,6),cplcUFeFeAhL(3,3,3),    & 
...
& cplcUFeFvHpmR(3,3,2),cplcUFeFvVWmL(3,3),cplcUFeFvVWmR(3,3),cplcUFuChiSuL(3,5,6),       & 
...
& cplcUFuGluSuR(3,6),cplcUFvChiSvL(3,5,3),cplcUFvChiSvR(3,5,3),cplcUFvFecHpmL(3,3,2),    & 
& cplcUFvFecHpmR(3,3,2),cplcUFvFecVWmL(3,3),cplcUFvFecVWmR(3,3),cplcUFvFvVZL(3,3),       & 
& cplcUFvFvVZR(3,3),cplcUHpmVPVWm(2),cplcUHpmVWmVZ(2),cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,& 
...
& cplhhhhUSucUSu(3,3,6,6),cplhhhhUSvcUSv(3,3,3,3),cplhhhhVZVZ(3,3),cplhhHpmcUHpm(3,2,2), & 
& cplhhHpmcVWm(3,2),cplhhSdcUSd(3,6,6),cplhhSecUSe(3,6,6),cplhhSucUSu(3,6,6),            & 
& cplhhSvcUSv(3,3,3),cplhhVZVZ(3),cplHpmcHpmcVWmVWm(2,2),cplHpmcHpmVP(2,2),              & 
...
& cplSecUSvcVWm(6,3),cplSeUSucSecUSu(6,6,6,6),cplSeUSvcSecUSv(6,3,6,3),cplSucSucVWmVWm(6,6),& 
...
Complex(dp) :: cplSucUSuVZ(6,6),cplSuUSvcSucUSv(6,3,6,3),cplSvcSvcVWmVWm(3,3),cplSvcSvVZ(3,3),        & 
& cplSvcSvVZVZ(3,3),cplSvcUSeVWm(3,6),cplSvcUSvVZ(3,3),cplUAhAhAh(3,3,3),cplUAhAhhh(3,3,3),& 
& cplUAhhhhh(3,3,3),cplUAhhhVZ(3,3),cplUAhHpmcHpm(3,2,2),cplUAhHpmcVWm(3,2),             & 
& cplUAhSdcSd(3,6,6),cplUAhSecSe(3,6,6),cplUAhSucSu(3,6,6),cplUAhUAhAhAh(3,3,3,3),       & 
& cplUAhUAhcVWmVWm(3,3),cplUAhUAhhhhh(3,3,3,3),cplUAhUAhHpmcHpm(3,3,2,2),cplUAhUAhSdcSd(3,3,6,6),& 
& cplUAhUAhSecSe(3,3,6,6),cplUAhUAhSucSu(3,3,6,6),cplUAhUAhSvcSv(3,3,3,3),               & 
& cplUAhUAhVZVZ(3,3),cplUChiChacHpmL(5,2,2),cplUChiChacHpmR(5,2,2),cplUChiChacVWmL(5,2), & 
& cplUChiChacVWmR(5,2),cplUChiChiAhL(5,5,3),cplUChiChiAhR(5,5,3),cplUChiChihhL(5,5,3),   & 
& cplUChiChihhR(5,5,3),cplUChiChiVZL(5,5),cplUChiChiVZR(5,5),cplUChiFdcSdL(5,3,6),       & 
& cplUChiFdcSdR(5,3,6),cplUChiFecSeL(5,3,6),cplUChiFecSeR(5,3,6),cplUChiFucSuL(5,3,6),   & 
& cplUChiFucSuR(5,3,6),cplUChiFvcSvL(5,3,3),cplUChiFvcSvR(5,3,3),cplUhhcVWmVWm(3),       & 
& cplUhhhhhh(3,3,3),cplUhhHpmcHpm(3,2,2),cplUhhHpmcVWm(3,2),cplUhhSdcSd(3,6,6),          & 
& cplUhhSecSe(3,6,6),cplUhhSucSu(3,6,6),cplUhhSvcSv(3,3,3),cplUhhUhhcVWmVWm(3,3),        & 
& cplUhhUhhhhhh(3,3,3,3),cplUhhUhhHpmcHpm(3,3,2,2),cplUhhUhhSdcSd(3,3,6,6),              & 
& cplUhhUhhSecSe(3,3,6,6),cplUhhUhhSucSu(3,3,6,6),cplUhhUhhSvcSv(3,3,3,3),               & 
& cplUhhUhhVZVZ(3,3),cplUhhVZVZ(3),cplUHpmcUHpmcVWmVWm(2,2),cplUHpmcUHpmVPVP(2,2),       & 
...
& cplcgZgWmcVWm,cplcgWpCgZcVWm,cplhhHpmcVWm,cplhhcVWmVWm,cplSdcSucVWm,cplSecSvcVWm,      & 
...
& ZN,ZDL,ZDR,g3,pG,vd,ZH,Tu,ZU,ZP,TW,Ye,ZE,ZEL,ZER,ZV,Te,Tlam,kap,Tk,cplAhSdcUSd,        & 
...
& cplUSdcUSdVZVZ,cplChiFvcUSvL,cplChiFvcUSvR,cplcChaFecUSvL,cplcChaFecUSvR,              & 
& cplhhSvcUSv,cplSecHpmcUSv,cplSecUSvcVWm,cplSvcUSvVZ,cplAhAhUSvcUSv,cplhhhhUSvcUSv,     & 
& cplHpmUSvcHpmcUSv,cplSdUSvcSdcUSv,cplSeUSvcSecUSv,cplSuUSvcSucUSv,cplUSvSvcUSvcSv,     & 
& cplUSvcUSvcVWmVWm,cplUSvcUSvVZVZ,cplAhSucUSu,cplChiFucUSuL,cplChiFucUSuR,              & 
...
& cplUSecUSecVWmVWm,cplUSecUSeVZVZ,cplAhAhUhh,cplAhUhhhh,cplAhUhhVZ,cplcChaChaUhhL,      & 
...
& cplUAhUAhcVWmVWm,cplUAhUAhVZVZ,cplAhHpmcUHpm,cplAhcUHpmVWm,cplChiChacUHpmL,            & 
...
& cplcChacUFuSdR,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,cplGluFucSuR,cplGluGluVGL,       & 
& cplGluGluVGR,cplcFdGluSdL,cplcFdGluSdR,cplcFuGluSuL,cplcFuGluSuR,cplcUFvChiSvL,        & 
& cplcUFvChiSvR,cplcUFvFecHpmL,cplcUFvFecHpmR,cplcUFvFecVWmL,cplcUFvFecVWmR,             & 
& cplcUFvFvVZL,cplcUFvFvVZR,cplcChacUFvSeL,cplcChacUFvSeR,cplcFdFdVGL,cplcFdFdVGR,       & 
& cplcFuFuVGL,cplcFuFuVGR,cplcgGgGVG,cplSdcSdVG,cplSucSuVG,cplVGVGVG,cplSdcSdVGVG,       & 
& cplSucSuVGVG,cplVGVGVGVG1,cplVGVGVGVG2,cplVGVGVGVG3,cplcChaChaVPL,cplcChaChaVPR,       & 
...
& cplUhhSdcSd,cplUhhSecSe,cplUhhSucSu,cplUhhSvcSv,cplUhhcVWmVWm,cplUhhVZVZ,              & 
& Tad1Loop(1:3))
...
If (NewGBC) Then 
Call CalculatePi2S(125._dp**2,vd,vu,vS,g1,g2,g3,Yd,Ye,lam,kap,Yu,Td,Te,               & 
& Tlam,Tk,Tu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,ms2,M1,M2,M3,kont,ti_ep2L,Pi2S_EffPot,        & 
& PiP2S_EffPot)
...
vevs_MSSM(2) = vu 
MAps = 0.0 
MAps = MAps + TLam*vS/Sqrt(2._dp)/sin(Atan(vu/vd))/cos(Atan(vu/vd)) 
mu_asat =  lam*vS/Sqrt(2._dp) 
MAps = MAps + lam*vS**2*kap/2._dp/sin(Atan(vu/vd))/cos(Atan(vu/vd)) 
Q2 = GetRenormalizationScale() 
...
Call OneLoopSe(g1,g2,Ye,Te,lam,ml2,me2,vd,vu,vS,MSe,MSe2,MAh,MAh2,MCha,               & 
...
& cplUhhSecSe,cplUhhSucSu,cplUhhSvcSv,cplUhhcVWmVWm,cplUhhVZVZ,cplAhAhUhhUhh,            & 
& cplUhhUhhhhhh,cplUhhUhhHpmcHpm,cplUhhUhhSdcSd,cplUhhUhhSecSe,cplUhhUhhSucSu,           & 
& cplUhhUhhSvcSv,cplUhhUhhcVWmVWm,cplUhhUhhVZVZ,0.1_dp*delta_mass,Mhh_1L,Mhh2_1L,        & 
& ZH_1L,kont)
...
& cplUAhhhhh,cplUAhhhVZ,cplUAhHpmcHpm,cplUAhHpmcVWm,cplUAhSdcSd,cplUAhSecSe,             & 
...
& MVZ,MVZ2,MSu,MSu2,MSd,MSd2,MSv,MSv2,MSe,MSe2,cplAhHpmcUHpm,cplAhcUHpmVWm,              & 
...
& cplhhHpmcUHpm,cplhhcUHpmVWm,cplHpmcUHpmVP,cplHpmcUHpmVZ,cplSdcUHpmcSu,cplSecUHpmcSv,   & 
...
& cplUChiFucSuR,cplUChiFvcSvL,cplUChiFvcSvR,cplcChaUChiHpmL,cplcChaUChiHpmR,             & 
& cplcFdUChiSdL,cplcFdUChiSdR,cplcFeUChiSeL,cplcFeUChiSeR,cplcFuUChiSuL,cplcFuUChiSuR,   & 
& cplcFvUChiSvL,cplcFvUChiSvR,cplcChaUChiVWmL,cplcChaUChiVWmR,0.1_dp*delta_mass,         & 
...
& cplcUFeFvVWmL,cplcUFeFvVWmR,0.1_dp*delta_mass,MFe_1L,MFe2_1L,ZEL_1L,ZER_1L,kont)
...
& MSv2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhUhh,cplcChaChaUhhL,cplcChaChaUhhR,cplChiChiUhhL,       & 
& cplChiChiUhhR,cplcFdFdUhhL,cplcFdFdUhhR,cplcFeFeUhhL,cplcFeFeUhhR,cplcFuFuUhhL,        & 
& cplcFuFuUhhR,cplcgWmgWmUhh,cplcgWpCgWpCUhh,cplcgZgZUhh,cplUhhhhhh,cplUhhHpmcHpm,       & 
...
& MFe2(3),MFu(3),MFu2(3),Mhh(3),Mhh2(3),MHpm(2),MHpm2(2),MSd(6),MSd2(6),MSe(6),          & 
...
& cplUhhSdcSd(3,6,6),cplUhhSecSe(3,6,6),cplUhhSucSu(3,6,6),cplUhhSvcSv(3,3,3),           & 
...
& MHpm2,MVZ,MVZ2,MVWm,MVWm2,MSe,MSe2,MSv,MSv2,cplAhSdcUSd,cplChaFucUSdL,cplChaFucUSdR,   & 
& cplChiFdcUSdL,cplChiFdcUSdR,cplGluFdcUSdL,cplGluFdcUSdR,cplhhSdcUSd,cplHpmSucUSd,      & 
& cplSdcUSdVG,cplSdcUSdVP,cplSdcUSdVZ,cplSucUSdVWm,cplAhAhUSdcUSd,cplhhhhUSdcUSd,        & 
& cplHpmUSdcHpmcUSd,cplUSdSdcUSdcSd,cplUSdSecUSdcSe,cplUSdSucUSdcSu,cplUSdSvcUSdcSv,     & 
...
Implicit None 
Real(dp), Intent(in) :: MChi(5),MChi2(5),MCha(2),MCha2(2),MFe(3),MFe2(3),MSv(3),MSv2(3),Mhh(3),               & 
& Mhh2(3),MHpm(2),MHpm2(2),MSe(6),MSe2(6),MVWm,MVWm2,MVZ,MVZ2,MAh(3),MAh2(3),            & 
...
Complex(dp), Intent(in) :: cplChiFvcUSvL(5,3,3),cplChiFvcUSvR(5,3,3),cplcChaFecUSvL(2,3,3),cplcChaFecUSvR(2,3,3),& 
& cplhhSvcUSv(3,3,3),cplSecHpmcUSv(6,2,3),cplSecUSvcVWm(6,3),cplSvcUSvVZ(3,3),           & 
& cplAhAhUSvcUSv(3,3,3,3),cplhhhhUSvcUSv(3,3,3,3),cplHpmUSvcHpmcUSv(2,3,2,3),            & 
...
Subroutine DerPi1LoopSv(p2,MChi,MChi2,MCha,MCha2,MFe,MFe2,MSv,MSv2,Mhh,               & 
& Mhh2,MHpm,MHpm2,MSe,MSe2,MVWm,MVWm2,MVZ,MVZ2,MAh,MAh2,MSd,MSd2,MSu,MSu2,               & 
& cplChiFvcUSvL,cplChiFvcUSvR,cplcChaFecUSvL,cplcChaFecUSvR,cplhhSvcUSv,cplSecHpmcUSv,   & 
& cplSecUSvcVWm,cplSvcUSvVZ,cplAhAhUSvcUSv,cplhhhhUSvcUSv,cplHpmUSvcHpmcUSv,             & 
& cplSdUSvcSdcUSv,cplSeUSvcSecUSv,cplSuUSvcSucUSv,cplUSvSvcUSvcSv,cplUSvcUSvcVWmVWm,     & 
...
sumI = 0._dp 
    ...
    Do i1 = 1, 3
       Do i2 = 1, 5
 G0m2 = Real(SA_DerGloop(p2,0._dp,MChi2(i2)),dp) 
B0m2 = -2._dp*0.*MChi(i2)*Real(SA_DerB0(p2,0._dp,MChi2(i2)),dp) 
Do gO1 = 1, 3
  Do gO2 = gO1, 3
coupL1 = cplChiFvcUSvL(i2,i1,gO1)
coupR1 = cplChiFvcUSvR(i2,i1,gO1)
...
& MSd2,MVWm,MVWm2,MVZ,MVZ2,MSe,MSe2,MSv,MSv2,cplAhSucUSu,cplChiFucUSuL,cplChiFucUSuR,    & 
& cplcChaFdcUSuL,cplcChaFdcUSuR,cplGluFucUSuL,cplGluFucUSuR,cplhhSucUSu,cplSdcHpmcUSu,   & 
& cplSdcUSucVWm,cplSucUSuVG,cplSucUSuVP,cplSucUSuVZ,cplAhAhUSucUSu,cplhhhhUSucUSu,       & 
& cplHpmUSucHpmcUSu,cplSdUSucSdcUSu,cplSeUSucSecUSu,cplUSuSucUSucSu,cplUSuSvcUSucSv,     & 
...
& cplUSucUSuVPVP,cplUSucUSucVWmVWm,cplUSucUSuVZVZ,kont,PiSf(1,:,:))
...
& MCha,MCha2,MFe,MFe2,MChi,MChi2,Mhh,Mhh2,MSv,MSv2,MHpm,MHpm2,MVZ,MVZ2,MVWm,             & 
& MVWm2,MSd,MSd2,MSu,MSu2,cplAhSecUSe,cplChaFvcUSeL,cplChaFvcUSeR,cplChiFecUSeL,         & 
& cplChiFecUSeR,cplhhSecUSe,cplHpmSvcUSe,cplSecUSeVP,cplSecUSeVZ,cplSvcUSeVWm,           & 
& cplAhAhUSecUSe,cplhhhhUSecUSe,cplHpmUSecHpmcUSe,cplSdUSecSdcUSe,cplUSeSecUSecSe,       & 
& cplUSeSucUSecSu,cplUSeSvcUSecSv,cplUSecUSeVPVP,cplUSecUSecVWmVWm,cplUSecUSeVZVZ,       & 
...
Implicit None 
Real(dp), Intent(in) :: MSe(6),MSe2(6),MAh(3),MAh2(3),MCha(2),MCha2(2),MFe(3),MFe2(3),MChi(5),MChi2(5),       & 
& Mhh(3),Mhh2(3),MSv(3),MSv2(3),MHpm(2),MHpm2(2),MVZ,MVZ2,MVWm,MVWm2,MSd(6),             & 
& MSd2(6),MSu(6),MSu2(6)
...
Complex(dp), Intent(in) :: cplAhSecUSe(3,6,6),cplChaFvcUSeL(2,3,6),cplChaFvcUSeR(2,3,6),cplChiFecUSeL(5,3,6),    & 
& cplChiFecUSeR(5,3,6),cplhhSecUSe(3,6,6),cplHpmSvcUSe(2,3,6),cplSecUSeVP(6,6),          & 
& cplSecUSeVZ(6,6),cplSvcUSeVWm(3,6),cplAhAhUSecUSe(3,3,6,6),cplhhhhUSecUSe(3,3,6,6),    & 
...
Subroutine DerPi1LoopSe(p2,MSe,MSe2,MAh,MAh2,MCha,MCha2,MFe,MFe2,MChi,MChi2,          & 
& Mhh,Mhh2,MSv,MSv2,MHpm,MHpm2,MVZ,MVZ2,MVWm,MVWm2,MSd,MSd2,MSu,MSu2,cplAhSecUSe,        & 
& cplChaFvcUSeL,cplChaFvcUSeR,cplChiFecUSeL,cplChiFecUSeR,cplhhSecUSe,cplHpmSvcUSe,      & 
& cplSecUSeVP,cplSecUSeVZ,cplSvcUSeVWm,cplAhAhUSecUSe,cplhhhhUSecUSe,cplHpmUSecHpmcUSe,  & 
& cplSdUSecSdcUSe,cplUSeSecUSecSe,cplUSeSucUSecSu,cplUSeSvcUSecSv,cplUSecUSeVPVP,        & 
...
sumI = 0._dp 
    ...
    Do i1 = 1, 3
       Do i2 = 1, 2
 G0m2 = Real(SA_DerGloop(p2,0._dp,MCha2(i2)),dp) 
B0m2 = -2._dp*0.*MCha(i2)*Real(SA_DerB0(p2,0._dp,MCha2(i2)),dp) 
Do gO1 = 1, 6
  Do gO2 = gO1, 6
coupL1 = cplChaFvcUSeL(i2,i1,gO1)
coupR1 = cplChaFvcUSeR(i2,i1,gO1)
...
& cplUhhSecSe,cplUhhSucSu,cplUhhSvcSv,cplUhhcVWmVWm,cplUhhVZVZ,cplAhAhUhhUhh,            & 
& cplUhhUhhhhhh,cplUhhUhhHpmcHpm,cplUhhUhhSdcSd,cplUhhUhhSecSe,cplUhhUhhSucSu,           & 
& cplUhhUhhSvcSv,cplUhhUhhcVWmVWm,cplUhhUhhVZVZ,delta,mass,mass2,RS,kont)
...
& cplUhhHpmcHpm(3,2,2),cplUhhHpmcVWm(3,2),cplUhhSdcSd(3,6,6),cplUhhSecSe(3,6,6),         & 
& cplUhhSucSu(3,6,6),cplUhhSvcSv(3,3,3),cplUhhcVWmVWm(3),cplUhhVZVZ(3),cplAhAhUhhUhh(3,3,3,3),& 
& cplUhhUhhhhhh(3,3,3,3),cplUhhUhhHpmcHpm(3,3,2,2),cplUhhUhhSdcSd(3,3,6,6),              & 
& cplUhhUhhSecSe(3,3,6,6),cplUhhUhhSucSu(3,3,6,6),cplUhhUhhSvcSv(3,3,3,3),               & 
...
& MSv,MSv2,cplAhAhUhh,cplAhUhhhh,cplAhUhhVZ,cplcChaChaUhhL,cplcChaChaUhhR,               & 
...
& MFd,MFd2,MFe,MFe2,MFu,MFu2,MHpm,MHpm2,MVWm,MVWm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,           & 
& MSv,MSv2,cplAhAhUhh,cplAhUhhhh,cplAhUhhVZ,cplcChaChaUhhL,cplcChaChaUhhR,               & 
& cplChiChiUhhL,cplChiChiUhhR,cplcFdFdUhhL,cplcFdFdUhhR,cplcFeFeUhhL,cplcFeFeUhhR,       & 
& cplcFuFuUhhL,cplcFuFuUhhR,cplcgWmgWmUhh,cplcgWpCgWpCUhh,cplcgZgZUhh,cplUhhhhhh,        & 
& cplUhhHpmcHpm,cplUhhHpmcVWm,cplUhhSdcSd,cplUhhSecSe,cplUhhSucSu,cplUhhSvcSv,           & 
& cplUhhcVWmVWm,cplUhhVZVZ,cplAhAhUhhUhh,cplUhhUhhhhhh,cplUhhUhhHpmcHpm,cplUhhUhhSdcSd,  & 
& cplUhhUhhSecSe,cplUhhUhhSucSu,cplUhhUhhSvcSv,cplUhhUhhcVWmVWm,cplUhhUhhVZVZ,kont,res)
...
& cplUAhHpmcVWm(3,2),cplUAhSdcSd(3,6,6),cplUAhSecSe(3,6,6),cplUAhSucSu(3,6,6),           & 
& cplUAhUAhAhAh(3,3,3,3),cplUAhUAhhhhh(3,3,3,3),cplUAhUAhHpmcHpm(3,3,2,2),               & 
& cplUAhUAhSdcSd(3,3,6,6),cplUAhUAhSecSe(3,3,6,6),cplUAhUAhSucSu(3,3,6,6),               & 
& cplUAhUAhSvcSv(3,3,3,3),cplUAhUAhcVWmVWm(3,3),cplUAhUAhVZVZ(3,3)
...
& MFe2,MFu,MFu2,MVZ,MVZ2,MHpm,MHpm2,MVWm,MVWm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,               & 
& MSv,MSv2,cplUAhAhAh,cplUAhAhhh,cplcChaChaUAhL,cplcChaChaUAhR,cplChiChiUAhL,            & 
& cplChiChiUAhR,cplcFdFdUAhL,cplcFdFdUAhR,cplcFeFeUAhL,cplcFeFeUAhR,cplcFuFuUAhL,        & 
& cplcFuFuUAhR,cplcgWmgWmUAh,cplcgWpCgWpCUAh,cplUAhhhhh,cplUAhhhVZ,cplUAhHpmcHpm,        & 
& cplUAhHpmcVWm,cplUAhSdcSd,cplUAhSecSe,cplUAhSucSu,cplUAhUAhAhAh,cplUAhUAhhhhh,         & 
& cplUAhUAhHpmcHpm,cplUAhUAhSdcSd,cplUAhUAhSecSe,cplUAhUAhSucSu,cplUAhUAhSvcSv,          & 
...
& MSu,MSu2,MSv,MSv2,cplUAhAhAh,cplUAhAhhh,cplcChaChaUAhL,cplcChaChaUAhR,cplChiChiUAhL,   & 
& cplChiChiUAhR,cplcFdFdUAhL,cplcFdFdUAhR,cplcFeFeUAhL,cplcFeFeUAhR,cplcFuFuUAhL,        & 
& cplcFuFuUAhR,cplcgWmgWmUAh,cplcgWpCgWpCUAh,cplUAhhhhh,cplUAhhhVZ,cplUAhHpmcHpm,        & 
& cplUAhHpmcVWm,cplUAhSdcSd,cplUAhSecSe,cplUAhSucSu,cplUAhUAhAhAh,cplUAhUAhhhhh,         & 
& cplUAhUAhHpmcHpm,cplUAhUAhSdcSd,cplUAhUAhSecSe,cplUAhUAhSucSu,cplUAhUAhSvcSv,          & 
...
& Mhh2,MVZ,MVZ2,MSu,MSu2,MSd,MSd2,MSv,MSv2,MSe,MSe2,cplAhHpmcUHpm,cplAhcUHpmVWm,         & 
& cplChiChacUHpmL,cplChiChacUHpmR,cplcFuFdcUHpmL,cplcFuFdcUHpmR,cplcFvFecUHpmL,          & 
& cplcFvFecUHpmR,cplcgZgWmcUHpm,cplcgWmgZUHpm,cplcgWpCgZcUHpm,cplcgZgWpCUHpm,            & 
& cplhhHpmcUHpm,cplhhcUHpmVWm,cplHpmcUHpmVP,cplHpmcUHpmVZ,cplSdcUHpmcSu,cplSecUHpmcSv,   & 
& cplcUHpmVPVWm,cplcUHpmVWmVZ,cplAhAhUHpmcUHpm,cplhhhhUHpmcUHpm,cplUHpmHpmcUHpmcHpm,     & 
...
& MFu(3),MFu2(3),MFd(3),MFd2(3),MFe(3),MFe2(3),Mhh(3),Mhh2(3),MVZ,MVZ2,MSu(6),           & 
...
& MSe2,MFe,MFe2,MSu,MSu2,MFu,MFu2,MSv,MSv2,cplUChiChiAhL,cplUChiChiAhR,cplUChiChacHpmL,  & 
...
& cplUChiFucSuL,cplUChiFucSuR,cplUChiFvcSvL,cplUChiFvcSvR,cplcChaUChiHpmL,               & 
& cplcChaUChiHpmR,cplcFdUChiSdL,cplcFdUChiSdR,cplcFeUChiSeL,cplcFeUChiSeR,               & 
& cplcFuUChiSuL,cplcFuUChiSuR,cplcFvUChiSvL,cplcFvUChiSvR,cplcChaUChiVWmL,               & 
...
& cplUChiFvcSvL(5,3,3),cplUChiFvcSvR(5,3,3),cplcChaUChiHpmL(2,5,2),cplcChaUChiHpmR(2,5,2),& 
& cplcFdUChiSdL(3,5,6),cplcFdUChiSdR(3,5,6),cplcFeUChiSeL(3,5,6),cplcFeUChiSeR(3,5,6),   & 
& cplcFuUChiSuL(3,5,6),cplcFuUChiSuR(3,5,6),cplcFvUChiSvL(3,5,3),cplcFvUChiSvR(3,5,3),   & 
...
& cplUChiFvcSvL,cplUChiFvcSvR,cplcChaUChiHpmL,cplcChaUChiHpmR,cplcFdUChiSdL,             & 
& cplcFdUChiSdR,cplcFeUChiSeL,cplcFeUChiSeR,cplcFuUChiSuL,cplcFuUChiSuR,cplcFvUChiSvL,   & 
& cplcFvUChiSvR,cplcChaUChiVWmL,cplcChaUChiVWmR,sigL,sigR,sigSL,sigSR)
...
& cplUChiFucSuR,cplUChiFvcSvL,cplUChiFvcSvR,cplcChaUChiHpmL,cplcChaUChiHpmR,             & 
& cplcFdUChiSdL,cplcFdUChiSdR,cplcFeUChiSeL,cplcFeUChiSeR,cplcFuUChiSuL,cplcFuUChiSuR,   & 
& cplcFvUChiSvL,cplcFvUChiSvR,cplcChaUChiVWmL,cplcChaUChiVWmR,sigL,sigR,sigSL,sigSR)
...
Do gO1 = 1, 5
  Do gO2 = 1, 5
B1m2 = -2._dp*Real(SA_B1(p2,0._dp,MSv2(i2)),dp) 
B0m2 = 2._dp*0.*Real(SA_B0(p2,0._dp,MSv2(i2)),dp) 
...
& MFu,MFu2,MSv,MSv2,cplUChiChiAhL,cplUChiChiAhR,cplUChiChacHpmL,cplUChiChacHpmR,         & 
& cplUChiChacVWmL,cplUChiChacVWmR,cplUChiChihhL,cplUChiChihhR,cplUChiChiVZL,             & 
& cplUChiChiVZR,cplUChiFdcSdL,cplUChiFdcSdR,cplUChiFecSeL,cplUChiFecSeR,cplUChiFucSuL,   & 
& cplUChiFucSuR,cplUChiFvcSvL,cplUChiFvcSvR,cplcChaUChiHpmL,cplcChaUChiHpmR,             & 
& cplcFdUChiSdL,cplcFdUChiSdR,cplcFeUChiSeL,cplcFeUChiSeR,cplcFuUChiSuL,cplcFuUChiSuR,   & 
...
Do gO1 = 1, 5
  Do gO2 = 1, 5
B1m2 = -2._dp*Real(SA_DerB1(p2,0._dp,MSv2(i1)),dp) 
B0m2 = 2._dp*0.*Real(SA_DerB0(p2,0._dp,MSv2(i1)),dp) 
coupL1 = cplUChiFvcSvL(gO1,i2,i1)
coupR1 = cplUChiFvcSvR(gO1,i2,i1)
coupL2 =  Conjg(cplUChiFvcSvL(gO2,i2,i1))
coupR2 =  Conjg(cplUChiFvcSvR(gO2,i2,i1))
...
Do gO1 = 1, 5
  Do gO2 = 1, 5
B1m2 = -2._dp*Real(SA_DerB1(p2,0._dp,MSv2(i2)),dp) 
B0m2 = 2._dp*0.*Real(SA_DerB0(p2,0._dp,MSv2(i2)),dp) 
coupL1 = cplcFvUChiSvL(i1,gO1,i2)
coupR1 = cplcFvUChiSvR(i1,gO1,i2)
coupL2 =  Conjg(cplcFvUChiSvL(i1,gO2,i2))
coupR2 =  Conjg(cplcFvUChiSvR(i1,gO2,i2))
...
& MVZ2,MHpm,MHpm2,MChi,MChi2,MVWm,MVWm2,MSu,MSu2,MFd,MFd2,MSv,MSv2,MFe,MFe2,             & 
& MFu,MFu2,MSd,MSd2,MSe,MSe2,cplcUChaChaAhL,cplcUChaChaAhR,cplcUChaChahhL,               & 
...
& cplcUChaFdcSuR,cplcUChaFecSvL,cplcUChaFecSvR,cplcUChacFuSdL,cplcUChacFuSdR,            & 
& cplcUChacFvSeL,cplcUChacFvSeR,delta,MCha_1L,MCha2_1L,UM_1L,UP_1L,ierr)

Implicit None 
Real(dp), Intent(in) :: MCha(2),MCha2(2),MAh(3),MAh2(3),Mhh(3),Mhh2(3),MVZ,MVZ2,MHpm(2),MHpm2(2),             & 
& MChi(5),MChi2(5),MVWm,MVWm2,MSu(6),MSu2(6),MFd(3),MFd2(3),MSv(3),MSv2(3),              & 
...
& cplcUChaChiHpmR,cplcUChaChiVWmL,cplcUChaChiVWmR,cplcUChaFdcSuL,cplcUChaFdcSuR,         & 
& cplcUChaFecSvL,cplcUChaFecSvR,cplcUChacFuSdL,cplcUChacFuSdR,cplcUChacFvSeL,            & 
& cplcUChacFvSeR,sigL,sigR,sigSL,sigSR)
...
Do gO1 = 1, 2
  Do gO2 = 1, 2
B1m2 = -Real(SA_B1(p2,0._dp,MSe2(i2)),dp) 
B0m2 = 0.*Real(SA_B0(p2,0._dp,MSe2(i2)),dp) 
...
Do gO1 = 1, 2
  Do gO2 = 1, 2
B1m2 = -Real(SA_DerB1(p2,0._dp,MSe2(i2)),dp) 
B0m2 = 0.*Real(SA_DerB0(p2,0._dp,MSe2(i2)),dp) 
coupL1 = cplcUChacFvSeL(gO1,i1,i2)
coupR1 = cplcUChacFvSeR(gO1,i1,i2)
coupL2 =  Conjg(cplcUChacFvSeL(gO2,i1,i2))
coupR2 =  Conjg(cplcUChacFvSeR(gO2,i1,i2))
...
Implicit None 
Real(dp), Intent(in) :: MFe(3),MFe2(3),MAh(3),MAh2(3),MSv(3),MSv2(3),MCha(2),MCha2(2),MSe(6),MSe2(6),         & 
& MChi(5),MChi2(5),Mhh(3),Mhh2(3),MVZ,MVZ2,MHpm(2),MHpm2(2),MVWm,MVWm2

Real(dp), Intent(in) :: vd

Complex(dp), Intent(in) :: Ye(3,3)

Complex(dp), Intent(in) :: cplcUFeFeAhL(3,3,3),cplcUFeFeAhR(3,3,3),cplcUFeChaSvL(3,2,3),cplcUFeChaSvR(3,2,3),    & 
& cplcUFeChiSeL(3,5,6),cplcUFeChiSeR(3,5,6),cplcUFeFehhL(3,3,3),cplcUFeFehhR(3,3,3),     & 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -Real(SA_DerB1(p2,0._dp,MHpm2(i1)),dp) 
B0m2 = 0.*Real(SA_DerB0(p2,0._dp,MHpm2(i1)),dp) 
coupL1 = cplcUFeFvHpmL(gO1,i2,i1)
coupR1 = cplcUFeFvHpmR(gO1,i2,i1)
coupL2 =  Conjg(cplcUFeFvHpmL(gO2,i2,i1))
coupR2 =  Conjg(cplcUFeFvHpmR(gO2,i2,i1))
...
Subroutine Sigma1LoopFv(p2,MSv,MSv2,MChi,MChi2,MHpm,MHpm2,MFe,MFe2,MVWm,              & 
& MVWm2,MVZ,MVZ2,MCha,MCha2,MSe,MSe2,cplcUFvChiSvL,cplcUFvChiSvR,cplcUFvFecHpmL,         & 
& cplcUFvFecHpmR,cplcUFvFecVWmL,cplcUFvFecVWmR,cplcUFvFvVZL,cplcUFvFvVZR,cplcChacUFvSeL, & 
& cplcChacUFvSeR,sigL,sigR,sigSL,sigSR)

Implicit None 
Real(dp), Intent(in) :: MSv(3),MSv2(3),MChi(5),MChi2(5),MHpm(2),MHpm2(2),MFe(3),MFe2(3),MVWm,MVWm2,           & 
& MVZ,MVZ2,MCha(2),MCha2(2),MSe(6),MSe2(6)

Complex(dp), Intent(in) :: cplcUFvChiSvL(3,5,3),cplcUFvChiSvR(3,5,3),cplcUFvFecHpmL(3,3,2),cplcUFvFecHpmR(3,3,2),& 
& cplcUFvFecVWmL(3,3),cplcUFvFecVWmR(3,3),cplcUFvFvVZL(3,3),cplcUFvFvVZR(3,3),           & 
& cplcChacUFvSeL(2,3,6),cplcChacUFvSeR(2,3,6)
...
Subroutine DerSigma1LoopFv(p2,MSv,MSv2,MChi,MChi2,MHpm,MHpm2,MFe,MFe2,MVWm,           & 
& MVWm2,MVZ,MVZ2,MCha,MCha2,MSe,MSe2,cplcUFvChiSvL,cplcUFvChiSvR,cplcUFvFecHpmL,         & 
& cplcUFvFecHpmR,cplcUFvFecVWmL,cplcUFvFecVWmR,cplcUFvFvVZL,cplcUFvFvVZR,cplcChacUFvSeL, & 
& cplcChacUFvSeR,sigL,sigR,sigSL,sigSR)
...
& cplcVWmVWmVZ,cplAhAhcVWmVWm(3,3),cplhhhhcVWmVWm(3,3),cplHpmcHpmcVWmVWm(2,2),           & 
...
& cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,cplSvcSvVZ,kont,res)

Implicit None 
Real(dp), Intent(in) :: MAh(3),MAh2(3),MCha(2),MCha2(2),MChi(5),MChi2(5),MFd(3),MFd2(3),MFe(3),               & 
& MFe2(3),MFu(3),MFu2(3),Mhh(3),Mhh2(3),MHpm(2),MHpm2(2),MSd(6),MSd2(6),MSe(6),          & 
& MSe2(6),MSu(6),MSu2(6),MSv(3),MSv2(3),MVWm,MVWm2
...
& cplChiChiVZR(5,5),cplcHpmVWmVZ(2),cplcVWmVWmVZ,cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),      & 
& cplhhHpmcHpm(3,2,2),cplhhHpmcVWm(3,2),cplhhSdcSd(3,6,6),cplhhSecSe(3,6,6),             & 
& cplhhSucSu(3,6,6),cplhhSvcSv(3,3,3),cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2),cplSdcSdVZ(6,6), & 
...
& cplAhSdcSd(3,6,6),cplAhSecSe(3,6,6),cplAhSucSu(3,6,6),cplcChaChaAhL(2,2,3),            & 
& cplcChaChaAhR(2,2,3),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplcFdFdAhL(3,3,3),         & 
& cplcFdFdAhR(3,3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFeFeAhL(3,3,3),               & 
& cplcFeFeAhR(3,3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFuFuAhL(3,3,3),               & 
& cplcFuFuAhR(3,3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcgWmgWmAh(3),cplcgWmgWmVZ,     & 
& cplcgWpCgWpCAh(3),cplcgWpCgWpCVZ,cplChiChiAhL(5,5,3),cplChiChiAhR(5,5,3),              & 
& cplChiChiVZL(5,5),cplChiChiVZR(5,5),cplcHpmVWmVZ(2),cplhhVZVZ(3),cplHpmcHpmVZ(2,2),    & 
...
& cplcgAgWpCVWm,cplcgWmgZVWm,cplcgWpCgAcHpm(2),cplcgWpCgZcHpm(2),cplcgZgWmcHpm(2),       & 
& cplcgZgWpCVWm,cplChiChacHpmL(5,2,2),cplChiChacHpmR(5,2,2),cplcHpmVPVWm(2),             & 
& cplcHpmVWmVZ(2),cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),           & 
& cplhhHpmcHpm(3,2,2),cplHpmcHpmVP(2,2),cplHpmcHpmVZ(2,2),cplSdcHpmcSu(6,2,6),           & 
& cplSecHpmcSv(6,2,3),cplSucSdVWm(6,6),cplSvcSeVWm(3,6)
...
& cplcFvFecHpmL,cplcFvFecHpmR,cplcgAgWpCVWm,cplcgWmgZVWm,cplcgWpCgAcHpm,cplcgWpCgZcHpm,  & 
& cplcgZgWmcHpm,cplcgZgWpCVWm,cplChiChacHpmL,cplChiChacHpmR,cplcHpmVPVWm,cplcHpmVWmVZ,   & 
& cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHpmVWm,cplhhcVWmVWm,cplhhHpmcHpm,cplHpmcHpmVP,         & 
