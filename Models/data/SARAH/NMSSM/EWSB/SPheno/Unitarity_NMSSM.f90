...
Integer :: iter 
Complex(dp) :: scatter_matrix(300,300) 
Complex(dp) :: rot_matrix(300,300) 
Real(dp) :: eigenvalues_matrix(300), test(2), unitarity_s, scattering_eigenvalue, step_size
...
scatter_matrix(91,265) =(-g1**2 - g2**2)/4._dp
scatter_matrix(92,266) =(-g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(93,267) =(g1**2/2._dp + g2**2/2._dp)/2._dp - lam*Conjg(lam)
scatter_matrix(93,275) =-g2**2/2._dp + lam*Conjg(lam)
scatter_matrix(93,291) =sqrt(2._dp)*lam*Conjg(kap)
scatter_matrix(94,268) =(g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(95,269) =-(lam*Conjg(lam))
scatter_matrix(103,103) =(-g1**2 - g2**2)/2._dp
scatter_matrix(103,123) =(-g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(103,142) =(g1**2/2._dp + g2**2/2._dp)/2._dp - lam*Conjg(lam)
scatter_matrix(103,160) =(g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(103,177) =-(lam*Conjg(lam))
scatter_matrix(104,122) =(-g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(104,143) =-g2**2/2._dp + lam*Conjg(lam)
scatter_matrix(105,140) =(g1**2/2._dp + g2**2/2._dp)/2._dp - lam*Conjg(lam)
scatter_matrix(106,141) =-g2**2/2._dp + lam*Conjg(lam)
scatter_matrix(106,157) =(g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(107,144) =2*lam*Conjg(kap)
scatter_matrix(107,173) =-(lam*Conjg(lam))
scatter_matrix(111,273) =(-g1**2 - g2**2)/4._dp
scatter_matrix(112,274) =(g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(113,267) =-g2**2/2._dp + lam*Conjg(lam)
scatter_matrix(113,275) =(g1**2/2._dp + g2**2/2._dp)/2._dp - lam*Conjg(lam)
scatter_matrix(113,291) =-(sqrt(2._dp)*lam*Conjg(kap))
scatter_matrix(114,276) =-(lam*Conjg(lam))
scatter_matrix(122,104) =(-g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(122,159) =-g2**2/2._dp + lam*Conjg(lam)
scatter_matrix(123,103) =(-g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(123,123) =(-g1**2 - g2**2)/2._dp
scatter_matrix(123,142) =(g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(123,160) =(g1**2/2._dp + g2**2/2._dp)/2._dp - lam*Conjg(lam)
scatter_matrix(123,177) =-(lam*Conjg(lam))
scatter_matrix(124,141) =(g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(124,157) =-g2**2/2._dp + lam*Conjg(lam)
scatter_matrix(125,158) =(g1**2/2._dp + g2**2/2._dp)/2._dp - lam*Conjg(lam)
scatter_matrix(126,161) =-2*lam*Conjg(kap)
scatter_matrix(126,174) =-(lam*Conjg(lam))
scatter_matrix(130,280) =(-g1**2 - g2**2)/4._dp
scatter_matrix(131,281) =(-g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(132,282) =-(lam*Conjg(lam))
scatter_matrix(140,105) =(g1**2/2._dp + g2**2/2._dp)/2._dp - lam*Conjg(lam)
scatter_matrix(141,106) =-g2**2/2._dp + lam*Conjg(lam)
scatter_matrix(141,124) =(g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(142,103) =(g1**2/2._dp + g2**2/2._dp)/2._dp - lam*Conjg(lam)
scatter_matrix(142,123) =(g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(142,142) =(-g1**2 - g2**2)/2._dp
scatter_matrix(142,160) =(-g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(142,177) =-(lam*Conjg(lam))
scatter_matrix(143,104) =-g2**2/2._dp + lam*Conjg(lam)
scatter_matrix(143,159) =(-g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(144,107) =2*lam*Conjg(kap)
scatter_matrix(144,175) =-(lam*Conjg(lam))
scatter_matrix(148,286) =(-g1**2 - g2**2)/4._dp
scatter_matrix(149,287) =-(lam*Conjg(lam))
scatter_matrix(157,106) =(g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(157,124) =-g2**2/2._dp + lam*Conjg(lam)
scatter_matrix(158,125) =(g1**2/2._dp + g2**2/2._dp)/2._dp - lam*Conjg(lam)
scatter_matrix(159,122) =-g2**2/2._dp + lam*Conjg(lam)
scatter_matrix(159,143) =(-g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(160,103) =(g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(160,123) =(g1**2/2._dp + g2**2/2._dp)/2._dp - lam*Conjg(lam)
scatter_matrix(160,142) =(-g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(160,160) =(-g1**2 - g2**2)/2._dp
scatter_matrix(160,177) =-(lam*Conjg(lam))
scatter_matrix(161,126) =-2*lam*Conjg(kap)
scatter_matrix(161,176) =-(lam*Conjg(lam))
scatter_matrix(165,267) =sqrt(2._dp)*kap*Conjg(lam)
scatter_matrix(165,275) =-(sqrt(2._dp)*kap*Conjg(lam))
scatter_matrix(165,291) =-2*kap*Conjg(kap)
scatter_matrix(173,107) =-(lam*Conjg(lam))
scatter_matrix(173,175) =2*kap*Conjg(lam)
scatter_matrix(174,126) =-(lam*Conjg(lam))
scatter_matrix(174,176) =-2*kap*Conjg(lam)
scatter_matrix(175,144) =-(lam*Conjg(lam))
scatter_matrix(175,173) =2*kap*Conjg(lam)
scatter_matrix(176,161) =-(lam*Conjg(lam))
scatter_matrix(176,174) =-2*kap*Conjg(lam)
scatter_matrix(177,103) =-(lam*Conjg(lam))
scatter_matrix(177,123) =-(lam*Conjg(lam))
scatter_matrix(177,142) =-(lam*Conjg(lam))
scatter_matrix(177,160) =-(lam*Conjg(lam))
scatter_matrix(177,177) =-4*kap*Conjg(kap)
scatter_matrix(265,91) =(-g1**2 - g2**2)/4._dp
scatter_matrix(266,92) =(-g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(267,93) =(g1**2/2._dp + g2**2/2._dp)/2._dp - lam*Conjg(lam)
scatter_matrix(267,113) =-g2**2/2._dp + lam*Conjg(lam)
scatter_matrix(267,165) =sqrt(2._dp)*kap*Conjg(lam)
scatter_matrix(268,94) =(g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(269,95) =-(lam*Conjg(lam))
scatter_matrix(273,111) =(-g1**2 - g2**2)/4._dp
scatter_matrix(274,112) =(g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(275,93) =-g2**2/2._dp + lam*Conjg(lam)
scatter_matrix(275,113) =(g1**2/2._dp + g2**2/2._dp)/2._dp - lam*Conjg(lam)
scatter_matrix(275,165) =-(sqrt(2._dp)*kap*Conjg(lam))
scatter_matrix(276,114) =-(lam*Conjg(lam))
scatter_matrix(280,130) =(-g1**2 - g2**2)/4._dp
scatter_matrix(281,131) =(-g1**2/2._dp - g2**2/2._dp)/2._dp
scatter_matrix(282,132) =-(lam*Conjg(lam))
scatter_matrix(286,148) =(-g1**2 - g2**2)/4._dp
scatter_matrix(287,149) =-(lam*Conjg(lam))
scatter_matrix(291,93) =sqrt(2._dp)*lam*Conjg(kap)
scatter_matrix(291,113) =-(sqrt(2._dp)*lam*Conjg(kap))
scatter_matrix(291,165) =-2*kap*Conjg(kap)
