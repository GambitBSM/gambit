...
& ZP,ZU,ZUL,ZUR,ZV,ZW,ZZ,betaH,vd,vu,vS,g1,g2,g3,Yd,Ye,lam,kap,Yu,Td,Te,Tlam,            & 
& Tk,Tu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,ms2,M1,M2,M3,delta0,gMZ,kont)
...
& cplcUFdFdAhL(3,3,3),cplcUFdFdAhR(3,3,3),cplcUFdChaSuL(3,2,6),cplcUFdChaSuR(3,2,6),     & 
...
& cplcUFuFuAhL(3,3,3),cplcUFuFuAhR(3,3,3),cplcUFuChiSuL(3,5,6),cplcUFuChiSuR(3,5,6),     & 
...
Call DeltaVB(sinW2,sinW2_Q,rho,MAh,MCha,MChi,MFe,Mhh,MHpm,MSe,MSv,MVWm,               & 
...
& cplcUFeFvVWmL,cplcUFeFvVWmR,sigR_l,sigL_l,sigSL_l,sigSR_l)
...
& mq2,ml2,mHd2,mHu2,md2,mu2,me2,ms2,M1,M2,M3,mGut,kont,WriteComment,niter)
...
Real(dp) ::mass_new(46),mass_old(46),diff_m(46)
