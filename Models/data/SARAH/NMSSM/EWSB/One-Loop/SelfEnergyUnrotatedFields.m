{{sum[gI1, 1, 3, Mass[Fd[{gI1}]]*sum[gI2, 1, 6, 
 ...
 {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fe[{gI2}]], Mass2[Hpm[{gI1}]]]*
      conj[Cp[bar[Fv[{gO2}]], conj[Hpm[{gI1}]], Fe[{gI2}]][PL]]*
      Mass[Fe[{gI2}]]*Cp[bar[Fv[{gO1}]], conj[Hpm[{gI1}]], Fe[{gI2}]][PR]]] + 
   ...
   sum[gI1, 1, 3, sum[gI2, 1, 5, B0[p^2, Mass2[Chi[{gI2}]], Mass2[Sv[{gI1}]]]*
      conj[Cp[bar[Fv[{gO2}]], Sv[{gI1}], Chi[{gI2}]][PL]]*Mass[Chi[{gI2}]]*
      Cp[bar[Fv[{gO1}]], Sv[{gI1}], Chi[{gI2}]][PR]]] - 
  ...
  -sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], Mass2[Hpm[{gI1}]]]*
        conj[Cp[bar[Fv[{gO2}]], conj[Hpm[{gI1}]], Fe[{gI2}]][PR]]*
        Cp[bar[Fv[{gO1}]], conj[Hpm[{gI1}]], Fe[{gI2}]][PR]]]/2 - 
   sum[gI1, 1, 2, sum[gI2, 1, 6, B1[p^2, Mass2[Cha[{gI1}]], Mass2[Se[{gI2}]]]*
       conj[Cp[bar[Fv[{gO2}]], bar[Cha[{gI1}]], Se[{gI2}]][PR]]*
       Cp[bar[Fv[{gO1}]], bar[Cha[{gI1}]], Se[{gI2}]][PR]]]/2 - 
   sum[gI1, 1, 3, sum[gI2, 1, 5, B1[p^2, Mass2[Chi[{gI2}]], Mass2[Sv[{gI1}]]]*
       conj[Cp[bar[Fv[{gO2}]], Sv[{gI1}], Chi[{gI2}]][PR]]*
       Cp[bar[Fv[{gO1}]], Sv[{gI1}], Chi[{gI2}]][PR]]]/2 - 
  ...
  -sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], Mass2[Hpm[{gI1}]]]*
        conj[Cp[bar[Fv[{gO2}]], conj[Hpm[{gI1}]], Fe[{gI2}]][PL]]*
        Cp[bar[Fv[{gO1}]], conj[Hpm[{gI1}]], Fe[{gI2}]][PL]]]/2 - 
   sum[gI1, 1, 2, sum[gI2, 1, 6, B1[p^2, Mass2[Cha[{gI1}]], Mass2[Se[{gI2}]]]*
       conj[Cp[bar[Fv[{gO2}]], bar[Cha[{gI1}]], Se[{gI2}]][PL]]*
       Cp[bar[Fv[{gO1}]], bar[Cha[{gI1}]], Se[{gI2}]][PL]]]/2 - 
   sum[gI1, 1, 3, sum[gI2, 1, 5, B1[p^2, Mass2[Chi[{gI2}]], Mass2[Sv[{gI1}]]]*
       conj[Cp[bar[Fv[{gO2}]], Sv[{gI1}], Chi[{gI2}]][PL]]*
       Cp[bar[Fv[{gO1}]], Sv[{gI1}], Chi[{gI2}]][PL]]]/2 - 
   sum[gI2, 1, 3, (rMS/2 + B1[p^2, Mass2[Fv[{gI2}]], Mass2[VZ]])*
 ...
 (-3*((2*p^2*rMS)/3 + 2*A0[0] + 4*p^2*B0[p^2, 0, 0] + 10*B00[p^2, 0, 0])*
  ...
  (3*(4*B0[p^2, Mass2[Glu], Mass2[Glu]]*Mass[Glu]^2*
      ...
      (conj[Cp[VG, Glu[{1}], Glu[{1}]][PL]]*Cp[VG, Glu[{1}], Glu[{1}]][PL] + 
       conj[Cp[VG, Glu[{1}], Glu[{1}]][PR]]*Cp[VG, Glu[{1}], Glu[{1}]][PR])))/
   2 - (A0[0]*(4*Cp[VG, VG, VG, VG][1] + Cp[VG, VG, VG, VG][2] + 
     Cp[VG, VG, VG, VG][3]))/2, B00[p^2, Mass2[gWm], Mass2[gWm]]*
   conj[Cp[VP, bar[gWm], gWm]]*Cp[VP, bar[gWm], gWm] + 
  B00[p^2, Mass2[gWmC], Mass2[gWmC]]*conj[Cp[VP, bar[gWmC], gWmC]]*
   Cp[VP, bar[gWmC], gWmC] - conj[Cp[VP, conj[VWm], VWm]]*
   Cp[VP, conj[VWm], VWm]*(2*A0[Mass2[VWm]] + 
    10*B00[p^2, Mass2[VWm], Mass2[VWm]] - 2*rMS*(-p^2/3 + 2*Mass2[VWm]) + 
    B0[p^2, Mass2[VWm], Mass2[VWm]]*(4*p^2 + 2*Mass2[VWm])) + 
  sum[gI1, 1, 2, A0[Mass2[Hpm[{gI1}]]]*Cp[VP, VP, conj[Hpm[{gI1}]], 
     Hpm[{gI1}]]] - 4*sum[gI1, 1, 2, sum[gI2, 1, 2, 
     B00[p^2, Mass2[Hpm[{gI1}]], Mass2[Hpm[{gI2}]]]*
      conj[Cp[VP, conj[Hpm[{gI1}]], Hpm[{gI2}]]]*Cp[VP, conj[Hpm[{gI1}]], 
       Hpm[{gI2}]]]] + sum[gI1, 1, 2, sum[gI2, 1, 2, 
  ...
  3*sum[gI1, 1, 6, A0[Mass2[Su[{gI1}]]]*Cp[VP, VP, conj[Su[{gI1}]], 
     ...
     B00[p^2, Mass2[Su[{gI1}]], Mass2[Su[{gI2}]]]*
      conj[Cp[VP, conj[Su[{gI1}]], Su[{gI2}]]]*Cp[VP, conj[Su[{gI1}]], 
       Su[{gI2}]]]] + 2*sum[gI2, 1, 2, B0[p^2, Mass2[VWm], Mass2[Hpm[{gI2}]]]*
 ...
 B00[p^2, Mass2[gWm], Mass2[gP]]*conj[Cp[conj[VWm], bar[gP], gWm]]*
  ...
  sum[gI1, 1, 3, A0[Mass2[Sv[{gI1}]]]*Cp[VWm, conj[VWm], conj[Sv[{gI1}]], 
     Sv[{gI1}]]] + sum[gI1, 1, 3, A0[Mass2[hh[{gI1}]]]*
     Cp[VWm, conj[VWm], hh[{gI1}], hh[{gI1}]]]/2 + 
  3*sum[gI1, 1, 3, sum[gI2, 1, 3, 
