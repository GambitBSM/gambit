...
{{Cha,conj[Su],Internal->Fd},chargefactor -> 1,{coup1L -> Cp[bar[Fd], Cha, Su][L][gt1,i1,i2],coup1R -> Cp[bar[Fd], Cha, Su][R][gt1,i1,i2],coup2L -> Cp[bar[Cha], Fd, conj[Su]][L][i1,i3,i2],coup2R -> Cp[bar[Cha], Fd, conj[Su]][R][i1,i3,i2],coup3L -> Cp[bar[Fd], Fd, VG][L][i3,gt2],coup3R -> Cp[bar[Fd], Fd, VG][R][i3,gt2]},{mF1 -> M[Cha][i1],mS1 -> M[Su][i2],MFin -> M[Fd][i3]-M[Fd][gt1]}},
(* Chi,conj[Sd], Internal:Fd*) 
{{Chi,conj[Sd],Internal->Fd},chargefactor -> 1,{coup1L -> Cp[bar[Fd], Chi, Sd][L][gt1,i1,i2],coup1R -> Cp[bar[Fd], Chi, Sd][R][gt1,i1,i2],coup2L -> Cp[Chi, Fd, conj[Sd]][L][i1,i3,i2],coup2R -> Cp[Chi, Fd, conj[Sd]][R][i1,i3,i2],coup3L -> Cp[bar[Fd], Fd, VG][L][i3,gt2],coup3R -> Cp[bar[Fd], Fd, VG][R][i3,gt2]},{mF1 -> M[Chi][i1],mS1 -> M[Sd][i2],MFin -> M[Fd][i3]-M[Fd][gt1]}},
(* Fd,hh, Internal:Fd*) 
...
{{Glu,conj[Sd],Internal->Fd},chargefactor -> 4/3,{coup1L -> Cp[bar[Fd], Glu, Sd][L][gt1,i2],coup1R -> Cp[bar[Fd], Glu, Sd][R][gt1,i2],coup2L -> Cp[Glu, Fd, conj[Sd]][L][i3,i2],coup2R -> Cp[Glu, Fd, conj[Sd]][R][i3,i2],coup3L -> Cp[bar[Fd], Fd, VG][L][i3,gt2],coup3R -> Cp[bar[Fd], Fd, VG][R][i3,gt2]},{mF1 -> M[Glu],mS1 -> M[Sd][i2],MFin -> M[Fd][i3]-M[Fd][gt1]}},
...
{{conj[Su],Cha,Internal->bar[Fd]},chargefactor -> 1,{coup3L -> Cp[bar[Fd], Fd, VG][L][gt1,i3],coup3R -> Cp[bar[Fd], Fd, VG][R][gt1,i3],coup2L -> Cp[bar[Fd], Cha, Su][L][i3,i2,i1],coup2R -> Cp[bar[Fd], Cha, Su][R][i3,i2,i1],coup1L -> Cp[bar[Cha], Fd, conj[Su]][L][i2,gt2,i1],coup1R -> Cp[bar[Cha], Fd, conj[Su]][R][i2,gt2,i1]},{mS1 -> M[Su][i1],mF1 -> M[Cha][i2],MFin -> M[Fd][i3]-M[Fd][gt2]}},
(* conj[Sd],Chi, Internal:bar[Fd]*) 
{{conj[Sd],Chi,Internal->bar[Fd]},chargefactor -> 1,{coup3L -> Cp[bar[Fd], Fd, VG][L][gt1,i3],coup3R -> Cp[bar[Fd], Fd, VG][R][gt1,i3],coup2L -> Cp[bar[Fd], Chi, Sd][L][i3,i2,i1],coup2R -> Cp[bar[Fd], Chi, Sd][R][i3,i2,i1],coup1L -> Cp[Chi, Fd, conj[Sd]][L][i2,gt2,i1],coup1R -> Cp[Chi, Fd, conj[Sd]][R][i2,gt2,i1]},{mS1 -> M[Sd][i1],mF1 -> M[Chi][i2],MFin -> M[Fd][i3]-M[Fd][gt2]}},
...
{{conj[Sd],Glu,Internal->bar[Fd]},chargefactor -> 4/3,{coup3L -> Cp[bar[Fd], Fd, VG][L][gt1,i3],coup3R -> Cp[bar[Fd], Fd, VG][R][gt1,i3],coup2L -> Cp[bar[Fd], Glu, Sd][L][i3,i1],coup2R -> Cp[bar[Fd], Glu, Sd][R][i3,i1],coup1L -> Cp[Glu, Fd, conj[Sd]][L][gt2,i1],coup1R -> Cp[Glu, Fd, conj[Sd]][R][gt2,i1]},{mS1 -> M[Sd][i1],mF1 -> M[Glu],MFin -> M[Fd][i3]-M[Fd][gt2]}}
(* Ah,bar[Fd],bar[Fd]*) 
