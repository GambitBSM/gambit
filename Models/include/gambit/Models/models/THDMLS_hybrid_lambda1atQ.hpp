...
#ifndef __THDMLS_hybrid_lambda1atQ_hpp__
#define __THDMLS_hybrid_lambda1atQ_hpp__
...
#define FRIEND THDMLSatQ
  ...
  INTERPRET_AS_X_FUNCTION(FRIEND, THDMLS_hybrid_lambda1atQ_to_THDMLSatQ)
  INTERPRET_AS_X_DEPENDENCY(FRIEND, SMINPUTS, SMInputs)
  // Translation functions defined in THDMLS_hybrid_lambda1atQ.cpp
#undef FRIEND
#undef MODEL
