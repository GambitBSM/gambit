...
#ifndef __THDMII_higgs_hpp__
#define __THDMII_higgs_hpp__
...
#define FRIEND THDMII
  ...
  INTERPRET_AS_X_FUNCTION(FRIEND, THDMII_higgs_to_THDMII)
  INTERPRET_AS_X_DEPENDENCY(FRIEND, SMINPUTS, SMInputs)
  // Translation functions defined in THDMII_higgs.cpp
#undef FRIEND
#undef MODEL
