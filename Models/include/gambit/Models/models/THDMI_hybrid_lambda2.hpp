...
#ifndef __THDMI_hybrid_lambda2_hpp__
#define __THDMI_hybrid_lambda2_hpp__
...
#define FRIEND THDMI
  ...
  INTERPRET_AS_X_FUNCTION(FRIEND, THDMI_hybrid_lambda2_to_THDMI)
  INTERPRET_AS_X_DEPENDENCY(FRIEND, SMINPUTS, SMInputs)
  // Translation functions defined in THDMI_hybrid_lambda2.cpp
#undef FRIEND
#undef MODEL
