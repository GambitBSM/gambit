...
#ifndef __THDMLS_hybrid_lambda1_hpp__
#define __THDMLS_hybrid_lambda1_hpp__
...
#define FRIEND THDMLS
  ...
  INTERPRET_AS_X_FUNCTION(FRIEND, THDMLS_hybrid_lambda1_to_THDMLS)
  INTERPRET_AS_X_DEPENDENCY(FRIEND, SMINPUTS, SMInputs)
  // Translation functions defined in THDMLS_hybrid_lambda1.cpp
#undef FRIEND
#undef MODEL
