...
#ifndef __THDMII_hybrid_lambda2_hpp__
#define __THDMII_hybrid_lambda2_hpp__
...
#define FRIEND THDMII
  ...
  INTERPRET_AS_X_FUNCTION(FRIEND, THDMII_hybrid_lambda2_to_THDMII)
  INTERPRET_AS_X_DEPENDENCY(FRIEND, SMINPUTS, SMInputs)
  // Translation functions defined in THDMII_hybrid_lambda2.cpp
#undef FRIEND
#undef MODEL
