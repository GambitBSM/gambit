...
#ifndef __THDMII_hybrid_lambda2atQ_hpp__
#define __THDMII_hybrid_lambda2atQ_hpp__
...
#define FRIEND THDMIIatQ
  ...
  INTERPRET_AS_X_FUNCTION(FRIEND, THDMII_hybrid_lambda2atQ_to_THDMIIatQ)
  INTERPRET_AS_X_DEPENDENCY(FRIEND, SMINPUTS, SMInputs)
  // Translation functions defined in THDMII_hybrid_lambda2atQ.cpp
#undef FRIEND
#undef MODEL
