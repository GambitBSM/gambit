...
#include <boost/preprocessor/seq/for_each.hpp>
  ...
  #define DEPENDENCY_ON_FUNCTION(TAG, DEP, TYPE, TARGET_FUNCTION) \
                                                            CORE_DEPENDENCY_ON_FUNCTION(TAG, DEP, TYPE, TARGET_FUNCTION, ANY_MODULE, MODEL, FUNCTION, IS_MODEL)
  #define DEPENDENCY_ON_FUNCTION_IN_MODULE(TAG, DEP, TYPE, TARGET_FUNCTION, TARGET_MODULE) \
                                                            CORE_DEPENDENCY_ON_FUNCTION(TAG, DEP, TYPE, TARGET_FUNCTION, TARGET_MODULE, MODEL, FUNCTION, IS_MODEL)
  ...
  #define DEPENDENCY_ON_FUNCTION(TAG, DEP, TYPE, TARGET_FUNCTION) \
                                                            MODULE_DEPENDENCY_ON_FUNCTION(TAG, TYPE, MODEL, FUNCTION, IS_MODEL)
  #define DEPENDENCY_ON_FUNCTION_IN_MODULE(TAG, DEP, TYPE, TARGET_FUNCTION, TARGET_MODULE) \
                                                            MODULE_DEPENDENCY_ON_FUNCTION(TAG, TYPE, MODEL, FUNCTION, IS_MODEL)
