...
constexpr double table_7[kRows][kCols] = {
  {83.966, -0.1017, -0.06352, 0.05500, -0.00145, 0.8051, -0.027, -0.017, 0.0066, -0.095, -0.010, -0.015, 0.23, -1.1, 0.064, 285, 0.0015},
  {83.776, -0.1016, -0.06339, 0.05488, -0.00145, 0.8036, -0.026, -0.017, 0.0066, -0.095, -0.010, -0.015, 0.23, -1.1, 0.064, 285, 0.0015},
  {167.157, -0.1567, -0.1194, 0.1031, -0.00269, 1.258, -0.13, -0.020, 0.0133, -0.19, -0.018, -0.021, 0.34, -0.084, 0.064, 503, 0.002},
  {299.936, -0.5681, -0.2636, 0.2334, -0.00592, 4.057, -0.50, -0.058, 0.0352, 14.26, 1.6, -0.081, 1.7, -11.1, 0.19, 1251, 0.006},
  {299.859, -0.5680, -0.2635, 0.2334, -0.00592, 4.056, -0.50, -0.058, 0.0352, 14.26, 1.6, -0.081, 1.7, -11.1, 0.19, 1251, 0.006},
  {382.770, -0.6199, -0.3182, 0.2800, -0.00711, 3.810, -0.25, -0.060, 0.0420, 10.20, -2.4, -0.083, 0.65, -10.1, 0.19, 1468, 0.006},
  {375.723, -0.5744, -0.3074, 0.2725, -0.00703, -2.292, -0.027, -0.013, 0.0428, 10.53, -2.4, -0.088, 1.2, -10.1, 0.19, 1456, 0.006},
  {2494.24, -3.725, -2.019, 1.773, -0.04554, 19.63, -2.0, -0.36, 0.257, 58.60, -4.1, -0.53, 7.6, -56.0, 1.3, 9256, 0.04},
  {20750.9, -10.00, -1.83, 1.878, -0.0343, -38.8, -11, 1.2, 0.72, 732.1, -44, -0.64, 5.6, -357, -4.7, 11771},
  {172.23, -0.034, -0.0058, 0.0054, -0.00012, 1.00, -0.15, -0.0074, 0.00091, 2.3, 1.3, -0.0013, 0.35, -1.2, 0.014, 37,  0.01},
...
class TwoLoop {
 public:
  double gamma_e() {return observable(0);}  // MeV
  ...
  double error_gamma_e() {return error(0);}  // MeV
  ...
  double error_gamma_s() {return error_gamma_s();}
 ...
 private:
  ...
  double observable(int i) {
    ...
    */
    ...
    return table_7[i][0] +
           table_7[i][1] * L_H +
           table_7[i][2] * pow(L_H, 2) +
           table_7[i][3] * delta_H +
           table_7[i][4] * pow(delta_H, 2) +
           table_7[i][5] * delta_t +
           table_7[i][6] * pow(delta_t, 2) +
           table_7[i][7] * delta_t * L_H +
           table_7[i][8] * delta_t * pow(L_H, 2) +
           table_7[i][9] * delta_alpha_s +
           table_7[i][10] * pow(delta_alpha_s, 2) +
           table_7[i][11] * delta_alpha_s * L_H +
