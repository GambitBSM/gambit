...
#ifndef __multinest_3_13_hpp__
#define __multinest_3_13_hpp__
...
// C++ prototypes for the main run functions for multinest, as well as the
// loglike and dumper functions
extern "C"
{
        // Standard run function (uses MPI_COMM_WORLD internally)
        ...
        // MPI-communicator-aware run function
        // Note: final int parameter is the MPI communicator (Fortran handle)
        void run_mpi(bool, bool, bool, int, double, double, int, int, int, int, int,
                    double, char[], int, int[], bool, bool, bool, bool, double, int,
                    double (*)(double*,int,int,void*),
                    void (*)(int,int,int,double*,double*,double*,double,double,
                      double,void*),
