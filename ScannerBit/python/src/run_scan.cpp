...
namespace Gambit
{
    ...
    namespace Scanner
    {
        ...
        namespace Python
        {
            ...
            /// Main GAMBIT program
            int run_scan(Gambit::IniParser::Parser &iniFile, const Gambit::Scanner::Factory_Base *factory, Gambit::Priors::BasePrior *user_prior, bool resume)
            {
...
extern "C"
{
    ...
    int __attribute__ ((visibility ("default"))) run_scan_str(std::string *filename, const Gambit::Scanner::Factory_Base *factory, Gambit::Priors::BasePrior *user_prior, bool resume)
    {
        IniFileParser iniFile;
