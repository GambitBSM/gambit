...
#include "gambit/ScannerBit/scanners/polychord_wraparound/1.20.2/polychord.hpp"
...
namespace Gambit
{
   namespace PolyChord_wraparound_1_20_2
   {
...
scanner_plugin(polychord_wraparound, version(1, 20, 2))
{
   // Access PolyChord stuff and standard Gambit things
   using namespace Gambit;
   using namespace Gambit::PolyChord_wraparound_1_20_2;
