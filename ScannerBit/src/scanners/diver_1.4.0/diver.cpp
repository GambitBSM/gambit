...
#include "gambit/ScannerBit/scanners/diver_1.4.0/diver.hpp"
...
scanner_plugin(diver, version(1, 4, 0))
{

  // Access Diver stuff and standard Gambit things
  using namespace Gambit;
  using namespace Gambit::Diver_1_4_0;
  ...
  int plugin_main (void)
  {
    ...
    // Negative value tells Diver to use MPI_COMM_WORLD
    int mpi_comm = -1;
#ifdef WITH_MPI
    ...
    cdiver(&objective, nPar, &lowerbounds[0], &upperbounds[0], &path[0], nDerived, &bestFitParams[0],
           ...
           discard_unfit_points, max_ini_attempts, max_acceptable_value, seed, context, verbose, mpi_comm);
