...
macro(SetMassSpectra)
  ...
  # include only if SpecBit is in use and if
  ...
  if(";${GAMBIT_BITS};" MATCHES ";SpecBit;")
    ...
    if(CMAKE_Fortran_COMPILER MATCHES "gfortran*")
      set(flexiblesusy_compilerlibs "-lgfortran -lm -ffree-line-length-none -cpp")
    ...
    elseif(CMAKE_Fortran_COMPILER MATCHES "ifort")
      set(flexiblesusy_compilerlibs "-lifcore -limf -ldl -lintlc -lsvml  -extend-source -fpp")
    endif()
