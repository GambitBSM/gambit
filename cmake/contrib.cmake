...
if (NOT EXCLUDE_ONNXRUNTIME)
  ...
  #TODO: Mac stuff untested
    set(dl "https://github.com/microsoft/onnxruntime/releases/download/v${ver}/onnxruntime-osx-universal2-${ver}.tgz")
    set(md5 9725836c49deb09fc352a57dc8a1b806)
  else ()
    set(dl "https://github.com/microsoft/onnxruntime/releases/download/v${ver}/onnxruntime-linux-x64-${ver}.tgz")
    set(md5 2b3a728a057226a3d6577335604db9bc)
  endif()
...
if(";${GAMBIT_BITS};" MATCHES ";ColliderBit;")
  ...
  include_directories("${fastjet_dir}/local/include" "${fjcontrib_dir}/RecursiveTools" "${fjcontrib_dir}/EnergyCorrelator" "${fjcontrib_dir}/VariableR"  "${fjcontrib_dir}/Nsubjettiness")
  ...
  set(fjcontrib_LDFLAGS "-L${fastjet_dir}/local/lib -lRecursiveTools -lEnergyCorrelator -lVariableR  -lRecursiveTools -lNsubjettiness")
...
#  set(FJCONTRIB_CXX_FLAGS "${FJCONTRIB_CXX_FLAGS} -L${fastjet_dir}/local/lib -lfastjet -lfastjettools -Wl,-rpath,${fastjet_dir}/local/lib")
  ...
  ExternalProject_Add(fjcontrib
    ...
    CONFIGURE_COMMAND ./configure CXX=${CMAKE_CXX_COMPILER} CXXFLAGS=${FJCONTRIB_CXX_FLAGS} --fastjet-config=${fastjet_dir}/fastjet-config --prefix=${fastjet_dir}/local --only=RecursiveTools,EnergyCorrelator,VariableR,Nsubjettiness
