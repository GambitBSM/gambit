...
set(dir "${PROJECT_SOURCE_DIR}/Backends/installed/${name}/${ver}")
set(md5 "baaa6115f0c77577badb0f3837c02f8e")
...
if(NOT ditched_${name}_${ver})
  ExternalProject_Add(${name}_${ver}
    ...
    CONFIGURE_COMMAND ""
    BUILD_COMMAND ${CMAKE_MAKE_PROGRAM} CC=${CMAKE_CXX_COMPILER} CXXFLAGS=${THDM_CXX_FLAGS} GSLINCLUDE_DIR=${GSL_INCLUDE_DIRS} boss
