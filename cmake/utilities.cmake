...
macro(BOSS_backend name backend_version ${ARGN})
  ...
  if(NOT EXISTS ${config_file_path})
    ...
    ExternalProject_Add_Step(${name}_${ver} BOSS
      ...
      COMMAND diff -rupN ${GB_backend_types_include_dir}/${name_in_frontend}_${backend_version_safe} ${BOSS_backend_types_include_dir} > ${name}_${backend_version}-prefix/${name}_${backend_version_safe}.dif || true
      COMMAND diff -rupN ${GB_backend_types_source_dir}/${name_in_frontend}_${backend_version_safe} ${BOSS_backend_types_source_dir] >> ${name}_${backend_version}-prefix/${name}_${backend_version_safe}.diff || true
      ...
      COMMAND ${CMAKE_COMMAND} -E remove_directory ${GB_backend_types_include_dir}/${name_in_frontend}_${backend_version_safe} || true
