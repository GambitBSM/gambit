...
macro(BOSS_backend name backend_version ${ARGN})
  ...
  if(NOT EXISTS ${config_file_path})
    ...
    ExternalProject_Add_Step(${name}_${ver} BOSS
      ...
      COMMAND diff -rupN ${PROJECT_SOURCE_DIR}/Backends/include/gambit/Backends/backend_types/${name_in_frontend}_${backend_version_safe} BOSS_output/${name_in_frontend}_${backend_version_safe}/for_gambit/include/backend_types/${name_in_frontend}_${backend_version_safe} > ${name}_${backend_version}-prefix/${name}_${backend_version_safe}.dif || true
      COMMAND diff -rupN ${PROJECT_SOURCE_DIR}/Backends/src/backend_types/${name_in_frontend}_${backend_version_safe} BOSS_output/${name_in_frontend}_${backend_version_safe}/for_gambit/src/backend_types/${name_in_frontend}_${backend_version_safe} >> ${name}_${backend_version}-prefix/${name}_${backend_version_safe}.diff || true
