...
function(check_ditch_status name version dir)
  ...
  foreach(arg0 ${ARGN})
    ...
    elseif ((arg STREQUAL "c++14") AND NOT GAMBIT_SUPPORTS_CXX14 AND NOT GAMBIT_SUPPORTS_CXX17)
      ...
      set (itch "${itch}" "${name}_${version}")
    elseif ((arg STREQUAL "c++17") AND NOT GAMBIT_SUPPORTS_CXX17 AND NOT GAMBIT_SUPPORTS_CXX1z)
      message("${BoldCyan} X ${name} (${version}) needs c++17 but GAMBIT is compiled with a lower version. ${name} will be excluded.${ColourReset}")
      set (itch "${itch}" "${name}_${version}")
