...
BE_ALLOW_MODELS(MSSM63atQ, MSSM63atMGUT, WC, WC_LUV, WC_LR, THDMI, THDMII, THDMLS, THDMflipped, THDMIatQ, THDMIIatQ, THDMLSatQ, THDMflippedatQ)
...
BE_CONV_FUNCTION(BRBKmumu_CONV, double, (const parameters*, double, double), "BRBKmumu_CONV", (MSSM63atQ, MSSM63atMGUT, WC, THDMI, THDMII, THDMLS, THDMflipped, THDMIatQ, THDMIIatQ, THDMLSatQ, THDMflippedatQ))
...
BE_CONV_FUNCTION(RK_CONV, double, (const parameters*, double, double), "RK_CONV", (MSSM63atQ, MSSM63atMGUT, WC, THDMI, THDMII, THDMLS, THDMflipped, THDMIatQ, THDMIIatQ, THDMLSatQ, THDMflippedatQ))
BE_CONV_FUNCTION(bsgamma_CONV, double, (const parameters*, double), "bsgamma_CONV", (MSSM63atQ, MSSM63atMGUT, WC, THDMI, THDMII, THDMLS, THDMflipped, THDMIatQ, THDMIIatQ, THDMLSatQ, THDMflippedatQ))
BE_CONV_FUNCTION(Bsll_untag_CONV, double, (const parameters*, int), "Bsll_untag_CONV", (MSSM63atQ, MSSM63atMGUT, WC, THDMI, THDMII, THDMLS, THDMflipped, THDMIatQ, THDMIIatQ, THDMLSatQ, THDMflippedatQ))
BE_CONV_FUNCTION(Bll_CONV, double, (const parameters*, int), "Bll_CONV", (MSSM63atQ, MSSM63atMGUT, WC, THDMI, THDMII, THDMLS, THDMflipped, THDMIatQ, THDMIIatQ, THDMLSatQ, THDMflippedatQ))
BE_CONV_FUNCTION(BRBXsmumu_lowq2_CONV, double, (const parameters*), "BRBXsmumu_lowq2_CONV",(MSSM63atQ, MSSM63atMGUT, WC, THDMI, THDMII, THDMLS, THDMflipped, THDMIatQ, THDMIIatQ, THDMLSatQ, THDMflippedatQ))
BE_CONV_FUNCTION(BRBXsmumu_highq2_CONV, double, (const parameters*), "BRBXsmumu_highq2_CONV",(MSSM63atQ, MSSM63atMGUT, WC, THDMI, THDMII, THDMLS, THDMflipped, THDMIatQ, THDMIIatQ, THDMLSatQ, THDMflippedatQ))
BE_CONV_FUNCTION(A_BXsmumu_lowq2_CONV, double, (const parameters*), "A_BXsmumu_lowq2_CONV",(MSSM63atQ, MSSM63atMGUT, WC, THDMI, THDMII, THDMLS, THDMflipped, THDMIatQ, THDMIIatQ, THDMLSatQ, THDMflippedatQ))
BE_CONV_FUNCTION(A_BXsmumu_highq2_CONV, double, (const parameters*), "A_BXsmumu_highq2_CONV",(MSSM63atQ, MSSM63atMGUT, WC, THDMI, THDMII, THDMLS, THDMflipped, THDMIatQ, THDMIIatQ, THDMLSatQ, THDMflippedatQ))
BE_CONV_FUNCTION(A_BXsmumu_zero_CONV, double, (const parameters*), "A_BXsmumu_zero_CONV",(MSSM63atQ, MSSM63atMGUT, WC, THDMI, THDMII, THDMLS, THDMflipped, THDMIatQ, THDMIIatQ, THDMLSatQ, THDMflippedatQ))
BE_CONV_FUNCTION(BRBXstautau_highq2_CONV, double, (const parameters*), "BRBXstautau_highq2_CONV", (MSSM63atQ, MSSM63atMGUT, WC, THDMI, THDMII, THDMLS, THDMflipped, THDMIatQ, THDMIIatQ, THDMLSatQ, THDMflippedatQ))
BE_CONV_FUNCTION(A_BXstautau_highq2_CONV, double, (const parameters*), "A_BXstautau_highq2_CONV", (MSSM63atQ, MSSM63atMGUT, WC, THDMI, THDMII, THDMLS, THDMflipped, THDMIatQ, THDMIIatQ, THDMLSatQ, THDMflippedatQ))
BE_CONV_FUNCTION(SI_AI_BKstarmumu_CONV, double, (const parameters*), "SI_AI_BKstarmumu_CONV", (MSSM63atQ, MSSM63atMGUT, WC, THDMI, THDMII, THDMLS, THDMflipped, THDMIatQ, THDMIIatQ, THDMLSatQ, THDMflippedatQ))
BE_CONV_FUNCTION(SI_AI_BKstarmumu_zero_CONV, double, (const parameters*), "SI_AI_BKstarmumu_zero_CONV", (MSSM63atQ, MSSM63atMGUT, WC, THDMI, THDMII, THDMLS, THDMflipped, THDMIatQ, THDMIIatQ, THDMLSatQ, THDMflippedatQ))
