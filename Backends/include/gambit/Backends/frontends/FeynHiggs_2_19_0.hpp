...
#define SAFE_VERSION 2_19_0
#define REFERENCE Bahl:2018qog,Bahl:2017aev,Bahl:2016brp,Hahn:2013ria,Frank:2006yh,Degrassi:2002fi,Heinemeyer:1998np,Heinemeyer:1998yj

LOAD_LIBRARY

BE_FUNCTION(FHSetFlags, void, (int&,int&,int&,int&,int&,int&,int&,int&,int&), "fhsetflags_", "FHSetFlags")
...
BE_FUNCTION(FHSetSMPara, void, (int&,fh_creal&,fh_creal&,fh_creal&,fh_creal&,fh_creal&,
        fh_creal&,fh_creal&,fh_creal&,fh_creal&,fh_creal&,fh_creal&,
				  fh_creal&,fh_creal&,fh_creal&,fh_creal&,fh_creal&,fh_creal&,fh_creal&,fh_creal&,fh_creal&), "fhsetsmpara_", "FHSetSMPara")
...
BE_FUNCTION(FHGetPara, void, (int&,int&,
            Farray<fh_real, 1,2, 1,5, 1,3>&, Farray<fh_complex, 1,2, 1,2, 1,5, 1,3>&,
			      Farray<fh_real, 1,6, 1,5>&, Farray<fh_complex, 1,6, 1, 6, 1,5>&,
			      Farray< fh_real,1,2>&, Farray< fh_complex,1,2,1,2>&,
			      Farray< fh_complex,1,2,1,2>&, Farray< fh_real,1,4>&,
			      Farray< fh_complex,1,4,1,4>&, fh_complex&, fh_real&,
			      Farray< fh_real,1,4>&, fh_real&,fh_real&), "fhgetpara_", "FHGetPara")
