...
#define BACKENDNAME MicrOmegas_Inert2
...
BE_INI_DEPENDENCY(Inert2_spectrum, Spectrum)
BE_INI_DEPENDENCY(decay_rates, DecayTable)
BE_INI_CONDITIONAL_DEPENDENCY(coupling_table_THDM, coupling_table, Inert2)
BE_INI_CONDITIONAL_DEPENDENCY(additional_scalar, str, Inert2)
BE_INI_CONDITIONAL_DEPENDENCY(SM_like_scalar, str, Inert2)
