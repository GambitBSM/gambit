...
// Decay options
BE_VARIABLE(Calc3BodyDecay_Glu, Flogical, "__model_data_nmssm_MOD_calc3bodydecay_glu", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(Calc3BodyDecay_Chi, Flogical, "__model_data_nmssm_MOD_calc3bodydecay_chi", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(Calc3BodyDecay_Cha, Flogical, "__model_data_nmssm_MOD_calc3bodydecay_cha", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(Calc3BodyDecay_Sd, Flogical, "__model_data_nmssm_MOD_calc3bodydecay_sd", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(Calc3BodyDecay_Su, Flogical, "__model_data_nmssm_MOD_calc3bodydecay_su", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(Calc3BodyDecay_Se, Flogical, "__model_data_nmssm_MOD_calc3bodydecay_se", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(Calc3BodyDecay_Sv, Flogical, "__model_data_nmssm_MOD_calc3bodydecay_sv", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(CalcLoopDecay_LoopInducedOnly, Flogical, "__model_data_nmssm_MOD_calcloopdecay_loopinducedonly", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(CalcLoopDecay_Sd, Flogical, "__model_data_nmssm_MOD_calcloopdecay_sd", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(CalcLoopDecay_Su, Flogical, "__model_data_nmssm_MOD_calcloopdecay_su", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(CalcLoopDecay_Se, Flogical, "__model_data_nmssm_MOD_calcloopdecay_se", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(CalcLoopDecay_Sv, Flogical, "__model_data_nmssm_MOD_calcloopdecay_sv", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(CalcLoopDecay_hh, Flogical, "__model_data_nmssm_MOD_calcloopdecay_hh", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(CalcLoopDecay_Ah, Flogical, "__model_data_nmssm_MOD_calcloopdecay_ah", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(CalcLoopDecay_Hpm, Flogical, "__model_data_nmssm_MOD_calcloopdecay_hpm", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(CalcLoopDecay_Glu, Flogical, "__model_data_nmssm_MOD_calcloopdecay_glu", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(CalcLoopDecay_Chi, Flogical, "__model_data_nmssm_MOD_calcloopdecay_chi", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(CalcLoopDecay_Cha, Flogical, "__model_data_nmssm_MOD_calcloopdecay_cha", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(CalcLoopDecay_Fu, Flogical, "__model_data_nmssm_MOD_calcloopdecay_fu", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(SimplisticLoopDecays, Flogical, "__settings_MOD_simplisticloopdecays", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(ShiftIRdiv, Flogical, "__settings_MOD_shiftirdiv", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(DebugLoopDecays, Flogical, "__settings_MOD_debugloopdecays", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(OnlyTreeLevelContributions, Flogical, "__settings_MOD_onlytreelevelcontributions", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(ExternalZfactors, Flogical, "__settings_MOD_externalzfactors", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(UseZeroRotationMatrices, Flogical, "__settings_MOD_usezerorotationmatrices", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(UseP2Matrices, Flogical, "__settings_MOD_usep2matrices", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(OSkinematics, Flogical, "__settings_MOD_oskinematics", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(ewOSinDecays, Flogical, "__settings_MOD_ewosindecays", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(yukOSinDecays, Flogical, "__settings_MOD_yukosindecays", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(CTinLoopDecays, Flogical, "__settings_MOD_ctinloopdecays", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(LoopInducedDecaysOS, Flogical, "__settings_MOD_loopinduceddecaysos", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(Mass_Regulator_PhotonGluon, Freal8, "__settings_MOD_mass_regulator_photongluon", "SARAHSPheno_NMSSM_internal")
...
BE_VARIABLE(rHB_P_P_Fu, Farray_Freal8_1_3_1_3, "__model_data_nmssm_MOD_rhb_p_p_fu", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(rHB_S_S_Fe, Farray_Freal8_1_3_1_3, "__model_data_nmssm_MOD_rhb_s_s_fe", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(rHB_P_P_Fe, Farray_Freal8_1_3_1_3, "__model_data_nmssm_MOD_rhb_p_p_fe", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(rHB_S_VWm, Farray_Freal8_1_3, "__model_data_nmssm_MOD_rhb_s_vwm", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(rHB_P_VWm, Farray_Freal8_1_3, "__model_data_nmssm_MOD_rhb_p_vwm", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(rHB_S_VZ, Farray_Freal8_1_3, "__model_data_nmssm_MOD_rhb_s_vz", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(rHB_P_VZ, Farray_Freal8_1_3, "__model_data_nmssm_MOD_rhb_p_vz", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(ratioPP, Farray_Fcomplex16_1_3, "__model_data_nmssm_MOD_ratiopp", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(ratioPPP, Farray_Fcomplex16_1_3, "__model_data_nmssm_MOD_ratioppp", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(ratioGG, Farray_Fcomplex16_1_3, "__model_data_nmssm_MOD_ratiogg", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(ratioPGG, Farray_Fcomplex16_1_3, "__model_data_nmssm_MOD_ratiopgg", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(CPL_H_H_Z, Farray_Fcomplex16_1_3_1_3, "__model_data_nmssm_MOD_cpl_h_h_z", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(CPL_A_A_Z, Farray_Fcomplex16_1_3_1_3, "__model_data_nmssm_MOD_cpl_a_a_z", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(CPL_A_H_Z, Farray_Fcomplex16_1_3_1_3, "__model_data_nmssm_MOD_cpl_a_h_z", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(BR_Hcs, Farray_Freal8_1_2, "__model_data_nmssm_MOD_br_hcs", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(BR_Hcb, Farray_Freal8_1_2, "__model_data_nmssm_MOD_br_hcb", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(BR_Htaunu, Farray_Freal8_1_2, "__model_data_nmssm_MOD_br_htaunu", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(BR_tWb, Freal8, "__model_data_nmssm_MOD_br_twb", "SARAHSPheno_NMSSM_internal")
BE_VARIABLE(BR_tHb, Farray_Freal8_1_2, "__model_data_nmssm_MOD_br_thb", "SARAHSPheno_NMSSM_internal")
...
BE_CONV_FUNCTION(get_HiggsCouplingsTable, int, (const Spectrum&, HiggsCouplingsTable&, const Finputs&), "NMSSM_HiggsCouplingsTable")
