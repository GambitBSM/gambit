...
// Calculation function for annual modulation experiments; should be run once for each experiment and model prior to using event and likelihood routines below.
BE_FUNCTION(DDCalc_CalcRates_mod,  void, (const int&, const int&, const int&, const double&, const double&), "C_DDRates_ddcalc_calcrates_mod",  "DD_CalcRates_mod")
...
//   BinSignal_mod  signal in a given bin for modulation experiments
//   Chi2_mod:      Chi-squared for annual modulation experiments
//   LogLikelihood_mod: log of the chi-squared for annual modulation
//	experiments (-0.5*Mod_Chi2)
...
BE_FUNCTION(DDCalc_BinSignal_mod, double, (const int&, const int&),    "C_DDRates_ddcalc_binsignal_mod", "DD_BinSignal_mod")
BE_FUNCTION(DDCalc_Mod_Chi2,      double, (const int&),                "C_DDStats_ddcalc_mod_chi2",      "DD_Chi2_mod")
BE_FUNCTION(DDCalc_LogLikelihood_mod, double, (const double&),                "C_DDStats_ddcalc_loglikelihood_mod", "DD_LogLikelihood_mod")
...
// Convenience function for calling CalcRates_mod with internally-initialised WIMP and halo objects.
BE_CONV_FUNCTION(DDCalc_CalcRates_mod_simple,  void, (const int&, const double&, const double&), "DD_CalcRates_mod")
