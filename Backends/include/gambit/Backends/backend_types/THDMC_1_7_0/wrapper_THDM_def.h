#ifndef __wrapper_THDM_def_THDMC_1_7_0_h__
#define __wrapper_THDM_def_THDMC_1_7_0_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    inline void THDM::write_LesHouches(const char* file, bool fulldecay, bool couplings, bool qcd_on, bool HBHS)
    {
        get_BEptr()->write_LesHouches(file, fulldecay, couplings, qcd_on, HBHS);
    }
    
    inline void THDM::write_LesHouches(const char* file, bool fulldecay, bool couplings, bool qcd_on)
    {
        get_BEptr()->write_LesHouches__BOSS(file, fulldecay, couplings, qcd_on);
    }
    
    inline void THDM::write_LesHouches(const char* file, bool fulldecay, bool couplings)
    {
        get_BEptr()->write_LesHouches__BOSS(file, fulldecay, couplings);
    }
...
#endif /* __wrapper_THDM_def_THDMC_1_7_0_h__ */
