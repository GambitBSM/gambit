#ifndef __wrapper_THDM_decl_THDMC_1_7_0_h__
#define __wrapper_THDM_decl_THDMC_1_7_0_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    class THDM : public WrapperBase
    {
        ...
        public:
            ...
            bool set_param_higgs_beta(double Lambda1, double Lambda2, double Lambda3, double Lambda4, double Lambda5, double Lambda7, double tanb, double sba, double M22_2);
            ...
            void write_LesHouches(const char* file, bool fulldecay, bool couplings, bool qcd_on, bool HBHS);
    
            void write_LesHouches(const char* file, bool fulldecay, bool couplings, bool qcd_on);
    
            void write_LesHouches(const char* file, bool fulldecay, bool couplings);
...
#endif /* __wrapper_THDM_decl_THDMC_1_7_0_h__ */
