#ifndef __wrapper_Settings_def_Pythia_8_306_h__
#define __wrapper_Settings_def_Pythia_8_306_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    namespace Pythia8
    {
        ...
        // Member functions: 
        inline void Settings::initPtrs(Pythia8::Info* infoPtrIn)
        {
        ...
        inline void Settings::parm(std::string keyIn, double nowIn, bool force)
        {
            get_BEptr()->parm(keyIn, nowIn, force);
        }
        
        inline void Settings::parm(std::string keyIn, double nowIn)
        {
            get_BEptr()->parm__BOSS(keyIn, nowIn);
        }
        ...
        inline void Settings::mvec(std::string keyIn, std::vector<int> nowIn, bool force)
        {
            get_BEptr()->mvec(keyIn, nowIn, force);
        }
        
        inline void Settings::mvec(std::string keyIn, std::vector<int> nowIn)
        {
            get_BEptr()->mvec__BOSS(keyIn, nowIn);
        }
        
        inline void Settings::pvec(std::string keyIn, std::vector<double> nowIn, bool force)
        {
            get_BEptr()->pvec(keyIn, nowIn, force);
        }
        
        inline void Settings::pvec(std::string keyIn, std::vector<double> nowIn)
        {
            get_BEptr()->pvec__BOSS(keyIn, nowIn);
        }
...
#endif /* __wrapper_Settings_def_Pythia_8_306_h__ */
