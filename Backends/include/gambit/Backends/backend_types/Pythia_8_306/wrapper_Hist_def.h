#ifndef __wrapper_Hist_def_Pythia_8_306_h__
#define __wrapper_Hist_def_Pythia_8_306_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    namespace Pythia8
    {
        ...
        {
            get_BEptr()->book(titleIn, nBinIn, xMinIn, xMaxIn, logXIn);
        }
        ...
        {
            get_BEptr()->pyplotTable(os, isHist);
        }
        ...
        {
            get_BEptr()->pyplotTable(fileName, isHist);
        }
        ...
        inline Hist::Hist(std::string titleIn, int nBinIn, double xMinIn, double xMaxIn, bool logXIn) :
            WrapperBase(__factory1(titleIn, nBinIn, xMinIn, xMaxIn, logXIn))
        {
            get_BEptr()->set_wptr(this);
            get_BEptr()->set_delete_wrapper(false);
        }
        ...
        inline Hist::Hist(std::string titleIn, int nBinIn, double xMinIn, double xMaxIn) :
            WrapperBase(__factory2(titleIn, nBinIn, xMinIn, xMaxIn))
        {
            get_BEptr()->set_wptr(this);
            get_BEptr()->set_delete_wrapper(false);
        }
        ...
        inline Hist::Hist(std::string titleIn, int nBinIn, double xMinIn) :
            WrapperBase(__factory3(titleIn, nBinIn, xMinIn))
        {
            get_BEptr()->set_wptr(this);
            get_BEptr()->set_delete_wrapper(false);
        }
        ...
        inline Hist::Hist(std::string titleIn, int nBinIn) :
            WrapperBase(__factory4(titleIn, nBinIn))
        {
            get_BEptr()->set_wptr(this);
            get_BEptr()->set_delete_wrapper(false);
        }
        ...
        inline Hist::Hist(std::string titleIn) :
            WrapperBase(__factory5(titleIn))
        {
            get_BEptr()->set_wptr(this);
            get_BEptr()->set_delete_wrapper(false);
        }
        ...
        inline Hist::Hist(std::string titleIn, const Pythia8::Hist& h) :
            WrapperBase(__factory6(titleIn, h))
        {
            get_BEptr()->set_wptr(this);
            get_BEptr()->set_delete_wrapper(false);
        }
...
#endif /* __wrapper_Hist_def_Pythia_8_306_h__ */
