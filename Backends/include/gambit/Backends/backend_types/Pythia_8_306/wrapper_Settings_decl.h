#ifndef __wrapper_Settings_decl_Pythia_8_306_h__
#define __wrapper_Settings_decl_Pythia_8_306_h__
    ...
    namespace Pythia8
    {
        ...
        class Settings : public WrapperBase
        {
            ...
            public:
                ...
                void parm(std::string keyIn, double nowIn, bool force);
                ...
                void mvec(std::string keyIn, std::vector<int> nowIn, bool force);
        
                void mvec(std::string keyIn, std::vector<int> nowIn);
        
                void pvec(std::string keyIn, std::vector<double> nowIn, bool force);
...
#endif /* __wrapper_Settings_decl_Pythia_8_306_h__ */
