#ifndef __abstract_Settings_Pythia_8_306_h__
#define __abstract_Settings_Pythia_8_306_h__
    ...
    namespace Pythia8
    {
        class Abstract_Settings : public virtual AbstractBase
        {
            public:
                ...
                virtual void parm(std::string, double, bool) =0;
    
                virtual void parm__BOSS(std::string, double) =0;
                ...
                virtual void mvec(std::string, std::vector<int>, bool) =0;
    
                virtual void mvec__BOSS(std::string, std::vector<int>) =0;
    
                virtual void pvec(std::string, std::vector<double>, bool) =0;
    
                virtual void pvec__BOSS(std::string, std::vector<double>) =0;
...
#endif /* __abstract_Settings_Pythia_8_306_h__ */
