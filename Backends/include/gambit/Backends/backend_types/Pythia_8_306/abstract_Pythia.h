#ifndef __abstract_Pythia_Pythia_8_306_h__
#define __abstract_Pythia_Pythia_8_306_h__
    ...
    namespace Pythia8
    {
        class Abstract_Pythia : public virtual AbstractBase
        {
            public:
                ...
                virtual bool next(double) =0;
    
                virtual bool next(double, double) =0;
    
                virtual bool next(double, double, double, double, double, double) =0;
                ...
                virtual double getLowEnergySigma(int, int, int) =0;
    
                virtual double getLowEnergySigma__BOSS(int, int) =0;
    
                virtual double getLowEnergySigma(int, int, double, double, double, int) =0;
    
                virtual double getLowEnergySigma__BOSS(int, int, double, double, double) =0;
    
                virtual double getLowEnergySigma(int, int, double, int) =0;
    
                virtual double getLowEnergySigma__BOSS(int, int, double) =0;
    
                virtual double getLowEnergySlope(int, int, double, double, double, int) =0;
    
                virtual double getLowEnergySlope__BOSS(int, int, double, double, double) =0;
                ...
                virtual Pythia8::Abstract_BeamParticle& beamA_ref__BOSS() =0;
    
                virtual Pythia8::Abstract_BeamParticle& beamB_ref__BOSS() =0;
...
#endif /* __abstract_Pythia_Pythia_8_306_h__ */
