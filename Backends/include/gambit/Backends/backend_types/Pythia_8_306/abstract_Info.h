#ifndef __abstract_Info_Pythia_8_306_h__
#define __abstract_Info_Pythia_8_306_h__
    ...
    namespace Pythia8
    {
        class Abstract_Info : public virtual AbstractBase
        {
            public:
                ...
                virtual void errorMsg(std::string, std::string, bool) =0;
                ...
                virtual const int& TIMESTOPRINT_ref__BOSS() =0;
                ...
                virtual std::map<std::basic_string<char>, int>& messages_ref__BOSS() =0;
...
#endif /* __abstract_Info_Pythia_8_306_h__ */
