#ifndef __abstract_Hist_Pythia_8_306_h__
#define __abstract_Hist_Pythia_8_306_h__
    ...
    namespace Pythia8
    {
        class Abstract_Hist : public virtual AbstractBase
        {
            public:
                ...
                virtual void book(std::string, int, double, double, bool) =0;
                ...
                virtual void pyplotTable(std::ostream&, bool) const =0;
    
                virtual void pyplotTable__BOSS(std::ostream&) const =0;
    
                virtual void pyplotTable__BOSS() const =0;
    
                virtual void pyplotTable(std::string, bool) const =0;
                ...
                virtual double getXMean() const =0;
...
#endif /* __abstract_Hist_Pythia_8_306_h__ */
