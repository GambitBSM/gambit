#ifndef __wrapper_Vec4_decl_Pythia_8_306_h__
#define __wrapper_Vec4_decl_Pythia_8_306_h__
    ...
    namespace Pythia8
    {
        ...
        class Vec4 : public WrapperBase
        {
            ...
            public:
                ...
                Pythia8::Vec4 operator+(const Pythia8::Vec4& v) const;
        
                Pythia8::Vec4 operator-(const Pythia8::Vec4& v) const;
        
                Pythia8::Vec4 operator*(double f) const;
        
                Pythia8::Vec4 operator/(double f) const;
        
                double operator*(const Pythia8::Vec4& v) const;
...
#endif /* __wrapper_Vec4_decl_Pythia_8_306_h__ */
