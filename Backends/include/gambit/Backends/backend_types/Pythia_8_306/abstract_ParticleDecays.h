#ifndef __abstract_ParticleDecays_Pythia_8_306_h__
#define __abstract_ParticleDecays_Pythia_8_306_h__
    ...
    namespace Pythia8
    {
        class Abstract_ParticleDecays : public virtual AbstractBase
        {
            public:
                ...
                virtual bool decayAll__BOSS(Pythia8::Abstract_Event&, double) =0;
    
                virtual bool decayAll__BOSS(Pythia8::Abstract_Event&) =0;
...
#endif /* __abstract_ParticleDecays_Pythia_8_306_h__ */
