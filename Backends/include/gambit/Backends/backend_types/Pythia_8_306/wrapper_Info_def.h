#ifndef __wrapper_Info_def_Pythia_8_306_h__
#define __wrapper_Info_def_Pythia_8_306_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    namespace Pythia8
    {
        ...
        inline ::std::string Info::weightLabel(int iWeight) const
        {
            return get_BEptr()->weightLabel(iWeight);
        }
        ...
        {
            get_BEptr()->errorMsg(messageIn, extraIn, showAlways);
        }
        ...
        inline int Info::errorTotalNumber() const
        {
            return get_BEptr()->errorTotalNumber();
        }
        
        inline void Info::errorStatistics() const
        {
        ...
        inline Info::Info() :
            ...
            TIMESTOPRINT( get_BEptr()->TIMESTOPRINT_ref__BOSS()),
            ...
            messages( get_BEptr()->messages_ref__BOSS()),
...
#endif /* __wrapper_Info_def_Pythia_8_306_h__ */
