#ifndef __wrapper_BeamParticle_def_Pythia_8_306_h__
#define __wrapper_BeamParticle_def_Pythia_8_306_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    namespace Pythia8
    {
        ...
        inline bool BeamParticle::resolvedGamma()
        {
        ...
        inline int BeamParticle::getGammaMode()
        {
            return get_BEptr()->getGammaMode();
        }
        
        inline bool BeamParticle::isResolvedUnresolved()
        {
        ...
        inline bool BeamParticle::gammaInBeam()
        {
...
#endif /* __wrapper_BeamParticle_def_Pythia_8_306_h__ */
