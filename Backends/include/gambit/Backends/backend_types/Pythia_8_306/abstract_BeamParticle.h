#ifndef __abstract_BeamParticle_Pythia_8_306_h__
#define __abstract_BeamParticle_Pythia_8_306_h__
    ...
    namespace Pythia8
    {
        class Abstract_BeamParticle : public virtual AbstractBase
        {
            public:
                ...
                virtual bool resolvedGamma() =0;
    
                virtual void setGammaMode(int) =0;
    
                virtual int getGammaMode() =0;
    
                virtual bool isResolvedUnresolved() =0;
    
                virtual void initGammaInBeam() =0;
    
                virtual bool gammaInBeam() =0;
...
#endif /* __abstract_BeamParticle_Pythia_8_306_h__ */
