#ifndef __wrapper_Info_decl_Pythia_8_306_h__
#define __wrapper_Info_decl_Pythia_8_306_h__
    ...
    namespace Pythia8
    {
        ...
        class Info : public WrapperBase
        {
            ...
            public:
                ...
                int (&counters)[50];
                std::map<std::basic_string<char>, int>& messages;
            ...
            public:
                ...
                ::std::string weightLabel(int iWeight) const;
...
#endif /* __wrapper_Info_decl_Pythia_8_306_h__ */
