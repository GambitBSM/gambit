#ifndef __wrapper_Hist_decl_Pythia_8_306_h__
#define __wrapper_Hist_decl_Pythia_8_306_h__
    ...
    namespace Pythia8
    {
        ...
        class Hist : public WrapperBase
        {
            ...
            public:
                ...
                static Abstract_Hist* (*__factory1)(std::string, int, double, double, bool);
                static Abstract_Hist* (*__factory2)(std::string, int, double, double);
                static Abstract_Hist* (*__factory3)(std::string, int, double);
                static Abstract_Hist* (*__factory4)(std::string, int);
                static Abstract_Hist* (*__factory5)(std::string);
                static Abstract_Hist* (*__factory6)(std::string, const Pythia8::Hist&);
...
#endif /* __wrapper_Hist_decl_Pythia_8_306_h__ */
