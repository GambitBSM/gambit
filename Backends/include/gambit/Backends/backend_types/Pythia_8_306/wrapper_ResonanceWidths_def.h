#ifndef __wrapper_ResonanceWidths_def_Pythia_8_306_h__
#define __wrapper_ResonanceWidths_def_Pythia_8_306_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    namespace Pythia8
    {
        ...
        inline bool ResonanceWidths::init(Pythia8::Info* infoPtrIn)
        {
            return get_BEptr()->init__BOSS((*infoPtrIn).get_BEptr());
        }
...
#endif /* __wrapper_ResonanceWidths_def_Pythia_8_306_h__ */
