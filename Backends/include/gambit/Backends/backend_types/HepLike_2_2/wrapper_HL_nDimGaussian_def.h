#ifndef __wrapper_HL_nDimGaussian_def_HepLike_2_2_h__
#define __wrapper_HL_nDimGaussian_def_HepLike_2_2_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
   ...
   inline bool HL_nDimGaussian::Restrict(std::vector<std::string> arg_1)
   {
      return get_BEptr()->Restrict(arg_1);
   }
   
   inline ::std::vector<std::string> HL_nDimGaussian::GetObservables()
   {
...
#endif /* __wrapper_HL_nDimGaussian_def_HepLike_2_2_h__ */
