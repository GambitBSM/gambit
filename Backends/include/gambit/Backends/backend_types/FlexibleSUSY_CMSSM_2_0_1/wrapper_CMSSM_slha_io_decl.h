#ifndef __wrapper_CMSSM_slha_io_decl_FlexibleSUSY_CMSSM_2_0_1_h__
#define __wrapper_CMSSM_slha_io_decl_FlexibleSUSY_CMSSM_2_0_1_h__
    ...
    namespace flexiblesusy
    {
        ...
        class CMSSM_slha_io : public WrapperBase
        {
            ...
            public:
                ...
                static Abstract_CMSSM_slha_io* (*__factory0)();
            ...
            public:
                ...
                void read_from_file(const ::std::basic_string<char>& arg_1);
        
                void read_from_source(const ::std::basic_string<char>& arg_1);
        
                void read_from_stream(::std::basic_istream<char>& arg_1);
                ...
                void set_spinfo(const ::std::vector<std::basic_string<char>>& arg_1, const ::std::vector<std::basic_string<char>>& arg_2);
        
                void set_print_imaginary_parts_of_majorana_mixings(bool arg_1);
        
                void write_to(const ::std::basic_string<char>& arg_1) const;
        
                void write_to_file(const ::std::basic_string<char>& file_name) const;
        
                void write_to_stream(::std::basic_ostream<char>& ostr) const;
            ...
            public:
                ...
                CMSSM_slha_io(Abstract_CMSSM_slha_io* in);
                ...
                Abstract_CMSSM_slha_io* get_BEptr() const;
...
#endif /* __wrapper_CMSSM_slha_io_decl_FlexibleSUSY_CMSSM_2_0_1_h__ */
