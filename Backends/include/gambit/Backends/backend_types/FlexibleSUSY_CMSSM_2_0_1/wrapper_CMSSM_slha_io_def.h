#ifndef __wrapper_CMSSM_slha_io_def_FlexibleSUSY_CMSSM_2_0_1_h__
#define __wrapper_CMSSM_slha_io_def_FlexibleSUSY_CMSSM_2_0_1_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    namespace flexiblesusy
    {
        ...
        inline void CMSSM_slha_io::read_from_file(const ::std::basic_string<char>& arg_1)
        {
            get_BEptr()->read_from_file(arg_1);
        }
        
        inline void CMSSM_slha_io::read_from_source(const ::std::basic_string<char>& arg_1)
        {
            get_BEptr()->read_from_source(arg_1);
        }
        
        inline void CMSSM_slha_io::read_from_stream(::std::basic_istream<char>& arg_1)
        {
        ...
        inline void CMSSM_slha_io::set_spinfo(const ::std::vector<std::basic_string<char>>& arg_1, const ::std::vector<std::basic_string<char>>& arg_2)
        {
        ...
        inline void CMSSM_slha_io::write_to(const ::std::basic_string<char>& arg_1) const
        {
            get_BEptr()->write_to(arg_1);
        }
        
        inline void CMSSM_slha_io::write_to_file(const ::std::basic_string<char>& file_name) const
        {
            get_BEptr()->write_to_file(file_name);
        }
        
        inline void CMSSM_slha_io::write_to_stream(::std::basic_ostream<char>& ostr) const
        {
        ...
        inline CMSSM_slha_io::CMSSM_slha_io() :
        ...
        inline CMSSM_slha_io::CMSSM_slha_io(Abstract_CMSSM_slha_io* in) :
            WrapperBase(in)
        {
            get_BEptr()->set_wptr(this);
            get_BEptr()->set_delete_wrapper(false);
        ...
        // Copy constructor: 
        inline CMSSM_slha_io::CMSSM_slha_io(const CMSSM_slha_io& in) :
        ...
        // Assignment operator: 
        inline CMSSM_slha_io& CMSSM_slha_io::operator=(const CMSSM_slha_io& in)
        {
            if (this != &in)
            {
        ...
        inline Abstract_CMSSM_slha_io* flexiblesusy::CMSSM_slha_io::get_BEptr() const
        {
            return dynamic_cast<Abstract_CMSSM_slha_io*>(BEptr);
        }
    }
...
#endif /* __wrapper_CMSSM_slha_io_def_FlexibleSUSY_CMSSM_2_0_1_h__ */
