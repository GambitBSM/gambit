...
#include "wrapper_CMSSM_spectrum_generator__flexiblesusy::Two_scale.h"
...
#define FlexibleSUSY_CMSSM_2_0_1_all_data \
  ...
  (( /*class*/(flexiblesusy)(CMSSM_spectrum_generator),    /*constructors*/(("Factory_CMSSM_spectrum_generator__flexiblesusy::Two_scale_0__BOSS_2",())) )) \
  (( /*class*/(flexiblesusy)(CMSSM_input_parameters),    /*constructors*/(("Factory_CMSSM_input_parameters_0__BOSS_3",())) )) \
  (( /*class*/(flexiblesusy)(Spectrum_generator_settings),    /*constructors*/(("Factory_Spectrum_generator_settings_0__BOSS_4",())) )) \
  (( /*class*/(flexiblesusy)(Spectrum_generator_problems),    /*constructors*/(("Factory_Spectrum_generator_problems_0__BOSS_5",())) )) \
  (( /*class*/(flexiblesusy)(Physical_input),    /*constructors*/(("Factory_Physical_input_0__BOSS_6",())) )) \
  (( /*class*/(flexiblesusy)(CMSSM_parameter_getter),    /*constructors*/(("Factory_CMSSM_parameter_getter_0__BOSS_7",())) )) \
