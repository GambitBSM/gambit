    ...
    namespace flexiblesusy
    {
        class Abstract_Spectrum_generator_problems : public virtual AbstractBase
        {
            public:
                ...
                virtual ::std::basic_string<char, std::char_traits<char>, std::allocator<char> > get_problem_string() const =0;
    
                virtual ::std::basic_string<char, std::char_traits<char>, std::allocator<char> > get_warning_string() const =0;
