#ifndef __wrapper_HL_nDimGaussian_def_HepLike_2_0_h__
#define __wrapper_HL_nDimGaussian_def_HepLike_2_0_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
   ...
   inline double HL_nDimGaussian::GetChi2(std::vector<double> theory, boost::numeric::ublas::matrix<double, boost::numeric::ublas::basic_row_major<unsigned long, long>, boost::numeric::ublas::unbounded_array<double, std::allocator<double> > > theory_cov)
   {
      return get_BEptr()->GetChi2(theory, theory_cov);
   }
   
   inline double HL_nDimGaussian::GetLikelihood(std::vector<double> theory, boost::numeric::ublas::matrix<double, boost::numeric::ublas::basic_row_major<unsigned long, long>, boost::numeric::ublas::unbounded_array<double, std::allocator<double> > > theory_cov)
   {
      return get_BEptr()->GetLikelihood(theory, theory_cov);
   }
   
   inline double HL_nDimGaussian::GetLogLikelihood(std::vector<double> theory, boost::numeric::ublas::matrix<double, boost::numeric::ublas::basic_row_major<unsigned long, long>, boost::numeric::ublas::unbounded_array<double, std::allocator<double> > > theory_cov)
   {
   ...
   inline HL_nDimGaussian::HL_nDimGaussian(std::string s) :
...
#endif /* __wrapper_HL_nDimGaussian_def_HepLike_2_0_h__ */
