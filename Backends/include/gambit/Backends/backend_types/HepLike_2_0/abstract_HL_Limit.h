#ifndef __abstract_HL_Limit_HepLike_2_0_h__
#define __abstract_HL_Limit_HepLike_2_0_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
   ...
   class Abstract_HL_Limit : public virtual AbstractBase
   {
      public:
      ...
      public:
         ...
         Abstract_HL_Limit(const Abstract_HL_Limit&)
         {
            wptr = 0;
            delete_wrapper = false;
         }
...
#endif /* __abstract_HL_Limit_HepLike_2_0_h__ */
