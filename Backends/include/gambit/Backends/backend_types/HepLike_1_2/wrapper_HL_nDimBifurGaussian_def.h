...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
   ...
   inline double HL_nDimBifurGaussian::GetChi2(::std::vector<double, std::allocator<double> > theory)
   {
      return get_BEptr()->GetChi2(theory);
   }
   
   inline double HL_nDimBifurGaussian::GetLikelihood(::std::vector<double, std::allocator<double> > theory)
   {
   ...
   inline HL_nDimBifurGaussian::HL_nDimBifurGaussian(::std::basic_string<char, std::char_traits<char>, std::allocator<char> > s) :
