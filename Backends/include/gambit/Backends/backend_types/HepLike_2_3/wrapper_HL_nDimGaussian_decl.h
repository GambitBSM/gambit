#ifndef __wrapper_HL_nDimGaussian_decl_HepLike_2_3_h__
#define __wrapper_HL_nDimGaussian_decl_HepLike_2_3_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
   ...
   class HL_nDimGaussian : public WrapperBase
   {
         // Member variables: 
      public:
         // -- Static factory pointers: 
         static Abstract_HL_nDimGaussian* (*__factory0)();
         static Abstract_HL_nDimGaussian* (*__factory1)(std::string);
...
#endif /* __wrapper_HL_nDimGaussian_decl_HepLike_2_3_h__ */
