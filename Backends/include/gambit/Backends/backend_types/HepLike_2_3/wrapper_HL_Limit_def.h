#ifndef __wrapper_HL_Limit_def_HepLike_2_3_h__
#define __wrapper_HL_Limit_def_HepLike_2_3_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
   ...
   inline double HL_Limit::GetChi2(double arg_1, double arg_2)
   {
      return get_BEptr()->GetChi2(arg_1, arg_2);
   }
   ...
   inline double HL_Limit::GetLogLikelihood(double arg_1, double arg_2)
   {
      return get_BEptr()->GetLogLikelihood(arg_1, arg_2);
   }
   ...
   inline double HL_Limit::GetLikelihood(double arg_1, double arg_2)
   {
      return get_BEptr()->GetLikelihood(arg_1, arg_2);
   }
   
   inline double HL_Limit::GetCLs(double arg_1)
   {
      return get_BEptr()->GetCLs(arg_1);
   }
   ...
   inline HL_Limit::HL_Limit(std::string s) :
...
#endif /* __wrapper_HL_Limit_def_HepLike_2_3_h__ */
