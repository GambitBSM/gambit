#ifndef __wrapper_HL_Limit_decl_HepLike_1_0_h__
#define __wrapper_HL_Limit_decl_HepLike_1_0_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
   ...
   class HL_Limit : public HL_Data
   {
      ...
      public:
         ...
         static Abstract_HL_Limit* (*__factory1)(::std::basic_string<char, std::char_traits<char>, std::allocator<char> >);
      ...
      public:
         HL_Limit();
         HL_Limit(::std::basic_string<char, std::char_traits<char>, std::allocator<char> > s);
...
#endif /* __wrapper_HL_Limit_decl_HepLike_1_0_h__ */
