#ifndef __wrapper_HL_Gaussian_decl_HepLike_1_0_h__
#define __wrapper_HL_Gaussian_decl_HepLike_1_0_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
   ...
   class HL_Gaussian : public HL_Data
   {
      ...
      public:
         ...
         static Abstract_HL_Gaussian* (*__factory1)(::std::basic_string<char, std::char_traits<char>, std::allocator<char> >);
      ...
      public:
         HL_Gaussian();
         HL_Gaussian(::std::basic_string<char, std::char_traits<char>, std::allocator<char> > s);
...
#endif /* __wrapper_HL_Gaussian_decl_HepLike_1_0_h__ */
