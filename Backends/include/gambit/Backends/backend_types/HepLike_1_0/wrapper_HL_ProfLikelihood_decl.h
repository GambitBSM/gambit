#ifndef __wrapper_HL_ProfLikelihood_decl_HepLike_1_0_h__
#define __wrapper_HL_ProfLikelihood_decl_HepLike_1_0_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
   ...
   class HL_ProfLikelihood : public HL_Data
   {
      ...
      public:
         ...
         static Abstract_HL_ProfLikelihood* (*__factory1)(::std::basic_string<char, std::char_traits<char>, std::allocator<char> >);
      ...
      public:
         HL_ProfLikelihood();
         HL_ProfLikelihood(::std::basic_string<char, std::char_traits<char>, std::allocator<char> > s);
...
#endif /* __wrapper_HL_ProfLikelihood_decl_HepLike_1_0_h__ */
