#ifndef __wrapper_HL_BifurGaussian_decl_HepLike_1_0_h__
#define __wrapper_HL_BifurGaussian_decl_HepLike_1_0_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
   ...
   class HL_BifurGaussian : public HL_Gaussian
   {
      ...
      public:
         ...
         static Abstract_HL_BifurGaussian* (*__factory1)(::std::basic_string<char, std::char_traits<char>, std::allocator<char> >);
      ...
      public:
         HL_BifurGaussian();
         HL_BifurGaussian(::std::basic_string<char, std::char_traits<char>, std::allocator<char> > s);
...
#endif /* __wrapper_HL_BifurGaussian_decl_HepLike_1_0_h__ */
