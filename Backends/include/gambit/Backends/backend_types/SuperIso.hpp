...
namespace Gambit
{
  ...
  struct parameters
  {
    ...
    double Re_DeltaC2p_mu = 0.;
    double Im_DeltaC2p_mu = 0.;
    double Re_DeltaC7p_mu = 0.;
    double Im_DeltaC7p_mu = 0.;
    double Re_DeltaC8p_mu = 0.;
    double Im_DeltaC8p_mu = 0.;
    double Re_DeltaC9p_mu = 0.;
    double Im_DeltaC9p_mu = 0.;
    double Re_DeltaC10p_mu = 0.;
    double Im_DeltaC10p_mu = 0.;
    double Re_DeltaCQ1p_mu = 0.;
    double Im_DeltaCQ1p_mu = 0.;
    double Re_DeltaCQ2p_mu = 0.;
    double Im_DeltaCQ2p_mu = 0.;

    double Re_DeltaC2_e = 0.;
    double Im_DeltaC2_e = 0.;
    double Re_DeltaC7_e = 0.;
    double Im_DeltaC7_e = 0.;
    double Re_DeltaC8_e = 0.;
    double Im_DeltaC8_e = 0.;
    ...
    double Re_DeltaC2p_e = 0.;
    double Im_DeltaC2p_e = 0.;
    double Re_DeltaC7p_e = 0.;
    double Im_DeltaC7p_e = 0.;
    double Re_DeltaC8p_e = 0.;
    double Im_DeltaC8p_e = 0.;
    double Re_DeltaC9p_e = 0.;
    double Im_DeltaC9p_e = 0.;
    double Re_DeltaC10p_e = 0.;
    double Im_DeltaC10p_e = 0.;
    double Re_DeltaCQ1p_e = 0.;
    double Im_DeltaCQ1p_e = 0.;
    double Re_DeltaCQ2p_e = 0.;
    double Im_DeltaCQ2p_e = 0.;

    double Re_DeltaC2_tau = 0.;
    double Im_DeltaC2_tau = 0.;
    double Re_DeltaC7_tau = 0.;
    double Im_DeltaC7_tau = 0.;
    double Re_DeltaC8_tau = 0.;
    double Im_DeltaC8_tau = 0.;
    ...
    double Re_DeltaC2p_tau = 0.;
    double Im_DeltaC2p_tau = 0.;
    double Re_DeltaC7p_tau = 0.;
    double Re_DeltaC8p_tau = 0.;
    double Im_DeltaC8p_tau = 0.;
    double Im_DeltaC7p_tau = 0.;
    double Re_DeltaC9p_tau = 0.;
    double Im_DeltaC9p_tau = 0.;
    double Re_DeltaC10p_tau = 0.;
    double Im_DeltaC10p_tau = 0.;
    double Re_DeltaCQ1p_tau = 0.;
    double Im_DeltaCQ1p_tau = 0.;
    double Re_DeltaCQ2p_tau = 0.;
    double Im_DeltaCQ2p_tau = 0.;
