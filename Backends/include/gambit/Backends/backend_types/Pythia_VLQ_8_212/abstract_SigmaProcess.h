#ifndef __abstract_SigmaProcess_Pythia_VLQ_8_212_h__
#define __abstract_SigmaProcess_Pythia_VLQ_8_212_h__
    ...
    namespace Pythia8
    {
        class Abstract_SigmaProcess : public virtual AbstractBase
        {
            public:
                ...
                virtual ::std::string inFlux() const =0;
...
#endif /* __abstract_SigmaProcess_Pythia_VLQ_8_212_h__ */
