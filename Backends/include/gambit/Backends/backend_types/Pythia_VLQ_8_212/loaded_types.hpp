#ifndef __loaded_types_Pythia_VLQ_8_212_hpp__
#define __loaded_types_Pythia_VLQ_8_212_hpp__ 1
...
#include "wrapper_CombineMatchingInput.h"
#include "identification.hpp"

// Indicate which types are provided by this backend, and what the symbols of their factories are.
#define Pythia_VLQ_8_212_all_data \
  (( /*class*/(Pythia8)(GAMBIT_hepmc_writer),    /*constructors*/(("Factory_GAMBIT_hepmc_writer_0__BOSS_1",())) )) \
  (( /*class*/(Pythia8)(Pythia),    /*constructors*/(("Factory_Pythia_0__BOSS_2",(std::string, bool))) (("Factory_Pythia_1__BOSS_3",(std::string))) (("Factory_Pythia_2__BOSS_4",())) (("Factory_Pythia_3__BOSS_5",(my_ns::Pythia8::ParticleData&, my_ns::Pythia8::Settings&, bool))) (("Factory_Pythia_4__BOSS_6",(my_ns::Pythia8::ParticleData&, my_ns::Pythia8::Settings&))) )) \
  ...
  (( /*class*/(Pythia8)(LHdecayChannel),    /*constructors*/(("Factory_LHdecayChannel_0__BOSS_15",())) (("Factory_LHdecayChannel_1__BOSS_16",(double, int, std::vector<int>, std::string))) (("Factory_LHdecayChannel_2__BOSS_17",(double, int, std::vector<int>))) )) \
  ...
  (( /*class*/(Pythia8)(SusyLesHouches),    /*constructors*/(("Factory_SusyLesHouches_0__BOSS_21",(int))) (("Factory_SusyLesHouches_1__BOSS_22",())) (("Factory_SusyLesHouches_2__BOSS_23",(std::string, int))) (("Factory_SusyLesHouches_3__BOSS_24",(std::string))) )) \
  ...
  (( /*class*/(Pythia8)(ParticleDataEntry),    /*constructors*/(("Factory_ParticleDataEntry_0__BOSS_38",(int, std::string, int, int, int, double, double, double, double, double))) (("Factory_ParticleDataEntry_1__BOSS_39",(int, std::string, int, int, int, double, double, double, double))) (("Factory_ParticleDataEntry_2__BOSS_40",(int, std::string, int, int, int, double, double, double))) (("Factory_ParticleDataEntry_3__BOSS_41",(int, std::string, int, int, int, double, double))) (("Factory_ParticleDataEntry_4__BOSS_42",(int, std::string, int, int, int, double))) (("Factory_ParticleDataEntry_5__BOSS_43",(int, std::string, int, int, int))) (("Factory_ParticleDataEntry_6__BOSS_44",(int, std::string, int, int))) (("Factory_ParticleDataEntry_7__BOSS_45",(int, std::string, int))) (("Factory_ParticleDataEntry_8__BOSS_46",(int, std::string))) (("Factory_ParticleDataEntry_9__BOSS_47",(int))) (("Factory_ParticleDataEntry_10__BOSS_48",())) (("Factory_ParticleDataEntry_11__BOSS_49",(int, std::string, std::string, int, int, int, double, double, double, double, double))) (("Factory_ParticleDataEntry_12__BOSS_50",(int, std::string, std::string, int, int, int, double, double, double, double))) (("Factory_ParticleDataEntry_13__BOSS_51",(int, std::string, std::string, int, int, int, double, double, double))) (("Factory_ParticleDataEntry_14__BOSS_52",(int, std::string, std::string, int, int, int, double, double))) (("Factory_ParticleDataEntry_15__BOSS_53",(int, std::string, std::string, int, int, int, double))) (("Factory_ParticleDataEntry_16__BOSS_54",(int, std::string, std::string, int, int, int))) (("Factory_ParticleDataEntry_17__BOSS_55",(int, std::string, std::string, int, int))) (("Factory_ParticleDataEntry_18__BOSS_56",(int, std::string, std::string, int))) (("Factory_ParticleDataEntry_19__BOSS_57",(int, std::string, std::string))) )) \
  ...
  (( /*class*/(Pythia8)(Parm),    /*constructors*/(("Factory_Parm_0__BOSS_92",(std::string, double, bool, bool, double, double))) (("Factory_Parm_1__BOSS_93",(std::string, double, bool, bool, double))) (("Factory_Parm_2__BOSS_94",(std::string, double, bool, bool))) (("Factory_Parm_3__BOSS_95",(std::string, double, bool))) (("Factory_Parm_4__BOSS_96",(std::string, double))) (("Factory_Parm_5__BOSS_97",(std::string))) (("Factory_Parm_6__BOSS_98",())) )) \
  ...
  (( /*class*/(Pythia8)(Hist),    /*constructors*/(("Factory_Hist_0__BOSS_108",())) (("Factory_Hist_1__BOSS_109",(std::string, int, double, double))) (("Factory_Hist_2__BOSS_110",(std::string, int, double))) (("Factory_Hist_3__BOSS_111",(std::string, int))) (("Factory_Hist_4__BOSS_112",(std::string))) (("Factory_Hist_5__BOSS_113",(std::string, const my_ns::Pythia8::Hist&))) )) \
  (( /*class*/(Pythia8)(CombineMatchingInput),    /*constructors*/(("Factory_CombineMatchingInput_0__BOSS_114",())) )) \
...
#endif /* __loaded_types_Pythia_VLQ_8_212_hpp__ */
