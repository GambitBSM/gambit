#ifndef __wrapper_SlowJet_def_Pythia_VLQ_8_212_h__
#define __wrapper_SlowJet_def_Pythia_VLQ_8_212_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    namespace Pythia8
    {
        ...
        inline void SlowJet::list(bool listAll, std::ostream& os) const
        {
...
#endif /* __wrapper_SlowJet_def_Pythia_VLQ_8_212_h__ */
