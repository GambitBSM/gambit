#ifndef __wrapper_SigmaProcess_def_Pythia_VLQ_8_212_h__
#define __wrapper_SigmaProcess_def_Pythia_VLQ_8_212_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    namespace Pythia8
    {
        ...
        inline ::std::string SigmaProcess::name() const
        {
        ...
        inline ::std::string SigmaProcess::inFlux() const
        {
...
#endif /* __wrapper_SigmaProcess_def_Pythia_VLQ_8_212_h__ */
