...
& ZW,ZZ,alphaH,betaH,vd,vu,g1,g2,g3,lam5,lam1,lam4,lam3,lam2,Yu,Yd,Ye,m122,              & 
& m112,m222,delta0,gMZ,kont)
...
CosW2SinW2=(1._dp-sinW2_Q)*sinW2_Q
If (IncludeDeltaVB) Then 
Call DeltaVB(sinW2,sinW2_Q,rho,MAh,MFe,Mhh,MHm,MVWm,g2,ZER,vd,vu,ZEL,Ye,              & 
& ZA,ZH,ZP,delta)
...
Call SetMatchingConditions(g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,vSM,vd,vu,g1,g2,             & 
& g3,lam5,lam1,lam4,lam3,lam2,Yu,Yd,Ye,m122,m112,m222,.True.)
...
! Full one-loop corrections
Call CouplingsForSMfermions(Yd,ZA,ZDL,ZDR,ZH,g3,g1,g2,TW,Yu,ZP,ZUL,ZUR,               & 
& Ye,ZEL,ZER,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,cplcUFdFdhhR,cplcUFdFdVGL,           & 
...
Call ParametersToG73(g1,g2,g3,lam5,lam1,lam4,lam3,lam2,Yu,Yd,Ye,m122,m112,m222,gMZ)
...
& Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,v,ZDL,ZEL,ZUL,ZA,ZH,ZP,               & 
& ZW,ZZ,alphaH,betaH,g1,g2,g3,lam5,lam1,lam4,lam3,lam2,Yu,Yd,Ye,m122,m112,               & 
& m222,mGut,kont,WriteComment,niter)
...
Real(dp) :: g_SM(62) 
Real(dp) :: delta0,deltaG0, gA(73), gB(73)
Real(dp) :: gC(75),  gD(75) 
...
& betaH,vd,vu,g1,g2,g3,lam5,lam1,lam4,lam3,lam2,Yu,Yd,Ye,m122,m112,m222,delta0,gB,kont)
...
mGUT = 1._dp 
Call GToParameters73(gB,g1,g2,g3,lam5,lam1,lam4,lam3,lam2,Yu,Yd,Ye,m122,              & 
& m112,m222)
...
Real(dp):: gA(73), gB(73), Scale_Save 
...
End Module Boundaries_gumTHDMII 
