...
Module TreeLevelMasses_gumTHDMII 
...
& betaH,vd,vu,g1,g2,g3,lam5,lam1,lam4,lam3,lam2,Yu,Yd,Ye,m122,m112,m222,GenerationMixing,kont)
...
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMassesgumTHDMII'
...
Call CalculateMhh(m122,lam5,m112,m222,lam1,lam4,lam3,lam2,vd,vu,ZH,Mhh,               & 
& Mhh2,kont)

kontSave = kont 
Call CalculateMAh(g1,g2,m122,lam5,m112,m222,lam1,lam4,lam3,lam2,vd,vu,TW,             & 
& ZA,MAh,MAh2,kont)

kont = kontSave 
kontSave = kont 
Call CalculateMHm(g2,m122,lam5,m112,m222,lam1,lam4,lam3,lam2,vd,vu,ZP,MHm,            & 
& MHm2,kont)
...
& alphaH,betaH,vd,vu,g1,g2,g3,lam5,lam1,lam4,lam3,lam2,Yu,Yd,Ye,m122,m112,               & 
& m222,GenerationMixing,kont)
...
Call CalculateMhhEffPot(m122,lam5,m112,m222,lam1,lam4,lam3,lam2,vd,vu,ZH,             & 
& Mhh,Mhh2,kont)

kontSave = kont 
Call CalculateMAhEffPot(g1,g2,m122,lam5,m112,m222,lam1,lam4,lam3,lam2,vd,             & 
& vu,TW,ZA,MAh,MAh2,kont)

kont = kontSave 
kontSave = kont 
Call CalculateMHmEffPot(g2,m122,lam5,m112,m222,lam1,lam4,lam3,lam2,vd,vu,             & 
& ZP,MHm,MHm2,kont)
...
Subroutine CalculateMhh(m122,lam5,m112,m222,lam1,lam4,lam3,lam2,vd,vu,ZH,             & 
& Mhh,Mhh2,kont)
...
mat(1,1) = mat(1,1)+(3*lam1*vd**2)/2._dp
...
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)-1._dp*(m122)/2._dp
...
Subroutine CalculateMAh(g1,g2,m122,lam5,m112,m222,lam1,lam4,lam3,lam2,vd,             & 
& vu,TW,ZA,MAh,MAh2,kont)
...
mat(1,1) = 0._dp 
mat(1,1) = mat(1,1)+m112
mat(1,1) = mat(1,1)+(lam1*vd**2)/2._dp
mat(1,1) = mat(1,1)+(lam3*vu**2)/2._dp
mat(1,1) = mat(1,1)+(lam4*vu**2)/2._dp
mat(1,1) = mat(1,1)-(lam5*vu**2)/4._dp
mat(1,1) = mat(1,1)-(vu**2*Conjg(lam5))/4._dp
...
mat(2,2) = mat(2,2)+(lam4*vd**2)/2._dp
mat(2,2) = mat(2,2)-(lam5*vd**2)/4._dp
mat(2,2) = mat(2,2)+(lam2*vu**2)/2._dp
mat(2,2) = mat(2,2)-(vd**2*Conjg(lam5))/4._dp
...
Subroutine CalculateMHm(g2,m122,lam5,m112,m222,lam1,lam4,lam3,lam2,vd,vu,             & 
& ZP,MHm,MHm2,kont)
...
Subroutine CalculateMhhEffPot(m122,lam5,m112,m222,lam1,lam4,lam3,lam2,vd,             & 
& vu,ZH,Mhh,Mhh2,kont)
...
Subroutine CalculateMAhEffPot(g1,g2,m122,lam5,m112,m222,lam1,lam4,lam3,               & 
...
Subroutine CalculateMHmEffPot(g2,m122,lam5,m112,m222,lam1,lam4,lam3,lam2,             & 
...
& Yu,Yd,Ye,m122,m112,m222,GenerationMixing,kont)
...
End Module TreeLevelMasses_gumTHDMII 
