...
Module TreeLevelDecays_gumTHDMII
...
Complex(dp),Intent(in) :: lam5,lam1,lam4,lam3,lam2,Yu(3,3),Yd(3,3),Ye(3,3),m122,m112,m222,ZDR(3,3),             & 
...
End Module TreeLevelDecays_gumTHDMII 
