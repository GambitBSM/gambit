...
Program SPhenogumTHDMII 
 
Use Control
Use InputOutput_gumTHDMII
Use LoopFunctions
Use Settings
Use LowEnergy_gumTHDMII
Use Mathematics
Use Model_Data_gumTHDMII
Use Tadpoles_gumTHDMII 
 !Use StandardModel
Use Unitarity_gumTHDMII 
 Use Boundaries_gumTHDMII
 Use HiggsCS_gumTHDMII
Use TreeLevelMasses_gumTHDMII
Use LoopMasses_gumTHDMII
 
Use BranchingRatios_gumTHDMII
...
& g3,lam5,lam1,lam4,lam3,lam2,Yu,Yd,Ye,m122,m112,m222,.False.)
...
& vd,vu,g1,g2,g3,lam5,lam1,lam4,lam3,lam2,Yu,Yd,Ye,m122,m112,m222,kont)
...
& ZDL,ZEL,ZUL,ZA,ZH,ZP,ZW,ZZ,alphaH,betaH,vd,vu,g1,g2,g3,lam5,lam1,lam4,lam3,            & 
& lam2,Yu,Yd,Ye,m122,m112,m222,mGUT)
...
& Yu,Yd,Ye,m122,m112,m222,mass_uncertainty_Q)
...
& MFe2,MFu,MFu2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,v,ZDL,              & 
& ZEL,ZUL,ZA,ZH,ZP,ZW,ZZ,alphaH,betaH,vd,vu,g1,g2,g3,lam5,lam1,lam4,lam3,lam2,           & 
& Yu,Yd,Ye,m122,m112,m222,gPFu,gTFu,BRFu,gPFe,gTFe,BRFe,gPFd,gTFd,BRFd,gPhh,             & 
...
& Yd,Ye,m122,m112,m222,vd,vu,Tpar,Spar,Upar,ae,amu,atau,EDMe,EDMmu,EDMtau,               & 
...
If (OutputForMO) Then 
Call RunningFermionMasses(MFe,MFe2,MFd,MFd2,MFu,MFu2,vd,vu,g1,g2,g3,lam5,             & 
& lam1,lam4,lam3,lam2,Yu,Yd,Ye,m122,m112,m222,kont)

End if 
If (TreeLevelUnitarityLimits) Then 
Write(*,*) "Calculating unitarity constraints " 
Call ScatteringEigenvalues(vd,vu,g1,g2,g3,lam5,lam1,lam4,lam3,lam2,Yu,Yd,             & 
& Ye,m122,m112,m222,deltaM,kont)
...
& ZA,ZH,ZP,ZW,ZZ,alphaH,betaH,vd,vu,g1,g2,g3,lam5,lam1,lam4,lam3,lam2,Yu,Yd,             & 
& Ye,m122,m112,m222,deltaM,kont)
...
& betaH,g1,g2,g3,lam5,lam1,lam4,lam3,lam2,Yu,Yd,Ye,m122,m112,m222,mGut,kont,             & 
& WriteOut,n_run)
...
& lam1input,lam4input,lam3input,lam2input,Yuinput,Ydinput,Yeinput,m122input,             & 
& m112input,m222input,mass_Qerror)
...
Real(dp) :: gD(75), Q, Qsave, Qstep, Qt, g_SM(62), mh_SM 
...
& Yeinput(3,3),m122input,m112input,m222input
...
Complex(dp) :: lam5,lam1,lam4,lam3,lam2,Yu(3,3),Yd(3,3),Ye(3,3),m122,m112,m222
...
If (iupdown.eq.1) Then 
 tz=Log(Q/Qsave)
 dt=-tz/50._dp
 Call odeint(gD,75,0._dp,tz,0.1_dp*delta,dt,0._dp,rge75,kont)
Else 
 tz=-Log(Q/Qsave)
 dt=tz/50._dp
 Call odeint(gD,75,tz,0._dp,0.1_dp*delta,dt,0._dp,rge75,kont)
End if 
Call GToParameters75(gD,g1,g2,g3,lam5,lam1,lam4,lam3,lam2,Yu,Yd,Ye,m122,              & 
& m112,m222,vd,vu)
