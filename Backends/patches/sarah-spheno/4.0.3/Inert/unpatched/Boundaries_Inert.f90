...
Subroutine BoundaryBSM(i_run,g_SM,MA0,MA02,MFd,MFd2,MFe,MFe2,MFu,MFu2,MG0,            & 
& MG02,MH0,MH02,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDL,ZDR,ZEL,ZER,ZP,             & 
& ZUL,ZUR,ZW,ZZ,betaH,v,g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Ye,Yd,Yu,mHd2,mHu2,            & 
& delta0,gMZ,kont)
...
Complex(dp) :: cplG0hhVZ,cplG0HpcVWp(2),cplG0G0cVWpVWp,cplG0G0VZVZ,cplhhHpcVWp(2),cplhhcVWpVWp,      & 
...
Complex(dp) :: cplcUFdFdG0L(3,3),cplcUFdFdG0R(3,3),cplcUFdFdhhL(3,3),cplcUFdFdhhR(3,3),              & 
...
MFd = sqrt(MFd2) 
MFu = sqrt(MFu2) 
alphaQ = AlphaEw_T(alphaEW_MS,mudim,Abs(MVWp),Abs(MHp),Abs(MFd),Abs(MFu),Abs(MFe)) 
...
Call Pi1LoopVWp(mW2,MHp,MHp2,MA0,MA02,MFd,MFd2,MFu,MFu2,MFe,MFe2,MG0,MG02,            & 
...
CosW2SinW2=(1._dp-sinW2_Q)*sinW2_Q
If (IncludeDeltaVB) Then 
Call DeltaVB(sinW2,sinW2_Q,rho,MFe,MG0,Mhh,MHp,Ye,ZEL,ZER,ZP,delta)
...
Call SetMatchingConditions(g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,vSM,v,g1,g2,g3,              & 
& Lam5,Lam1,Lam4,Lam3,Lam2,Ye,Yd,Yu,mHd2,mHu2,.True.)
...
! Full one-loop corrections
Call CouplingsForSMfermions(Yd,ZDL,ZDR,g3,g1,g2,TW,Yu,ZP,ZUL,ZUR,Ye,ZEL,              & 
& ZER,cplcUFdFdG0L,cplcUFdFdG0R,cplcUFdFdhhL,cplcUFdFdhhR,cplcUFdFdVGL,cplcUFdFdVGR,     & 
...
Call Sigma1LoopFeMZ(p2,MG0,MG02,MFe,MFe2,Mhh,Mhh2,MVZ,MVZ2,MHp,MHp2,MVWp,             & 
...
Call Sigma1LoopFdMZ(p2,MG0,MG02,MFd,MFd2,Mhh,Mhh2,MVZ,MVZ2,MHp,MHp2,MFu,              & 
& MFu2,MVWp,MVWp2,cplcUFdFdG0L,cplcUFdFdG0R,cplcUFdFdhhL,cplcUFdFdhhR,cplcUFdFdVGL,      & 
...
Call Sigma1LoopFuMZ(p2,MHp,MHp2,MFd,MFd2,MVWp,MVWp2,MG0,MG02,MFu,MFu2,Mhh,            & 
...
Call ParametersToG69(g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Ye,Yd,Yu,mHd2,mHu2,gMZ)
...
Subroutine Match_and_Run(delta0,MA0,MA02,MFd,MFd2,MFe,MFe2,MFu,MFu2,MG0,              & 
& MG02,MH0,MH02,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDL,ZDR,ZEL,ZER,ZP,             & 
...
Real(dp) :: g_SM(62) 
Real(dp) :: delta0,deltaG0, gA(69), gB(69)
Real(dp) :: gC(70),  gD(70) 
Real(dp),Intent(out) :: mGUT
Complex(dp) :: Tad1Loop(2), lambda_SM, lambda_MZ 
Real(dp) :: comp(1), tanbQ, vev2 
Complex(dp) :: cplH0HpcUHp(2,2),cplH0cUHpVWp(2),cplhhHpcUHp(2,2),cplhhcUHpVWp(2),cplH0H0UHpcUHp(2,2),& 
...
FoundResult= .False.
n_tot =1
mass_old(n_tot:n_tot+1) = MHp
n_tot = n_tot + 2 
mass_old(n_tot:n_tot+0) = MG0
n_tot = n_tot + 1 
mass_old(n_tot:n_tot+0) = Mhh
n_tot = n_tot + 1 
mass_old(n_tot:n_tot+0) = MA0
n_tot = n_tot + 1 
mass_old(n_tot:n_tot+0) = MH0
...
If (kont.Ne.0) Then 
  ...
  Call TerminateProgram 
End If 
Call BoundaryBSM(j,g_SM,MA0,MA02,MFd,MFd2,MFe,MFe2,MFu,MFu2,MG0,MG02,MH0,             & 
& MH02,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDL,ZDR,ZEL,ZER,ZP,ZUL,ZUR,              & 
& ZW,ZZ,betaH,v,g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Ye,Yd,Yu,mHd2,mHu2,delta0,gB,kont)
...
mGUT = 1._dp 
Call GToParameters69(gB,g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Ye,Yd,Yu,mHd2,mHu2)
...
Subroutine FirstGuess(MA0,MA02,MFd,MFd2,MFe,MFe2,MFu,MFu2,MG0,MG02,MH0,               & 
& MH02,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDL,ZDR,ZEL,ZER,ZP,ZUL,ZUR,              & 
...
Real(dp):: gA(69), gB(69), Scale_Save 
