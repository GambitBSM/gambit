...
complex(dp) :: tad1LmatrixA0(1,1)
complex(dp) :: tad1LmatrixH0(1,1)
...
do i1=1,1
do i2=1,1
 funcvalue= tad1LmatrixA0(i2,i1)*BB(MA02,MA02,qscale)
do gE1=1,1
coup1 = cplA0A0hh
delta2Ltadpoles(gE1)=delta2Ltadpoles(gE1)+real(0.5_dp*coup1*1._dp*funcvalue,dp)
end do
...
do i2=1,1
do i3=1,1
 funcvalue= tad1LmatrixA0(i2,i3)*CCtilde(MA02,MA02,MA02,qscale)
do gE1=1,1
do gE2=1,1
coup1 = cplA0A0hh
coup2 = cplA0A0hh
...
do i2=1,1
do i3=1,1
 funcvalue= tad1LmatrixA0(i2,i3)*CCtilde(MH02,MA02,MA02,Qscale)
do gE1=1,1
do gE2=1,1
coup1 = cplA0G0H0
coup2 = cplA0G0H0
...
do i1=1,1
do i2=1,1
 funcvalue= tad1LmatrixH0(i2,i1)*BB(MH02,MH02,qscale)
do gE1=1,1
coup1 = cplH0H0hh
delta2Ltadpoles(gE1)=delta2Ltadpoles(gE1)+real(0.5_dp*coup1*1._dp*funcvalue,dp)
end do
...
do i2=1,1
do i3=1,1
 funcvalue= tad1LmatrixH0(i2,i3)*CCtilde(MH02,MH02,MH02,qscale)
do gE1=1,1
do gE2=1,1
coup1 = cplH0H0hh
coup2 = cplH0H0hh
...
do i2=1,1
do i3=1,1
 funcvalue= tad1LmatrixH0(i2,i3)*CCtilde(MA02,MH02,MH02,Qscale)
do gE1=1,1
do gE2=1,1
coup1 = cplA0G0H0
coup2 = cplA0G0H0
