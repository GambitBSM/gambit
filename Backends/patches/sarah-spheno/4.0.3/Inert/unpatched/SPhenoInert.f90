...
Use Tadpoles_Inert 
 !Use StandardModel
Use Unitarity_Inert 
 Use Boundaries_Inert
 Use HiggsCS_Inert
Use TreeLevelMasses_Inert
Use LoopMasses_Inert
 
Use BranchingRatios_Inert
...
& Yd,Yu,mHd2,mHu2,v,Tpar,Spar,Upar,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho)
...
Call ScatteringEigenvalues(v,g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Ye,Yd,Yu,              & 
& mHd2,mHu2,deltaM,kont)

End if 
If (TrilinearUnitarity) Then 
If (.not.TreeLevelUnitarityLimits) Write(*,*) "Calculating unitarity constraints " 
Call ScatteringEigenvaluesWithTrilinears(MA0,MA02,MFd,MFd2,MFe,MFe2,MFu,              & 
& MFu2,MG0,MG02,MH0,MH02,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDL,ZDR,               & 
& ZEL,ZER,ZP,ZUL,ZUR,ZW,ZZ,betaH,v,g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Ye,Yd,              & 
& Yu,mHd2,mHu2,deltaM,kont)
