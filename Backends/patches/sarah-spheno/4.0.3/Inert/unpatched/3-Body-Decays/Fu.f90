...
Subroutine FuThreeBodyDecay(n_in,MA0,MA02,MFd,MFd2,MFe,MFe2,MFu,MFu2,MG0,             & 
...
& v,gThh,gTHp,gTVWp,gTVZ,gFuFucFdFd,gFuFdcFeFv,gFuFucFeFe,gFuFucFuFu,gFuFucFvFv,         & 
...
Call CouplingsFor_Fu_decays_3B(MFu(i_run),i_run,MA0,MA02,MFd,MFd2,MFe,MFe2,           & 
...
gFuFucFdFdi = 0._dp 
Call FuToFucFdFd(i_run,MFu,MFd,MVZ,MVWp,MHp,Mhh,cplcFdFdhhL,cplcFdFdhhR,              & 
...
gFuFdcFeFvi = 0._dp 
Call FuToFdcFeFv(i_run,MFd,MFe,MVWp,MHp,MFu,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,  & 
...
& gTVWptemp,gTHptemp,deltaM,epsI,check,gFuFdcFeFvi)
...
Subroutine FuToFucFdFd(iIN,MFu,MFd,MVZ,MVWp,MHp,Mhh,cplcFdFdhhL,cplcFdFdhhR,          & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,         & 
& cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuhhL,cplcFuFuhhR,             & 
& cplcFuFuVZL,cplcFuFuVZR,IntegralSs,IntegralSSss,IntegralSSst,IntegralVs,               & 
& IntegralVSss,IntegralVSst,IntegralVVss,IntegralVVst,NSs,NSSss,NSSst,NVs,               & 
...
Real(dp),Intent(in) :: MFu(3),MFd(3),MVZ,MVWp,MHp(2),Mhh
...
coup(2) = Conjg(cplcFuFdHpL(iIN,gt3,i1)) 
coup(1) = Conjg(cplcFuFdHpR(iIN,gt3,i1)) 
coup(4) = Conjg(cplcFdFucHpL(gt2,gt1,i1)) 
coup(3) = Conjg(cplcFdFucHpR(gt2,gt1,i1))
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: Hp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
gSum(gt1,gt2,gt3,Isum)=resD
End If 
Contribution(gt1,gt2,gt3,Isum)='Hp'
      End Do 
...
coup2(1) = cplcFuFuVZL(iIN,gt1) 
coup2(2) = cplcFuFuVZR(iIN,gt1) 
coup2(4) = cplcFuFdHpL(iIN,gt3,i2) 
coup2(3) = cplcFuFdHpR(iIN,gt3,i2)  
coup2(5) = cplcFdFdVZL(gt2,gt3) 
coup2(6) = cplcFdFdVZR(gt2,gt3) 
coup2(8) = cplcFdFucHpL(gt2,gt1,i2) 
coup2(7) = cplcFdFucHpR(gt2,gt1,i2) 
coupT = coup2(7) 
coup2(7) = coup2(8) 
coup2(8) = coupT 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: VZ,Hp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='VZ,Hp'
      End Do 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: VWp,Hp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='VWp,Hp'
      End Do 
...
coup2(1) = cplcFuFdHpL(iIN,gt3,i1) 
coup2(2) = cplcFuFdHpR(iIN,gt3,i1) 
coup2(4) = cplcFuFdHpL(iIN,gt3,i2) 
coup2(3) = cplcFuFdHpR(iIN,gt3,i2)  
coup2(5) = cplcFdFucHpL(gt2,gt1,i1) 
coup2(6) = cplcFdFucHpR(gt2,gt1,i1) 
coup2(8) = cplcFdFucHpL(gt2,gt1,i2) 
coup2(7) = cplcFdFucHpR(gt2,gt1,i2) 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: Hp,Hp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='Hp,Hp'
        End Do 
      End Do 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: Hp,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='Hp,hh'
        End Do 
...
Subroutine FuToFdcFeFv(iIN,MFd,MFe,MVWp,MHp,MFu,cplcFeFvcHpL,cplcFeFvcHpR,            & 
...
Real(dp),Intent(in) :: MFd(3),MFe(3),MVWp,MHp(2),MFu(3)
...
coup(2) = Conjg(cplcFuFdHpL(iIN,gt1,i1)) 
coup(1) = Conjg(cplcFuFdHpR(iIN,gt1,i1)) 
coup(4) = Conjg(cplcFeFvcHpL(gt2,gt3,i1)) 
coup(3) = Conjg(cplcFeFvcHpR(gt2,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd cFe Fv Propagator: Hp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplcFuFdVWpL(iIN,gt1) 
coup2(2) = cplcFuFdVWpR(iIN,gt1) 
coup2(4) = cplcFuFdHpL(iIN,gt1,i2) 
coup2(3) = cplcFuFdHpR(iIN,gt1,i2)  
coup2(5) = cplcFeFvcVWpL(gt2,gt3) 
coup2(6) = cplcFeFvcVWpR(gt2,gt3) 
coup2(8) = cplcFeFvcHpL(gt2,gt3,i2) 
coup2(7) = cplcFeFvcHpR(gt2,gt3,i2) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd cFe Fv Propagator: VWp,Hp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplcFuFdHpL(iIN,gt1,i1) 
coup2(2) = cplcFuFdHpR(iIN,gt1,i1) 
coup2(4) = cplcFuFdHpL(iIN,gt1,i2) 
coup2(3) = cplcFuFdHpR(iIN,gt1,i2)  
coup2(5) = cplcFeFvcHpL(gt2,gt3,i1) 
coup2(6) = cplcFeFvcHpR(gt2,gt3,i1) 
coup2(8) = cplcFeFvcHpL(gt2,gt3,i2) 
coup2(7) = cplcFeFvcHpR(gt2,gt3,i2) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd cFe Fv Propagator: Hp,Hp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
