...
Module Fd3Decays_Inert 
 
Use Control 
Use Settings 
Use CouplingsForDecays_Inert 
Use ThreeBodyPhaseSpace 
 
Contains 
 
Subroutine FdThreeBodyDecay(n_in,MA0,MA02,MFd,MFd2,MFe,MFe2,MFu,MFu2,MG0,             & 
...
& v,gThh,gTHp,gTVWp,gTVZ,gFdFdcFdFd,gFdFdcFeFe,gFdFdcFuFu,gFdFdcFvFv,gFdFucFvFe,         & 
...
Call CouplingsFor_Fd_decays_3B(MFd(i_run),i_run,MA0,MA02,MFd,MFd2,MFe,MFe2,           & 
...
& Yd,Yu,mHd2,mHu2,v,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucHpL,        & 
& cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,          & 
& cplcFeFeVZR,cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuhhL,             & 
...
gFdFdcFuFui = 0._dp 
Call FdToFdcFuFu(i_run,MFd,MFu,MVZ,MVWp,MHp,Mhh,cplcFdFdhhL,cplcFdFdhhR,              & 
...
& cplcFuFuVZL,cplcFuFuVZR,IntegralSs,IntegralSSss,IntegralSSst,IntegralVs,               & 
& IntegralVSss,IntegralVSst,IntegralVVss,IntegralVVst,NSs,NSSss,NSSst,NVs,               & 
& NVSss,NVSst,NVVss,NVVst,gTVZtemp,gTVWptemp,gTHptemp,gThhtemp,deltaM,epsI,              & 
& check,gFdFdcFuFui)
...
gFdFucFvFei = 0._dp 
Call FdToFucFvFe(i_run,MFu,MFe,MVWp,MHp,MFd,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,  & 
& cplcFdFucVWpR,cplcFvFeHpL,cplcFvFeHpR,cplcFvFeVWpL,cplcFvFeVWpR,IntegralSs,            & 
& IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,NVSss,NVVss,           & 
& gTVWptemp,gTHptemp,deltaM,epsI,check,gFdFucFvFei)
...
Subroutine FdToFdcFuFu(iIN,MFd,MFu,MVZ,MVWp,MHp,Mhh,cplcFdFdhhL,cplcFdFdhhR,          & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,         & 
& cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuhhL,cplcFuFuhhR,             & 
& cplcFuFuVZL,cplcFuFuVZR,IntegralSs,IntegralSSss,IntegralSSst,IntegralVs,               & 
& IntegralVSss,IntegralVSst,IntegralVVss,IntegralVVst,NSs,NSSss,NSSst,NVs,               & 
& NVSss,NVSst,NVVss,NVVst,gTVZ,gTVWp,gTHp,gThh,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFd(3),MFu(3),MVZ,MVWp,MHp(2),Mhh

Complex(dp),Intent(in) :: cplcFdFdhhL(3,3),cplcFdFdhhR(3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFdFucHpL(3,3,2),& 
& cplcFdFucHpR(3,3,2),cplcFdFucVWpL(3,3),cplcFdFucVWpR(3,3),cplcFuFdHpL(3,3,2),          & 
& cplcFuFdHpR(3,3,2),cplcFuFdVWpL(3,3),cplcFuFdVWpR(3,3),cplcFuFuhhL(3,3),               & 
...
Real(dp),Intent(inout) :: gTVZ,gTVWp,gTHp(2),gThh
...
coup(2) = Conjg(cplcFdFucHpL(iIN,gt3,i1)) 
coup(1) = Conjg(cplcFdFucHpR(iIN,gt3,i1)) 
coup(4) = Conjg(cplcFuFdHpL(gt2,gt1,i1)) 
coup(3) = Conjg(cplcFuFdHpR(gt2,gt1,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 3*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: conj[Hp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplcFdFdVZL(iIN,gt1) 
coup2(2) = cplcFdFdVZR(iIN,gt1) 
coup2(4) = cplcFdFucHpL(iIN,gt3,i2) 
coup2(3) = cplcFdFucHpR(iIN,gt3,i2)  
coup2(5) = cplcFuFuVZL(gt2,gt3) 
coup2(6) = cplcFuFuVZR(gt2,gt3) 
coup2(8) = cplcFuFdHpL(gt2,gt1,i2) 
coup2(7) = cplcFuFdHpR(gt2,gt1,i2) 
coupT = coup2(7) 
coup2(7) = coup2(8) 
coup2(8) = coupT 
Call IntegrateGaugeSscalarT(Boson4, mass, coup2, deltaM, epsI,IntegralVSst,NVSst, resC, check) 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: VZ,conj[Hp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: conj[VWp],conj[Hp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplcFdFucHpL(iIN,gt3,i1) 
coup2(2) = cplcFdFucHpR(iIN,gt3,i1) 
coup2(4) = cplcFdFucHpL(iIN,gt3,i2) 
coup2(3) = cplcFdFucHpR(iIN,gt3,i2)  
coup2(5) = cplcFuFdHpL(gt2,gt1,i1) 
coup2(6) = cplcFuFdHpR(gt2,gt1,i1) 
coup2(8) = cplcFuFdHpL(gt2,gt1,i2) 
coup2(7) = cplcFuFdHpR(gt2,gt1,i2) 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: conj[Hp],conj[Hp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: conj[Hp],hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='conj[Hp],hh'
        End Do 
...
Subroutine FdToFucFvFe(iIN,MFu,MFe,MVWp,MHp,MFd,cplcFdFucHpL,cplcFdFucHpR,            & 
& cplcFdFucVWpL,cplcFdFucVWpR,cplcFvFeHpL,cplcFvFeHpR,cplcFvFeVWpL,cplcFvFeVWpR,         & 
...
Real(dp),Intent(in) :: MFu(3),MFe(3),MVWp,MHp(2),MFd(3)

Complex(dp),Intent(in) :: cplcFdFucHpL(3,3,2),cplcFdFucHpR(3,3,2),cplcFdFucVWpL(3,3),cplcFdFucVWpR(3,3),        & 
& cplcFvFeHpL(3,3,2),cplcFvFeHpR(3,3,2),cplcFvFeVWpL(3,3),cplcFvFeVWpR(3,3)
...
coup(2) = Conjg(cplcFdFucHpL(iIN,gt1,i1)) 
coup(1) = Conjg(cplcFdFucHpR(iIN,gt1,i1)) 
coup(4) = Conjg(cplcFvFeHpL(gt2,gt3,i1)) 
coup(3) = Conjg(cplcFvFeHpR(gt2,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fu cFv Fe Propagator: conj[Hp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplcFdFucVWpL(iIN,gt1) 
coup2(2) = cplcFdFucVWpR(iIN,gt1) 
coup2(4) = cplcFdFucHpL(iIN,gt1,i2) 
coup2(3) = cplcFdFucHpR(iIN,gt1,i2)  
coup2(5) = cplcFvFeVWpL(gt2,gt3) 
coup2(6) = cplcFvFeVWpR(gt2,gt3) 
coup2(8) = cplcFvFeHpL(gt2,gt3,i2) 
coup2(7) = cplcFvFeHpR(gt2,gt3,i2) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fu cFv Fe Propagator: conj[VWp],conj[Hp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplcFdFucHpL(iIN,gt1,i1) 
coup2(2) = cplcFdFucHpR(iIN,gt1,i1) 
coup2(4) = cplcFdFucHpL(iIN,gt1,i2) 
coup2(3) = cplcFdFucHpR(iIN,gt1,i2)  
coup2(5) = cplcFvFeHpL(gt2,gt3,i1) 
coup2(6) = cplcFvFeHpR(gt2,gt3,i1) 
coup2(8) = cplcFvFeHpL(gt2,gt3,i2) 
coup2(7) = cplcFvFeHpR(gt2,gt3,i2) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fu cFv Fe Propagator: conj[Hp],conj[Hp]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
