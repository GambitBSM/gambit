...
! ------------------------------------------------------------------------------  
! File created at 15:31 on 18.2.2026   
! ----------------------------------------------------------------------  
 
 
Module Couplings_Inert
...
res = 0._dp 
res = res+(Lam5*v)/2._dp
res = res-1._dp/2._dp*(v*Conjg(Lam5))
res = -(0.,1.)*res 
...
res = res-1._dp/2._dp*(Lam4*v*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(Lam5*v*ZP(gt2,1)*ZP(gt3,2))
res = -(0.,1.)*res 
...
res = 0._dp 
res = res-1._dp/2._dp*(Lam4*v*ZP(gt2,2)*ZP(gt3,1))
res = res+(v*Conjg(Lam5)*ZP(gt2,2)*ZP(gt3,1))/2._dp
res = res-1._dp/2._dp*(Lam4*v*ZP(gt2,1)*ZP(gt3,2))
...
res = res-2*Lam1*v*ZP(gt2,2)*ZP(gt3,2)
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = 0._dp 
res = res-1._dp*(Lam3)
res = res-1._dp/2._dp*Lam5
res = res-1._dp/2._dp*Conjg(Lam5)
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = 0._dp 
res = res-2*Lam2*ZP(gt3,1)*ZP(gt4,1)
...
res = res-1._dp/2._dp*(Conjg(Lam5)*ZP(gt3,2)*ZP(gt4,1))
res = res+(Lam4*ZP(gt3,1)*ZP(gt4,2))/2._dp
res = res-1._dp/2._dp*(Lam5*ZP(gt3,1)*ZP(gt4,2))
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = res-1._dp/2._dp*(Lam4*ZP(gt3,1)*ZP(gt4,2))
res = res-1._dp/2._dp*(Lam5*ZP(gt3,1)*ZP(gt4,2))
res = -(0.,1.)*res 
...
res = res-2*Lam1*ZP(gt3,2)*ZP(gt4,2)
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = 0._dp 
res = res-1._dp/2._dp*(Lam4*ZP(gt3,2)*ZP(gt4,1))
res = res+(Conjg(Lam5)*ZP(gt3,2)*ZP(gt4,1))/2._dp
res = res-1._dp/2._dp*(Lam4*ZP(gt3,1)*ZP(gt4,2))
...
res = 0._dp 
res = res-4*Lam2*ZP(gt1,1)*ZP(gt2,1)*ZP(gt3,1)*ZP(gt4,1)
...
res = res-4*Lam1*ZP(gt1,2)*ZP(gt2,2)*ZP(gt3,2)*ZP(gt4,2)
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = 0._dp 
res = res-1._dp/2._dp*(g2*ZP(gt2,1))
res = -(0.,1.)*res 
...
res = 0._dp 
res = res-1._dp/2._dp*(g2*ZP(gt2,2))
res = -(0.,1.)*res 
...
res = res-1._dp/2._dp*(g1*Sin(TW)*ZP(gt1,1)*ZP(gt2,1))
res = res+(g2*Cos(TW)*ZP(gt1,2)*ZP(gt2,2))/2._dp
res = res-1._dp/2._dp*(g1*Sin(TW)*ZP(gt1,2)*ZP(gt2,2))
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = 0._dp 
res = res-1._dp/2._dp*(g1*g2*v*Cos(TW)*ZP(gt1,2))
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = 0._dp 
res = res-1._dp/2._dp*(g1*g2*Sin(TW)*ZP(gt2,1))
res = -(0.,1.)*res 
...
res = 0._dp 
res = res-1._dp/2._dp*(g1*g2*Cos(TW)*ZP(gt2,1))
res = -(0.,1.)*res 
...
res = 0._dp 
res = res-1._dp/2._dp*(g1*g2*Sin(TW)*ZP(gt2,2))
res = -(0.,1.)*res 
...
res = 0._dp 
res = res-1._dp/2._dp*(g1*g2*Cos(TW)*ZP(gt2,2))
res = -(0.,1.)*res 
...
res = res-1._dp/4._dp*(g1**2*Sin(2._dp*(TW))*ZP(gt1,1)*ZP(gt2,1))
res = res+(g2**2*Sin(2._dp*(TW))*ZP(gt1,1)*ZP(gt2,1))/4._dp
res = res+(g1*g2*Cos(2._dp*(TW))*ZP(gt1,2)*ZP(gt2,2))/2._dp
res = res-1._dp/4._dp*(g1**2*Sin(2._dp*(TW))*ZP(gt1,2)*ZP(gt2,2))
...
res = 0._dp 
res = res-1._dp/4._dp*(g2**2*v*Cos(TW)*RXiZ*ZP(gt3,2))
res = res-1._dp/4._dp*(g1*g2*v*RXiZ*Sin(TW)*ZP(gt3,2))
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = res-1._dp/4._dp*(g1*g2*v*RXiWp*Sin(TW)*ZP(gt3,2))
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = 0._dp 
If ((2.eq.gt3)) Then 
res = res-1._dp/2._dp*(Lam4*v*ZP(gt2,1))
End If 
If ((2.eq.gt3)) Then 
res = res-1._dp/2._dp*(Lam5*v*ZP(gt2,1))
End If 
If ((1.eq.gt3)) Then 
...
res = 0._dp 
If ((2.eq.gt3)) Then 
res = res-1._dp/4._dp*(g2**2*v*Cos(TW)*RXiZ)
End If 
If ((2.eq.gt3)) Then 
res = res-1._dp/4._dp*(g1*g2*v*RXiZ*Sin(TW))
End If 
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
...
End If 
If ((2.eq.gt3)) Then 
res = res-1._dp/4._dp*(g1*g2*v*RXiWp*Sin(TW))
End If 
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
...
End If 
If ((1.eq.gt3)) Then 
res = res-1._dp/2._dp*(Lam4*v*ZP(gt2,2))
End If 
If ((1.eq.gt3)) Then 
res = res+(v*Conjg(Lam5)*ZP(gt2,2))/2._dp
End If 
...
End If 
If ((1.eq.gt2)) Then 
res = res-1._dp/2._dp*(g1*Sin(TW)*ZP(gt1,1))
End If 
If ((2.eq.gt2)) Then 
res = res+(g2*Cos(TW)*ZP(gt1,2))/2._dp
End If 
If ((2.eq.gt2)) Then 
res = res-1._dp/2._dp*(g1*Sin(TW)*ZP(gt1,2))
End If 
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
...
res = 0._dp 
If ((2.eq.gt1)) Then 
res = res-1._dp/2._dp*(g1*g2*v*Cos(TW))
End If 
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
...
res = res-4*Lam2*ZP(gt2,1)*ZP(gt4,1)
End If 
...
End If 
If ((2.eq.gt1).And.(2.eq.gt3)) Then 
res = res-4*Lam1*ZP(gt2,2)*ZP(gt4,2)
End If 
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
...
res1 = res1-1._dp/2._dp*Lam5
res1 = res1-1._dp/2._dp*Conjg(Lam5)
...
res1 = 0._dp 
res1 = res1-2*Lam2*ZP(gt3,1)*ZP(gt4,1)
...
res1 = res1-1._dp/2._dp*(Conjg(Lam5)*ZP(gt3,2)*ZP(gt4,1))
res1 = res1+(Lam4*ZP(gt3,1)*ZP(gt4,2))/2._dp
res1 = res1-1._dp/2._dp*(Lam5*ZP(gt3,1)*ZP(gt4,2))
...
res1 = res1-1._dp/2._dp*(Lam4*ZP(gt3,1)*ZP(gt4,2))
res1 = res1-1._dp/2._dp*(Lam5*ZP(gt3,1)*ZP(gt4,2))
res1 = -(0.,1.)*res1 
...
res1 = res1-2*Lam1*ZP(gt3,2)*ZP(gt4,2)
...
res1 = 0._dp 
res1 = res1-1._dp/2._dp*(Lam4*ZP(gt3,2)*ZP(gt4,1))
res1 = res1+(Conjg(Lam5)*ZP(gt3,2)*ZP(gt4,1))/2._dp
res1 = res1-1._dp/2._dp*(Lam4*ZP(gt3,1)*ZP(gt4,2))
...
res1 = 0._dp 
res1 = res1-4*Lam2*ZP(gt1,1)*ZP(gt2,1)*ZP(gt3,1)*ZP(gt4,1)
...
res1 = res1-4*Lam1*ZP(gt1,2)*ZP(gt2,2)*ZP(gt3,2)*ZP(gt4,2)
...
res1 = 0._dp 
res1 = res1-1._dp/2._dp*(g1*g2*Sin(TW)*ZP(gt2,1))
res1 = -(0.,1.)*res1 
...
res1 = 0._dp 
res1 = res1-1._dp/2._dp*(g1*g2*Cos(TW)*ZP(gt2,1))
res1 = -(0.,1.)*res1 
...
res1 = 0._dp 
res1 = res1-1._dp/2._dp*(g1*g2*Sin(TW)*ZP(gt2,2))
res1 = -(0.,1.)*res1 
...
res1 = 0._dp 
res1 = res1-1._dp/2._dp*(g1*g2*Cos(TW)*ZP(gt2,2))
res1 = -(0.,1.)*res1 
...
res1 = res1-1._dp/4._dp*(g1**2*Sin(2._dp*(TW))*ZP(gt1,1)*ZP(gt2,1))
res1 = res1+(g2**2*Sin(2._dp*(TW))*ZP(gt1,1)*ZP(gt2,1))/4._dp
res1 = res1+(g1*g2*Cos(2._dp*(TW))*ZP(gt1,2)*ZP(gt2,2))/2._dp
res1 = res1-1._dp/4._dp*(g1**2*Sin(2._dp*(TW))*ZP(gt1,2)*ZP(gt2,2))
...
Subroutine CouplingsColourStructures(Lam5,v,Lam3,Lam4,ZP,Lam1,Lam2,cplA0A0G0,         & 
...
Complex(dp), Intent(in) :: Lam5,Lam3,Lam4,Lam1,Lam2
...
cplA0A0G0 = 0._dp 
Call CouplingA0A0G0CS(Lam5,v,cplA0A0G0)



cplA0A0hh = 0._dp 
Call CouplingA0A0hhCS(Lam5,Lam3,v,cplA0A0hh)



cplA0G0H0 = 0._dp 
Call CouplingA0G0H0CS(Lam5,v,cplA0G0H0)



cplA0H0hh = 0._dp 
Call CouplingA0H0hhCS(Lam5,v,cplA0H0hh)
...
Do gt2 = 1, 2
 Do gt3 = 1, 2
Call CouplingA0HpcHpCS(gt2,gt3,Lam5,Lam4,v,ZP,cplA0HpcHp(gt2,gt3))
...
cplG0G0hh = 0._dp 
Call CouplingG0G0hhCS(Lam1,v,cplG0G0hh)



cplG0H0H0 = 0._dp 
Call CouplingG0H0H0CS(Lam5,v,cplG0H0H0)



cplH0H0hh = 0._dp 
Call CouplingH0H0hhCS(Lam5,Lam3,v,cplH0H0hh)
...
Do gt2 = 1, 2
 Do gt3 = 1, 2
Call CouplingH0HpcHpCS(gt2,gt3,Lam5,Lam4,v,ZP,cplH0HpcHp(gt2,gt3))
...
cplhhhhhh = 0._dp 
Call CouplinghhhhhhCS(Lam1,v,cplhhhhhh)
...
Do gt2 = 1, 2
 Do gt3 = 1, 2
Call CouplinghhHpcHpCS(gt2,gt3,Lam1,Lam4,Lam3,v,ZP,cplhhHpcHp(gt2,gt3))
...
cplA0A0A0A0 = 0._dp 
Call CouplingA0A0A0A0CS(Lam2,cplA0A0A0A0)



cplA0A0G0G0 = 0._dp 
Call CouplingA0A0G0G0CS(Lam5,Lam3,cplA0A0G0G0)



cplA0A0G0hh = 0._dp 
Call CouplingA0A0G0hhCS(Lam5,cplA0A0G0hh)



cplA0A0H0H0 = 0._dp 
Call CouplingA0A0H0H0CS(Lam2,cplA0A0H0H0)



cplA0A0hhhh = 0._dp 
Call CouplingA0A0hhhhCS(Lam5,Lam3,cplA0A0hhhh)
...
Do gt3 = 1, 2
 Do gt4 = 1, 2
Call CouplingA0A0HpcHpCS(gt3,gt4,Lam4,Lam3,Lam2,ZP,cplA0A0HpcHp(gt3,gt4))
...
cplA0G0G0H0 = 0._dp 
Call CouplingA0G0G0H0CS(Lam5,cplA0G0G0H0)



cplA0G0H0hh = 0._dp 
Call CouplingA0G0H0hhCS(Lam5,cplA0G0H0hh)
...
Do gt3 = 1, 2
 Do gt4 = 1, 2
Call CouplingA0G0HpcHpCS(gt3,gt4,Lam5,Lam4,ZP,cplA0G0HpcHp(gt3,gt4))
...
cplA0H0hhhh = 0._dp 
Call CouplingA0H0hhhhCS(Lam5,cplA0H0hhhh)
...
Do gt3 = 1, 2
 Do gt4 = 1, 2
Call CouplingA0hhHpcHpCS(gt3,gt4,Lam5,Lam4,ZP,cplA0hhHpcHp(gt3,gt4))
...
cplG0G0G0G0 = 0._dp 
Call CouplingG0G0G0G0CS(Lam1,cplG0G0G0G0)



cplG0G0H0H0 = 0._dp 
Call CouplingG0G0H0H0CS(Lam5,Lam3,cplG0G0H0H0)



cplG0G0hhhh = 0._dp 
Call CouplingG0G0hhhhCS(Lam1,cplG0G0hhhh)
...
Do gt3 = 1, 2
 Do gt4 = 1, 2
Call CouplingG0G0HpcHpCS(gt3,gt4,Lam1,Lam4,Lam3,ZP,cplG0G0HpcHp(gt3,gt4))
...
cplG0H0H0hh = 0._dp 
Call CouplingG0H0H0hhCS(Lam5,cplG0H0H0hh)
...
Do gt3 = 1, 2
 Do gt4 = 1, 2
Call CouplingG0H0HpcHpCS(gt3,gt4,Lam5,Lam4,ZP,cplG0H0HpcHp(gt3,gt4))
...
cplH0H0H0H0 = 0._dp 
Call CouplingH0H0H0H0CS(Lam2,cplH0H0H0H0)



cplH0H0hhhh = 0._dp 
Call CouplingH0H0hhhhCS(Lam5,Lam3,cplH0H0hhhh)
...
Do gt3 = 1, 2
 Do gt4 = 1, 2
Call CouplingH0H0HpcHpCS(gt3,gt4,Lam4,Lam3,Lam2,ZP,cplH0H0HpcHp(gt3,gt4))
...
Do gt3 = 1, 2
 Do gt4 = 1, 2
Call CouplingH0hhHpcHpCS(gt3,gt4,Lam5,Lam4,ZP,cplH0hhHpcHp(gt3,gt4))
...
cplhhhhhhhh = 0._dp 
Call CouplinghhhhhhhhCS(Lam1,cplhhhhhhhh)
...
Do gt3 = 1, 2
 Do gt4 = 1, 2
Call CouplinghhhhHpcHpCS(gt3,gt4,Lam1,Lam4,Lam3,ZP,cplhhhhHpcHp(gt3,gt4))
...
Do gt1 = 1, 2
 Do gt2 = 1, 2
  Do gt3 = 1, 2
   Do gt4 = 1, 2
Call CouplingHpHpcHpcHpCS(gt1,gt2,gt3,gt4,Lam5,Lam1,Lam3,Lam2,ZP,cplHpHpcHpcHp(gt1,gt2,gt3,gt4))
...
Subroutine CouplingA0A0G0CS(Lam5,v,res1)
...
res1 = 0._dp 
res1 = res1-1._dp/2._dp*(Lam5*v)
res1 = res1+(v*Conjg(Lam5))/2._dp
res1 = -(0.,1.)*res1 
...
End Subroutine CouplingA0A0G0CS  
 
 
Subroutine CouplingA0A0hhCS(Lam5,Lam3,v,res1)
...
End Subroutine CouplingA0A0hhCS  
 
 
Subroutine CouplingA0G0H0CS(Lam5,v,res1)
...
End Subroutine CouplingA0G0H0CS  
 
 
Subroutine CouplingA0H0hhCS(Lam5,v,res1)
...
res1 = 0._dp 
res1 = res1+(Lam5*v)/2._dp
res1 = res1-1._dp/2._dp*(v*Conjg(Lam5))
res1 = -(0.,1.)*res1 
...
End Subroutine CouplingA0H0hhCS  
 
 
Subroutine CouplingA0HpcHpCS(gt2,gt3,Lam5,Lam4,v,ZP,res1)
...
res1 = 0._dp 
res1 = res1+(Lam4*v*ZP(gt2,2)*ZP(gt3,1))/2._dp
res1 = res1+(v*Conjg(Lam5)*ZP(gt2,2)*ZP(gt3,1))/2._dp
res1 = res1-1._dp/2._dp*(Lam4*v*ZP(gt2,1)*ZP(gt3,2))
res1 = res1-1._dp/2._dp*(Lam5*v*ZP(gt2,1)*ZP(gt3,2))
res1 = -(0.,1.)*res1 
...
End Subroutine CouplingA0HpcHpCS  
 
 
Subroutine CouplingG0G0hhCS(Lam1,v,res1)
...
End Subroutine CouplingG0G0hhCS  
 
 
Subroutine CouplingG0H0H0CS(Lam5,v,res1)
...
End Subroutine CouplingG0H0H0CS  
 
 
Subroutine CouplingH0H0hhCS(Lam5,Lam3,v,res1)
...
End Subroutine CouplingH0H0hhCS  
 
 
Subroutine CouplingH0HpcHpCS(gt2,gt3,Lam5,Lam4,v,ZP,res1)
...
res1 = 0._dp 
res1 = res1-1._dp/2._dp*(Lam4*v*ZP(gt2,2)*ZP(gt3,1))
res1 = res1+(v*Conjg(Lam5)*ZP(gt2,2)*ZP(gt3,1))/2._dp
res1 = res1-1._dp/2._dp*(Lam4*v*ZP(gt2,1)*ZP(gt3,2))
res1 = res1+(Lam5*v*ZP(gt2,1)*ZP(gt3,2))/2._dp
...
End Subroutine CouplingH0HpcHpCS  
 
 
Subroutine CouplinghhhhhhCS(Lam1,v,res1)
...
Subroutine CouplinghhHpcHpCS(gt2,gt3,Lam1,Lam4,Lam3,v,ZP,res1)
...
res1 = 0._dp 
res1 = res1-(Lam3*v*ZP(gt2,1)*ZP(gt3,1))
res1 = res1-(Lam4*v*ZP(gt2,1)*ZP(gt3,1))
res1 = res1-2*Lam1*v*ZP(gt2,2)*ZP(gt3,2)
...
Subroutine CouplingA0A0A0A0CS(Lam2,res1)
...
End Subroutine CouplingA0A0A0A0CS  
 
 
Subroutine CouplingA0A0G0G0CS(Lam5,Lam3,res1)
...
End Subroutine CouplingA0A0G0G0CS  
 
 
Subroutine CouplingA0A0G0hhCS(Lam5,res1)
...
End Subroutine CouplingA0A0G0hhCS  
 
 
Subroutine CouplingA0A0H0H0CS(Lam2,res1)
...
End Subroutine CouplingA0A0H0H0CS  
 
 
Subroutine CouplingA0A0hhhhCS(Lam5,Lam3,res1)
...
End Subroutine CouplingA0A0hhhhCS  
 
 
Subroutine CouplingA0A0HpcHpCS(gt3,gt4,Lam4,Lam3,Lam2,ZP,res1)
...
End Subroutine CouplingA0A0HpcHpCS  
 
 
Subroutine CouplingA0G0G0H0CS(Lam5,res1)
...
End Subroutine CouplingA0G0G0H0CS  
 
 
Subroutine CouplingA0G0H0hhCS(Lam5,res1)
...
End Subroutine CouplingA0G0H0hhCS  
 
 
Subroutine CouplingA0G0HpcHpCS(gt3,gt4,Lam5,Lam4,ZP,res1)
...
End Subroutine CouplingA0G0HpcHpCS  
 
 
Subroutine CouplingA0H0hhhhCS(Lam5,res1)
...
End Subroutine CouplingA0H0hhhhCS  
 
 
Subroutine CouplingA0hhHpcHpCS(gt3,gt4,Lam5,Lam4,ZP,res1)
...
End Subroutine CouplingA0hhHpcHpCS  
 
 
Subroutine CouplingG0G0G0G0CS(Lam1,res1)
...
End Subroutine CouplingG0G0G0G0CS  
 
 
Subroutine CouplingG0G0H0H0CS(Lam5,Lam3,res1)
...
End Subroutine CouplingG0G0H0H0CS  
 
 
Subroutine CouplingG0G0hhhhCS(Lam1,res1)
...
End Subroutine CouplingG0G0hhhhCS  
 
 
Subroutine CouplingG0G0HpcHpCS(gt3,gt4,Lam1,Lam4,Lam3,ZP,res1)
...
End Subroutine CouplingG0G0HpcHpCS  
 
 
Subroutine CouplingG0H0H0hhCS(Lam5,res1)
...
End Subroutine CouplingG0H0H0hhCS  
 
 
Subroutine CouplingG0H0HpcHpCS(gt3,gt4,Lam5,Lam4,ZP,res1)
...
End Subroutine CouplingG0H0HpcHpCS  
 
 
Subroutine CouplingH0H0H0H0CS(Lam2,res1)
...
End Subroutine CouplingH0H0H0H0CS  
 
 
Subroutine CouplingH0H0hhhhCS(Lam5,Lam3,res1)
...
End Subroutine CouplingH0H0hhhhCS  
 
 
Subroutine CouplingH0H0HpcHpCS(gt3,gt4,Lam4,Lam3,Lam2,ZP,res1)
...
End Subroutine CouplingH0H0HpcHpCS  
 
 
Subroutine CouplingH0hhHpcHpCS(gt3,gt4,Lam5,Lam4,ZP,res1)
...
End Subroutine CouplingH0hhHpcHpCS  
 
 
Subroutine CouplinghhhhhhhhCS(Lam1,res1)
...
Subroutine CouplinghhhhHpcHpCS(gt3,gt4,Lam1,Lam4,Lam3,ZP,res1)
...
Subroutine CouplingHpHpcHpcHpCS(gt1,gt2,gt3,gt4,Lam5,Lam1,Lam3,Lam2,ZP,res1)
