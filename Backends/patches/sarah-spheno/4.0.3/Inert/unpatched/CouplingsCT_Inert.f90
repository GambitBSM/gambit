...
res = 0._dp 
res = res-1._dp/2._dp*(dv*Lam5)
res = res-1._dp/2._dp*(dLam5*v)
...
res = res+(dv*Lam5)/2._dp
res = res+(dLam5*v)/2._dp
res = res-1._dp/2._dp*(v*Conjg(dLam5))
res = res-1._dp/2._dp*(dv*Conjg(Lam5))
res = -(0.,1.)*res 
...
res = 0._dp 
res = res-1._dp/2._dp*(Lam4*v*dZP(gt3,2)*ZP(gt2,1))
res = res-1._dp/2._dp*(Lam5*v*dZP(gt3,2)*ZP(gt2,1))
...
res = res-1._dp/2._dp*(Lam4*v*dZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(Lam5*v*dZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(dv*Lam4*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(dv*Lam5*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(dLam4*v*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(dLam5*v*ZP(gt2,1)*ZP(gt3,2))
res = -(0.,1.)*res 
...
res = res-1._dp/2._dp*(Lam4*v*dZP(gt3,1)*ZP(gt2,2))
res = res+(v*Conjg(Lam5)*dZP(gt3,1)*ZP(gt2,2))/2._dp
res = res-1._dp/2._dp*(Lam4*v*dZP(gt2,2)*ZP(gt3,1))
res = res+(v*Conjg(Lam5)*dZP(gt2,2)*ZP(gt3,1))/2._dp
res = res-1._dp/2._dp*(dv*Lam4*ZP(gt2,2)*ZP(gt3,1))
res = res-1._dp/2._dp*(dLam4*v*ZP(gt2,2)*ZP(gt3,1))
res = res+(v*Conjg(dLam5)*ZP(gt2,2)*ZP(gt3,1))/2._dp
res = res+(dv*Conjg(Lam5)*ZP(gt2,2)*ZP(gt3,1))/2._dp
res = res-1._dp/2._dp*(Lam4*v*dZP(gt2,1)*ZP(gt3,2))
...
res = res-2*Lam1*v*dZP(gt3,2)*ZP(gt2,2)
...
res = res-2*Lam1*v*dZP(gt2,2)*ZP(gt3,2)
res = res-2*dv*Lam1*ZP(gt2,2)*ZP(gt3,2)
res = res-2*dLam1*v*ZP(gt2,2)*ZP(gt3,2)
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = 0._dp 
res = res-1._dp/2._dp*(g2*dZP(gt2,1))
res = res-1._dp/2._dp*(dg2*ZP(gt2,1))
res = -(0.,1.)*res 
...
res = res-1._dp/2._dp*(dCosTW*g2)
res = res-1._dp/2._dp*(dg2*Cos(TW))
...
res = 0._dp 
res = res-1._dp/2._dp*(g2*dZP(gt2,2))
res = res-1._dp/2._dp*(dg2*ZP(gt2,2))
res = -(0.,1.)*res 
...
res = res-1._dp/2._dp*(g1*dZP(gt2,1)*Sin(TW)*ZP(gt1,1))
res = res+(g2*Cos(TW)*dZP(gt2,2)*ZP(gt1,2))/2._dp
res = res-1._dp/2._dp*(g1*dZP(gt2,2)*Sin(TW)*ZP(gt1,2))
res = res+(g2*Cos(TW)*dZP(gt1,1)*ZP(gt2,1))/2._dp
res = res-1._dp/2._dp*(g1*dZP(gt1,1)*Sin(TW)*ZP(gt2,1))
res = res-1._dp/2._dp*(dSinTW*g1*ZP(gt1,1)*ZP(gt2,1))
res = res+(dCosTW*g2*ZP(gt1,1)*ZP(gt2,1))/2._dp
res = res+(dg2*Cos(TW)*ZP(gt1,1)*ZP(gt2,1))/2._dp
res = res-1._dp/2._dp*(dg1*Sin(TW)*ZP(gt1,1)*ZP(gt2,1))
res = res+(g2*Cos(TW)*dZP(gt1,2)*ZP(gt2,2))/2._dp
res = res-1._dp/2._dp*(g1*dZP(gt1,2)*Sin(TW)*ZP(gt2,2))
res = res-1._dp/2._dp*(dSinTW*g1*ZP(gt1,2)*ZP(gt2,2))
res = res+(dCosTW*g2*ZP(gt1,2)*ZP(gt2,2))/2._dp
res = res+(dg2*Cos(TW)*ZP(gt1,2)*ZP(gt2,2))/2._dp
res = res-1._dp/2._dp*(dg1*Sin(TW)*ZP(gt1,2)*ZP(gt2,2))
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = 0._dp 
res = res-1._dp/2._dp*(g1*g2*v*Cos(TW)*dZP(gt1,2))
res = res-1._dp/2._dp*(dCosTW*g1*g2*v*ZP(gt1,2))
res = res-1._dp/2._dp*(dv*g1*g2*Cos(TW)*ZP(gt1,2))
res = res-1._dp/2._dp*(dg2*g1*v*Cos(TW)*ZP(gt1,2))
res = res-1._dp/2._dp*(dg1*g2*v*Cos(TW)*ZP(gt1,2))
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
