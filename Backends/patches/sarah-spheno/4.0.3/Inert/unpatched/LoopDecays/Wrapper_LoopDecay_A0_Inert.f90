...
Module Wrapper_OneLoopDecay_A0_Inert
Use Model_Data_Inert 
Use Kinematics 
Use OneLoopDecay_A0_Inert 
Use Control 
Use Settings 
...
Call Amplitude_Tree_Inert_A0TohhA0(cplA0A0hh,MA0,Mhh,MA02,Mhh2,AmpTreeA0TohhA0)

  Else 
Call Amplitude_Tree_Inert_A0TohhA0(ZcplA0A0hh,MA0,Mhh,MA02,Mhh2,AmpTreeA0TohhA0)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_A0TohhA0(MLambda,em,gs,cplA0A0hh,MA0OS,MhhOS,MRPA0TohhA0,       & 
& MRGA0TohhA0)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_A0TohhA0(MLambda,em,gs,ZcplA0A0hh,MA0OS,MhhOS,MRPA0TohhA0,      & 
& MRGA0TohhA0)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_A0TohhA0(MLambda,em,gs,cplA0A0hh,MA0,Mhh,MRPA0TohhA0,           & 
& MRGA0TohhA0)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_A0TohhA0(MLambda,em,gs,ZcplA0A0hh,MA0,Mhh,MRPA0TohhA0,          & 
& MRGA0TohhA0)
...
Call Amplitude_WAVE_Inert_A0TohhA0(cplA0A0hh,ctcplA0A0hh,MA0,MA02,Mhh,Mhh2,           & 
& ZfA0,Zfhh,AmpWaveA0TohhA0)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0TohhA0(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_A0TohhA0(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,            & 
& MG02,MH02,Mhh2,MHp2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,cplA0H0VZ,      & 
& cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplG0G0hh,cplG0hhVZ,cplH0H0hh,cplhhhhhh,            & 
& cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,cplA0A0A0A01,cplA0A0G0G01,   & 
& cplA0A0G0hh1,cplA0A0H0H01,cplA0A0hhhh1,cplA0A0HpcHp1,cplA0A0cVWpVWp1,cplA0A0VZVZ1,     & 
& cplA0G0H0hh1,cplA0H0hhhh1,cplA0hhHpcHp1,AmpVertexIRdrA0TohhA0)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_A0TohhA0(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,MVWpOS,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_A0TohhH0(cplA0H0hh,MA0,MH0,Mhh,MA02,MH02,Mhh2,              & 
& AmpTreeA0TohhH0)

  Else 
Call Amplitude_Tree_Inert_A0TohhH0(ZcplA0H0hh,MA0,MH0,Mhh,MA02,MH02,Mhh2,             & 
& AmpTreeA0TohhH0)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_A0TohhH0(MLambda,em,gs,cplA0H0hh,MA0OS,MH0OS,MhhOS,             & 
& MRPA0TohhH0,MRGA0TohhH0)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_A0TohhH0(MLambda,em,gs,ZcplA0H0hh,MA0OS,MH0OS,MhhOS,            & 
& MRPA0TohhH0,MRGA0TohhH0)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_A0TohhH0(MLambda,em,gs,cplA0H0hh,MA0,MH0,Mhh,MRPA0TohhH0,       & 
& MRGA0TohhH0)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_A0TohhH0(MLambda,em,gs,ZcplA0H0hh,MA0,MH0,Mhh,MRPA0TohhH0,      & 
& MRGA0TohhH0)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_A0TohhH0(cplA0H0hh,ctcplA0H0hh,MA0,MA02,MH0,MH02,           & 
& Mhh,Mhh2,ZfA0,ZfH0,Zfhh,AmpWaveA0TohhH0)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0TohhH0(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,               & 
& MG02,MH02,Mhh2,MHp2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,cplA0H0VZ,      & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_A0TohhH0(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,            & 
& MG02,MH02,Mhh2,MHp2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,cplA0H0VZ,      & 
& cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplG0G0hh,cplG0H0H0,cplG0hhVZ,cplH0H0hh,            & 
& cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,       & 
& cplhhcVWpVWp,cplA0A0G0hh1,cplA0A0H0H01,cplA0A0hhhh1,cplA0G0G0H01,cplA0G0H0hh1,         & 
& cplA0H0hhhh1,cplA0hhHpcHp1,cplG0H0H0hh1,cplH0H0hhhh1,cplH0hhHpcHp1,AmpVertexIRdrA0TohhH0)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_A0TohhH0(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,MVWpOS,         & 
& MVZOS,MA02OS,MG02OS,MH02OS,Mhh2OS,MHp2OS,MVWp2OS,MVZ2OS,cplA0A0G0,cplA0A0hh,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_A0ToH0VZ(cplA0H0VZ,MA0,MH0,MVZ,MA02,MH02,MVZ2,              & 
& AmpTreeA0ToH0VZ)

  Else 
Call Amplitude_Tree_Inert_A0ToH0VZ(ZcplA0H0VZ,MA0,MH0,MVZ,MA02,MH02,MVZ2,             & 
& AmpTreeA0ToH0VZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_A0ToH0VZ(MLambda,em,gs,cplA0H0VZ,MA0OS,MH0OS,MVZOS,             & 
& MRPA0ToH0VZ,MRGA0ToH0VZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_A0ToH0VZ(MLambda,em,gs,ZcplA0H0VZ,MA0OS,MH0OS,MVZOS,            & 
& MRPA0ToH0VZ,MRGA0ToH0VZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_A0ToH0VZ(MLambda,em,gs,cplA0H0VZ,MA0,MH0,MVZ,MRPA0ToH0VZ,       & 
& MRGA0ToH0VZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_A0ToH0VZ(MLambda,em,gs,ZcplA0H0VZ,MA0,MH0,MVZ,MRPA0ToH0VZ,      & 
& MRGA0ToH0VZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_A0ToH0VZ(cplA0H0VZ,ctcplA0H0VZ,MA0,MA02,MH0,MH02,           & 
& MVZ,MVZ2,ZfA0,ZfH0,ZfVZ,AmpWaveA0ToH0VZ)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0ToH0VZ(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,               & 
& MG02,MH02,Mhh2,MHp2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,cplA0H0VZ,      & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_A0ToH0VZ(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,            & 
& MG02,MH02,Mhh2,MHp2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,cplA0H0VZ,      & 
& cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplG0H0H0,cplG0hhVZ,cplH0H0hh,cplH0HpcHp,           & 
& cplH0HpcVWp,cplH0cHpVWp,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVWpVZ,cplcVWpVWpVZ,     & 
& cplA0A0VZVZ1,cplA0HpcVWpVZ1,cplA0cHpVWpVZ1,cplH0H0VZVZ1,cplH0HpcVWpVZ1,cplH0cHpVWpVZ1, & 
& AmpVertexIRdrA0ToH0VZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_A0ToH0VZ(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,MVWpOS,         & 
& MVZOS,MA02OS,MG02OS,MH02OS,Mhh2OS,MHp2OS,MVWp2OS,MVZ2OS,cplA0A0G0,cplA0A0hh,           & 
...
& cplH0H0VZVZ1,cplH0HpcVWpVZ1,cplH0cHpVWpVZ1,AmpVertexIRosA0ToH0VZ)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_A0TocHpHp(cplA0HpcHp,MA0,MHp,MA02,MHp2,AmpTreeA0TocHpHp)

  Else 
Call Amplitude_Tree_Inert_A0TocHpHp(ZcplA0HpcHp,MA0,MHp,MA02,MHp2,AmpTreeA0TocHpHp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_A0TocHpHp(MLambda,em,gs,cplA0HpcHp,MA0OS,MHpOS,MRPA0TocHpHp,    & 
& MRGA0TocHpHp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_A0TocHpHp(MLambda,em,gs,ZcplA0HpcHp,MA0OS,MHpOS,MRPA0TocHpHp,   & 
& MRGA0TocHpHp)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_A0TocHpHp(MLambda,em,gs,cplA0HpcHp,MA0,MHp,MRPA0TocHpHp,        & 
& MRGA0TocHpHp)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_A0TocHpHp(MLambda,em,gs,ZcplA0HpcHp,MA0,MHp,MRPA0TocHpHp,       & 
& MRGA0TocHpHp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_A0TocHpHp(cplA0HpcHp,ctcplA0HpcHp,MA0,MA02,MHp,             & 
& MHp2,ZfA0,ZfHp,AmpWaveA0TocHpHp)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0TocHpHp(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_A0TocHpHp(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,            & 
& MA02,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,      & 
& cplA0H0VZ,cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplG0HpcVWp,cplG0cHpVWp,cplH0HpcHp,       & 
& cplH0HpcVWp,cplH0cHpVWp,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplHpcHpVP,cplHpcVWpVP,     & 
& cplHpcHpVZ,cplHpcVWpVZ,cplcHpVPVWp,cplcHpVWpVZ,cplA0A0HpcHp1,cplA0G0HpcHp1,            & 
& cplA0hhHpcHp1,cplA0HpcVWpVP1,cplA0HpcVWpVZ1,cplA0cHpVPVWp1,cplA0cHpVWpVZ1,             & 
& cplG0H0HpcHp1,cplH0hhHpcHp1,cplHpHpcHpcHp1,AmpVertexIRdrA0TocHpHp)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_A0TocHpHp(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,               & 
...
& cplHpcHpVZ,cplHpcVWpVZ,cplcHpVPVWp,cplcHpVWpVZ,cplA0A0HpcHp1,cplA0G0HpcHp1,            & 
& cplA0hhHpcHp1,cplA0HpcVWpVP1,cplA0HpcVWpVZ1,cplA0cHpVPVWp1,cplA0cHpVWpVZ1,             & 
& cplG0H0HpcHp1,cplH0hhHpcHp1,cplHpHpcHpcHp1,AmpVertexIRosA0TocHpHp)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_A0ToHpcVWp(cplA0HpcVWp,MA0,MHp,MVWp,MA02,MHp2,              & 
& MVWp2,AmpTreeA0ToHpcVWp)

  Else 
Call Amplitude_Tree_Inert_A0ToHpcVWp(ZcplA0HpcVWp,MA0,MHp,MVWp,MA02,MHp2,             & 
& MVWp2,AmpTreeA0ToHpcVWp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_A0ToHpcVWp(MLambda,em,gs,cplA0HpcVWp,MA0OS,MHpOS,               & 
& MVWpOS,MRPA0ToHpcVWp,MRGA0ToHpcVWp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_A0ToHpcVWp(MLambda,em,gs,ZcplA0HpcVWp,MA0OS,MHpOS,              & 
& MVWpOS,MRPA0ToHpcVWp,MRGA0ToHpcVWp)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_A0ToHpcVWp(MLambda,em,gs,cplA0HpcVWp,MA0,MHp,MVWp,              & 
& MRPA0ToHpcVWp,MRGA0ToHpcVWp)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_A0ToHpcVWp(MLambda,em,gs,ZcplA0HpcVWp,MA0,MHp,MVWp,             & 
& MRPA0ToHpcVWp,MRGA0ToHpcVWp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_A0ToHpcVWp(cplA0HpcVWp,ctcplA0HpcVWp,MA0,MA02,              & 
& MHp,MHp2,MVWp,MVWp2,ZfA0,ZfHp,ZfVWp,AmpWaveA0ToHpcVWp)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0ToHpcVWp(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,              & 
& MA02,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,      & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_A0ToHpcVWp(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,               & 
...
& cplH0HpcVWpVZ1,cplHpcHpcVWpVWp1,AmpVertexIRdrA0ToHpcVWp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_A0ToHpcVWp(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,              & 
& MVP,MVWpOS,MVZOS,MA02OS,MG02OS,MH02OS,Mhh2OS,MHp2OS,MVP2,MVWp2OS,MVZ2OS,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_A0ToA0A0(MA0OS,MHpOS,MVWpOS,MA02OS,MHp2OS,MVWp2OS,        & 
& cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplA0A0HpcHp1,AmpVertexA0ToA0A0)
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0ToA0A0(MA0,MHp,MVWp,MA02,MHp2,MVWp2,cplA0HpcHp,         & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_A0ToA0H0(MA0OS,MH0OS,MHpOS,MVWpOS,MA02OS,MH02OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0ToA0H0(MA0,MH0,MHp,MVWp,MA02,MH02,MHp2,MVWp2,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_A0ToA0VP(MA0OS,MHpOS,MVP,MVWpOS,MA02OS,MHp2OS,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0ToA0VP(MA0,MHp,MVP,MVWp,MA02,MHp2,MVP2,MVWp2,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_A0ToA0VZ(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,MVWpOS,            & 
& MVZOS,MA02OS,MG02OS,MH02OS,Mhh2OS,MHp2OS,MVWp2OS,MVZ2OS,cplA0A0G0,cplA0A0hh,           & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0ToA0VZ(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,               & 
& MG02,MH02,Mhh2,MHp2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,cplA0H0VZ,      & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_A0ToFdcFd(MA0OS,MFdOS,MFuOS,MHpOS,MVWpOS,MA02OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0ToFdcFd(MA0,MFd,MFu,MHp,MVWp,MA02,MFd2,MFu2,            & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_A0ToFecFe(MA0OS,MFeOS,MHpOS,MVWpOS,MA02OS,MFe2OS,         & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0ToFecFe(MA0,MFe,MHp,MVWp,MA02,MFe2,MHp2,MVWp2,          & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_A0ToFucFu(MA0OS,MFdOS,MFuOS,MHpOS,MVWpOS,MA02OS,          & 
& MFd2OS,MFu2OS,MHp2OS,MVWp2OS,cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplcFuFdHpL,           & 
& cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,         & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0ToFucFu(MA0,MFd,MFu,MHp,MVWp,MA02,MFd2,MFu2,            & 
& MHp2,MVWp2,cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,    & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_A0ToFvcFv(MA0OS,MFeOS,MHpOS,MVWpOS,MA02OS,MFe2OS,         & 
& MHp2OS,MVWp2OS,cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplcFvFeHpL,cplcFvFeHpR,             & 
& cplcFvFeVWpL,cplcFvFeVWpR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,       & 
& AmpVertexA0ToFvcFv)
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0ToFvcFv(MA0,MFe,MHp,MVWp,MA02,MFe2,MHp2,MVWp2,          & 
& cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplcFvFeHpL,cplcFvFeHpR,cplcFvFeVWpL,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_A0ToH0H0(MA0OS,MH0OS,MHpOS,MVWpOS,MA02OS,MH02OS,          & 
& MHp2OS,MVWp2OS,cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplH0HpcHp,cplH0HpcVWp,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0ToH0H0(MA0,MH0,MHp,MVWp,MA02,MH02,MHp2,MVWp2,           & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_Inert_A0ToH0VP(cplA0H0VZ,ctcplA0H0VZ,MA0OS,MA02OS,MH0OS,          & 
& MH02OS,MVP,MVP2,MVZOS,MVZ2OS,ZfA0,ZfH0,ZfVP,ZfVZVP,AmpWaveA0ToH0VP)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_A0ToH0VP(MA0OS,MH0OS,MHpOS,MVP,MVWpOS,MA02OS,             & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_A0ToH0VP(cplA0H0VZ,ctcplA0H0VZ,MA0,MA02,MH0,MH02,           & 
& MVP,MVP2,MVZ,MVZ2,ZfA0,ZfH0,ZfVP,ZfVZVP,AmpWaveA0ToH0VP)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0ToH0VP(MA0,MH0,MHp,MVP,MVWp,MA02,MH02,MHp2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_A0Tohhhh(MA0OS,MhhOS,MHpOS,MVWpOS,MA02OS,Mhh2OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0Tohhhh(MA0,Mhh,MHp,MVWp,MA02,Mhh2,MHp2,MVWp2,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_A0TohhVP(MA0OS,MhhOS,MHpOS,MVP,MVWpOS,MA02OS,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0TohhVP(MA0,Mhh,MHp,MVP,MVWp,MA02,Mhh2,MHp2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_A0TohhVZ(MA0OS,MhhOS,MHpOS,MVWpOS,MVZOS,MA02OS,           & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0TohhVZ(MA0,Mhh,MHp,MVWp,MVZ,MA02,Mhh2,MHp2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_A0ToVPVP(MA0OS,MHpOS,MVP,MVWpOS,MA02OS,MHp2OS,            & 
& MVP2,MVWp2OS,cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplHpcHpVP,cplHpcVWpVP,cplcHpVPVWp,    & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0ToVPVP(MA0,MHp,MVP,MVWp,MA02,MHp2,MVP2,MVWp2,           & 
& cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplHpcHpVP,cplHpcVWpVP,cplcHpVPVWp,cplcVWpVPVWp,    & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_A0ToVPVZ(MA0OS,MHpOS,MVP,MVWpOS,MVZOS,MA02OS,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0ToVPVZ(MA0,MHp,MVP,MVWp,MVZ,MA02,MHp2,MVP2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_A0ToVWpcVWp(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,MVP,            & 
...
& cplG0HpcVWp,cplG0cHpVWp,cplH0HpcVWp,cplH0cHpVWp,cplhhHpcVWp,cplhhcHpVWp,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0ToVWpcVWp(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,             & 
& MA02,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,      & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_A0ToVZVZ(MA0OS,MHpOS,MVWpOS,MVZOS,MA02OS,MHp2OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_A0ToVZVZ(MA0,MHp,MVWp,MVZ,MA02,MHp2,MVWp2,MVZ2,           & 
& cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVWpVZ,cplcVWpVWpVZ,    & 
& cplA0HpcVWpVZ1,cplA0cHpVWpVZ1,cplHpcHpVZVZ1,AmpVertexA0ToVZVZ)
...
End Module Wrapper_OneLoopDecay_A0_Inert
