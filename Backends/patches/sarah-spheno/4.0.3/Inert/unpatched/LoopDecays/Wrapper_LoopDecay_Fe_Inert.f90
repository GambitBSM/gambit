...
Module Wrapper_OneLoopDecay_Fe_Inert
Use Model_Data_Inert 
Use Kinematics 
Use OneLoopDecay_Fe_Inert 
Use Control 
Use Settings 
...
Call Amplitude_Tree_Inert_FeToFehh(cplcFeFehhL,cplcFeFehhR,MFe,Mhh,MFe2,              & 
& Mhh2,AmpTreeFeToFehh)

  Else 
Call Amplitude_Tree_Inert_FeToFehh(ZcplcFeFehhL,ZcplcFeFehhR,MFe,Mhh,MFe2,            & 
& Mhh2,AmpTreeFeToFehh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_FeToFehh(MLambda,em,gs,cplcFeFehhL,cplcFeFehhR,MFeOS,           & 
& MhhOS,MRPFeToFehh,MRGFeToFehh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_FeToFehh(MLambda,em,gs,ZcplcFeFehhL,ZcplcFeFehhR,               & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_FeToFehh(MLambda,em,gs,cplcFeFehhL,cplcFeFehhR,MFe,             & 
...
Call Amplitude_WAVE_Inert_FeToFehh(cplcFeFehhL,cplcFeFehhR,ctcplcFeFehhL,             & 
& ctcplcFeFehhR,MFe,MFe2,Mhh,Mhh2,ZfEL,ZfER,Zfhh,AmpWaveFeToFehh)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_FeToFehh(MFe,MG0,Mhh,MHp,MVP,MVWp,MVZ,MFe2,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_FeToFehh(MFe,MG0,Mhh,MHp,MVP,MVWp,MVZ,MFe2,            & 
& MG02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplcFeFeG0L,cplcFeFeG0R,cplcFeFehhL,cplcFeFehhR,        & 
& cplcFvFeHpL,cplcFvFeHpR,cplcFeFeVPL,cplcFeFeVPR,cplcFvFeVWpL,cplcFvFeVWpR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,         & 
& cplG0G0hh,cplG0hhVZ,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,         & 
& cplhhVZVZ,AmpVertexIRdrFeToFehh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_FeToFehh(MFeOS,MG0OS,MhhOS,MHpOS,MVP,MVWpOS,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_FeToFeVZ(cplcFeFeVZL,cplcFeFeVZR,MFe,MVZ,MFe2,              & 
& MVZ2,AmpTreeFeToFeVZ)

  Else 
Call Amplitude_Tree_Inert_FeToFeVZ(ZcplcFeFeVZL,ZcplcFeFeVZR,MFe,MVZ,MFe2,            & 
& MVZ2,AmpTreeFeToFeVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_FeToFeVZ(MLambda,em,gs,cplcFeFeVZL,cplcFeFeVZR,MFeOS,           & 
& MVZOS,MRPFeToFeVZ,MRGFeToFeVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_FeToFeVZ(MLambda,em,gs,ZcplcFeFeVZL,ZcplcFeFeVZR,               & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_FeToFeVZ(MLambda,em,gs,cplcFeFeVZL,cplcFeFeVZR,MFe,             & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_FeToFeVZ(cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_FeToFeVZ(MFe,MG0,Mhh,MHp,MVP,MVWp,MVZ,MFe2,               & 
& MG02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplcFeFeG0L,cplcFeFeG0R,cplcFeFehhL,cplcFeFehhR,        & 
& cplcFvFeHpL,cplcFvFeHpR,cplcFeFeVPL,cplcFeFeVPR,cplcFvFeVWpL,cplcFvFeVWpR,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_FeToFeVZ(MFe,MG0,Mhh,MHp,MVP,MVWp,MVZ,MFe2,            & 
& MG02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplcFeFeG0L,cplcFeFeG0R,cplcFeFehhL,cplcFeFehhR,        & 
& cplcFvFeHpL,cplcFvFeHpR,cplcFeFeVPL,cplcFeFeVPR,cplcFvFeVWpL,cplcFvFeVWpR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFvFvVZL,cplcFvFvVZR,cplcFeFvcHpL,cplcFeFvcHpR,             & 
& cplcFeFvcVWpL,cplcFeFvcVWpR,cplG0hhVZ,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVWpVZ,    & 
& cplcVWpVWpVZ,AmpVertexIRdrFeToFeVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_FeToFeVZ(MFeOS,MG0OS,MhhOS,MHpOS,MVP,MVWpOS,           & 
& MVZOS,MFe2OS,MG02OS,Mhh2OS,MHp2OS,MVP2,MVWp2OS,MVZ2OS,cplcFeFeG0L,cplcFeFeG0R,         & 
& cplcFeFehhL,cplcFeFehhR,cplcFvFeHpL,cplcFvFeHpR,cplcFeFeVPL,cplcFeFeVPR,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_FeToFvcHp(cplcFeFvcHpL,cplcFeFvcHpR,MFe,MHp,MFe2,           & 
& MHp2,AmpTreeFeToFvcHp)

  Else 
Call Amplitude_Tree_Inert_FeToFvcHp(ZcplcFeFvcHpL,ZcplcFeFvcHpR,MFe,MHp,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_FeToFvcHp(MLambda,em,gs,cplcFeFvcHpL,cplcFeFvcHpR,              & 
& MFeOS,MHpOS,MRPFeToFvcHp,MRGFeToFvcHp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_FeToFvcHp(MLambda,em,gs,ZcplcFeFvcHpL,ZcplcFeFvcHpR,            & 
& MFeOS,MHpOS,MRPFeToFvcHp,MRGFeToFvcHp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_FeToFvcHp(cplcFeFvcHpL,cplcFeFvcHpR,ctcplcFeFvcHpL,         & 
& ctcplcFeFvcHpR,MFe,MFe2,MHp,MHp2,ZfEL,ZfER,ZfHp,ZfvL,AmpWaveFeToFvcHp)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_FeToFvcHp(MFe,MG0,Mhh,MHp,MVP,MVWp,MVZ,MFe2,              & 
& MG02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplcFeFeG0L,cplcFeFeG0R,cplcFeFehhL,cplcFeFehhR,        & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_FeToFvcHp(MFe,MG0,Mhh,MHp,MVP,MVWp,MVZ,MFe2,           & 
& MG02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplcFeFeG0L,cplcFeFeG0R,cplcFeFehhL,cplcFeFehhR,        & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFvVZL,cplcFvFvVZR,               & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplG0cHpVWp,cplhhHpcHp,          & 
& cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,cplcHpVPVWp,cplcHpVWpVZ,AmpVertexIRdrFeToFvcHp)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_FeToFvcHp(MFeOS,MG0OS,MhhOS,MHpOS,MVP,MVWpOS,          & 
& MVZOS,MFe2OS,MG02OS,Mhh2OS,MHp2OS,MVP2,MVWp2OS,MVZ2OS,cplcFeFeG0L,cplcFeFeG0R,         & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
...
& cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,cplcHpVPVWp,cplcHpVWpVZ,AmpVertexIRosFeToFvcHp)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_FeToFvcVWp(cplcFeFvcVWpL,cplcFeFvcVWpR,MFe,MVWp,            & 
& MFe2,MVWp2,AmpTreeFeToFvcVWp)

  Else 
Call Amplitude_Tree_Inert_FeToFvcVWp(ZcplcFeFvcVWpL,ZcplcFeFvcVWpR,MFe,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_FeToFvcVWp(MLambda,em,gs,cplcFeFvcVWpL,cplcFeFvcVWpR,           & 
& MFeOS,MVWpOS,MRPFeToFvcVWp,MRGFeToFvcVWp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_FeToFvcVWp(MLambda,em,gs,ZcplcFeFvcVWpL,ZcplcFeFvcVWpR,         & 
& MFeOS,MVWpOS,MRPFeToFvcVWp,MRGFeToFvcVWp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_FeToFvcVWp(cplcFeFvcVWpL,cplcFeFvcVWpR,ctcplcFeFvcVWpL,     & 
& ctcplcFeFvcVWpR,MFe,MFe2,MVWp,MVWp2,ZfEL,ZfER,ZfvL,ZfVWp,AmpWaveFeToFvcVWp)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_FeToFvcVWp(MFe,MG0,Mhh,MHp,MVP,MVWp,MVZ,MFe2,             & 
& MG02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplcFeFeG0L,cplcFeFeG0R,cplcFeFehhL,cplcFeFehhR,        & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFvVZL,cplcFvFvVZR,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_FeToFvcVWp(MFe,MG0,Mhh,MHp,MVP,MVWp,MVZ,               & 
...
& AmpVertexIRdrFeToFvcVWp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_FeToFvcVWp(MFeOS,MG0OS,MhhOS,MHpOS,MVP,MVWpOS,         & 
& MVZOS,MFe2OS,MG02OS,Mhh2OS,MHp2OS,MVP2,MVWp2OS,MVZ2OS,cplcFeFeG0L,cplcFeFeG0R,         & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFvFvVZL,cplcFvFvVZR,GosZcplcFeFvcHpL,GosZcplcFeFvcHpR,ZcplcFeFvcVWpL,              & 
...
& MVZOS,MFe2OS,MG02OS,Mhh2OS,MHp2OS,MVP2,MVWp2OS,MVZ2OS,cplcFeFeG0L,cplcFeFeG0R,         & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFvFvVZL,cplcFvFvVZR,GcplcFeFvcHpL,GcplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,       & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_FeToFeA0(MA0OS,MFeOS,MHpOS,MVWpOS,MA02OS,MFe2OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_FeToFeA0(MA0,MFe,MHp,MVWp,MA02,MFe2,MHp2,MVWp2,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_FeToFeH0(MFeOS,MH0OS,MHpOS,MVWpOS,MFe2OS,MH02OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_FeToFeH0(MFe,MH0,MHp,MVWp,MFe2,MH02,MHp2,MVWp2,           & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_Inert_FeToFeVP(ZcplcFeFeVPL,ZcplcFeFeVPR,ZcplcFeFeVZL,            & 
...
& MFe2OS,MVP,MVP2,ZfEL,ZfER,ZfVP,ZfVZVP,AmpWaveFeToFeVP)
 ...
 Else 
Call Amplitude_WAVE_Inert_FeToFeVP(cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_FeToFeVP(MFeOS,MG0OS,MhhOS,MHpOS,MVP,MVWpOS,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_FeToFeVP(MFe,MG0,Mhh,MHp,MVP,MVWp,MVZ,MFe2,               & 
& MG02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplcFeFeG0L,cplcFeFeG0R,cplcFeFehhL,cplcFeFehhR,        & 
& cplcFvFeHpL,cplcFvFeHpR,cplcFeFeVPL,cplcFeFeVPR,cplcFvFeVWpL,cplcFvFeVWpR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,         & 
...
End Module Wrapper_OneLoopDecay_Fe_Inert
