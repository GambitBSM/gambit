...
Module Wrapper_OneLoopDecay_Fu_Inert
Use Model_Data_Inert 
Use Kinematics 
Use OneLoopDecay_Fu_Inert 
Use Control 
Use Settings 
...
Call Amplitude_Tree_Inert_FuToFdHp(cplcFuFdHpL,cplcFuFdHpR,MFd,MFu,MHp,               & 
& MFd2,MFu2,MHp2,AmpTreeFuToFdHp)

  Else 
Call Amplitude_Tree_Inert_FuToFdHp(ZcplcFuFdHpL,ZcplcFuFdHpR,MFd,MFu,MHp,             & 
& MFd2,MFu2,MHp2,AmpTreeFuToFdHp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_FuToFdHp(MLambda,em,gs,cplcFuFdHpL,cplcFuFdHpR,MFdOS,           & 
& MFuOS,MHpOS,MRPFuToFdHp,MRGFuToFdHp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_FuToFdHp(MLambda,em,gs,ZcplcFuFdHpL,ZcplcFuFdHpR,               & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_FuToFdHp(MLambda,em,gs,cplcFuFdHpL,cplcFuFdHpR,MFd,             & 
...
Call Amplitude_WAVE_Inert_FuToFdHp(cplcFuFdHpL,cplcFuFdHpR,ctcplcFuFdHpL,             & 
& ctcplcFuFdHpR,MFd,MFd2,MFu,MFu2,MHp,MHp2,ZfDL,ZfDR,ZfHp,ZfUL,ZfUR,AmpWaveFuToFdHp)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_FuToFdHp(MFd,MFu,MG0,Mhh,MHp,MVG,MVP,MVWp,MVZ,            & 
& MFd2,MFu2,MG02,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFdFdG0L,cplcFdFdG0R,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFuFdHpL,cplcFuFdHpR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,               & 
& cplcFdFdVPR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuG0L,             & 
& cplcFuFuG0R,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
& cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplG0HpcVWp,cplhhHpcHp,cplhhHpcVWp,cplHpcHpVP,     & 
& cplHpcVWpVP,cplHpcHpVZ,cplHpcVWpVZ,AmpVertexFuToFdHp)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_FuToFdHp(MFd,MFu,MG0,Mhh,MHp,MVG,MVP,MVWp,             & 
...
& cplHpcHpVP,cplHpcVWpVP,cplHpcHpVZ,cplHpcVWpVZ,AmpVertexIRdrFuToFdHp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_FuToFdHp(MFdOS,MFuOS,MG0OS,MhhOS,MHpOS,MVG,            & 
& MVP,MVWpOS,MVZOS,MFd2OS,MFu2OS,MG02OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,          & 
& cplcFdFdG0L,cplcFdFdG0R,cplcFdFdhhL,cplcFdFdhhR,ZcplcFuFdHpL,ZcplcFuFdHpR,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_FuToFdVWp(cplcFuFdVWpL,cplcFuFdVWpR,MFd,MFu,MVWp,           & 
& MFd2,MFu2,MVWp2,AmpTreeFuToFdVWp)

  Else 
Call Amplitude_Tree_Inert_FuToFdVWp(ZcplcFuFdVWpL,ZcplcFuFdVWpR,MFd,MFu,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_FuToFdVWp(MLambda,em,gs,cplcFuFdVWpL,cplcFuFdVWpR,              & 
& MFdOS,MFuOS,MVWpOS,MRPFuToFdVWp,MRGFuToFdVWp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_FuToFdVWp(MLambda,em,gs,ZcplcFuFdVWpL,ZcplcFuFdVWpR,            & 
& MFdOS,MFuOS,MVWpOS,MRPFuToFdVWp,MRGFuToFdVWp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_FuToFdVWp(cplcFuFdVWpL,cplcFuFdVWpR,ctcplcFuFdVWpL,         & 
& ctcplcFuFdVWpR,MFd,MFd2,MFu,MFu2,MVWp,MVWp2,ZfDL,ZfDR,ZfUL,ZfUR,ZfVWp,AmpWaveFuToFdVWp)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_FuToFdVWp(MFd,MFu,MG0,Mhh,MHp,MVG,MVP,MVWp,               & 
& MVZ,MFd2,MFu2,MG02,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFdFdG0L,cplcFdFdG0R,             & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFuFdHpL,cplcFuFdHpR,cplcFdFdVGL,cplcFdFdVGR,               & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFdFdVZL,cplcFdFdVZR,             & 
& cplcFuFuG0L,cplcFuFuG0R,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_FuToFdVWp(MFd,MFu,MG0,Mhh,MHp,MVG,MVP,MVWp,            & 
& MVZ,MFd2,MFu2,MG02,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFdFdG0L,cplcFdFdG0R,             & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFuFdHpL,cplcFuFdHpR,cplcFdFdVGL,cplcFdFdVGR,               & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFdFdVZL,cplcFdFdVZR,             & 
& cplcFuFuG0L,cplcFuFuG0R,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,               & 
...
& cplhhcVWpVWp,cplcHpVPVWp,cplcVWpVPVWp,cplcHpVWpVZ,cplcVWpVWpVZ,AmpVertexIRdrFuToFdVWp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_FuToFdVWp(MFdOS,MFuOS,MG0OS,MhhOS,MHpOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,MFu2,              & 
& Mhh2,AmpTreeFuToFuhh)

  Else 
Call Amplitude_Tree_Inert_FuToFuhh(ZcplcFuFuhhL,ZcplcFuFuhhR,MFu,Mhh,MFu2,            & 
& Mhh2,AmpTreeFuToFuhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,MFuOS,           & 
& MhhOS,MRPFuToFuhh,MRGFuToFuhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_FuToFuhh(MLambda,em,gs,ZcplcFuFuhhL,ZcplcFuFuhhR,               & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,MFu,             & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,             & 
& ctcplcFuFuhhR,MFu,MFu2,Mhh,Mhh2,Zfhh,ZfUL,ZfUR,AmpWaveFuToFuhh)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_FuToFuhh(MFd,MFu,MG0,Mhh,MHp,MVG,MVP,MVWp,MVZ,            & 
& MFd2,MFu2,MG02,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdHpL,     & 
...
& cplcFuFuVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,cplG0G0hh,           & 
& cplG0hhVZ,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,         & 
& AmpVertexFuToFuhh)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_FuToFuhh(MFd,MFu,MG0,Mhh,MHp,MVG,MVP,MVWp,             & 
...
& cplhhVZVZ,AmpVertexIRdrFuToFuhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_FuToFuhh(MFdOS,MFuOS,MG0OS,MhhOS,MHpOS,MVG,            & 
& MVP,MVWpOS,MVZOS,MFd2OS,MFu2OS,MG02OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_FuToFuVZ(cplcFuFuVZL,cplcFuFuVZR,MFu,MVZ,MFu2,              & 
& MVZ2,AmpTreeFuToFuVZ)

  Else 
Call Amplitude_Tree_Inert_FuToFuVZ(ZcplcFuFuVZL,ZcplcFuFuVZR,MFu,MVZ,MFu2,            & 
& MVZ2,AmpTreeFuToFuVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,MFuOS,           & 
& MVZOS,MRPFuToFuVZ,MRGFuToFuVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_FuToFuVZ(MLambda,em,gs,ZcplcFuFuVZL,ZcplcFuFuVZR,               & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,MFu,             & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_FuToFuVZ(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_FuToFuVZ(MFd,MFu,MG0,Mhh,MHp,MVG,MVP,MVWp,MVZ,            & 
& MFd2,MFu2,MG02,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,    & 
& cplcFuFdVWpR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuG0L,cplcFuFuG0R,cplcFuFuhhL,              & 
& cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,               & 
& cplcFuFuVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,cplG0hhVZ,           & 
& cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVWpVZ,cplcVWpVWpVZ,AmpVertexFuToFuVZ)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_FuToFuVZ(MFd,MFu,MG0,Mhh,MHp,MVG,MVP,MVWp,             & 
...
& cplG0hhVZ,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVWpVZ,cplcVWpVWpVZ,AmpVertexIRdrFuToFuVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_FuToFuVZ(MFdOS,MFuOS,MG0OS,MhhOS,MHpOS,MVG,            & 
& MVP,MVWpOS,MVZOS,MFd2OS,MFu2OS,MG02OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,          & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_FuToFuA0(MA0OS,MFdOS,MFuOS,MHpOS,MVWpOS,MA02OS,           & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_FuToFuA0(MA0,MFd,MFu,MHp,MVWp,MA02,MFd2,MFu2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_FuToFuH0(MFdOS,MFuOS,MH0OS,MHpOS,MVWpOS,MFd2OS,           & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_FuToFuH0(MFd,MFu,MH0,MHp,MVWp,MFd2,MFu2,MH02,             & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_Inert_FuToFuVG(ZcplcFuFuVGL,ZcplcFuFuVGR,ctcplcFuFuVGL,           & 
& ctcplcFuFuVGR,MFuOS,MFu2OS,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)

 Else 
Call Amplitude_WAVE_Inert_FuToFuVG(cplcFuFuVGL,cplcFuFuVGR,ctcplcFuFuVGL,             & 
& ctcplcFuFuVGR,MFuOS,MFu2OS,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_FuToFuVG(MFdOS,MFuOS,MG0OS,MhhOS,MHpOS,MVG,               & 
& MVP,MVWpOS,MVZOS,MFd2OS,MFu2OS,MG02OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_FuToFuVG(MFd,MFu,MG0,Mhh,MHp,MVG,MVP,MVWp,MVZ,            & 
& MFd2,MFu2,MG02,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFuFdHpL,cplcFuFdHpR,cplcFdFdVGL,     & 
& cplcFdFdVGR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuG0L,cplcFuFuG0R,cplcFuFuhhL,             & 
& cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,               & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_Inert_FuToFuVP(ZcplcFuFuVPL,ZcplcFuFuVPR,ZcplcFuFuVZL,            & 
...
& MFu2OS,MVP,MVP2,ZfUL,ZfUR,ZfVP,ZfVZVP,AmpWaveFuToFuVP)
 ...
 Else 
Call Amplitude_WAVE_Inert_FuToFuVP(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_FuToFuVP(MFdOS,MFuOS,MG0OS,MhhOS,MHpOS,MVG,               & 
& MVP,MVWpOS,MVZOS,MFd2OS,MFu2OS,MG02OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_FuToFuVP(MFd,MFu,MG0,Mhh,MHp,MVG,MVP,MVWp,MVZ,            & 
& MFd2,MFu2,MG02,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFuFdHpL,cplcFuFdHpR,cplcFdFdVPL,     & 
& cplcFdFdVPR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuG0L,cplcFuFuG0R,cplcFuFuhhL,             & 
& cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,               & 
...
End Module Wrapper_OneLoopDecay_Fu_Inert
