...
Module Wrapper_OneLoopDecay_Hp_Inert
Use Model_Data_Inert 
Use Kinematics 
Use OneLoopDecay_Hp_Inert 
Use Control 
Use Settings 
...
Call Amplitude_Tree_Inert_HpToHpA0(cplA0HpcHp,MA0,MHp,MA02,MHp2,AmpTreeHpToHpA0)

  Else 
Call Amplitude_Tree_Inert_HpToHpA0(ZcplA0HpcHp,MA0,MHp,MA02,MHp2,AmpTreeHpToHpA0)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_HpToHpA0(MLambda,em,gs,cplA0HpcHp,MA0OS,MHpOS,MRPHpToHpA0,      & 
& MRGHpToHpA0)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_HpToHpA0(MLambda,em,gs,ZcplA0HpcHp,MA0OS,MHpOS,MRPHpToHpA0,     & 
& MRGHpToHpA0)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_HpToHpA0(MLambda,em,gs,cplA0HpcHp,MA0,MHp,MRPHpToHpA0,          & 
& MRGHpToHpA0)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_HpToHpA0(MLambda,em,gs,ZcplA0HpcHp,MA0,MHp,MRPHpToHpA0,         & 
& MRGHpToHpA0)
...
Call Amplitude_WAVE_Inert_HpToHpA0(cplA0HpcHp,ctcplA0HpcHp,MA0,MA02,MHp,              & 
& MHp2,ZfA0,ZfHp,AmpWaveHpToHpA0)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_HpToHpA0(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,MA02,           & 
& MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,           & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_HpToHpA0(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,             & 
...
& cplG0H0HpcHp1,cplH0hhHpcHp1,cplHpHpcHpcHp1,AmpVertexIRdrHpToHpA0)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_HpToHpA0(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,MVP,            & 
& MVWpOS,MVZOS,MA02OS,MG02OS,MH02OS,Mhh2OS,MHp2OS,MVP2,MVWp2OS,MVZ2OS,cplA0A0G0,         & 
& cplA0A0hh,cplA0G0H0,cplA0H0hh,cplA0H0VZ,ZcplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,           & 
& cplG0HpcVWp,cplG0cHpVWp,cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,cplhhHpcHp,cplhhHpcVWp,     & 
& cplhhcHpVWp,cplHpcHpVP,cplHpcVWpVP,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVPVWp,cplcHpVWpVZ,     & 
& cplA0A0HpcHp1,cplA0G0HpcHp1,cplA0hhHpcHp1,cplA0HpcVWpVP1,cplA0HpcVWpVZ1,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_HpToA0VWp(cplA0cHpVWp,MA0,MHp,MVWp,MA02,MHp2,               & 
& MVWp2,AmpTreeHpToA0VWp)

  Else 
Call Amplitude_Tree_Inert_HpToA0VWp(ZcplA0cHpVWp,MA0,MHp,MVWp,MA02,MHp2,              & 
& MVWp2,AmpTreeHpToA0VWp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_HpToA0VWp(MLambda,em,gs,cplA0cHpVWp,MA0OS,MHpOS,MVWpOS,         & 
& MRPHpToA0VWp,MRGHpToA0VWp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_HpToA0VWp(MLambda,em,gs,ZcplA0cHpVWp,MA0OS,MHpOS,               & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_HpToA0VWp(MLambda,em,gs,cplA0cHpVWp,MA0,MHp,MVWp,               & 
& MRPHpToA0VWp,MRGHpToA0VWp)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_HpToA0VWp(MLambda,em,gs,ZcplA0cHpVWp,MA0,MHp,MVWp,              & 
& MRPHpToA0VWp,MRGHpToA0VWp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_HpToA0VWp(cplA0cHpVWp,ctcplA0cHpVWp,MA0,MA02,               & 
& MHp,MHp2,MVWp,MVWp2,ZfA0,ZfHp,ZfVWp,AmpWaveHpToA0VWp)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_HpToA0VWp(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,               & 
& MA02,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,      & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_HpToA0VWp(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,            & 
& MA02,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,      & 
& cplA0H0VZ,cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplG0cHpVWp,cplH0HpcHp,cplH0cHpVWp,       & 
& cplhhHpcHp,cplhhcHpVWp,cplhhcVWpVWp,cplHpcHpVP,cplHpcHpVZ,cplcHpVPVWp,cplcVWpVPVWp,    & 
& cplcHpVWpVZ,cplcVWpVWpVZ,cplA0A0cVWpVWp1,cplA0cHpVPVWp1,cplA0cHpVWpVZ1,cplH0cHpVWpVZ1, & 
& cplHpcHpcVWpVWp1,AmpVertexIRdrHpToA0VWp)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_HpToA0VWp(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,               & 
...
Call Amplitude_IR_VERTEX_Inert_HpToA0VWp(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,            & 
& MA02,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,      & 
& cplA0H0VZ,GZcplA0HpcHp,cplA0HpcVWp,ZcplA0cHpVWp,cplG0cHpVWp,cplH0HpcHp,cplH0cHpVWp,    & 
& cplhhHpcHp,cplhhcHpVWp,cplhhcVWpVWp,cplHpcHpVP,cplHpcHpVZ,GZcplcHpVPVWp,               & 
...
& cplhhHpcHp,cplhhcHpVWp,cplhhcVWpVWp,cplHpcHpVP,cplHpcHpVZ,cplcHpVPVWp,cplcVWpVPVWp,    & 
& cplcHpVWpVZ,cplcVWpVWpVZ,cplA0A0cVWpVWp1,cplA0cHpVPVWp1,cplA0cHpVWpVZ1,cplH0cHpVWpVZ1, & 
& cplHpcHpcVWpVWp1,AmpVertexIRosHpToA0VWp)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_HpTocFdFu(cplcFdFucHpL,cplcFdFucHpR,MFd,MFu,MHp,            & 
& MFd2,MFu2,MHp2,AmpTreeHpTocFdFu)

  Else 
Call Amplitude_Tree_Inert_HpTocFdFu(ZcplcFdFucHpL,ZcplcFdFucHpR,MFd,MFu,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_HpTocFdFu(MLambda,em,gs,cplcFdFucHpL,cplcFdFucHpR,              & 
& MFdOS,MFuOS,MHpOS,MRPHpTocFdFu,MRGHpTocFdFu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_HpTocFdFu(MLambda,em,gs,ZcplcFdFucHpL,ZcplcFdFucHpR,            & 
& MFdOS,MFuOS,MHpOS,MRPHpTocFdFu,MRGHpTocFdFu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_HpTocFdFu(cplcFdFucHpL,cplcFdFucHpR,ctcplcFdFucHpL,         & 
& ctcplcFdFucHpR,MFd,MFd2,MFu,MFu2,MHp,MHp2,ZfDL,ZfDR,ZfHp,ZfUL,ZfUR,AmpWaveHpTocFdFu)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_HpTocFdFu(MFd,MFu,MG0,Mhh,MHp,MVG,MVP,MVWp,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_HpTocFdFu(MFd,MFu,MG0,Mhh,MHp,MVG,MVP,MVWp,            & 
& MVZ,MFd2,MFu2,MG02,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFdFdG0L,cplcFdFdG0R,             & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,               & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFuFuG0L,cplcFuFuG0R,cplcFuFuhhL,cplcFuFuhhR,               & 
& cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,               & 
...
& cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,cplcHpVPVWp,cplcHpVWpVZ,AmpVertexIRdrHpTocFdFu)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_HpTocFdFu(MFdOS,MFuOS,MG0OS,MhhOS,MHpOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_HpTocFeFv(cplcFeFvcHpL,cplcFeFvcHpR,MFe,MHp,MFe2,           & 
& MHp2,AmpTreeHpTocFeFv)

  Else 
Call Amplitude_Tree_Inert_HpTocFeFv(ZcplcFeFvcHpL,ZcplcFeFvcHpR,MFe,MHp,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_HpTocFeFv(MLambda,em,gs,cplcFeFvcHpL,cplcFeFvcHpR,              & 
& MFeOS,MHpOS,MRPHpTocFeFv,MRGHpTocFeFv)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_HpTocFeFv(MLambda,em,gs,ZcplcFeFvcHpL,ZcplcFeFvcHpR,            & 
& MFeOS,MHpOS,MRPHpTocFeFv,MRGHpTocFeFv)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_HpTocFeFv(cplcFeFvcHpL,cplcFeFvcHpR,ctcplcFeFvcHpL,         & 
& ctcplcFeFvcHpR,MFe,MFe2,MHp,MHp2,ZfEL,ZfER,ZfHp,ZfvL,AmpWaveHpTocFeFv)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_HpTocFeFv(MFe,MG0,Mhh,MHp,MVP,MVWp,MVZ,MFe2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_HpTocFeFv(MFe,MG0,Mhh,MHp,MVP,MVWp,MVZ,MFe2,           & 
& MG02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplcFeFeG0L,cplcFeFeG0R,cplcFeFehhL,cplcFeFehhR,        & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFvVZL,cplcFvFvVZR,               & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplG0cHpVWp,cplhhHpcHp,          & 
& cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,cplcHpVPVWp,cplcHpVWpVZ,AmpVertexIRdrHpTocFeFv)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_HpTocFeFv(MFeOS,MG0OS,MhhOS,MHpOS,MVP,MVWpOS,          & 
...
& MG02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplcFeFeG0L,cplcFeFeG0R,cplcFeFehhL,cplcFeFehhR,        & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFvVZL,cplcFvFvVZR,               & 
& ZcplcFeFvcHpL,ZcplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplG0cHpVWp,cplhhHpcHp,        & 
& cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,cplcHpVPVWp,cplcHpVWpVZ,AmpVertexIRosHpTocFeFv)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_HpToHpH0(cplH0HpcHp,MH0,MHp,MH02,MHp2,AmpTreeHpToHpH0)

  Else 
Call Amplitude_Tree_Inert_HpToHpH0(ZcplH0HpcHp,MH0,MHp,MH02,MHp2,AmpTreeHpToHpH0)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_HpToHpH0(MLambda,em,gs,cplH0HpcHp,MH0OS,MHpOS,MRPHpToHpH0,      & 
& MRGHpToHpH0)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_HpToHpH0(MLambda,em,gs,ZcplH0HpcHp,MH0OS,MHpOS,MRPHpToHpH0,     & 
& MRGHpToHpH0)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_HpToHpH0(MLambda,em,gs,cplH0HpcHp,MH0,MHp,MRPHpToHpH0,          & 
& MRGHpToHpH0)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_HpToHpH0(MLambda,em,gs,ZcplH0HpcHp,MH0,MHp,MRPHpToHpH0,         & 
& MRGHpToHpH0)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_HpToHpH0(cplH0HpcHp,ctcplH0HpcHp,MH0,MH02,MHp,              & 
& MHp2,ZfH0,ZfHp,AmpWaveHpToHpH0)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_HpToHpH0(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,MA02,           & 
& MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0G0H0,cplA0H0hh,cplA0H0VZ,cplA0HpcHp,          & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_HpToHpH0(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,             & 
...
& cplH0cHpVPVWp1,cplH0cHpVWpVZ1,cplHpHpcHpcHp1,AmpVertexIRdrHpToHpH0)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_HpToHpH0(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,MVP,            & 
& MVWpOS,MVZOS,MA02OS,MG02OS,MH02OS,Mhh2OS,MHp2OS,MVP2,MVWp2OS,MVZ2OS,cplA0G0H0,         & 
& cplA0H0hh,cplA0H0VZ,cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplG0H0H0,cplG0HpcVWp,          & 
& cplG0cHpVWp,cplH0H0hh,ZcplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,cplhhHpcHp,cplhhHpcVWp,      & 
& cplhhcHpVWp,cplHpcHpVP,cplHpcVWpVP,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVPVWp,cplcHpVWpVZ,     & 
& cplA0G0HpcHp1,cplA0hhHpcHp1,cplG0H0HpcHp1,cplH0H0HpcHp1,cplH0hhHpcHp1,cplH0HpcVWpVP1,  & 
& cplH0HpcVWpVZ1,cplH0cHpVPVWp1,cplH0cHpVWpVZ1,cplHpHpcHpcHp1,AmpVertexIRosHpToHpH0)
...
& MVWpOS,MVZOS,MA02OS,MG02OS,MH02OS,Mhh2OS,MHp2OS,MVP2,MVWp2OS,MVZ2OS,cplA0G0H0,         & 
& cplA0H0hh,cplA0H0VZ,cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplG0H0H0,cplG0HpcVWp,          & 
& cplG0cHpVWp,cplH0H0hh,cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,cplhhHpcHp,cplhhHpcVWp,       & 
& cplhhcHpVWp,cplHpcHpVP,cplHpcVWpVP,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVPVWp,cplcHpVWpVZ,     & 
& cplA0G0HpcHp1,cplA0hhHpcHp1,cplG0H0HpcHp1,cplH0H0HpcHp1,cplH0hhHpcHp1,cplH0HpcVWpVP1,  & 
& cplH0HpcVWpVZ1,cplH0cHpVPVWp1,cplH0cHpVWpVZ1,cplHpHpcHpcHp1,AmpVertexIRosHpToHpH0)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_HpToH0VWp(cplH0cHpVWp,MH0,MHp,MVWp,MH02,MHp2,               & 
& MVWp2,AmpTreeHpToH0VWp)

  Else 
Call Amplitude_Tree_Inert_HpToH0VWp(ZcplH0cHpVWp,MH0,MHp,MVWp,MH02,MHp2,              & 
& MVWp2,AmpTreeHpToH0VWp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_HpToH0VWp(MLambda,em,gs,cplH0cHpVWp,MH0OS,MHpOS,MVWpOS,         & 
& MRPHpToH0VWp,MRGHpToH0VWp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_HpToH0VWp(MLambda,em,gs,ZcplH0cHpVWp,MH0OS,MHpOS,               & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_HpToH0VWp(MLambda,em,gs,cplH0cHpVWp,MH0,MHp,MVWp,               & 
& MRPHpToH0VWp,MRGHpToH0VWp)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_HpToH0VWp(MLambda,em,gs,ZcplH0cHpVWp,MH0,MHp,MVWp,              & 
& MRPHpToH0VWp,MRGHpToH0VWp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_HpToH0VWp(cplH0cHpVWp,ctcplH0cHpVWp,MH0,MH02,               & 
& MHp,MHp2,MVWp,MVWp2,ZfH0,ZfHp,ZfVWp,AmpWaveHpToH0VWp)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_HpToH0VWp(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,               & 
& MA02,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0G0H0,cplA0H0hh,cplA0H0VZ,cplA0HpcHp,     & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_HpToH0VWp(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,            & 
& MA02,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0G0H0,cplA0H0hh,cplA0H0VZ,cplA0HpcHp,     & 
& cplA0cHpVWp,cplG0H0H0,cplG0cHpVWp,cplH0H0hh,cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,        & 
& cplhhHpcHp,cplhhcHpVWp,cplhhcVWpVWp,cplHpcHpVP,cplHpcHpVZ,cplcHpVPVWp,cplcVWpVPVWp,    & 
& cplcHpVWpVZ,cplcVWpVWpVZ,cplA0cHpVWpVZ1,cplH0H0cVWpVWp1,cplH0cHpVPVWp1,cplH0cHpVWpVZ1, & 
& cplHpcHpcVWpVWp1,AmpVertexIRdrHpToH0VWp)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_HpToH0VWp(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,               & 
& MVP,MVWpOS,MVZOS,MA02OS,MG02OS,MH02OS,Mhh2OS,MHp2OS,MVP2,MVWp2OS,MVZ2OS,               & 
...
Call Amplitude_IR_VERTEX_Inert_HpToH0VWp(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,            & 
& MA02,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0G0H0,cplA0H0hh,cplA0H0VZ,cplA0HpcHp,     & 
& cplA0cHpVWp,cplG0H0H0,cplG0cHpVWp,cplH0H0hh,GZcplH0HpcHp,cplH0HpcVWp,ZcplH0cHpVWp,     & 
& cplhhHpcHp,cplhhcHpVWp,cplhhcVWpVWp,cplHpcHpVP,cplHpcHpVZ,GZcplcHpVPVWp,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_HpToHphh(cplhhHpcHp,Mhh,MHp,Mhh2,MHp2,AmpTreeHpToHphh)

  Else 
Call Amplitude_Tree_Inert_HpToHphh(ZcplhhHpcHp,Mhh,MHp,Mhh2,MHp2,AmpTreeHpToHphh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_HpToHphh(MLambda,em,gs,cplhhHpcHp,MhhOS,MHpOS,MRPHpToHphh,      & 
& MRGHpToHphh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_HpToHphh(MLambda,em,gs,ZcplhhHpcHp,MhhOS,MHpOS,MRPHpToHphh,     & 
& MRGHpToHphh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_HpToHphh(MLambda,em,gs,cplhhHpcHp,Mhh,MHp,MRPHpToHphh,          & 
& MRGHpToHphh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_HpToHphh(MLambda,em,gs,ZcplhhHpcHp,Mhh,MHp,MRPHpToHphh,         & 
& MRGHpToHphh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_HpToHphh(cplhhHpcHp,ctcplhhHpcHp,Mhh,Mhh2,MHp,              & 
& MHp2,Zfhh,ZfHp,AmpWaveHpToHphh)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_HpToHphh(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,MVP,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_HpToHphh(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,              & 
...
& cplHpcHpVZVZ1,AmpVertexIRdrHpToHphh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_HpToHphh(MA0OS,MFdOS,MFeOS,MFuOS,MG0OS,MH0OS,          & 
& MhhOS,MHpOS,MVP,MVWpOS,MVZOS,MA02OS,MFd2OS,MFe2OS,MFu2OS,MG02OS,MH02OS,Mhh2OS,         & 
& MHp2OS,MVP2,MVWp2OS,MVZ2OS,cplA0A0hh,cplA0H0hh,cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,     & 
...
& cplcFeFvcHpL,cplcFeFvcHpR,cplG0G0hh,cplG0hhVZ,cplG0HpcVWp,cplG0cHpVWp,cplcgWpgWphh,    & 
& cplcgZgWpcHp,cplcgWCgWChh,cplcgZgWCHp,cplcgZgZhh,cplcgWpgZHp,cplcgWCgZcHp,             & 
& cplH0H0hh,cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,cplhhhhhh,ZcplhhHpcHp,cplhhHpcVWp,        & 
& cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,cplHpcHpVP,cplHpcVWpVP,cplHpcHpVZ,cplHpcVWpVZ,      & 
& cplcHpVPVWp,cplcHpVWpVZ,cplA0A0HpcHp1,cplA0hhHpcHp1,cplG0G0HpcHp1,cplH0H0HpcHp1,       & 
& cplH0hhHpcHp1,cplhhhhHpcHp1,cplhhHpcVWpVP1,cplhhHpcVWpVZ1,cplhhcHpVPVWp1,              & 
& cplhhcHpVWpVZ1,cplHpHpcHpcHp1,cplHpcHpcVWpVWp1,cplHpcHpVZVZ1,AmpVertexIRosHpToHphh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_HpTohhVWp(cplhhcHpVWp,Mhh,MHp,MVWp,Mhh2,MHp2,               & 
& MVWp2,AmpTreeHpTohhVWp)

  Else 
Call Amplitude_Tree_Inert_HpTohhVWp(ZcplhhcHpVWp,Mhh,MHp,MVWp,Mhh2,MHp2,              & 
& MVWp2,AmpTreeHpTohhVWp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_HpTohhVWp(MLambda,em,gs,cplhhcHpVWp,MhhOS,MHpOS,MVWpOS,         & 
& MRPHpTohhVWp,MRGHpTohhVWp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_HpTohhVWp(MLambda,em,gs,ZcplhhcHpVWp,MhhOS,MHpOS,               & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_HpTohhVWp(MLambda,em,gs,cplhhcHpVWp,Mhh,MHp,MVWp,               & 
& MRPHpTohhVWp,MRGHpTohhVWp)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_HpTohhVWp(MLambda,em,gs,ZcplhhcHpVWp,Mhh,MHp,MVWp,              & 
& MRPHpTohhVWp,MRGHpTohhVWp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_HpTohhVWp(cplhhcHpVWp,ctcplhhcHpVWp,Mhh,Mhh2,               & 
& MHp,MHp2,MVWp,MVWp2,Zfhh,ZfHp,ZfVWp,AmpWaveHpTohhVWp)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_HpTohhVWp(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,MVP,            & 
& MVWp,MVZ,MA02,MFd2,MFe2,MFu2,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0A0hh,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_HpTohhVWp(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,             & 
& MVP,MVWp,MVZ,MA02,MFd2,MFe2,MFu2,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0A0hh,        & 
& cplA0H0hh,cplA0HpcHp,cplA0cHpVWp,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdVWpL,cplcFuFdVWpR,    & 
& cplcFeFehhL,cplcFeFehhR,cplcFvFeVWpL,cplcFvFeVWpR,cplcFuFuhhL,cplcFuFuhhR,             & 
& cplcFdFucHpL,cplcFdFucHpR,cplcFeFvcHpL,cplcFeFvcHpR,cplG0hhVZ,cplG0cHpVWp,             & 
...
& cplhhhhcVWpVWp1,cplhhcHpVPVWp1,cplhhcHpVWpVZ1,cplHpcHpcVWpVWp1,AmpVertexIRdrHpTohhVWp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_HpTohhVWp(MA0OS,MFdOS,MFeOS,MFuOS,MG0OS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_HpToHpVZ(cplHpcHpVZ,MHp,MVZ,MHp2,MVZ2,AmpTreeHpToHpVZ)

  Else 
Call Amplitude_Tree_Inert_HpToHpVZ(ZcplHpcHpVZ,MHp,MVZ,MHp2,MVZ2,AmpTreeHpToHpVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_HpToHpVZ(MLambda,em,gs,cplHpcHpVZ,MHpOS,MVZOS,MRPHpToHpVZ,      & 
& MRGHpToHpVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_HpToHpVZ(MLambda,em,gs,ZcplHpcHpVZ,MHpOS,MVZOS,MRPHpToHpVZ,     & 
& MRGHpToHpVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_HpToHpVZ(MLambda,em,gs,cplHpcHpVZ,MHp,MVZ,MRPHpToHpVZ,          & 
& MRGHpToHpVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_HpToHpVZ(MLambda,em,gs,ZcplHpcHpVZ,MHp,MVZ,MRPHpToHpVZ,         & 
& MRGHpToHpVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_HpToHpVZ(cplHpcHpVP,cplHpcHpVZ,ctcplHpcHpVP,ctcplHpcHpVZ,   & 
& MHp,MHp2,MVP,MVP2,MVZ,MVZ2,ZfHp,ZfVPVZ,ZfVZ,AmpWaveHpToHpVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_HpToHpVZ(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,MVP,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_HpToHpVZ(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,              & 
...
& cplhhcHpVWpVZ1,cplHpcHpVPVZ1,cplHpcHpVZVZ1,AmpVertexIRdrHpToHpVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_HpToHpVZ(MA0OS,MFdOS,MFeOS,MFuOS,MG0OS,MH0OS,          & 
& MhhOS,MHpOS,MVP,MVWpOS,MVZOS,MA02OS,MFd2OS,MFe2OS,MFu2OS,MG02OS,MH02OS,Mhh2OS,         & 
& MHp2OS,MVP2,MVWp2OS,MVZ2OS,cplA0H0VZ,cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_HpToVZVWp(cplcHpVWpVZ,MHp,MVWp,MVZ,MHp2,MVWp2,              & 
& MVZ2,AmpTreeHpToVZVWp)

  Else 
Call Amplitude_Tree_Inert_HpToVZVWp(ZcplcHpVWpVZ,MHp,MVWp,MVZ,MHp2,MVWp2,             & 
& MVZ2,AmpTreeHpToVZVWp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_HpToVZVWp(MLambda,em,gs,cplcHpVWpVZ,MHpOS,MVWpOS,               & 
& MVZOS,MRPHpToVZVWp,MRGHpToVZVWp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_HpToVZVWp(MLambda,em,gs,ZcplcHpVWpVZ,MHpOS,MVWpOS,              & 
& MVZOS,MRPHpToVZVWp,MRGHpToVZVWp)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_HpToVZVWp(MLambda,em,gs,cplcHpVWpVZ,MHp,MVWp,MVZ,               & 
& MRPHpToVZVWp,MRGHpToVZVWp)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_HpToVZVWp(MLambda,em,gs,ZcplcHpVWpVZ,MHp,MVWp,MVZ,              & 
& MRPHpToVZVWp,MRGHpToVZVWp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_HpToVZVWp(cplcHpVPVWp,cplcHpVWpVZ,ctcplcHpVPVWp,            & 
& ctcplcHpVWpVZ,MHp,MHp2,MVP,MVP2,MVWp,MVWp2,MVZ,MVZ2,ZfHp,ZfVWp,ZfVZ,AmpWaveHpToVZVWp)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_HpToVZVWp(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,MVP,            & 
& MVWp,MVZ,MA02,MFd2,MFe2,MFu2,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0H0VZ,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_HpToVZVWp(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,             & 
& MVP,MVWp,MVZ,MA02,MFd2,MFe2,MFu2,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0H0VZ,        & 
& cplA0HpcHp,cplA0cHpVWp,cplcFuFdVWpL,cplcFuFdVWpR,cplcFdFdVZL,cplcFdFdVZR,              & 
& cplcFvFeVWpL,cplcFvFeVWpR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuVZL,cplcFuFuVZR,             & 
& cplcFdFucHpL,cplcFdFucHpR,cplcFvFvVZL,cplcFvFvVZR,cplcFeFvcHpL,cplcFeFvcHpR,           & 
...
& AmpVertexIRdrHpToVZVWp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_HpToVZVWp(MA0OS,MFdOS,MFeOS,MFuOS,MG0OS,               & 
& MH0OS,MhhOS,MHpOS,MVP,MVWpOS,MVZOS,MA02OS,MFd2OS,MFe2OS,MFu2OS,MG02OS,MH02OS,          & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_Inert_HpToHpVP(cplHpcHpVP,cplHpcHpVZ,ctcplHpcHpVP,ctcplHpcHpVZ,   & 
& MHpOS,MHp2OS,MVP,MVP2,ZfHp,ZfVP,ZfVZVP,AmpWaveHpToHpVP)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_HpToHpVP(MA0OS,MFdOS,MFeOS,MFuOS,MG0OS,MH0OS,             & 
& MhhOS,MHpOS,MVP,MVWpOS,MVZOS,MA02OS,MFd2OS,MFe2OS,MFu2OS,MG02OS,MH02OS,Mhh2OS,         & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_HpToHpVP(cplHpcHpVP,cplHpcHpVZ,ctcplHpcHpVP,ctcplHpcHpVZ,   & 
& MHp,MHp2,MVP,MVP2,ZfHp,ZfVP,ZfVZVP,AmpWaveHpToHpVP)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_HpToHpVP(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,MVP,             & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_Inert_HpToVPVWp(cplcHpVPVWp,cplcHpVWpVZ,ctcplcHpVPVWp,            & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_HpToVPVWp(MA0OS,MFdOS,MFeOS,MFuOS,MG0OS,MH0OS,            & 
& MhhOS,MHpOS,MVP,MVWpOS,MVZOS,MA02OS,MFd2OS,MFe2OS,MFu2OS,MG02OS,MH02OS,Mhh2OS,         & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_HpToVPVWp(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,MVP,            & 
& MVWp,MVZ,MA02,MFd2,MFe2,MFu2,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0HpcHp,           & 
...
End Module Wrapper_OneLoopDecay_Hp_Inert
