...
Module Wrapper_OneLoopDecay_H0_Inert
Use Model_Data_Inert 
Use Kinematics 
Use OneLoopDecay_H0_Inert 
Use Control 
Use Settings 
...
Call Amplitude_Tree_Inert_H0TohhA0(cplA0H0hh,MA0,MH0,Mhh,MA02,MH02,Mhh2,              & 
& AmpTreeH0TohhA0)

  Else 
Call Amplitude_Tree_Inert_H0TohhA0(ZcplA0H0hh,MA0,MH0,Mhh,MA02,MH02,Mhh2,             & 
& AmpTreeH0TohhA0)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_H0TohhA0(MLambda,em,gs,cplA0H0hh,MA0OS,MH0OS,MhhOS,             & 
& MRPH0TohhA0,MRGH0TohhA0)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_H0TohhA0(MLambda,em,gs,ZcplA0H0hh,MA0OS,MH0OS,MhhOS,            & 
& MRPH0TohhA0,MRGH0TohhA0)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_H0TohhA0(MLambda,em,gs,cplA0H0hh,MA0,MH0,Mhh,MRPH0TohhA0,       & 
& MRGH0TohhA0)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_H0TohhA0(MLambda,em,gs,ZcplA0H0hh,MA0,MH0,Mhh,MRPH0TohhA0,      & 
& MRGH0TohhA0)
...
Call Amplitude_WAVE_Inert_H0TohhA0(cplA0H0hh,ctcplA0H0hh,MA0,MA02,MH0,MH02,           & 
& Mhh,Mhh2,ZfA0,ZfH0,Zfhh,AmpWaveH0TohhA0)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0TohhA0(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_H0TohhA0(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,            & 
& MG02,MH02,Mhh2,MHp2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,cplA0H0VZ,      & 
& cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplG0G0hh,cplG0H0H0,cplG0hhVZ,cplH0H0hh,            & 
& cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,       & 
& cplhhcVWpVWp,cplA0A0G0hh1,cplA0A0H0H01,cplA0A0hhhh1,cplA0G0G0H01,cplA0G0H0hh1,         & 
& cplA0H0hhhh1,cplA0hhHpcHp1,cplG0H0H0hh1,cplH0H0hhhh1,cplH0hhHpcHp1,AmpVertexIRdrH0TohhA0)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_H0TohhA0(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,MVWpOS,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_H0ToA0VZ(cplA0H0VZ,MA0,MH0,MVZ,MA02,MH02,MVZ2,              & 
& AmpTreeH0ToA0VZ)

  Else 
Call Amplitude_Tree_Inert_H0ToA0VZ(ZcplA0H0VZ,MA0,MH0,MVZ,MA02,MH02,MVZ2,             & 
& AmpTreeH0ToA0VZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_H0ToA0VZ(MLambda,em,gs,cplA0H0VZ,MA0OS,MH0OS,MVZOS,             & 
& MRPH0ToA0VZ,MRGH0ToA0VZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_H0ToA0VZ(MLambda,em,gs,ZcplA0H0VZ,MA0OS,MH0OS,MVZOS,            & 
& MRPH0ToA0VZ,MRGH0ToA0VZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_H0ToA0VZ(MLambda,em,gs,cplA0H0VZ,MA0,MH0,MVZ,MRPH0ToA0VZ,       & 
& MRGH0ToA0VZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_H0ToA0VZ(MLambda,em,gs,ZcplA0H0VZ,MA0,MH0,MVZ,MRPH0ToA0VZ,      & 
& MRGH0ToA0VZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_H0ToA0VZ(cplA0H0VZ,ctcplA0H0VZ,MA0,MA02,MH0,MH02,           & 
& MVZ,MVZ2,ZfA0,ZfH0,ZfVZ,AmpWaveH0ToA0VZ)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0ToA0VZ(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,               & 
& MG02,MH02,Mhh2,MHp2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,cplA0H0VZ,      & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_H0ToA0VZ(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,            & 
& MG02,MH02,Mhh2,MHp2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,cplA0H0VZ,      & 
& cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplG0H0H0,cplG0hhVZ,cplH0H0hh,cplH0HpcHp,           & 
& cplH0HpcVWp,cplH0cHpVWp,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVWpVZ,cplcVWpVWpVZ,     & 
& cplA0A0VZVZ1,cplA0HpcVWpVZ1,cplA0cHpVWpVZ1,cplH0H0VZVZ1,cplH0HpcVWpVZ1,cplH0cHpVWpVZ1, & 
& AmpVertexIRdrH0ToA0VZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_H0ToA0VZ(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,MVWpOS,         & 
& MVZOS,MA02OS,MG02OS,MH02OS,Mhh2OS,MHp2OS,MVWp2OS,MVZ2OS,cplA0A0G0,cplA0A0hh,           & 
& cplA0G0H0,cplA0H0hh,ZcplA0H0VZ,cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplG0H0H0,           & 
& cplG0hhVZ,cplH0H0hh,cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,cplhhVZVZ,cplHpcHpVZ,           & 
& cplHpcVWpVZ,cplcHpVWpVZ,cplcVWpVWpVZ,cplA0A0VZVZ1,cplA0HpcVWpVZ1,cplA0cHpVWpVZ1,       & 
& cplH0H0VZVZ1,cplH0HpcVWpVZ1,cplH0cHpVWpVZ1,AmpVertexIRosH0ToA0VZ)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_H0TohhH0(cplH0H0hh,MH0,Mhh,MH02,Mhh2,AmpTreeH0TohhH0)

  Else 
Call Amplitude_Tree_Inert_H0TohhH0(ZcplH0H0hh,MH0,Mhh,MH02,Mhh2,AmpTreeH0TohhH0)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_H0TohhH0(MLambda,em,gs,cplH0H0hh,MH0OS,MhhOS,MRPH0TohhH0,       & 
& MRGH0TohhH0)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_H0TohhH0(MLambda,em,gs,ZcplH0H0hh,MH0OS,MhhOS,MRPH0TohhH0,      & 
& MRGH0TohhH0)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_H0TohhH0(MLambda,em,gs,cplH0H0hh,MH0,Mhh,MRPH0TohhH0,           & 
& MRGH0TohhH0)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_H0TohhH0(MLambda,em,gs,ZcplH0H0hh,MH0,Mhh,MRPH0TohhH0,          & 
& MRGH0TohhH0)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_H0TohhH0(cplH0H0hh,ctcplH0H0hh,MH0,MH02,Mhh,Mhh2,           & 
& ZfH0,Zfhh,AmpWaveH0TohhH0)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0TohhH0(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_H0TohhH0(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,            & 
& MG02,MH02,Mhh2,MHp2,MVWp2,MVZ2,cplA0A0hh,cplA0G0H0,cplA0H0hh,cplA0H0VZ,cplG0G0hh,      & 
& cplG0H0H0,cplG0hhVZ,cplH0H0hh,cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,cplhhhhhh,            & 
& cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,cplA0A0H0H01,cplA0G0H0hh1,   & 
& cplA0H0hhhh1,cplG0G0H0H01,cplG0H0H0hh1,cplH0H0H0H01,cplH0H0hhhh1,cplH0H0HpcHp1,        & 
& cplH0H0cVWpVWp1,cplH0H0VZVZ1,cplH0hhHpcHp1,AmpVertexIRdrH0TohhH0)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_H0TohhH0(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,MVWpOS,         & 
...
& cplH0H0hhhh1,cplH0H0HpcHp1,cplH0H0cVWpVWp1,cplH0H0VZVZ1,cplH0hhHpcHp1,AmpVertexIRosH0TohhH0)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_H0TocHpHp(cplH0HpcHp,MH0,MHp,MH02,MHp2,AmpTreeH0TocHpHp)

  Else 
Call Amplitude_Tree_Inert_H0TocHpHp(ZcplH0HpcHp,MH0,MHp,MH02,MHp2,AmpTreeH0TocHpHp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_H0TocHpHp(MLambda,em,gs,cplH0HpcHp,MH0OS,MHpOS,MRPH0TocHpHp,    & 
& MRGH0TocHpHp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_H0TocHpHp(MLambda,em,gs,ZcplH0HpcHp,MH0OS,MHpOS,MRPH0TocHpHp,   & 
& MRGH0TocHpHp)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_H0TocHpHp(MLambda,em,gs,cplH0HpcHp,MH0,MHp,MRPH0TocHpHp,        & 
& MRGH0TocHpHp)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_H0TocHpHp(MLambda,em,gs,ZcplH0HpcHp,MH0,MHp,MRPH0TocHpHp,       & 
& MRGH0TocHpHp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_H0TocHpHp(cplH0HpcHp,ctcplH0HpcHp,MH0,MH02,MHp,             & 
& MHp2,ZfH0,ZfHp,AmpWaveH0TocHpHp)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0TocHpHp(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_H0TocHpHp(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,            & 
& MA02,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0G0H0,cplA0H0hh,cplA0H0VZ,cplA0HpcHp,     & 
& cplA0HpcVWp,cplA0cHpVWp,cplG0H0H0,cplG0HpcVWp,cplG0cHpVWp,cplH0H0hh,cplH0HpcHp,        & 
& cplH0HpcVWp,cplH0cHpVWp,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplHpcHpVP,cplHpcVWpVP,     & 
& cplHpcHpVZ,cplHpcVWpVZ,cplcHpVPVWp,cplcHpVWpVZ,cplA0G0HpcHp1,cplA0hhHpcHp1,            & 
...
& cplH0cHpVPVWp1,cplH0cHpVWpVZ1,cplHpHpcHpcHp1,AmpVertexIRdrH0TocHpHp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_H0TocHpHp(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_H0ToHpcVWp(cplH0HpcVWp,MH0,MHp,MVWp,MH02,MHp2,              & 
& MVWp2,AmpTreeH0ToHpcVWp)

  Else 
Call Amplitude_Tree_Inert_H0ToHpcVWp(ZcplH0HpcVWp,MH0,MHp,MVWp,MH02,MHp2,             & 
& MVWp2,AmpTreeH0ToHpcVWp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_H0ToHpcVWp(MLambda,em,gs,cplH0HpcVWp,MH0OS,MHpOS,               & 
& MVWpOS,MRPH0ToHpcVWp,MRGH0ToHpcVWp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_H0ToHpcVWp(MLambda,em,gs,ZcplH0HpcVWp,MH0OS,MHpOS,              & 
& MVWpOS,MRPH0ToHpcVWp,MRGH0ToHpcVWp)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_H0ToHpcVWp(MLambda,em,gs,cplH0HpcVWp,MH0,MHp,MVWp,              & 
& MRPH0ToHpcVWp,MRGH0ToHpcVWp)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_H0ToHpcVWp(MLambda,em,gs,ZcplH0HpcVWp,MH0,MHp,MVWp,             & 
& MRPH0ToHpcVWp,MRGH0ToHpcVWp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_H0ToHpcVWp(cplH0HpcVWp,ctcplH0HpcVWp,MH0,MH02,              & 
& MHp,MHp2,MVWp,MVWp2,ZfH0,ZfHp,ZfVWp,AmpWaveH0ToHpcVWp)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0ToHpcVWp(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,              & 
& MA02,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0G0H0,cplA0H0hh,cplA0H0VZ,cplA0HpcHp,     & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_H0ToHpcVWp(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,               & 
...
& cplH0HpcVWpVZ1,cplHpcHpcVWpVWp1,AmpVertexIRdrH0ToHpcVWp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_H0ToHpcVWp(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,              & 
& MVP,MVWpOS,MVZOS,MA02OS,MG02OS,MH02OS,Mhh2OS,MHp2OS,MVP2,MVWp2OS,MVZ2OS,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_H0ToA0A0(MA0OS,MH0OS,MHpOS,MVWpOS,MA02OS,MH02OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0ToA0A0(MA0,MH0,MHp,MVWp,MA02,MH02,MHp2,MVWp2,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_H0ToA0H0(MA0OS,MH0OS,MHpOS,MVWpOS,MA02OS,MH02OS,          & 
& MHp2OS,MVWp2OS,cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplH0HpcHp,cplH0HpcVWp,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0ToA0H0(MA0,MH0,MHp,MVWp,MA02,MH02,MHp2,MVWp2,           & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_Inert_H0ToA0VP(cplA0H0VZ,ctcplA0H0VZ,MA0OS,MA02OS,MH0OS,          & 
& MH02OS,MVP,MVP2,MVZOS,MVZ2OS,ZfA0,ZfH0,ZfVP,ZfVZVP,AmpWaveH0ToA0VP)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_H0ToA0VP(MA0OS,MH0OS,MHpOS,MVP,MVWpOS,MA02OS,             & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_H0ToA0VP(cplA0H0VZ,ctcplA0H0VZ,MA0,MA02,MH0,MH02,           & 
& MVP,MVP2,MVZ,MVZ2,ZfA0,ZfH0,ZfVP,ZfVZVP,AmpWaveH0ToA0VP)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0ToA0VP(MA0,MH0,MHp,MVP,MVWp,MA02,MH02,MHp2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_H0ToFdcFd(MFdOS,MFuOS,MH0OS,MHpOS,MVWpOS,MFd2OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0ToFdcFd(MFd,MFu,MH0,MHp,MVWp,MFd2,MFu2,MH02,            & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_H0ToFecFe(MFeOS,MH0OS,MHpOS,MVWpOS,MFe2OS,MH02OS,         & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0ToFecFe(MFe,MH0,MHp,MVWp,MFe2,MH02,MHp2,MVWp2,          & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_H0ToFucFu(MFdOS,MFuOS,MH0OS,MHpOS,MVWpOS,MFd2OS,          & 
& MFu2OS,MH02OS,MHp2OS,MVWp2OS,cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,        & 
& cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,cplH0HpcHp,cplH0HpcVWp,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0ToFucFu(MFd,MFu,MH0,MHp,MVWp,MFd2,MFu2,MH02,            & 
& MHp2,MVWp2,cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFdFucHpL,             & 
& cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,           & 
& AmpVertexH0ToFucFu)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_H0ToFvcFv(MFeOS,MH0OS,MHpOS,MVWpOS,MFe2OS,MH02OS,         & 
& MHp2OS,MVWp2OS,cplcFvFeHpL,cplcFvFeHpR,cplcFvFeVWpL,cplcFvFeVWpR,cplcFeFvcHpL,         & 
& cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,           & 
& AmpVertexH0ToFvcFv)
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0ToFvcFv(MFe,MH0,MHp,MVWp,MFe2,MH02,MHp2,MVWp2,          & 
& cplcFvFeHpL,cplcFvFeHpR,cplcFvFeVWpL,cplcFvFeVWpR,cplcFeFvcHpL,cplcFeFvcHpR,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_H0ToH0H0(MH0OS,MHpOS,MVWpOS,MH02OS,MHp2OS,MVWp2OS,        & 
& cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,cplH0H0HpcHp1,AmpVertexH0ToH0H0)
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0ToH0H0(MH0,MHp,MVWp,MH02,MHp2,MVWp2,cplH0HpcHp,         & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_H0ToH0VP(MH0OS,MHpOS,MVP,MVWpOS,MH02OS,MHp2OS,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0ToH0VP(MH0,MHp,MVP,MVWp,MH02,MHp2,MVP2,MVWp2,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_H0ToH0VZ(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,MVWpOS,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0ToH0VZ(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_H0Tohhhh(MH0OS,MhhOS,MHpOS,MVWpOS,MH02OS,Mhh2OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0Tohhhh(MH0,Mhh,MHp,MVWp,MH02,Mhh2,MHp2,MVWp2,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_H0TohhVP(MH0OS,MhhOS,MHpOS,MVP,MVWpOS,MH02OS,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0TohhVP(MH0,Mhh,MHp,MVP,MVWp,MH02,Mhh2,MHp2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_H0TohhVZ(MH0OS,MhhOS,MHpOS,MVWpOS,MVZOS,MH02OS,           & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0TohhVZ(MH0,Mhh,MHp,MVWp,MVZ,MH02,Mhh2,MHp2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_H0ToVPVP(MH0OS,MHpOS,MVP,MVWpOS,MH02OS,MHp2OS,            & 
& MVP2,MVWp2OS,cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,cplHpcHpVP,cplHpcVWpVP,cplcHpVPVWp,    & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0ToVPVP(MH0,MHp,MVP,MVWp,MH02,MHp2,MVP2,MVWp2,           & 
& cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,cplHpcHpVP,cplHpcVWpVP,cplcHpVPVWp,cplcVWpVPVWp,    & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_H0ToVPVZ(MH0OS,MHpOS,MVP,MVWpOS,MVZOS,MH02OS,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0ToVPVZ(MH0,MHp,MVP,MVWp,MVZ,MH02,MHp2,MVP2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_H0ToVWpcVWp(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,MVP,            & 
& MVWpOS,MVZOS,MA02OS,MG02OS,MH02OS,Mhh2OS,MHp2OS,MVP2,MVWp2OS,MVZ2OS,cplA0G0H0,         & 
& cplA0H0hh,cplA0H0VZ,cplA0HpcVWp,cplA0cHpVWp,cplG0H0H0,cplG0HpcVWp,cplG0cHpVWp,         & 
& cplH0H0hh,cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,     & 
& cplHpcVWpVP,cplHpcVWpVZ,cplcHpVPVWp,cplcVWpVPVWp,cplcHpVWpVZ,cplcVWpVWpVZ,             & 
& cplH0HpcVWpVP1,cplH0HpcVWpVZ1,cplH0cHpVPVWp1,cplH0cHpVWpVZ1,cplHpcHpcVWpVWp1,          & 
& AmpVertexH0ToVWpcVWp)
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0ToVWpcVWp(MA0,MG0,MH0,Mhh,MHp,MVP,MVWp,MVZ,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_H0ToVZVZ(MH0OS,MHpOS,MVWpOS,MVZOS,MH02OS,MHp2OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_H0ToVZVZ(MH0,MHp,MVWp,MVZ,MH02,MHp2,MVWp2,MVZ2,           & 
& cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVWpVZ,cplcVWpVWpVZ,    & 
& cplH0HpcVWpVZ1,cplH0cHpVWpVZ1,cplHpcHpVZVZ1,AmpVertexH0ToVZVZ)
...
End Module Wrapper_OneLoopDecay_H0_Inert
