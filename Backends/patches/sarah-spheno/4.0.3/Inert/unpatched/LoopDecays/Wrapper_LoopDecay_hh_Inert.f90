...
Module Wrapper_OneLoopDecay_hh_Inert
Use Model_Data_Inert 
Use Kinematics 
Use OneLoopDecay_hh_Inert 
Use Control 
Use Settings 
...
Call Amplitude_Tree_Inert_hhToA0A0(cplA0A0hh,MA0,Mhh,MA02,Mhh2,AmpTreehhToA0A0)

  Else 
Call Amplitude_Tree_Inert_hhToA0A0(ZcplA0A0hh,MA0,Mhh,MA02,Mhh2,AmpTreehhToA0A0)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_hhToA0A0(MLambda,em,gs,cplA0A0hh,MA0OS,MhhOS,MRPhhToA0A0,       & 
& MRGhhToA0A0)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_hhToA0A0(MLambda,em,gs,ZcplA0A0hh,MA0OS,MhhOS,MRPhhToA0A0,      & 
& MRGhhToA0A0)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_hhToA0A0(MLambda,em,gs,cplA0A0hh,MA0,Mhh,MRPhhToA0A0,           & 
& MRGhhToA0A0)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_hhToA0A0(MLambda,em,gs,ZcplA0A0hh,MA0,Mhh,MRPhhToA0A0,          & 
& MRGhhToA0A0)
...
Call Amplitude_WAVE_Inert_hhToA0A0(cplA0A0hh,ctcplA0A0hh,MA0,MA02,Mhh,Mhh2,           & 
& ZfA0,Zfhh,AmpWavehhToA0A0)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhToA0A0(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_hhToA0A0(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,            & 
& MG02,MH02,Mhh2,MHp2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,cplA0H0VZ,      & 
& cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplG0G0hh,cplG0hhVZ,cplH0H0hh,cplhhhhhh,            & 
& cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,cplA0A0A0A01,cplA0A0G0G01,   & 
& cplA0A0G0hh1,cplA0A0H0H01,cplA0A0hhhh1,cplA0A0HpcHp1,cplA0A0cVWpVWp1,cplA0A0VZVZ1,     & 
& cplA0G0H0hh1,cplA0H0hhhh1,cplA0hhHpcHp1,AmpVertexIRdrhhToA0A0)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_hhToA0A0(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,MVWpOS,         & 
& MVZOS,MA02OS,MG02OS,MH02OS,Mhh2OS,MHp2OS,MVWp2OS,MVZ2OS,cplA0A0G0,ZcplA0A0hh,          & 
& cplA0G0H0,cplA0H0hh,cplA0H0VZ,cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplG0G0hh,            & 
& cplG0hhVZ,cplH0H0hh,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,         & 
& cplhhVZVZ,cplA0A0A0A01,cplA0A0G0G01,cplA0A0G0hh1,cplA0A0H0H01,cplA0A0hhhh1,            & 
& cplA0A0HpcHp1,cplA0A0cVWpVWp1,cplA0A0VZVZ1,cplA0G0H0hh1,cplA0H0hhhh1,cplA0hhHpcHp1,    & 
& AmpVertexIRoshhToA0A0)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_hhToH0A0(cplA0H0hh,MA0,MH0,Mhh,MA02,MH02,Mhh2,              & 
& AmpTreehhToH0A0)

  Else 
Call Amplitude_Tree_Inert_hhToH0A0(ZcplA0H0hh,MA0,MH0,Mhh,MA02,MH02,Mhh2,             & 
& AmpTreehhToH0A0)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_hhToH0A0(MLambda,em,gs,cplA0H0hh,MA0OS,MH0OS,MhhOS,             & 
& MRPhhToH0A0,MRGhhToH0A0)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_hhToH0A0(MLambda,em,gs,ZcplA0H0hh,MA0OS,MH0OS,MhhOS,            & 
& MRPhhToH0A0,MRGhhToH0A0)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_hhToH0A0(MLambda,em,gs,cplA0H0hh,MA0,MH0,Mhh,MRPhhToH0A0,       & 
& MRGhhToH0A0)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_hhToH0A0(MLambda,em,gs,ZcplA0H0hh,MA0,MH0,Mhh,MRPhhToH0A0,      & 
& MRGhhToH0A0)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_hhToH0A0(cplA0H0hh,ctcplA0H0hh,MA0,MA02,MH0,MH02,           & 
& Mhh,Mhh2,ZfA0,ZfH0,Zfhh,AmpWavehhToH0A0)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhToH0A0(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,               & 
& MG02,MH02,Mhh2,MHp2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,cplA0H0VZ,      & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_hhToH0A0(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,            & 
& MG02,MH02,Mhh2,MHp2,MVWp2,MVZ2,cplA0A0G0,cplA0A0hh,cplA0G0H0,cplA0H0hh,cplA0H0VZ,      & 
& cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplG0G0hh,cplG0H0H0,cplG0hhVZ,cplH0H0hh,            & 
& cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,       & 
& cplhhcVWpVWp,cplA0A0G0hh1,cplA0A0H0H01,cplA0A0hhhh1,cplA0G0G0H01,cplA0G0H0hh1,         & 
& cplA0H0hhhh1,cplA0hhHpcHp1,cplG0H0H0hh1,cplH0H0hhhh1,cplH0hhHpcHp1,AmpVertexIRdrhhToH0A0)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_hhToH0A0(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,MVWpOS,         & 
& MVZOS,MA02OS,MG02OS,MH02OS,Mhh2OS,MHp2OS,MVWp2OS,MVZ2OS,cplA0A0G0,cplA0A0hh,           & 
& cplA0G0H0,ZcplA0H0hh,cplA0H0VZ,cplA0HpcHp,cplA0HpcVWp,cplA0cHpVWp,cplG0G0hh,           & 
& cplG0H0H0,cplG0hhVZ,cplH0H0hh,cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,cplhhhhhh,            & 
& cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplA0A0G0hh1,cplA0A0H0H01,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_hhTocFdFd(cplcFdFdhhL,cplcFdFdhhR,MFd,Mhh,MFd2,             & 
& Mhh2,AmpTreehhTocFdFd)

  Else 
Call Amplitude_Tree_Inert_hhTocFdFd(ZcplcFdFdhhL,ZcplcFdFdhhR,MFd,Mhh,MFd2,           & 
& Mhh2,AmpTreehhTocFdFd)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_hhTocFdFd(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,MFdOS,          & 
& MhhOS,MRPhhTocFdFd,MRGhhTocFdFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_hhTocFdFd(MLambda,em,gs,ZcplcFdFdhhL,ZcplcFdFdhhR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_hhTocFdFd(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,MFd,            & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_hhTocFdFd(cplcFdFdhhL,cplcFdFdhhR,ctcplcFdFdhhL,            & 
& ctcplcFdFdhhR,MFd,MFd2,Mhh,Mhh2,ZfDL,ZfDR,Zfhh,AmpWavehhTocFdFd)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhTocFdFd(MFd,MFu,MG0,Mhh,MHp,MVG,MVP,MVWp,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_hhTocFdFd(MFd,MFu,MG0,Mhh,MHp,MVG,MVP,MVWp,            & 
& MVZ,MFd2,MFu2,MG02,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFdFdG0L,cplcFdFdG0R,             & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFuFdHpL,cplcFuFdHpR,cplcFdFdVGL,cplcFdFdVGR,               & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFdFdVZL,cplcFdFdVZR,             & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,         & 
...
& cplhhVZVZ,AmpVertexIRdrhhTocFdFd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_hhTocFdFd(MFdOS,MFuOS,MG0OS,MhhOS,MHpOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_hhTocFeFe(cplcFeFehhL,cplcFeFehhR,MFe,Mhh,MFe2,             & 
& Mhh2,AmpTreehhTocFeFe)

  Else 
Call Amplitude_Tree_Inert_hhTocFeFe(ZcplcFeFehhL,ZcplcFeFehhR,MFe,Mhh,MFe2,           & 
& Mhh2,AmpTreehhTocFeFe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_hhTocFeFe(MLambda,em,gs,cplcFeFehhL,cplcFeFehhR,MFeOS,          & 
& MhhOS,MRPhhTocFeFe,MRGhhTocFeFe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_hhTocFeFe(MLambda,em,gs,ZcplcFeFehhL,ZcplcFeFehhR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_hhTocFeFe(MLambda,em,gs,cplcFeFehhL,cplcFeFehhR,MFe,            & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_hhTocFeFe(cplcFeFehhL,cplcFeFehhR,ctcplcFeFehhL,            & 
& ctcplcFeFehhR,MFe,MFe2,Mhh,Mhh2,ZfEL,ZfER,Zfhh,AmpWavehhTocFeFe)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhTocFeFe(MFe,MG0,Mhh,MHp,MVP,MVWp,MVZ,MFe2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_hhTocFeFe(MFe,MG0,Mhh,MHp,MVP,MVWp,MVZ,MFe2,           & 
& MG02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplcFeFeG0L,cplcFeFeG0R,cplcFeFehhL,cplcFeFehhR,        & 
& cplcFvFeHpL,cplcFvFeHpR,cplcFeFeVPL,cplcFeFeVPR,cplcFvFeVWpL,cplcFvFeVWpR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,         & 
& cplG0G0hh,cplG0hhVZ,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,         & 
& cplhhVZVZ,AmpVertexIRdrhhTocFeFe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_hhTocFeFe(MFeOS,MG0OS,MhhOS,MHpOS,MVP,MVWpOS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_hhTocFuFu(cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,MFu2,             & 
& Mhh2,AmpTreehhTocFuFu)

  Else 
Call Amplitude_Tree_Inert_hhTocFuFu(ZcplcFuFuhhL,ZcplcFuFuhhR,MFu,Mhh,MFu2,           & 
& Mhh2,AmpTreehhTocFuFu)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_hhTocFuFu(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,MFuOS,          & 
& MhhOS,MRPhhTocFuFu,MRGhhTocFuFu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_hhTocFuFu(MLambda,em,gs,ZcplcFuFuhhL,ZcplcFuFuhhR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_hhTocFuFu(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,MFu,            & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_hhTocFuFu(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,            & 
& ctcplcFuFuhhR,MFu,MFu2,Mhh,Mhh2,Zfhh,ZfUL,ZfUR,AmpWavehhTocFuFu)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhTocFuFu(MFd,MFu,MG0,Mhh,MHp,MVG,MVP,MVWp,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_hhTocFuFu(MFd,MFu,MG0,Mhh,MHp,MVG,MVP,MVWp,            & 
& MVZ,MFd2,MFu2,MG02,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuG0L,cplcFuFuG0R,             & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplcFuFuVZL,cplcFuFuVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,         & 
...
& cplhhVZVZ,AmpVertexIRdrhhTocFuFu)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_hhTocFuFu(MFdOS,MFuOS,MG0OS,MhhOS,MHpOS,               & 
& MVG,MVP,MVWpOS,MVZOS,MFd2OS,MFu2OS,MG02OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_hhToH0H0(cplH0H0hh,MH0,Mhh,MH02,Mhh2,AmpTreehhToH0H0)

  Else 
Call Amplitude_Tree_Inert_hhToH0H0(ZcplH0H0hh,MH0,Mhh,MH02,Mhh2,AmpTreehhToH0H0)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_hhToH0H0(MLambda,em,gs,cplH0H0hh,MH0OS,MhhOS,MRPhhToH0H0,       & 
& MRGhhToH0H0)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_hhToH0H0(MLambda,em,gs,ZcplH0H0hh,MH0OS,MhhOS,MRPhhToH0H0,      & 
& MRGhhToH0H0)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_hhToH0H0(MLambda,em,gs,cplH0H0hh,MH0,Mhh,MRPhhToH0H0,           & 
& MRGhhToH0H0)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_hhToH0H0(MLambda,em,gs,ZcplH0H0hh,MH0,Mhh,MRPhhToH0H0,          & 
& MRGhhToH0H0)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_hhToH0H0(cplH0H0hh,ctcplH0H0hh,MH0,MH02,Mhh,Mhh2,           & 
& ZfH0,Zfhh,AmpWavehhToH0H0)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhToH0H0(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_hhToH0H0(MA0,MG0,MH0,Mhh,MHp,MVWp,MVZ,MA02,            & 
& MG02,MH02,Mhh2,MHp2,MVWp2,MVZ2,cplA0A0hh,cplA0G0H0,cplA0H0hh,cplA0H0VZ,cplG0G0hh,      & 
& cplG0H0H0,cplG0hhVZ,cplH0H0hh,cplH0HpcHp,cplH0HpcVWp,cplH0cHpVWp,cplhhhhhh,            & 
& cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,cplA0A0H0H01,cplA0G0H0hh1,   & 
& cplA0H0hhhh1,cplG0G0H0H01,cplG0H0H0hh1,cplH0H0H0H01,cplH0H0hhhh1,cplH0H0HpcHp1,        & 
& cplH0H0cVWpVWp1,cplH0H0VZVZ1,cplH0hhHpcHp1,AmpVertexIRdrhhToH0H0)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_hhToH0H0(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,MVWpOS,         & 
& MVZOS,MA02OS,MG02OS,MH02OS,Mhh2OS,MHp2OS,MVWp2OS,MVZ2OS,cplA0A0hh,cplA0G0H0,           & 
& cplA0H0hh,cplA0H0VZ,cplG0G0hh,cplG0H0H0,cplG0hhVZ,ZcplH0H0hh,cplH0HpcHp,               & 
...
Call Amplitude_IR_VERTEX_Inert_hhToH0H0(MA0OS,MG0OS,MH0OS,MhhOS,MHpOS,MVWpOS,         & 
& MVZOS,MA02OS,MG02OS,MH02OS,Mhh2OS,MHp2OS,MVWp2OS,MVZ2OS,cplA0A0hh,cplA0G0H0,           & 
& cplA0H0hh,cplA0H0VZ,cplG0G0hh,cplG0H0H0,cplG0hhVZ,cplH0H0hh,cplH0HpcHp,cplH0HpcVWp,    & 
& cplH0cHpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,       & 
& cplA0A0H0H01,cplA0G0H0hh1,cplA0H0hhhh1,cplG0G0H0H01,cplG0H0H0hh1,cplH0H0H0H01,         & 
& cplH0H0hhhh1,cplH0H0HpcHp1,cplH0H0cVWpVWp1,cplH0H0VZVZ1,cplH0hhHpcHp1,AmpVertexIRoshhToH0H0)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_hhTohhhh(cplhhhhhh,Mhh,Mhh2,AmpTreehhTohhhh)

  Else 
Call Amplitude_Tree_Inert_hhTohhhh(Zcplhhhhhh,Mhh,Mhh2,AmpTreehhTohhhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_hhTohhhh(MLambda,em,gs,cplhhhhhh,MhhOS,MRPhhTohhhh,             & 
& MRGhhTohhhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_hhTohhhh(MLambda,em,gs,Zcplhhhhhh,MhhOS,MRPhhTohhhh,            & 
& MRGhhTohhhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_hhTohhhh(MLambda,em,gs,cplhhhhhh,Mhh,MRPhhTohhhh,               & 
& MRGhhTohhhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_hhTohhhh(MLambda,em,gs,Zcplhhhhhh,Mhh,MRPhhTohhhh,              & 
& MRGhhTohhhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_hhTohhhh(cplhhhhhh,ctcplhhhhhh,Mhh,Mhh2,Zfhh,               & 
& AmpWavehhTohhhh)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhTohhhh(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,MVWp,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_hhTohhhh(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,              & 
...
& AmpVertexIRdrhhTohhhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_hhTohhhh(MA0OS,MFdOS,MFeOS,MFuOS,MG0OS,MH0OS,          & 
& MhhOS,MHpOS,MVWpOS,MVZOS,MA02OS,MFd2OS,MFe2OS,MFu2OS,MG02OS,MH02OS,Mhh2OS,             & 
& MHp2OS,MVWp2OS,MVZ2OS,cplA0A0hh,cplA0H0hh,cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,         & 
& cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplG0G0hh,cplG0hhVZ,cplcgWpgWphh,cplcgWCgWChh,     & 
& cplcgZgZhh,cplH0H0hh,Zcplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,       & 
& cplhhVZVZ,cplA0A0hhhh1,cplA0H0hhhh1,cplG0G0hhhh1,cplH0H0hhhh1,cplhhhhhhhh1,            & 
& cplhhhhHpcHp1,cplhhhhcVWpVWp1,cplhhhhVZVZ1,AmpVertexIRoshhTohhhh)
...
& MHp2OS,MVWp2OS,MVZ2OS,cplA0A0hh,cplA0H0hh,cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,         & 
& cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplG0G0hh,cplG0hhVZ,cplcgWpgWphh,cplcgWCgWChh,     & 
& cplcgZgZhh,cplH0H0hh,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,        & 
& cplhhVZVZ,cplA0A0hhhh1,cplA0H0hhhh1,cplG0G0hhhh1,cplH0H0hhhh1,cplhhhhhhhh1,            & 
& cplhhhhHpcHp1,cplhhhhcVWpVWp1,cplhhhhVZVZ1,AmpVertexIRoshhTohhhh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_hhTocHpHp(cplhhHpcHp,Mhh,MHp,Mhh2,MHp2,AmpTreehhTocHpHp)

  Else 
Call Amplitude_Tree_Inert_hhTocHpHp(ZcplhhHpcHp,Mhh,MHp,Mhh2,MHp2,AmpTreehhTocHpHp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_hhTocHpHp(MLambda,em,gs,cplhhHpcHp,MhhOS,MHpOS,MRPhhTocHpHp,    & 
& MRGhhTocHpHp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_hhTocHpHp(MLambda,em,gs,ZcplhhHpcHp,MhhOS,MHpOS,MRPhhTocHpHp,   & 
& MRGhhTocHpHp)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_hhTocHpHp(MLambda,em,gs,cplhhHpcHp,Mhh,MHp,MRPhhTocHpHp,        & 
& MRGhhTocHpHp)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_hhTocHpHp(MLambda,em,gs,ZcplhhHpcHp,Mhh,MHp,MRPhhTocHpHp,       & 
& MRGhhTocHpHp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_hhTocHpHp(cplhhHpcHp,ctcplhhHpcHp,Mhh,Mhh2,MHp,             & 
& MHp2,Zfhh,ZfHp,AmpWavehhTocHpHp)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhTocHpHp(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,MVP,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_hhTocHpHp(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,             & 
...
& cplHpcHpVZVZ1,AmpVertexIRdrhhTocHpHp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_hhTocHpHp(MA0OS,MFdOS,MFeOS,MFuOS,MG0OS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_hhToHpcVWp(cplhhHpcVWp,Mhh,MHp,MVWp,Mhh2,MHp2,              & 
& MVWp2,AmpTreehhToHpcVWp)

  Else 
Call Amplitude_Tree_Inert_hhToHpcVWp(ZcplhhHpcVWp,Mhh,MHp,MVWp,Mhh2,MHp2,             & 
& MVWp2,AmpTreehhToHpcVWp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_hhToHpcVWp(MLambda,em,gs,cplhhHpcVWp,MhhOS,MHpOS,               & 
& MVWpOS,MRPhhToHpcVWp,MRGhhToHpcVWp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_hhToHpcVWp(MLambda,em,gs,ZcplhhHpcVWp,MhhOS,MHpOS,              & 
& MVWpOS,MRPhhToHpcVWp,MRGhhToHpcVWp)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_hhToHpcVWp(MLambda,em,gs,cplhhHpcVWp,Mhh,MHp,MVWp,              & 
& MRPhhToHpcVWp,MRGhhToHpcVWp)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_hhToHpcVWp(MLambda,em,gs,ZcplhhHpcVWp,Mhh,MHp,MVWp,             & 
& MRPhhToHpcVWp,MRGhhToHpcVWp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_hhToHpcVWp(cplhhHpcVWp,ctcplhhHpcVWp,Mhh,Mhh2,              & 
& MHp,MHp2,MVWp,MVWp2,Zfhh,ZfHp,ZfVWp,AmpWavehhToHpcVWp)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhToHpcVWp(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,               & 
& MVP,MVWp,MVZ,MA02,MFd2,MFe2,MFu2,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0A0hh,        & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_hhToHpcVWp(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,            & 
& MVP,MVWp,MVZ,MA02,MFd2,MFe2,MFu2,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0A0hh,        & 
& cplA0H0hh,cplA0HpcHp,cplA0HpcVWp,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdHpL,cplcFuFdHpR,      & 
& cplcFeFehhL,cplcFeFehhR,cplcFvFeHpL,cplcFvFeHpR,cplcFuFuhhL,cplcFuFuhhR,               & 
& cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplG0hhVZ,cplG0HpcVWp,         & 
...
& cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,cplHpcHpVP,        & 
& cplHpcVWpVP,cplHpcHpVZ,cplHpcVWpVZ,cplcVWpVPVWp,cplcVWpVWpVZ,cplG0HpcVWpVZ1,           & 
& cplhhhhcVWpVWp1,cplhhHpcVWpVP1,cplhhHpcVWpVZ1,cplHpcHpcVWpVWp1,AmpVertexIRdrhhToHpcVWp)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_hhToHpcVWp(MA0OS,MFdOS,MFeOS,MFuOS,MG0OS,              & 
& MH0OS,MhhOS,MHpOS,MVP,MVWpOS,MVZOS,MA02OS,MFd2OS,MFe2OS,MFu2OS,MG02OS,MH02OS,          & 
& Mhh2OS,MHp2OS,MVP2,MVWp2OS,MVZ2OS,cplA0A0hh,cplA0H0hh,cplA0HpcHp,cplA0HpcVWp,          & 
...
& cplcgZgAhh,cplcgWpgAHp,cplcgWpgWphh,cplcgAgWpcVWp,cplcgZgWpcVWp,cplcgWCgWChh,          & 
& cplcgZgWCHp,cplcgZgZhh,cplcgWpgZHp,cplcgWCgZcVWp,cplH0H0hh,cplH0HpcHp,cplH0HpcVWp,     & 
& cplhhhhhh,GZcplhhHpcHp,ZcplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,cplHpcHpVP,     & 
& GZcplHpcVWpVP,cplHpcHpVZ,cplHpcVWpVZ,cplcVWpVPVWp,cplcVWpVWpVZ,cplG0HpcVWpVZ1,         & 
& cplhhhhcVWpVWp1,cplhhHpcVWpVP1,cplhhHpcVWpVZ1,cplHpcHpcVWpVWp1,AmpVertexIRoshhToHpcVWp)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_hhTocVWpVWp(cplhhcVWpVWp,Mhh,MVWp,Mhh2,MVWp2,               & 
& AmpTreehhTocVWpVWp)

  Else 
Call Amplitude_Tree_Inert_hhTocVWpVWp(ZcplhhcVWpVWp,Mhh,MVWp,Mhh2,MVWp2,              & 
& AmpTreehhTocVWpVWp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_hhTocVWpVWp(MLambda,em,gs,cplhhcVWpVWp,MhhOS,MVWpOS,            & 
& MRPhhTocVWpVWp,MRGhhTocVWpVWp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_hhTocVWpVWp(MLambda,em,gs,ZcplhhcVWpVWp,MhhOS,MVWpOS,           & 
& MRPhhTocVWpVWp,MRGhhTocVWpVWp)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_hhTocVWpVWp(MLambda,em,gs,cplhhcVWpVWp,Mhh,MVWp,MRPhhTocVWpVWp, & 
& MRGhhTocVWpVWp)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_hhTocVWpVWp(MLambda,em,gs,ZcplhhcVWpVWp,Mhh,MVWp,               & 
& MRPhhTocVWpVWp,MRGhhTocVWpVWp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_hhTocVWpVWp(cplhhcVWpVWp,ctcplhhcVWpVWp,Mhh,Mhh2,           & 
& MVWp,MVWp2,Zfhh,ZfVWp,AmpWavehhTocVWpVWp)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhTocVWpVWp(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,              & 
& MVP,MVWp,MVZ,MA02,MFd2,MFe2,MFu2,MG02,MH02,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplA0A0hh,        & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_hhTocVWpVWp(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,               & 
...
& cplcVWpcVWpVWpVWp3Q,cplcVWpVWpVZVZ2Q,cplcVWpVWpVZVZ3Q,cplcVWpVWpVZVZ1Q,AmpVertexIRdrhhTocVWpVWp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_hhTocVWpVWp(MA0OS,MFdOS,MFeOS,MFuOS,MG0OS,             & 
& MH0OS,MhhOS,MHpOS,MVP,MVWpOS,MVZOS,MA02OS,MFd2OS,MFe2OS,MFu2OS,MG02OS,MH02OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_Inert_hhToVZVZ(cplhhVZVZ,Mhh,MVZ,Mhh2,MVZ2,AmpTreehhToVZVZ)

  Else 
Call Amplitude_Tree_Inert_hhToVZVZ(ZcplhhVZVZ,Mhh,MVZ,Mhh2,MVZ2,AmpTreehhToVZVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_Inert_hhToVZVZ(MLambda,em,gs,cplhhVZVZ,MhhOS,MVZOS,MRPhhToVZVZ,       & 
& MRGhhToVZVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_Inert_hhToVZVZ(MLambda,em,gs,ZcplhhVZVZ,MhhOS,MVZOS,MRPhhToVZVZ,      & 
& MRGhhToVZVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_Inert_hhToVZVZ(MLambda,em,gs,cplhhVZVZ,Mhh,MVZ,MRPhhToVZVZ,           & 
& MRGhhToVZVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_Inert_hhToVZVZ(MLambda,em,gs,ZcplhhVZVZ,Mhh,MVZ,MRPhhToVZVZ,          & 
& MRGhhToVZVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_Inert_hhToVZVZ(cplhhVZVZ,ctcplhhVZVZ,Mhh,Mhh2,MVZ,MVZ2,           & 
& Zfhh,ZfVZ,AmpWavehhToVZVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhToVZVZ(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,MVWp,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_Inert_hhToVZVZ(MA0,MFd,MFe,MFu,MG0,MH0,Mhh,MHp,              & 
...
& cplcVWpVWpVZVZ3Q,cplcVWpVWpVZVZ1Q,AmpVertexIRdrhhToVZVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_Inert_hhToVZVZ(MA0OS,MFdOS,MFeOS,MFuOS,MG0OS,MH0OS,          & 
& MhhOS,MHpOS,MVWpOS,MVZOS,MA02OS,MFd2OS,MFe2OS,MFu2OS,MG02OS,MH02OS,Mhh2OS,             & 
& MHp2OS,MVWp2OS,MVZ2OS,cplA0A0hh,cplA0H0VZ,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,         & 
& cplcFdFdVZR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuhhL,               & 
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplG0G0hh,cplG0hhVZ,cplcgWpgWphh,cplcgWpgWpVZ,     & 
& cplcgWCgWChh,cplcgWCgWCVZ,cplH0H0hh,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,      & 
& cplhhcVWpVWp,ZcplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVWpVZ,cplcVWpVWpVZ,               & 
...
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplG0G0hh,cplG0hhVZ,cplcgWpgWphh,cplcgWpgWpVZ,     & 
& cplcgWCgWChh,cplcgWCgWCVZ,cplH0H0hh,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,      & 
& cplhhcVWpVWp,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVWpVZ,cplcVWpVWpVZ,cplA0A0VZVZ1,   & 
& cplG0G0VZVZ1,cplH0H0VZVZ1,cplhhhhVZVZ1,cplhhHpcVWpVZ1,cplhhcHpVWpVZ1,cplHpcHpVZVZ1,    & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_hhToA0hh(MA0OS,MhhOS,MHpOS,MVWpOS,MA02OS,Mhh2OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhToA0hh(MA0,Mhh,MHp,MVWp,MA02,Mhh2,MHp2,MVWp2,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_hhToA0VP(MA0OS,MhhOS,MHpOS,MVP,MVWpOS,MA02OS,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhToA0VP(MA0,Mhh,MHp,MVP,MVWp,MA02,Mhh2,MHp2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_hhToA0VZ(MA0OS,MhhOS,MHpOS,MVWpOS,MVZOS,MA02OS,           & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhToA0VZ(MA0,Mhh,MHp,MVWp,MVZ,MA02,Mhh2,MHp2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_hhToFvcFv(MFeOS,MhhOS,MHpOS,MVWpOS,MVZOS,MFe2OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhToFvcFv(MFe,Mhh,MHp,MVWp,MVZ,MFe2,Mhh2,MHp2,            & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_hhToH0hh(MH0OS,MhhOS,MHpOS,MVWpOS,MH02OS,Mhh2OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhToH0hh(MH0,Mhh,MHp,MVWp,MH02,Mhh2,MHp2,MVWp2,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_hhToH0VP(MH0OS,MhhOS,MHpOS,MVP,MVWpOS,MH02OS,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhToH0VP(MH0,Mhh,MHp,MVP,MVWp,MH02,Mhh2,MHp2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_hhToH0VZ(MH0OS,MhhOS,MHpOS,MVWpOS,MVZOS,MH02OS,           & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhToH0VZ(MH0,Mhh,MHp,MVWp,MVZ,MH02,Mhh2,MHp2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_hhTohhVP(MFdOS,MFeOS,MFuOS,MhhOS,MHpOS,MVP,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhTohhVP(MFd,MFe,MFu,Mhh,MHp,MVP,MVWp,MFd2,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_hhTohhVZ(MA0OS,MFdOS,MFeOS,MFuOS,MH0OS,MhhOS,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhTohhVZ(MA0,MFd,MFe,MFu,MH0,Mhh,MHp,MVWp,MVZ,            & 
& MA02,MFd2,MFe2,MFu2,MH02,Mhh2,MHp2,MVWp2,MVZ2,cplA0A0hh,cplA0H0hh,cplA0H0VZ,           & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFehhL,cplcFeFehhR,               & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_hhToVGVG(MFdOS,MFuOS,MhhOS,MVG,MFd2OS,MFu2OS,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhToVGVG(MFd,MFu,Mhh,MVG,MFd2,MFu2,Mhh2,MVG2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_hhToVPVP(MFdOS,MFeOS,MFuOS,MhhOS,MHpOS,MVP,               & 
& MVWpOS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHp2OS,MVP2,MVWp2OS,cplcFdFdhhL,cplcFdFdhhR,        & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,               & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcgWpgWphh,cplcgWpgWpVP,             & 
& cplcgWCgWChh,cplcgWCgWCVP,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhToVPVP(MFd,MFe,MFu,Mhh,MHp,MVP,MVWp,MFd2,               & 
& MFe2,MFu2,Mhh2,MHp2,MVP2,MVWp2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,        & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFuFuhhL,cplcFuFuhhR,               & 
& cplcFuFuVPL,cplcFuFuVPR,cplcgWpgWphh,cplcgWpgWpVP,cplcgWCgWChh,cplcgWCgWCVP,           & 
& cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplHpcHpVP,cplHpcVWpVP,cplcHpVPVWp,    & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_Inert_hhToVPVZ(MFdOS,MFeOS,MFuOS,MhhOS,MHpOS,MVP,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_Inert_hhToVPVZ(MFd,MFe,MFu,Mhh,MHp,MVP,MVWp,MVZ,MFd2,           & 
...
End Module Wrapper_OneLoopDecay_hh_Inert
