...
& ZUinput,ZULinput,ZURinput,ZVinput,ZWinput,ZZinput,betaHinput,vdinput,vuinput,          & 
& vSinput,g1input,g2input,g3input,Ydinput,Yeinput,laminput,kapinput,Yuinput,             & 
& Tdinput,Teinput,Tlaminput,Tkinput,Tuinput,mq2input,ml2input,mHd2input,mHu2input,       & 
& md2input,mu2input,me2input,ms2input,M1input,M2input,M3input,mass_Qerror)

Implicit None 
Integer, Intent(inout) :: kont 
Logical, Intent(in) :: WriteOut 
Real(dp), Intent(in) :: delta 
Real(dp) :: mass_in(46), mass_new(46) 
Real(dp), Intent(out) :: mass_Qerror(46) 
