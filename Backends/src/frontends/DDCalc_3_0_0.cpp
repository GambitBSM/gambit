...
#include "gambit/Backends/frontends/DDCalc_3_0_0.hpp"
...
BE_NAMESPACE
{
  ...
  void DDCalc_CalcRates_mod_simple(const int& D, const double& tobsmax, const double& tobsmin) { DDCalc_CalcRates_mod(D, WIMP, Halo, tobsmax, tobsmin); }
}
END_BE_NAMESPACE
