...
BE_NAMESPACE
{
  ...
  /// This version of SuperIso does not ship with a computation of the mcmc mass, so fake it with the sminputs value
  double mcmc_from_pole(double, int, parameters* param)
  {
    return param->mass_c;
  }
  ...
  {
    Cpb[7]+=param->Re_DeltaC7_Prime;
    Cpb[9]+=param->Re_DeltaC9_Prime;
    Cpb[10]+=param->Re_DeltaC10_Prime;
  }
