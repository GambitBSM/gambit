...
///  \file
///
///  Frontend for SPheno 4.3.0 backend (SARAH NMSSMEFT version)
///
///  *********************************************
///
...
#include "gambit/Backends/frontends/SARAHSPheno_NMSSMEFT_4_0_3.hpp"
...
BE_NAMESPACE
{
  ...
  int run_SPheno(Spectrum &spectrum, const Finputs &inputs)
  {
    ...
    *CalcTBD = false;
    ...
    // Intialize variables native to SARAH-SPheno_NMSSMEFT
    Freal8 vSM = 0.0;
    Freal8 g1SM = 0.0;
    Freal8 g2SM = 0.0;
    Freal8 g3SM = 0.0;
