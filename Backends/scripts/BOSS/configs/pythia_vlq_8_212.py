...
gambit_backend_name      = 'Pythia_VLQ'
...
input_files   = [
                  ...
                  '../../../Backends/installed/'+gambit_backend_name.lower()+'/'+gambit_backend_version+'/include/Pythia8Plugins/CombineMatchingInput.h',
