...
/// type \em TYPE.
#define DECLARE_FUNCTION(TYPE, FLAG)                      CORE_DECLARE_FUNCTION(MODULE, CAPABILITY, FUNCTION, TYPE, FLAG, NOT_MODEL, NOT_EMULATABLE)
/// Long (all argument) version of \link DECLARE_FUNCTION() DECLARE_FUNCTION\endlink.
#define LONG_DECLARE_FUNCTION(MODULE, CAPABILITY, FUNCTION, TYPE, FLAG) CORE_DECLARE_FUNCTION(MODULE, CAPABILITY, FUNCTION, TYPE, FLAG, NOT_MODEL, NOT_EMULATABLE)

#define DECLARE_EMULATABLE_FUNCTION(TYPE)                 CORE_DECLARE_FUNCTION(MODULE, CAPABILITY, FUNCTION, TYPE, 0, NOT_MODEL, EMULATABLE)
