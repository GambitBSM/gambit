...
#define DECLARE_EMULATABLE_FUNCTION(TYPE)                 MODULE_DECLARE_FUNCTION(MODULE, FUNCTION, TYPE, 0, NOT_MODEL) //CORE_DECLARE_FUNCTION(MODULE, CAPABILITY, FUNCTION, TYPE, 0, NOT_MODEL, EMULATABLE) // TODO: See if this works here.
