...
//CQ2p in the general THDM capability
  ...
  START_CAPABILITY
    ...
    MODEL_CONDITIONAL_DEPENDENCY(THDM_spectrum, Spectrum, THDM, THDMatQ, THDM_physical)
    MODEL_CONDITIONAL_DEPENDENCY(DeltaC7, std::complex<double>, THDM, THDMatQ, THDM_physical)
    MODEL_CONDITIONAL_DEPENDENCY(DeltaC9, std::complex<double>, THDM, THDMatQ, THDM_physical)
    MODEL_CONDITIONAL_DEPENDENCY(DeltaC10, std::complex<double>, THDM, THDMatQ, THDM, physical)
    MODEL_CONDITIONAL_DEPENDENCY(DeltaC7p, std::complex<double>, THDM, THDMatQ, THDM_physical)
    MODEL_CONDITIONAL_DEPENDENCY(DeltaC9p, std::complex<double>, THDM, THDMatQ, THDM_physical)
    MODEL_CONDITIONAL_DEPENDENCY(DeltaC10p, std::complex<double>, THDM, THDMatQ, THDM_physical)
    MODEL_CONDITIONAL_DEPENDENCY(DeltaCQ1, std::complex<double>, THDM, THDMatQ, THDM_physical)
    MODEL_CONDITIONAL_DEPENDENCY(DeltaCQ2, std::complex<double>, THDM, THDMatQ, THDM_physical)
    MODEL_CONDITIONAL_DEPENDENCY(DeltaCQ1p, std::complex<double>, THDM, THDMatQ, THDM_physical)
    MODEL_CONDITIONAL_DEPENDENCY(DeltaCQ2p, std::complex<double>, THDM, THDMatQ, THDM_physical)
    #undef FUNCTION
  #undef CAPABILITY
