...
// Old Analysis Name: CMS_13TeV_0LEP_chargino_VV_VH_137invfb
...
namespace Gambit
{
  namespace ColliderBit
  {
    ...
    class Analysis_CMS_SUS_21_002 : public Analysis
    {
    private:
    ...
    public:
      ...
      static constexpr const char* CUTFLOW_NAME = "CMS-SUS-21-002";

      Analysis_CMS_SUS_21_002()
      {
#ifdef CHECK_CUTFLOW
      ...
      void run(const HEPUtils::Event *event)
      {
        ...
        if (WH_SR)    _cutflows[CUTFLOW_NAME].fill(11);
        if (W_SR)     _cutflows[CUTFLOW_NAME].fill(12);
        if (H_SR)     _cutflows[CUTFLOW_NAME].fill(13);
#endif
    ...
    // Factory fn
    DEFINE_ANALYSIS_FACTORY(CMS_SUS_21_002)
