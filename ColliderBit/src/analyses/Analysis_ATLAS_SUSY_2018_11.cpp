...
///  - code in Analysis_ATLAS_SUSY_2016_27.cpp by Martin White
///
///
...
namespace Gambit
{
  namespace ColliderBit
  {
    ...
    class Analysis_ATLAS_SUSY_2018_11 : public Analysis
    {
    protected:
    ...
    public:
      ...
      Analysis_ATLAS_SUSY_2018_11()
      {
        ...
        set_analysis_name("ATLAS_SUSY_2018_11");
        set_luminosity(139.);
    ...
    // Factory function
    DEFINE_ANALYSIS_FACTORY(ATLAS_SUSY_2018_11)
