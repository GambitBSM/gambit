  ...
  namespace ColliderBit
  {
    ...
    public:
      ...
      _cutflow("ATLAS 2-lep chargino-W 13 TeV", {"Two_OS_leptons", "mll_25", "b_jet_veto", "MET_100", "MET_significance_10", "n_j<=1", "m_ll_m_Z"})
      {
        ...
        set_analysis_name("ATLAS_CONF_2018_042");
        set_luminosity(80.5);
    ...
    // Factory fn
    DEFINE_ANALYSIS_FACTORY(ATLAS_CONF_2018_042)


    //
    // Derived analysis class for the 2Lep0Jets SRs
    //
    class Analysis_ATLAS_CONF_2018_042_chargino_inclusive : public Analysis_ATLAS_CONF_2018_042 {

    public:
      Analysis_ATLAS_CONF_2018_042_chargino_inclusive() {
        set_analysis_name("ATLAS_CONF_2018_042_chargino_inclusive");
      }
    ...
    // Factory fn
    DEFINE_ANALYSIS_FACTORY(ATLAS_CONF_2018_042_chargino_inclusive)

    //
    // Derived analysis class for the 3Lep SRs
    //
    class Analysis_ATLAS_CONF_2018_042_chargino_binned : public Analysis_ATLAS_CONF_2018_042 {

    public:
      Analysis_ATLAS_CONF_2018_042_chargino_binned() {
        set_analysis_name("ATLAS_CONF_2018_042_chargino_binned");
      }
    ...
    // Factory fn
    DEFINE_ANALYSIS_FACTORY(ATLAS_CONF_2018_042_chargino_binned)
