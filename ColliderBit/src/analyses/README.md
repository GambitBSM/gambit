...
- Physics-object requirement types, in all cases implying a context-dependent
  ...
  - `P`, `J`, `JJ`, `B`: photons, jets, large-R/reclustered jets, and b-jets.
...
- Boolean event-characteristic requirement types, which can be negated
  ...
  - `MET`: significantly large missing transverse momentum; no absolute number is implied, other than non-zero.
