...
//            bool MTmin_l_120 = MTmin<120;
//            bool MTmin_g_120 = MTmin>120;
...
//            bool SSHH_combine = ((MTmin_l_120&&((met_50_200&&Nj_5)||met_200_300)) or (MTmin_g_120&&met<300) )&&HT_300 ;

//            // SSHH: exactly 2 leptons, both with PT>25 GeV, and MET>50 GeV
//            if (leptons.size()==2 and leptons[1]->pT() > 25.) {

//                if (Nb==0) {
//                    if (MTmin_l_120 and met_50_200  and Nj_2_4 and HT_300)               _counters.at("SRHH-0").add_event(event);
//                    if (MTmin_l_120 and met_50_200  and Nj_2_4 and HT_300_1125)          _counters.at("SRHH-1").add_event(event);
//                    if (SSHH_combine)                                                     _counters.at("SRHH-2").add_event(event);
//                    if (MTmin_l_120 and met_50_200  and Nj_5   and HT_300_1125)          _counters.at("SRHH-3").add_event(event);
//                    if (MTmin_l_120 and met_200_300 and Nj_2_4 and HT_300_1125 and pp)   _counters.at("SRHH-4").add_event(event);
//                    if (MTmin_l_120 and met_200_300 and Nj_2_4 and HT_300_1125 and !pp)  _counters.at("SRHH-5").add_event(event);
//                    if (MTmin_l_120 and met_200_300 and Nj_5   and HT_300_1125)          _counters.at("SRHH-6").add_event(event);
//                    if (MTmin_g_120 and met_50_200  and Nj_2_4 and HT_300_1125 and pp)   _counters.at("SRHH-7").add_event(event);
//                    if (MTmin_g_120 and met_50_200  and Nj_2_4 and HT_300_1125 and !pp)  _counters.at("SRHH-8").add_event(event);
//                    if (MTmin_g_120 and((met_50_200&&Nj_5)||met_200_300)and HT_300_1125) _counters.at("SRHH-9").add_event(event);
//                } else if (Nb==1) {
//                    if (MTmin_l_120 and met_50_200  and Nj_2_4 and HT_300)              _counters.at("SRHH-10").add_event(event);
//                    if (MTmin_l_120 and met_50_200  and Nj_2_4 and HT_300_1125)         _counters.at("SRHH-11").add_event(event);
//                    if (SSHH_combine and pp)                                             _counters.at("SRHH-12").add_event(event);
//                    if (SSHH_combine and !pp)                                            _counters.at("SRHH-13").add_event(event);
//                    if (MTmin_l_120 and met_50_200  and Nj_5   and HT_300_1125 and pp)  _counters.at("SRHH-14").add_event(event);
//                    if (MTmin_l_120 and met_50_200  and Nj_5   and HT_300_1125 and !pp) _counters.at("SRHH-15").add_event(event);
//                    if (MTmin_l_120 and met_200_300 and Nj_2_4 and HT_300_1125 and pp)  _counters.at("SRHH-16").add_event(event);
//                    if (MTmin_l_120 and met_200_300 and Nj_2_4 and HT_300_1125 and !pp) _counters.at("SRHH-17").add_event(event);
//                    if (MTmin_l_120 and met_200_300 and Nj_5   and HT_300_1125)         _counters.at("SRHH-18").add_event(event);
//                    if (MTmin_g_120 and met_50_200  and Nj_2_4 and HT_300_1125 and pp)  _counters.at("SRHH-19").add_event(event);
//                    if (MTmin_g_120 and met_50_200  and Nj_2_4 and HT_300_1125 and !pp) _counters.at("SRHH-20").add_event(event);
//                    if (MTmin_g_120 and((met_50_200&&Nj_5)||met_200_300)and HT_300_1125) _counters.at("SRHH-21").add_event(event);
//                } else if (Nb==2){
//                    if (MTmin_l_120 and met_50_200  and Nj_2_4 and HT_300)              _counters.at("SRHH-22").add_event(event);
//                    if (MTmin_l_120 and met_50_200  and Nj_2_4 and HT_300_1125)         _counters.at("SRHH-23").add_event(event);
//                    if (SSHH_combine and pp)                                             _counters.at("SRHH-24").add_event(event);
//                    if (SSHH_combine and !pp)                                            _counters.at("SRHH-25").add_event(event);
//                    if (MTmin_l_120 and met_50_200  and Nj_5   and HT_300_1125 and pp)  _counters.at("SRHH-26").add_event(event);
//                    if (MTmin_l_120 and met_50_200  and Nj_5   and HT_300_1125 and !pp) _counters.at("SRHH-27").add_event(event);
//                    if (MTmin_l_120 and met_200_300 and Nj_2_4 and HT_300_1125 and pp)  _counters.at("SRHH-28").add_event(event);
//                    if (MTmin_l_120 and met_200_300 and Nj_2_4 and HT_300_1125 and !pp) _counters.at("SRHH-29").add_event(event);
//                    if (MTmin_l_120 and met_200_300 and Nj_5   and HT_300_1125)         _counters.at("SRHH-30").add_event(event);
//                    if (MTmin_g_120 and met_50_200  and Nj_2_4 and HT_300_1125 and pp)  _counters.at("SRHH-31").add_event(event);
//                    if (MTmin_g_120 and met_50_200  and Nj_2_4 and HT_300_1125 and !pp) _counters.at("SRHH-32").add_event(event);
//                    if (MTmin_g_120 and((met_50_200&&Nj_5)||met_200_300)and HT_300_1125) _counters.at("SRHH-33").add_event(event);
//                } else if (Nb>=3){
//                    if (MTmin_l_120 and met<300                and HT_300 and pp)       _counters.at("SRHH-34").add_event(event);
//                    if (MTmin_l_120 and met<300                and HT_300 and !pp)      _counters.at("SRHH-35").add_event(event);
//                    if (MTmin_l_120 and met<300     and Nj_2_4 and HT_300_1125 and pp)  _counters.at("SRHH-36").add_event(event);
//                    if (MTmin_l_120 and met<300     and Nj_2_4 and HT_300_1125 and !pp) _counters.at("SRHH-37").add_event(event);
//                    if (MTmin_l_120 and met<300     and Nj_5   and HT_300_1125 and pp)  _counters.at("SRHH-38").add_event(event);
//                    if (MTmin_l_120 and met<300     and Nj_5   and HT_300_1125 and !pp) _counters.at("SRHH-39").add_event(event);
//                    if (MTmin_g_120                            and HT_300)              _counters.at("SRHH-40").add_event(event);
//                    if (MTmin_g_120 and met<300     and Nj_2_4 and HT_300_1125 and pp)  _counters.at("SRHH-41").add_event(event);
//                    if (MTmin_g_120 and met<300     and Nj_2_4 and HT_300_1125 and !pp) _counters.at("SRHH-42").add_event(event);
//                    if (MTmin_g_120 and met<300     and Nj_5   and HT_300_1125 and pp)  _counters.at("SRHH-43").add_event(event);
//                    if (MTmin_g_120 and met<300     and Nj_5   and HT_300_1125 and !pp) _counters.at("SRHH-44").add_event(event);
//                }
...
//            bool SSHL_combine = MTmin_l_120&&( (met_50_200&&Nj_5) or met_200_300 )&&HT_300 ;

//            // SSHL: exactly 2 leptons, one with PT>25 GeV, one with PT<25 GeV,  and MET>50 GeV
//            if (leptons.size()==2 and leptons[0]->pT() > 25. and leptons[1]->pT() < 25.) {
//                if (Nb==0 and MTmin_l_120) {
...
//                }
//                if (MTmin_g_120 and met<300 and HT_300)       _counters.at("SRHL-30").add_event(event);
//                if (MTmin_g_120 and met<300 and HT_300_1125)  _counters.at("SRHL-31").add_event(event);
...
//                        if (HT<400) {
//                            if (met<150) {
//                                if (MTmin_l_120) _counters.at("SRML-0").add_event(event);
//                                else              _counters.at("SRML-1").add_event(event);
//                            } else if (met<300) {
//                                if (MTmin_l_120) _counters.at("SRML-2").add_event(event);
...
//                    if (HT>=600) {
//                        if (met<150) {
//                            if (MTmin_l_120)     _counters.at("SRML-15").add_event(event);
//                            else                  _counters.at("SRML-16").add_event(event);
//                        } else if (met<300) {
//                            if (MTmin_l_120)     _counters.at("SRML-17").add_event(event);
//                            else                  _counters.at("SRML-18").add_event(event);
//                        }
//                    }
//                    if (met>300) {
//                        if (MTmin_l_120)         _counters.at("SRML-19").add_event(event);
...
//                            double MTmin_try = sqrt(2.*leptons[i]->pT()*met*(1. - cos(leptons[i]->mom().deltaPhi(ptot))));
//                            if (MTmin_try<MTmin_Z) MTmin_Z=MTmin_try;
//                        }
//                    }
//                    bool MTmin_Z_l_120 = MTmin_Z<120;
//                    if (Nb==0) {
//                        if (HT<400) {
//                            if (met<150) {
//                                if (MTmin_Z_l_120) _counters.at("SRML-21").add_event(event);
//                                else                _counters.at("SRML-22").add_event(event);
//                            } else if (met<300) {
//                                if (MTmin_Z_l_120) _counters.at("SRML-23").add_event(event);
//                                else                _counters.at("SRML-24").add_event(event);
//                            }
//                        }
//                        else if (HT<600) {
//                            if (met<150) {
//                                if (MTmin_Z_l_120) _counters.at("SRML-25").add_event(event);
//                                else                _counters.at("SRML-26").add_event(event);
//                            } else if (met<300) {
//                                if (MTmin_Z_l_120) _counters.at("SRML-27").add_event(event);
...
//                    if (HT>=600) {
//                        if (met<150) {
//                            if (MTmin_Z_l_120)     _counters.at("SRML-38").add_event(event);
//                            else                    _counters.at("SRML-39").add_event(event);
//                        } else if (met<300) {
//                            if (MTmin_Z_l_120)     _counters.at("SRML-40").add_event(event);
//                            else                    _counters.at("SRML-41").add_event(event);
//                        }
//                    }
//                    if (met>300) {
//                        if (MTmin_Z_l_120)         _counters.at("SRML-42").add_event(event);
