...
//#include "gambit/ColliderBit/wrappertopness.h"
...
namespace Gambit
{
  namespace ColliderBit
  {
    ...
    static bool sortByPT_1l(const HEPUtils::Jet *jet1, const HEPUtils::Jet *jet2) { return (jet1->pT() > jet2->pT()); }
    static bool sortByPT_1l_sharedptr(std::shared_ptr<HEPUtils::Jet> jet1, std::shared_ptr<HEPUtils::Jet> jet2) { return sortByPT_1l(jet1.get(), jet2.get()); }
    ...
    DEFINE_ANALYSIS_FACTORY(ATLAS_SUSY_2018_07)
