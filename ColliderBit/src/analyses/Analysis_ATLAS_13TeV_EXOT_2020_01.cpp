...
/// n.b. The original paper fits to a distribution 
/// within the SR, but based on what's available,
/// we can only test against the SR itself
///  *********************************************
...
namespace Gambit
{
  namespace ColliderBit
  {
    ...
    class Analysis_ATLAS_13TeV_EXOT_2020_01 : public Analysis
    {
      ...
      public:
        ...
        Analysis_ATLAS_13TeV_EXOT_2020_01()
        {
          set_analysis_name("ATLAS_13TeV_EXOT_2020_01");
          set_luminosity(139.);
        }
        ...
        void run(const HEPUtils::Event* event)
        {
          ...
          applyEfficiency(electrons, ATLAS::eff1DEl.at("EGAM_2018_01_Recon"));
          ...
          applyEfficiency(muons, ATLAS::eff1DMu.at("MUON_2018_03_Iso_Tight"));
          ...
          // TODO: ntracks requirement not currently doable -- skipped for now (should not be big effect)
          ...
          // I think central (consistency with prev papers) but not 100% sure
        ...
        {
          const Analysis_ATLAS_13TeV_EXOT_2020_01* specificOther = dynamic_cast<const Analysis_ATLAS_13TeV_EXOT_2020_01*>(other);
        ...
        void collect_results()
        {
          ...
          // Use CRs is pyhf is ever provided
          // Control regions
    ...
    // Factory fn
    DEFINE_ANALYSIS_FACTORY(ATLAS_13TeV_EXOT_2020_01)
