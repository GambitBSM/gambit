...
// to lie between 80 and 100 GeV, together with missing transverse energy of
// at least 100 GeV.
...
namespace Gambit
{
  namespace ColliderBit
  {
    ...
    /// @brief Basic ATLAS dijet mass analysis, signal region 80-100 GeV
    class Analysis_ATLAS_13TeV_DIJETMASS_80_100_139invfb : public Analysis
    {
      public:
        ...
        Analysis_ATLAS_13TeV_DIJETMASS_80_100_139invfb()
        {
          analysis_specific_reset();
          set_analysis_name("ATLAS_13TeV_DIJETMASS_80_100_139invfb");
        ...
        void run(const Event* event)
        {
          ...
          // Signal region: dijet mass between 80 and 100 GeV
          if (mjj > 80. && mjj < 100.)
          {
        ...
        {
          const Analysis_ATLAS_13TeV_DIJETMASS_80_100_139invfb* specificOther = dynamic_cast<const Analysis_ATLAS_13TeV_DIJETMASS_80_100_139invfb*>(other);
    ...
    // Factory fn
    DEFINE_ANALYSIS_FACTORY(ATLAS_13TeV_DIJETMASS_80_100_139invfb)
