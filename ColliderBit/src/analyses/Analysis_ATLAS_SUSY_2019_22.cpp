...
namespace Gambit 
{
  namespace ColliderBit 
  {
    ...
    public:
      ...
      Analysis_ATLAS_SUSY_2019_22() 
      {
        set_analysis_name("ATLAS_SUSY_2019_22");
        set_luminosity(139);

        //Defining signal regions
        // wh
        defineSignalRegion("SRWh-high-mt2-ee-1",   "n jets (pt>25) >= 1", "Nsig >= 2", "pt(l) >= 25GeV", "Nsig = 2", "same-sign", "n bjets = 0", "met >= 50", "mjj < 350 GeV", "mt2 >= 80 GeV",  "met sig >= 7", "met: [75, 125) GeV",  "type ee");
        defineSignalRegion("SRWh-high-mt2-ee-2",   "n jets (pt>25) >= 1", "Nsig >= 2", "pt(l) >= 25GeV", "Nsig = 2", "same-sign", "n bjets = 0", "met >= 50", "mjj < 350 GeV", "mt2 >= 80 GeV",  "met sig >= 7", "met: [125,175) GeV",  "type ee");
        defineSignalRegion("SRWh-high-mt2-ee-3",   "n jets (pt>25) >= 1", "Nsig >= 2", "pt(l) >= 25GeV", "Nsig = 2", "same-sign", "n bjets = 0", "met >= 50", "mjj < 350 GeV", "mt2 >= 80 GeV",  "met sig >= 7", "met >= 175 GeV",      "type ee");
        defineSignalRegion("SRWh-high-mt2-emu-1",  "n jets (pt>25) >= 1", "Nsig >= 2", "pt(l) >= 25GeV", "Nsig = 2", "same-sign", "n bjets = 0", "met >= 50", "mjj < 350 GeV", "mt2 >= 80 GeV",  "met sig >= 7", "met: [75, 125) GeV",  "type emu");
        defineSignalRegion("SRWh-high-mt2-emu-2",  "n jets (pt>25) >= 1", "Nsig >= 2", "pt(l) >= 25GeV", "Nsig = 2", "same-sign", "n bjets = 0", "met >= 50", "mjj < 350 GeV", "mt2 >= 80 GeV",  "met sig >= 7", "met: [125, 175) GeV", "type emu");
        defineSignalRegion("SRWh-high-mt2-emu-3",  "n jets (pt>25) >= 1", "Nsig >= 2", "pt(l) >= 25GeV", "Nsig = 2", "same-sign", "n bjets = 0", "met >= 50", "mjj < 350 GeV", "mt2 >= 80 GeV",  "met sig >= 7", "met >= 175 GeV",      "type emu");
        defineSignalRegion("SRWh-high-mt2-mumu-1", "n jets (pt>25) >= 1", "Nsig >= 2", "pt(l) >= 25GeV", "Nsig = 2", "same-sign", "n bjets = 0", "met >= 50", "mjj < 350 GeV", "mt2 >= 80 GeV",  "met sig >= 7", "met: [75, 125) GeV",  "type mumu");
        defineSignalRegion("SRWh-high-mt2-mumu-2", "n jets (pt>25) >= 1", "Nsig >= 2", "pt(l) >= 25GeV", "Nsig = 2", "same-sign", "n bjets = 0", "met >= 50", "mjj < 350 GeV", "mt2 >= 80 GeV",  "met sig >= 7", "met: [125, 175) GeV", "type mumu");
        defineSignalRegion("SRWh-high-mt2-mumu-3", "n jets (pt>25) >= 1", "Nsig >= 2", "pt(l) >= 25GeV", "Nsig = 2", "same-sign", "n bjets = 0", "met >= 50", "mjj < 350 GeV", "mt2 >= 80 GeV",  "met sig >= 7", "met >= 175 GeV",      "type mumu");

        defineSignalRegion("SRWh-low-mt2-ee",      "n jets (pt>25) >= 1", "Nsig >= 2", "pt(l) >= 25GeV", "Nsig = 2", "same-sign", "n bjets = 0", "met >= 50", "mjj < 350 GeV", "mt2 < 80 GeV", "mtmin >= 100 GeV", "met sig >= 6", "type ee");
        defineSignalRegion("SRWh-low-mt2-emu",     "n jets (pt>25) >= 1", "Nsig >= 2", "pt(l) >= 25GeV", "Nsig = 2", "same-sign", "n bjets = 0", "met >= 50", "mjj < 350 GeV", "mt2 < 80 GeV", "mtmin >= 100 GeV", "met sig >= 6", "type emu");
        defineSignalRegion("SRWh-low-mt2-mumu",    "n jets (pt>25) >= 1", "Nsig >= 2", "pt(l) >= 25GeV", "Nsig = 2", "same-sign", "n bjets = 0", "met >= 50", "mjj < 350 GeV", "mt2 < 80 GeV", "mtmin >= 100 GeV", "met sig >= 6", "type mumu");

        //wz
        defineSignalRegion("SRWZ-high-mt2-1", "n jets >= 1", "Nsig(l) >= 2 && Nbl(l) >= 2", "same-sign", "Nbl(l)=2", "Nsig(l)==2", "pt(l) >= 25GeV", "n jets (pt>25) >= 1", "n bjets = 0", "mjj <= 350 GeV", "mt2 >= 100 GeV",  "mtmin >= 100 GeV", "met >= 100 GeV", "MET sig: [0,10]", "spread >= 2.2");
        defineSignalRegion("SRWZ-high-mt2-2", "n jets >= 1", "Nsig(l) >= 2 && Nbl(l) >= 2", "same-sign", "Nbl(l)=2", "Nsig(l)==2", "pt(l) >= 25GeV", "n jets (pt>25) >= 1", "n bjets = 0", "mjj <= 350 GeV", "mt2 >= 100 GeV",  "mtmin >= 100 GeV", "met >= 100 GeV", "MET sig: [10,13]");
        defineSignalRegion("SRWZ-high-mt2-3", "n jets >= 1", "Nsig(l) >= 2 && Nbl(l) >= 2", "same-sign", "Nbl(l)=2", "Nsig(l)==2", "pt(l) >= 25GeV", "n jets (pt>25) >= 1", "n bjets = 0", "mjj <= 350 GeV", "mt2 >= 100 GeV",  "mtmin >= 100 GeV", "met >= 100 GeV", "MET sig >= 13",   "dR_ll >= 1");
        defineSignalRegion("SRWZ-low-mt2",    "n jets >= 1", "Nsig(l) >= 2 && Nbl(l) >= 2", "same-sign", "Nbl(l)=2", "Nsig(l)==2", "pt(l) >= 25GeV", "n jets (pt>25) >= 1", "n bjets = 0", "mjj <= 350 GeV", "mt2 <= 100 GeV",  "mtmin >= 130 GeV", "met >= 140 GeV", "meff <= 600 GeV", "dR_ll <= 3");

        // // bRPV
        // defineSignalRegion("SRbRPV-2l-SS", "pt >= 20GeV", "n jets (> 25GeV) >= 1", "Nsig = 2", "charge = same-sign", "mt2 >= 60 GeV" , "met >= 100 GeV", "n bjets = 0", "njets (>40 GeV) <= 4");
        // defineSignalRegion("SRbRPV-3l",    "pt >= 20GeV", "n jets (> 25GeV) >= 1", "Nsig = 3", "mt2 >= 80 GeV" , "met >= 120 GeV", "meff >= 350 GeV", "mee,mmumu notin [81,101] GeV");


        // //UDD
        // defineSignalRegion("SRRPV-2l1b-L", "Nbl=2", "Nsig = 2", "charge = same-sign", "pt > 25GeV", "n jets (> 25GeV) >= 1", "n bjets = 1",  "sum pt(l) >= 100" , "met >= 100 GeV", "njets (>20 GeV) <= 2",     "sum pt_bjet / sum pt jet >= 0.7",  "sum pt jet >= 120GeV", "dR(l_1, jet)min <= 1.2", "dRll>=2.0");
        // defineSignalRegion("SRRPV-2l1b-M", "Nbl=2", "Nsig = 2", "charge = same-sign", "pt > 25GeV", "n jets (> 25GeV) >= 1", "n bjets = 1",  "sum pt(l) >= 100" , "met >= 50 GeV",  "njets (>20 GeV) = 2 or 3", "sum pt_bjet / sum pt jet >= 0.45", "sum pt jet >= 400GeV", "dR(l_1, jet)min <= 1.0", "dRll>=2.5");
        // defineSignalRegion("SRRPV-2l2b-L", "Nbl=2", "Nsig = 2", "charge = same-sign", "pt > 25GeV", "n jets (> 25GeV) >= 1", "n bjets = 2",  "met >= 80 GeV", "njets (>20 GeV) <= 3",     "sum pt_bjet / sum pt jet >= 097",  "sum pt jet >= 300GeV", "dR(l_1, jet)min <= 1.0", "dRll>=2.5");
        // defineSignalRegion("SRRPV-2l2b-M", "Nbl=2", "Nsig = 2", "charge = same-sign", "pt > 25GeV", "n jets (> 25GeV) >= 1", "n bjets = 2",  "met >= 80 GeV", "njets (>20 GeV) = 3 or 4", "sum pt_bjet / sum pt jet >= 0.75", "sum pt jet >= 420GeV", "dR(l_1, jet)min <= 1.0", "dRll>=2.5");
        // defineSignalRegion("SRRPV-2l2b-H", "Nbl=2", "Nsig = 2", "charge = same-sign", "pt > 25GeV", "n jets (> 25GeV) >= 1", "n bjets = 2",  "met >= 80 GeV", "njets (>20 GeV) => 5 or <=6", "sum pt jet >= 420GeV", "dR(l_1, jet)min <= 1.0", "dRll>=2.0");
        // defineSignalRegion("SRRPV-2l3b-L", "Nbl=2", "Nsig = 2", "charge = same-sign", "pt > 25GeV", "n jets (> 25GeV) >= 1", "n bjets >= 3", "met >= 20 GeV", "njets (>20 GeV) <= 3 ", "sum pt_bjet / sum pt jet >= 0.8", "dR(l_1, jet)min <= 1.5", "dRll>=2.0");
        // defineSignalRegion("SRRPV-2l3b-M", "Nbl=2", "Nsig = 2", "charge = same-sign", "pt > 25GeV", "n jets (> 25GeV) >= 1", "n bjets >= 3", "met >= 20 GeV", "njets (>20 GeV) <= 3 ", "sum pt_bjet / sum pt jet >= 0.8");
        // defineSignalRegion("SRRPV-2l3b-H", "Nbl=2", "Nsig = 2", "charge = same-sign", "pt > 25GeV", "n jets (> 25GeV) >= 1", "n bjets >= 3", "met >= 20 GeV", "njets (>20 GeV) <= 6",  "sum pt_bjet / sum pt jet >= 0.5", "sum pt jet >= 350GeV", "dR(l_1, jet)min <= 1.0", "dRll>=2.0");
    ...
    // Factory fn
    DEFINE_ANALYSIS_FACTORY(ATLAS_SUSY_2019_22)
