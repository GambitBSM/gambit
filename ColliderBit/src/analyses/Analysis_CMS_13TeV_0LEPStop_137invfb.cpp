...
//      High dM: Nj>=5, Nb>=1, dPhi(MET,j1,2,3,4)>0.5
        ...
        if (doCutflow)
        {
            ...
            defineSignalRegion("baseline_MET");
            defineSignalRegion("baseline_MET_Nj");
            defineSignalRegion("baseline_MET_Nj_0e0mu");
            defineSignalRegion("baseline_MET_Nj_0e0mu_0tau");
            defineSignalRegion("baseline_MET_Nj_0e0mu_0tau_Ht");
            defineSignalRegion("lowDM_NtNwNres");
            defineSignalRegion("lowDM_NtNwNres_mTb");
            defineSignalRegion("lowDM_NtNwNres_mTb_dPhi");
            defineSignalRegion("lowDM_NtNwNres_mTb_dPhi_ISR");
            defineSignalRegion("lowDM_NtNwNres_mTb_dPhi_ISR_METHt");
            defineSignalRegion("highDM_Nj");
            defineSignalRegion("highDM_Nj_Nb");
            defineSignalRegion("highDM_Nj_Nb_dPhi");
        }
