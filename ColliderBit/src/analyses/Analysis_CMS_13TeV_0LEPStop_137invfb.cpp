...
//      High dM: Nj>=5, Nb>=1, dPhi(MET,j1,2,3,4)>0.5
        ...
        if (doCutflow)
        {
            ...
            DEFINE_SIGNAL_REGION("lowDM_NtNwNres");
            DEFINE_SIGNAL_REGION("lowDM_NtNwNres_mTb");
            DEFINE_SIGNAL_REGION("lowDM_NtNwNres_mTb_dPhi");
            DEFINE_SIGNAL_REGION("lowDM_NtNwNres_mTb_dPhi_ISR");
            DEFINE_SIGNAL_REGION("lowDM_NtNwNres_mTb_dPhi_ISR_METHt");
            DEFINE_SIGNAL_REGION("highDM_Nj");
            DEFINE_SIGNAL_REGION("highDM_Nj_Nb");
            DEFINE_SIGNAL_REGION("highDM_Nj_Nb_dPhi");
        }
