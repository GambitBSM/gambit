...
namespace Gambit
{
    ...
    {
        class Analysis_ATLAS_13TeV_EXOT_2016_17 : public Analysis
        {
        private:
            /* data */
        public:
            ...
            Analysis_ATLAS_13TeV_EXOT_2016_17()
            {
                DEFINE_SIGNAL_REGION("SR");

                set_analysis_name("ATLAS_13TeV_EXOT_2016_17");
                set_luminosity(36.1);
        ...
        DEFINE_ANALYSIS_FACTORY(ATLAS_13TeV_EXOT_2016_17)
    } // namespace ColliderBit
} // namespace Gambi
