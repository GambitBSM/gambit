...
// Renamed from: Analysis_ATLAS_13TeV_2OSLEP_chargino_139invfb
...
namespace Gambit
{
  namespace ColliderBit
  {
    ...
    // - ATLAS_CONF_2019_008_chargino_binned
    // - ATLAS_CONF_2019_008_chargino_inclusive
    ...
    public:
      ...
      Analysis_ATLAS_CONF_2019_008()
      {
        #ifdef CHECK_CUTFLOW
        _cutflows.addCutflow(CUTFLOW_NAME, {"Two_OS_leptons", "mll_25", "b_jet_veto", "MET_110", "MET_significance_10", "n_j<=1", "m_ll_m_Z"});
        #endif
        ...
        set_luminosity(139);
        set_bkgjson("ColliderBit/data/analyses_json_files/ATLAS_CONF_2019_008_bkgonly.json");
      }
...
COMMIT_CUTFLOWS;
    ...
    // Factory fn
    DEFINE_ANALYSIS_FACTORY(ATLAS_CONF_2019_008)


    //
    // Derived analysis class for the 2Lep0Jets SRs
    //
    class Analysis_ATLAS_CONF_2019_008_chargino_inclusive : public Analysis_ATLAS_CONF_2019_008 {

    public:
      Analysis_ATLAS_CONF_2019_008_chargino_inclusive() {
        set_analysis_name("ATLAS_CONF_2019_008_chargino_inclusive");
      }
...
COMMIT_CUTFLOWS;
    ...
    // Factory fn
    DEFINE_ANALYSIS_FACTORY(ATLAS_CONF_2019_008_chargino_inclusive)

    //
    // Derived analysis class for the 3Lep SRs
    //
    class Analysis_ATLAS_CONF_2019_008_chargino_binned : public Analysis_ATLAS_CONF_2019_008 {

    public:
      Analysis_ATLAS_CONF_2019_008_chargino_binned() {
        set_analysis_name("ATLAS_CONF_2019_008_chargino_binned");
      }
...
COMMIT_CUTFLOWS;
    ...
    // Factory fn
    DEFINE_ANALYSIS_FACTORY(ATLAS_CONF_2019_008_chargino_binned)
