...
// Renamed from: 
//        ATLAS_13TeV_0LEPStop_RJR_139invfb
...
namespace Gambit
{
    namespace ColliderBit
    {
        ...
        public:
            ...
            {
                defineSignalRegion("SRC1");
                defineSignalRegion("SRC2");
                defineSignalRegion("SRC3");
                defineSignalRegion("SRC4");
                defineSignalRegion("SRC5");
...
#pragma omp critical(init_ATLAS_SUSY_2018_12_RJR)
                {
                    ...
                    {
                        str errmsg;
                        errmsg = "Some problem occurred when calling LAB->InitializeTree() from the Analysis_ATLAS_SUSY_2018_12_RJR analysis class.\n";
                    ...
                    {
                        str errmsg;
                        errmsg = "Some problem occured when calling LAB->InitializeAnalysis() from the Analysis_ATLAS_SUSY_2018_12_RJR analysis class.\n";
                        piped_errors.request(LOCAL_INFO, errmsg);
                    }
                }
            }
            ...
            void run(const HEPUtils::Event *event)
            {
                ...
                if (nSignalJets > 0)
                {
                    ...
                    {
                        str errmsg;
                        errmsg = "Some problem occured when calling LAB_comb->AnalyzeEvent() from the Analysis_ATLAS_SUSY_2018_12_RJR analysis class.\n";
        ...
        DEFINE_ANALYSIS_FACTORY(ATLAS_SUSY_2018_12_RJR)
