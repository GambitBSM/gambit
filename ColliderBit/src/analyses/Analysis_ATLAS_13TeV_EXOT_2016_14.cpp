...
namespace Gambit
{
    namespace ColliderBit
    {
        ...
        class Analysis_ATLAS_13TeV_EXOT_2016_14 : public Analysis
        {
            // protected:
        ...
        public:
            ...
            Analysis_ATLAS_13TeV_EXOT_2016_14()
            {
                DEFINE_SIGNAL_REGION("SR");

                set_analysis_name("ATLAS_13TeV_EXOT_2016_14");
                set_luminosity(36.1);
        ...
        DEFINE_ANALYSIS_FACTORY(ATLAS_13TeV_EXOT_2016_14)
    } // namespace ColliderBit
} // namespace Gambit {