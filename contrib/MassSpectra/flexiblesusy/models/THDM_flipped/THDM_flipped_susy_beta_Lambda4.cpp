...
double THDM_flipped_susy_parameters::calc_beta_Lambda4_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda4 = Re(oneOver16PiSqr*(2*Lambda1*Lambda4 + 2*Lambda2*
      Lambda4 + 8*Lambda3*Lambda4 + 6*Lambda4*traceYdAdjYd + 12*
      ...
      *AbsSqr(Lambda5) + 10*AbsSqr(Lambda7) + 2*(5*Lambda6 + Lambda7)*Conj(
      Lambda6) + 2*Lambda6*Conj(Lambda7) - 3*Lambda4*Sqr(g1) - 9*Lambda4*Sqr(g2
      ) + 3*Sqr(g1)*Sqr(g2) + 4*Sqr(Lambda4)));
...
double THDM_flipped_susy_parameters::calc_beta_Lambda4_2_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda4 = Re(twoLoop*(-40*Lambda1*Lambda3*Lambda4 - 40*Lambda2*
      Lambda3*Lambda4 - 48*Lambda5*Lambda6*Lambda7 - 12*Lambda1*Lambda4*
      ...
      Lambda4*traceYeAdjYe - 8*Lambda3*Lambda4*traceYeAdjYe - 4.5*Lambda4*
      ...
      - 68*Lambda4*AbsSqr(Lambda7) - 20*traceYeAdjYe*AbsSqr(Lambda7) - 60*
      traceYuAdjYu*AbsSqr(Lambda7) - 10*Lambda1*Lambda6*Conj(Lambda7) - 10*
      ...
      2.0833333333333335*Lambda4*traceYdAdjYd*Sqr(g1) + 1.3333333333333333*
      traceYdAdjYuYuAdjYd*Sqr(g1) + 6.25*Lambda4*traceYeAdjYe*Sqr(g1) +
      ...
      *Lambda1*Lambda7 - 5*Lambda2*Lambda7 - 20*Lambda3*Lambda7 - 40*Lambda4*
      Lambda7 - 30*Lambda6*traceYdAdjYd - 3*Lambda7*traceYdAdjYd - Lambda7*
      traceYeAdjYe - 3*Lambda7*traceYuAdjYu + (7*Lambda6 + 2*Lambda7)*Sqr(g1) +
      27*Lambda6*Sqr(g2)) + 40*Lambda4*traceYdAdjYd*Sqr(g3) + 64*
      traceYdAdjYuYuAdjYd*Sqr(g3) + 40*Lambda4*traceYuAdjYu*Sqr(g3) - 7*Lambda4
      *Sqr(Lambda1) - 7*Lambda4*Sqr(Lambda2) - 28*Lambda4*Sqr(Lambda3) - 20*
      Lambda1*Sqr(Lambda4) - 20*Lambda2*Sqr(Lambda4) - 28*Lambda3*Sqr(Lambda4)
      - 12*traceYdAdjYd*Sqr(Lambda4) - 4*traceYeAdjYe*Sqr(Lambda4) - 12*
      traceYuAdjYu*Sqr(Lambda4) + 8*Sqr(g1)*Sqr(Lambda4) + 18*Sqr(g2)*Sqr(
