...
// File generated at Wed 31 Oct 2018 21:01:25
 ...
 */
double THDM_flipped_susy_parameters::calc_beta_Lambda4_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double THDM_flipped_susy_parameters::calc_beta_Lambda4_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Lambda4 = Re(twoLoop*(-40*Lambda1*Lambda3*Lambda4 - 40*Lambda2*
      ...
      traceYdAdjYuYuAdjYdYdAdjYd - 24*traceYdAdjYuYuAdjYuYuAdjYd - 4*Lambda2*
      ...
      *Sqr(Lambda5) - 74*Lambda1*Sqr(Lambda6) - 10*Lambda2*Sqr(Lambda6) - 72*
      ...
      - 60*traceYdAdjYd*Sqr(Lambda6) - 10*Lambda1*Sqr(Lambda7) - 74*Lambda2*Sqr
      (Lambda7) - 72*Lambda3*Sqr(Lambda7) - 68*Lambda4*Sqr(Lambda7) - 80*
      Lambda5*Sqr(Lambda7) - 20*traceYeAdjYe*Sqr(Lambda7) - 60*traceYuAdjYu*Sqr
 ...
 */
double THDM_flipped_susy_parameters::calc_beta_Lambda4_3_loop(const Susy_traces& susy_traces) const
{
