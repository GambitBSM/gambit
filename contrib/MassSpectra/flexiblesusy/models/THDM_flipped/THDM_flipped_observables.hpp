...
#ifndef THDM_flipped_OBSERVABLES_H
#define THDM_flipped_OBSERVABLES_H
...
THDM_flipped_observables calculate_observables(
   const THDM_flipped_mass_eigenstates&, const softsusy::QedQcd&,
