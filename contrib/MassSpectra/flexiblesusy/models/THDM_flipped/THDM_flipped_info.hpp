...
namespace THDM_flipped_info {
   ...
   class THDM_flipped_particle_names : public Names {
   public:
      virtual ~THDM_flipped_particle_names() = default;
   ...
   class THDM_flipped_parameter_names : public Names {
   public:
      virtual ~THDM_flipped_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const THDM_flipped_particle_names  particle_names_getter{};
   const THDM_flipped_parameter_names parameter_names_getter{};
