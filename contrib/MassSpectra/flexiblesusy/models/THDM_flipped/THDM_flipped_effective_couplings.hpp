...
#ifndef THDM_flipped_EFFECTIVE_COUPLINGS_H
#define THDM_flipped_EFFECTIVE_COUPLINGS_H
...
class THDM_flipped_effective_couplings {
public:
   THDM_flipped_effective_couplings(const THDM_flipped_mass_eigenstates&,
   ...
   void set_model(const THDM_flipped_mass_eigenstates& model_);
