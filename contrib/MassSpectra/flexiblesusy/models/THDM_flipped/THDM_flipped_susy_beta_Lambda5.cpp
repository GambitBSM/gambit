...
// File generated at Wed 31 Oct 2018 21:01:23
 ...
 */
double THDM_flipped_susy_parameters::calc_beta_Lambda5_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double THDM_flipped_susy_parameters::calc_beta_Lambda5_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Lambda5 = Re(twoLoop*(-40*Lambda1*Lambda3*Lambda5 - 40*Lambda2*
      ...
      *Sqr(Lambda6) - 72*Lambda5*Sqr(Lambda6) - 60*traceYdAdjYd*Sqr(Lambda6) -
      ...
      Lambda7) - 76*Lambda4*Sqr(Lambda7) - 72*Lambda5*Sqr(Lambda7) - 20*
 ...
 */
double THDM_flipped_susy_parameters::calc_beta_Lambda5_3_loop(const Susy_traces& susy_traces) const
{
