...
/**
 * @file THDM_flipped_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Tue 7 Apr 2020 14:56:48

#ifndef THDM_flipped_SLHA_H
#define THDM_flipped_SLHA_H
...
class THDM_flipped_slha : public Model {
public:
   explicit THDM_flipped_slha(const THDM_flipped_input_parameters& input_ = THDM_flipped_input_parameters());
   explicit THDM_flipped_slha(const Model&, bool do_convert_masses_to_slha = true);
   THDM_flipped_slha(const THDM_flipped_slha&) = default;
   THDM_flipped_slha(THDM_flipped_slha&&) = default;
   virtual ~THDM_flipped_slha() = default;
   THDM_flipped_slha& operator=(const THDM_flipped_slha&) = default;
   THDM_flipped_slha& operator=(THDM_flipped_slha&&) = default;
   ...
   const THDM_flipped_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   THDM_flipped_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   THDM_flipped_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
THDM_flipped_slha<Model>::THDM_flipped_slha(const THDM_flipped_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
THDM_flipped_slha<Model>::THDM_flipped_slha(const Model& model_,
...
template <class Model>
void THDM_flipped_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void THDM_flipped_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void THDM_flipped_slha<Model>::convert_to_slha()
{
...
template <class Model>
void THDM_flipped_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void THDM_flipped_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void THDM_flipped_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void THDM_flipped_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void THDM_flipped_slha<Model>::convert_soft_squared_masses_to_slha()
{

}

template <class Model>
const THDM_flipped_physical& THDM_flipped_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
THDM_flipped_physical& THDM_flipped_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void THDM_flipped_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void THDM_flipped_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const THDM_flipped_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
