...
#ifndef THDM_flipped_WEINBERG_ANGLE_H
#define THDM_flipped_WEINBERG_ANGLE_H
...
/**
 * @class THDM_flipped_weinberg_angle
...
public:
   ...
   THDM_flipped_weinberg_angle(const THDM_flipped_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const THDM_flipped_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const THDM_flipped_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
