...
double THDM_flipped_soft_parameters::calc_beta_M222_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_M222 = Re(oneOver16PiSqr*(4*Lambda3*M112 + 2*Lambda4*M112 + 6*
      Lambda2*M222 + 2*M222*traceYeAdjYe + 6*M222*traceYuAdjYu - 6*M122*Conj(
...
double THDM_flipped_soft_parameters::calc_beta_M222_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_M222 = Re(twoLoop*(-8*Lambda3*Lambda4*M112 + 6*Lambda5*Lambda6*
      M122 + 12*Lambda5*Lambda7*M122 - 2*Lambda3*Lambda4*M222 - 24*Lambda3*M112
      *traceYdAdjYd - 12*Lambda4*M112*traceYdAdjYd - 4.5*M222*
      traceYdAdjYuYuAdjYd - 12*Lambda2*M222*traceYeAdjYe - 4.5*M222*
      traceYeAdjYeYeAdjYe - 36*Lambda2*M222*traceYuAdjYu - 13.5*M222*
      ...
      (g1) + 12*Lambda2*M222*Sqr(g1) + 6.25*M222*traceYeAdjYe*Sqr(g1) +
      7.083333333333333*M222*traceYuAdjYu*Sqr(g1) - 12*M122*Conj(Lambda7)*Sqr(
      g1) - 12*Lambda7*Conj(M122)*Sqr(g1) + 24*Lambda3*M112*Sqr(g2) + 12*
      Lambda4*M112*Sqr(g2) + 36*Lambda2*M222*Sqr(g2) + 3.75*M222*traceYeAdjYe*
