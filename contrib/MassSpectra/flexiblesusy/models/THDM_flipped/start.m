...
Print["Starting model: ", ToString[HoldForm[Start["THDM_flipped"]]]];

Start["THDM_flipped"];

MakeFlexibleSUSY[InputFile -> FileNameJoin[{"models/THDM_flipped","FlexibleSUSY.m"}],
                 OutputDirectory -> "models/THDM_flipped",
                 DebugOutput -> False];
