...
// File generated at Wed 31 Oct 2018 21:01:26
...
double THDM_flipped_susy_parameters::calc_beta_Lambda3_2_loop(const Susy_traces& susy_traces) const
{
   ...
   const double beta_Lambda3_1 = Re(-0.041666666666666664*twoLoop*(393*
      ...
      *Sqr(Lambda3) + 24*traceYdAdjYd*Sqr(Lambda3) + 8*traceYeAdjYe*Sqr(Lambda3
      ...
      Lambda6) + 48*traceYdAdjYd*Sqr(Lambda6) + 120*Lambda3*Sqr(Lambda7) + 136*
      Lambda4*Sqr(Lambda7) + 136*Lambda5*Sqr(Lambda7) + 16*traceYeAdjYe*Sqr(
      Lambda7) + 4*Lambda1*(8*Lambda3*Lambda4 + 22*Lambda6*Lambda7 + 18*Lambda3
      *traceYdAdjYd + 6*Lambda4*traceYdAdjYd + 18*Sqr(Lambda3) + 7*Sqr(Lambda4)
      + 9*Sqr(Lambda5) + 31*Sqr(Lambda6) + 11*Sqr(Lambda7)) + 4*Lambda2*(8*
      Lambda3*Lambda4 + 22*Lambda6*Lambda7 + 6*Lambda3*traceYeAdjYe + 2*Lambda4
      *traceYeAdjYe + 18*Sqr(Lambda3) + 7*Sqr(Lambda4) + 9*Sqr(Lambda5) + 11*
