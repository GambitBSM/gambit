 ...
 */
double THDM_flipped_susy_parameters::calc_beta_g1_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double THDM_flipped_susy_parameters::calc_beta_g1_2_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double THDM_flipped_susy_parameters::calc_beta_g1_3_loop(const Susy_traces& susy_traces) const
{
