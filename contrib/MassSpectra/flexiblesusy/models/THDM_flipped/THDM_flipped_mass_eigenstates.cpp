...
/**
 * @file THDM_flipped_mass_eigenstates.cpp
 * @brief implementation of the THDM_flipped model class
 *
 * Contains the definition of the THDM_flipped model class methods
 * which solve EWSB and calculate pole masses and mixings from MSbar
 * parameters.
 *
 * This file was generated at Wed 31 Oct 2018 21:01:45 with FlexibleSUSY
 * 2.0.1 (git commit: unknown) and SARAH 4.12.3 .
 */

#include "THDM_flipped_mass_eigenstates.hpp"
#include "THDM_flipped_ewsb_solver_interface.hpp"
...
#define CLASSNAME THDM_flipped_mass_eigenstates
...
CLASSNAME::THDM_flipped_mass_eigenstates(const THDM_flipped_input_parameters& input_)
   : THDM_flipped_soft_parameters(input_)
#if defined(ENABLE_TWO_SCALE_SOLVER)
   , ewsb_solver(new THDM_flipped_ewsb_solver<Two_scale>())
#endif
{
}
...
const THDM_flipped_physical& CLASSNAME::get_physical() const
{
   return physical;
}

THDM_flipped_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const THDM_flipped_physical& physical_)
{
   physical = physical_;
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<THDM_flipped_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
{
   if (!ewsb_solver) {
      throw SetupError("THDM_flipped_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("THDM_flipped_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("THDM_flipped_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }

   VERBOSE_MSG("\t\tSolving THDM_flipped EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           "THDM_flipped\n"
           "========================================\n";
   THDM_flipped_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   if (PHYSICAL(Mhh).tail<2>().minCoeff() < 0.) problems.flag_pole_tachyon(THDM_flipped_info::hh);
   if (PHYSICAL(MAh).tail<1>().minCoeff() < 0.) problems.flag_pole_tachyon(THDM_flipped_info::Ah);
   if (PHYSICAL(MHm).tail<1>().minCoeff() < 0.) problems.flag_pole_tachyon(THDM_flipped_info::Hm);
...
{
   THDM_flipped_soft_parameters::clear();
   clear_DRbar_parameters();
   physical.clear();
   problems.clear();
}
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   THDM_flipped_soft_parameters::run_to(scale, eps);
}
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(THDM_flipped_info::hh, eigenvalue_error >
      precision * Abs(Mhh(0)));
#else
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_running_tachyon(THDM_flipped_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(THDM_flipped_info::Ah, eigenvalue_error >
      precision * Abs(MAh(0)));
#else
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_running_tachyon(THDM_flipped_info::Ah);
   }
...
void CLASSNAME::calculate_MHm()
{
   ...
   problems.flag_bad_mass(THDM_flipped_info::Hm, eigenvalue_error >
      precision * Abs(MHm(0)));
#else
   ...
   if (MHm.minCoeff() < 0.) {
      problems.flag_running_tachyon(THDM_flipped_info::Hm);
   }
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(THDM_flipped_info::Fd, eigenvalue_error >
      precision * Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(THDM_flipped_info::Fu, eigenvalue_error >
      precision * Abs(MFu(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(THDM_flipped_info::Fe, eigenvalue_error >
      precision * Abs(MFe(0)));
#else
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_running_tachyon(THDM_flipped_info::VWm);
   }
...
std::complex<double> CLASSNAME::CpbarUFdFuhhPL(int gO2, int gI2, int gI1) const
{
   const std::complex<double> result = IF(gO2 < 3,0.7071067811865475*SUM(j2,0,2
      ,Conj(Vu(gI2,j2))*Yd(gO2,j2))*ZH(gI1,0),0);
...
std::complex<double> CLASSNAME::CpbarUFdFuAhPL(int gO2, int gI1, int gI2) const
{
   const std::complex<double> result = IF(gO2 < 3,std::complex<double>(0.,
      0.7071067811865475)*SUM(j2,0,2,Conj(Vu(gI1,j2))*Yd(gO2,j2))*ZA(gI2,0),0);
...
std::complex<double> CLASSNAME::CpbarFuFdhhPR(int gO1, int gI2, int gI1) const
{
   const std::complex<double> result = 0.7071067811865475*SUM(j2,0,2,SUM(j1,0,2
      ,Conj(Yd(j1,j2))*Ud(gI2,j1))*Vu(gO1,j2))*ZH(gI1,0);
...
{
   if (!force_output && problems.is_running_tachyon(THDM_flipped_info::VZ
      ))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(THDM_flipped_info::VZ);
...
{
   if (!force_output && problems.is_running_tachyon(THDM_flipped_info::hh
      ))
      return;
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZH;
            ...
            problems.flag_bad_mass(THDM_flipped_info::hh,
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(THDM_flipped_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(THDM_flipped_info::hh);
}

void CLASSNAME::calculate_MAh_pole()
{
   if (!force_output && problems.is_running_tachyon(THDM_flipped_info::Ah
      ))
      return;
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZA;
            ...
            problems.flag_bad_mass(THDM_flipped_info::Ah,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZA);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(THDM_flipped_info::Ah);
   else
      problems.unflag_no_pole_mass_convergence(THDM_flipped_info::Ah);
}

void CLASSNAME::calculate_MHm_pole()
{
   if (!force_output && problems.is_running_tachyon(THDM_flipped_info::Hm
      ))
      return;
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      Eigen::Matrix<double,2,2> mix_ZP;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZP,
            eigenvalue_error);
         problems.flag_bad_mass(THDM_flipped_info::Hm,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZP);
      #endif
...
void CLASSNAME::calculate_MVWm_pole()
{
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(THDM_flipped_info::VWm);
...
std::ostream& operator<<(std::ostream& ostr, const THDM_flipped_mass_eigenstates& model)
{
   model.print(ostr);
   return ostr;
}
