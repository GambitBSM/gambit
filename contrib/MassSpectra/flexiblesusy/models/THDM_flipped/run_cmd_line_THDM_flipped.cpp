...
{
   std::cout <<
      "Usage: run_cmd_line_THDM_flipped.x [options]\n"
      "Options:\n"
      "  --Lambda1IN=<value>\n"
      "  --Lambda2IN=<value>\n"
      "  --Lambda3IN=<value>\n"
...
int run_solver(const THDM_flipped_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(THDM_flipped_slha_io::fill_slhaea(
...
int run(int solver_type, const THDM_flipped_input_parameters& input)
{
   int exit_code = 0;
