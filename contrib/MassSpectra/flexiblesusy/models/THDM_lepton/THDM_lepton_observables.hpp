...
#ifndef THDM_lepton_OBSERVABLES_H
#define THDM_lepton_OBSERVABLES_H
...
THDM_lepton_observables calculate_observables(
   const THDM_lepton_mass_eigenstates&, const softsusy::QedQcd&,
