...
const int THDM_lepton_observables::NUMBER_OF_OBSERVABLES;

THDM_lepton_observables::THDM_lepton_observables()
...
Eigen::ArrayXd THDM_lepton_observables::get() const
{
   Eigen::ArrayXd vec(THDM_lepton_observables::NUMBER_OF_OBSERVABLES);
...
std::vector<std::string> THDM_lepton_observables::get_names()
{
   std::vector<std::string> names(THDM_lepton_observables::NUMBER_OF_OBSERVABLES);
...
void THDM_lepton_observables::clear()
{
   eff_cp_higgs_photon_photon = Eigen::Array<std::complex<double>,2,1>::Zero();
   eff_cp_higgs_gluon_gluon = Eigen::Array<std::complex<double>,2,1>::Zero();
...
void THDM_lepton_observables::set(const Eigen::ArrayXd& vec)
{
   assert(vec.rows() == THDM_lepton_observables::NUMBER_OF_OBSERVABLES);
...
THDM_lepton_observables calculate_observables(const THDM_lepton_mass_eigenstates& model,
...
THDM_lepton_observables calculate_observables(const THDM_lepton_mass_eigenstates& model,
                                              ...
                                              const Physical_input& physical_input)
{
   THDM_lepton_observables observables;

   THDM_lepton_effective_couplings effective_couplings(model, qedqcd, physical_input);
