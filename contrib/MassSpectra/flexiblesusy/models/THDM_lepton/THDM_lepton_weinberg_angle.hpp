...
#ifndef THDM_lepton_WEINBERG_ANGLE_H
#define THDM_lepton_WEINBERG_ANGLE_H
...
/**
 * @class THDM_lepton_weinberg_angle
...
public:
   ...
   THDM_lepton_weinberg_angle(const THDM_lepton_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const THDM_lepton_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const THDM_lepton_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
