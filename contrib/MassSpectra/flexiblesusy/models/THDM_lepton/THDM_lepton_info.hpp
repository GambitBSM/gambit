...
#ifndef THDM_lepton_INFO_H
#define THDM_lepton_INFO_H
...
namespace THDM_lepton_info {
   ...
   enum Parameters : int { g1, g2, g3, Lambda6, Lambda5, Lambda7, Lambda1,
      Lambda4, Lambda3, Lambda2, Ye0_0, Ye0_1, Ye0_2, Ye1_0, Ye1_1, Ye1_2, Ye2_0,
      Ye2_1, Ye2_2, Yd0_0, Yd0_1, Yd0_2, Yd1_0, Yd1_1, Yd1_2, Yd2_0, Yd2_1, Yd2_2,
   ...
   class THDM_lepton_particle_names : public Names {
   public:
      virtual ~THDM_lepton_particle_names() = default;
   ...
   class THDM_lepton_parameter_names : public Names {
   public:
      virtual ~THDM_lepton_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const THDM_lepton_particle_names  particle_names_getter{};
   const THDM_lepton_parameter_names parameter_names_getter{};
