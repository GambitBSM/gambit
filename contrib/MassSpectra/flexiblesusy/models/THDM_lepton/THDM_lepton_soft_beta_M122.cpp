 ...
 */
double THDM_lepton_soft_parameters::calc_beta_M122_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double THDM_lepton_soft_parameters::calc_beta_M122_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_M122 = Re(twoLoop*(18*Lambda1*Lambda6*M112 + 12*Lambda3*Lambda6*
      ...
      *M122*traceYdAdjYd + 36*Lambda7*M222*traceYdAdjYd - 6.75*M122*
      traceYdAdjYdYdAdjYd + 1.5*M122*traceYdAdjYuYuAdjYd + 12*Lambda6*M112*
 ...
 */
double THDM_lepton_soft_parameters::calc_beta_M122_3_loop(const Soft_traces& soft_traces) const
{
