...
#ifndef THDM_lepton_EFFECTIVE_COUPLINGS_H
#define THDM_lepton_EFFECTIVE_COUPLINGS_H
...
class THDM_lepton_effective_couplings {
public:
   THDM_lepton_effective_couplings(const THDM_lepton_mass_eigenstates&,
   ...
   void set_model(const THDM_lepton_mass_eigenstates& model_);
