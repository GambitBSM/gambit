...
// File generated at Wed 31 Oct 2018 19:30:56

#include "THDM_lepton_effective_couplings.hpp"
...
THDM_lepton_effective_couplings::THDM_lepton_effective_couplings(
...
void THDM_lepton_effective_couplings::calculate_effective_couplings()
{
...
void THDM_lepton_effective_couplings::set_model(const THDM_lepton_mass_eigenstates& model_)
{
   model = model_;
   copy_mixing_matrices_from_model();
}

void THDM_lepton_effective_couplings::copy_mixing_matrices_from_model()
{
   ZH = PHYSICAL(ZH);
   ZA = PHYSICAL(ZA);
   ZP = PHYSICAL(ZP);
...
standard_model::Standard_model THDM_lepton_effective_couplings::initialise_SM() const
{
...
void THDM_lepton_effective_couplings::run_SM_strong_coupling_to(standard_model::Standard_model sm, double m)
{
   sm.run_to(m);
...
std::complex<double> THDM_lepton_effective_couplings::scalar_scalar_qcd_factor(double m_decay, double m_loop) const
{
...
std::complex<double> THDM_lepton_effective_couplings::scalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
std::complex<double> THDM_lepton_effective_couplings::pseudoscalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
double THDM_lepton_effective_couplings::number_of_active_flavours(double m) const
{
...
double THDM_lepton_effective_couplings::scalar_scaling_factor(double m) const
{
...
double THDM_lepton_effective_couplings::pseudoscalar_scaling_factor(double m) const
{
   const double Nf = number_of_active_flavours(m);
   const double mtpole = qedqcd.displayPoleMt();
   const double l = Log(Sqr(m) / Sqr(mtpole));
...
double THDM_lepton_effective_couplings::get_hhVPVP_partial_width(int gO1) const
{
   const double mass = PHYSICAL(Mhh)(gO1);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CphhVPVP(gO1));
}

double THDM_lepton_effective_couplings::get_hhVGVG_partial_width(int gO1) const
{
   const double mass = PHYSICAL(Mhh)(gO1);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CphhVGVG(gO1));
}

double THDM_lepton_effective_couplings::get_AhVPVP_partial_width(int gO1) const
{
   const double mass = PHYSICAL(MAh)(gO1);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CpAhVPVP(gO1));
}

double THDM_lepton_effective_couplings::get_AhVGVG_partial_width(int gO1) const
{
   const double mass = PHYSICAL(MAh)(gO1);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CpAhVGVG(gO1));
}

std::complex<double> THDM_lepton_effective_couplings::CphhconjVWmVWm(int gI2) const
{
...
std::complex<double> THDM_lepton_effective_couplings::CphhHmconjHm(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.5*(-(ZH(gt1,1)*(ZP(gt2,0)*((Lambda6*v1
      + 2*Lambda3*v2 + v1*Conj(Lambda6))*ZP(gt3,0) + (Lambda4*v1 + Lambda5*v1 + 2
      *Lambda7*v2)*ZP(gt3,1)) + ZP(gt2,1)*((Lambda4*v1 + v1*Conj(Lambda5) + 2*v2*
      Conj(Lambda7))*ZP(gt3,0) + (Lambda7*v1 + 2*Lambda2*v2 + v1*Conj(Lambda7))*ZP
      (gt3,1)))) - ZH(gt1,0)*(ZP(gt2,0)*((2*Lambda1*v1 + Lambda6*v2 + v2*Conj(
      Lambda6))*ZP(gt3,0) + (2*Lambda6*v1 + (Lambda4 + Lambda5)*v2)*ZP(gt3,1)) +
      ZP(gt2,1)*((Lambda4*v2 + v2*Conj(Lambda5) + 2*v1*Conj(Lambda6))*ZP(gt3,0) +
      (2*Lambda3*v1 + Lambda7*v2 + v2*Conj(Lambda7))*ZP(gt3,1))));

   return result;
}

std::complex<double> THDM_lepton_effective_couplings::CpAhHmconjHm(int gt1, int gt2, int gt3) const
{
   const auto Lambda4 = MODELPARAMETER(Lambda4);
   const auto Lambda5 = MODELPARAMETER(Lambda5);
   const auto Lambda6 = MODELPARAMETER(Lambda6);
   ...
   const std::complex<double> result = std::complex<double>(0,0.5)*(v2*ZA(gt1,0
      ...
      -Lambda4 + Lambda5)*ZP(gt3,1)) + ZP(gt2,1)*((Lambda4 - Conj(Lambda5))*ZP(gt3
      ,0) + (Lambda7 - Conj(Lambda7))*ZP(gt3,1)));

   return result;
}

void THDM_lepton_effective_couplings::calculate_eff_CphhVPVP(int gO1)
{
...
void THDM_lepton_effective_couplings::calculate_eff_CphhVGVG(int gO1)
{
   const auto g3 = MODELPARAMETER(g3);
...
void THDM_lepton_effective_couplings::calculate_eff_CpAhVPVP(int gO1)
{
...
void THDM_lepton_effective_couplings::calculate_eff_CpAhVGVG(int gO1)
{
   const auto g3 = MODELPARAMETER(g3);
   const double alpha_s = 0.07957747154594767*Sqr(g3);
   const auto decay_mass = PHYSICAL(MAh)(gO1);
