...
// File generated at Wed 31 Oct 2018 19:30:28
 ...
 */
double THDM_lepton_susy_parameters::calc_beta_Lambda5_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double THDM_lepton_susy_parameters::calc_beta_Lambda5_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Lambda5 = Re(twoLoop*(-40*Lambda1*Lambda3*Lambda5 - 40*Lambda2*
      ...
      *Sqr(Lambda6) - 72*Lambda5*Sqr(Lambda6) - 20*traceYeAdjYe*Sqr(Lambda6) -
      10*Lambda1*Sqr(Lambda7) - 74*Lambda2*Sqr(Lambda7) - 72*Lambda3*Sqr(
      Lambda7) - 76*Lambda4*Sqr(Lambda7) - 72*Lambda5*Sqr(Lambda7) - 60*
      traceYdAdjYd*Sqr(Lambda7) - 60*traceYuAdjYu*Sqr(Lambda7) + Sqr(g1)*(-2*
 ...
 */
double THDM_lepton_susy_parameters::calc_beta_Lambda5_3_loop(const Susy_traces& susy_traces) const
{
