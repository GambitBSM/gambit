...
{
   std::cout <<
      "Usage: scan_THDM_lepton.x [options]\n"
      "Options:\n"
      "  --Lambda1IN=<value>\n"
      "  --Lambda2IN=<value>\n"
      "  --Lambda3IN=<value>\n"
...
struct THDM_lepton_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
THDM_lepton_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   THDM_lepton_input_parameters& input)
{
   ...
   THDM_lepton_scan_result result;
...
void scan(int solver_type, THDM_lepton_input_parameters& input,
