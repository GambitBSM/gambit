...
class THDM_lepton_slha : public Model {
public:
   explicit THDM_lepton_slha(const THDM_lepton_input_parameters& input_ = THDM_lepton_input_parameters());
   explicit THDM_lepton_slha(const Model&, bool do_convert_masses_to_slha = true);
   THDM_lepton_slha(const THDM_lepton_slha&) = default;
   THDM_lepton_slha(THDM_lepton_slha&&) = default;
   virtual ~THDM_lepton_slha() = default;
   THDM_lepton_slha& operator=(const THDM_lepton_slha&) = default;
   THDM_lepton_slha& operator=(THDM_lepton_slha&&) = default;
   ...
   const THDM_lepton_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   THDM_lepton_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   THDM_lepton_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
THDM_lepton_slha<Model>::THDM_lepton_slha(const THDM_lepton_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
THDM_lepton_slha<Model>::THDM_lepton_slha(const Model& model_,
...
template <class Model>
void THDM_lepton_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void THDM_lepton_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void THDM_lepton_slha<Model>::convert_to_slha()
{
...
template <class Model>
void THDM_lepton_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void THDM_lepton_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void THDM_lepton_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void THDM_lepton_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void THDM_lepton_slha<Model>::convert_soft_squared_masses_to_slha()
{

}

template <class Model>
const THDM_lepton_physical& THDM_lepton_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
THDM_lepton_physical& THDM_lepton_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void THDM_lepton_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void THDM_lepton_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const THDM_lepton_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
