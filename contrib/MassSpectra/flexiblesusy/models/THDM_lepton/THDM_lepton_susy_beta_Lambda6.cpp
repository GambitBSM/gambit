 ...
 */
double THDM_lepton_susy_parameters::calc_beta_Lambda6_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda6 = Re(oneOver16PiSqr*(12*Lambda1*Lambda6 + 6*Lambda3*
      ...
      Lambda4*Lambda7 + 2*Lambda5*Lambda7 + 3*Lambda6*traceYdAdjYd + 3*Lambda6*
 ...
 */
double THDM_lepton_susy_parameters::calc_beta_Lambda6_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Lambda6 = Re(twoLoop*(-66*Lambda1*Lambda3*Lambda6 - 18*Lambda2*
      ...
      traceYdAdjYdYdAdjYd + 1.5*Lambda6*traceYdAdjYuYuAdjYd - 24*Lambda1*
      Lambda6*traceYeAdjYe - 6*Lambda3*Lambda6*traceYeAdjYe - 8*Lambda4*Lambda6
      *traceYeAdjYe - 10*Lambda5*Lambda6*traceYeAdjYe - 2.75*Lambda6*
      ...
      0.375*(47*Lambda6 - 30*Lambda7)*Quad(g2) + 1.125*(48*Lambda1*Lambda6 +
      32*Lambda4*Lambda6 + 48*Lambda5*Lambda6 + 16*Lambda4*Lambda7 + 16*Lambda3
      *(Lambda6 + 2*Lambda7) + 5*Lambda6*traceYdAdjYd + 5*Lambda6*traceYeAdjYe
      + 5*Lambda6*traceYuAdjYu)*Sqr(g2) + Sqr(g1)*(18*Lambda1*Lambda6 + 6*
      Lambda3*Lambda6 + 10*Lambda4*Lambda6 + 20*Lambda5*Lambda6 + 12*Lambda3*
      Lambda7 + 8*Lambda4*Lambda7 - 2*Lambda5*Lambda7 + 1.0416666666666667*
      Lambda6*traceYdAdjYd + 9.375*Lambda6*traceYeAdjYe + 3.5416666666666665*
      Lambda6*traceYuAdjYu + 0.25*(29*Lambda6 + 10*Lambda7)*Sqr(g2)) + 20*
      Lambda6*traceYdAdjYd*Sqr(g3) + 20*Lambda6*traceYuAdjYu*Sqr(g3) - 79.5*
      Lambda6*Sqr(Lambda1) + 1.5*Lambda6*Sqr(Lambda2) - 32*Lambda6*Sqr(Lambda3)
      - 36*Lambda7*Sqr(Lambda3) - 34*Lambda6*Sqr(Lambda4) - 34*Lambda7*Sqr(
      Lambda4) - 36*Lambda6*Sqr(Lambda5) - 42*Lambda7*Sqr(Lambda5) - 126*
      Lambda7*Sqr(Lambda6) - 33*Lambda6*Sqr(Lambda7)));
 ...
 */
double THDM_lepton_susy_parameters::calc_beta_Lambda6_3_loop(const Susy_traces& susy_traces) const
{
