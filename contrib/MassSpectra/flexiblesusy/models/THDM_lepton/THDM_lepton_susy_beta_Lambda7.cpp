 ...
 */
double THDM_lepton_susy_parameters::calc_beta_Lambda7_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda7 = Re(oneOver16PiSqr*(2*Lambda5*Lambda6 + 12*Lambda2*
      ...
      (Lambda6 + 2*Lambda7) + 9*Lambda7*traceYdAdjYd + Lambda7*traceYeAdjYe + 9
 ...
 */
double THDM_lepton_susy_parameters::calc_beta_Lambda7_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Lambda7 = Re(twoLoop*(-18*Lambda1*Lambda3*Lambda6 - 18*Lambda2*
      ...
      traceYdAdjYdYdAdjYd - 19.5*Lambda7*traceYdAdjYuYuAdjYd - 12*Lambda3*
      Lambda6*traceYeAdjYe - 8*Lambda4*Lambda6*traceYeAdjYe - 4*Lambda5*Lambda6
      ...
      *(30*Lambda6 - 47*Lambda7)*Quad(g2) + 0.375*(48*Lambda3*(2*Lambda6 +
      ...
      Lambda5 + 5*(9*traceYdAdjYd + traceYeAdjYe + 9*traceYuAdjYu)))*Sqr(g2) +
      ...
      Lambda6 + Lambda7) + 25*Lambda7*traceYdAdjYd + 25*Lambda7*traceYeAdjYe +
 ...
 */
double THDM_lepton_susy_parameters::calc_beta_Lambda7_3_loop(const Susy_traces& susy_traces) const
{
