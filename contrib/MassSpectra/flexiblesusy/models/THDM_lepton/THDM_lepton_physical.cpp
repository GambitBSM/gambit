...
void THDM_lepton_physical::clear()
{
   MVG = 0.;
 ...
 * to be complex.
 */
void THDM_lepton_physical::convert_to_hk()
{
 ...
 * be negative.
 */
void THDM_lepton_physical::convert_to_slha()
{

}

Eigen::ArrayXd THDM_lepton_physical::get() const
{
...
void THDM_lepton_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd THDM_lepton_physical::get_masses() const
{
...
void THDM_lepton_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MFv(0) = pars(1);
   MFv(1) = pars(2);
...
void THDM_lepton_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const THDM_lepton_physical& phys_pars)
{
