...
class THDM_II_soft_parameters : public THDM_II_susy_parameters {
public:
   explicit THDM_II_soft_parameters(const THDM_II_input_parameters& input_ = THDM_II_input_parameters());
   THDM_II_soft_parameters(const THDM_II_susy_parameters& , double M122_, double M112_, double M222_, double v1_, double v2_
);
   THDM_II_soft_parameters(const THDM_II_soft_parameters&) = default;
   THDM_II_soft_parameters(THDM_II_soft_parameters&&) = default;
   virtual ~THDM_II_soft_parameters() = default;
   THDM_II_soft_parameters& operator=(const THDM_II_soft_parameters&) = default;
   THDM_II_soft_parameters& operator=(THDM_II_soft_parameters&&) = default;
   ...
   THDM_II_soft_parameters calc_beta() const;
   THDM_II_soft_parameters calc_beta(int) const;
...
std::ostream& operator<<(std::ostream&, const THDM_II_soft_parameters&);
