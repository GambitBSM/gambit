...
Eigen::ArrayXd THDM_II_observables::get() const
{
   Eigen::ArrayXd vec(THDM_II_observables::NUMBER_OF_OBSERVABLES);
...
std::vector<std::string> THDM_II_observables::get_names()
{
   std::vector<std::string> names(THDM_II_observables::NUMBER_OF_OBSERVABLES);
...
void THDM_II_observables::clear()
{
   eff_cp_higgs_photon_photon = Eigen::Array<std::complex<double>,2,1>::Zero();
   eff_cp_higgs_gluon_gluon = Eigen::Array<std::complex<double>,2,1>::Zero();
...
void THDM_II_observables::set(const Eigen::ArrayXd& vec)
{
   assert(vec.rows() == THDM_II_observables::NUMBER_OF_OBSERVABLES);
