...
double THDM_II_susy_parameters::calc_beta_Lambda6_2_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda6 = Re(twoLoop*(-66*Lambda1*Lambda3*Lambda6 - 18*Lambda2*
      ...
      traceYdAdjYdYdAdjYd - 21*Lambda6*traceYdAdjYuYuAdjYd - 24*Lambda1*Lambda6
      ...
      *(Lambda6 + 2*Lambda7) + 15*Lambda6*traceYdAdjYd + 5*Lambda6*traceYeAdjYe
      ...
      Lambda7 + 8*Lambda4*Lambda7 - 2*Lambda5*Lambda7 + 3.125*Lambda6*
      traceYdAdjYd + 9.375*Lambda6*traceYeAdjYe + 3.5416666666666665*Lambda6*
      traceYuAdjYu + 0.25*(29*Lambda6 + 10*Lambda7)*Sqr(g2)) + 60*Lambda6*
      traceYdAdjYd*Sqr(g3) + 20*Lambda6*traceYuAdjYu*Sqr(g3) - 79.5*Lambda6*Sqr
      (Lambda1) + 1.5*Lambda6*Sqr(Lambda2) - 32*Lambda6*Sqr(Lambda3) - 36*
 ...
 */
double THDM_II_susy_parameters::calc_beta_Lambda6_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
