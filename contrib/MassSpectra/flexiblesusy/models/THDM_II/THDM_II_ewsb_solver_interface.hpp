 ...
 *
 * This file was generated at Tue 31 Jul 2018 21:13:45 with FlexibleSUSY
 * 2.0.1 (git commit: unknown) and SARAH 4.12.3 .
 */

#ifndef THDM_II_EWSB_SOLVER_INTERFACE_H
#define THDM_II_EWSB_SOLVER_INTERFACE_H
...
class THDM_II_ewsb_solver_interface {
public:
   virtual ~THDM_II_ewsb_solver_interface() {}
   ...
   virtual int solve(THDM_II_mass_eigenstates&) = 0;
};
