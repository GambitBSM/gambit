...
class THDM_II_parameter_getter {
private:
   ...
   std::array<std::string, THDM_II_info::NUMBER_OF_MIXINGS> get_mixing_names() const {
      return THDM_II_info::particle_mixing_names;
   }

public:
   /// returns DR-bar parameters
   Eigen::ArrayXd get_parameters(const THDM_II_mass_eigenstates& model) {
      return model.get();
   }

   /// returns names of DR-bar parameters
   std::array<std::string, THDM_II_info::NUMBER_OF_PARAMETERS> get_parameter_names() const {
      return THDM_II_info::parameter_names;
   }

   /// returns names of particles
   std::array<std::string, THDM_II_info::NUMBER_OF_PARTICLES> get_particle_names() const {
      return THDM_II_info::particle_names;
   }
   ...
   std::array<std::string, THDM_II_info::NUMBER_OF_MIXINGS> get_DRbar_mixing_names() const {
      return get_mixing_names();
   }

   /// returns names of pole mixing matrices
   std::array<std::string, THDM_II_info::NUMBER_OF_MIXINGS> get_pole_mixing_names() const {
   ...
   std::array<std::string, THDM_II_info::NUMBER_OF_INPUT_PARAMETERS> get_input_parameter_names() const {
      return THDM_II_info::input_parameter_names;
   }

   /// returns names of input parameters
   std::array<std::string, THDM_II_info::NUMBER_OF_EXTRA_PARAMETERS> get_extra_parameter_names() const {
      return THDM_II_info::extra_parameter_names;
   }

   /// returns number of particle masses
   decltype(THDM_II_info::NUMBER_OF_MASSES) get_number_of_masses() const {
      return THDM_II_info::NUMBER_OF_MASSES;
   }
};

class THDM_II_spectrum_plotter {
public:
   THDM_II_spectrum_plotter() = default;
   explicit THDM_II_spectrum_plotter(const THDM_II_mass_eigenstates&);
   void extract_spectrum(const THDM_II_mass_eigenstates&);
...
THDM_II_mass_eigenstates from_database(
   ...
   THDM_II_observables* observables = nullptr);
