...
THDM_II_initial_guesser<Two_scale>::THDM_II_initial_guesser(
   THDM_II<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const THDM_II_low_scale_constraint<Two_scale>& low_constraint_,
   const THDM_II_susy_scale_constraint<Two_scale>& susy_constraint_
)
   : model(model_)
   , qedqcd(qedqcd_)
...
{
   if (!model)
      throw SetupError("THDM_II_initial_guesser: Error: pointer to model"
                       " THDM_II<Two_scale> must not be zero");
}
 ...
 */
void THDM_II_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void THDM_II_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void THDM_II_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void THDM_II_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void THDM_II_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void THDM_II_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void THDM_II_initial_guesser<Two_scale>::guess_soft_parameters()
{
