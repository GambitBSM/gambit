...
THDM_II_INCLUDE_MK += $(DIR)/two_scale.mk

LIBTHDM_II_SRC += \
		$(DIR)/THDM_II_two_scale_convergence_tester.cpp \
		$(DIR)/THDM_II_two_scale_ewsb_solver.cpp \
...
LIBTHDM_II_HDR += \
		...
		$(DIR)/THDM_II_two_scale_spectrum_generator.hpp \
