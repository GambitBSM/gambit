...
public:
   ...
   THDM_II_weinberg_angle(const THDM_II_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const THDM_II_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const THDM_II_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
