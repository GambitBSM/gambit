...
#include "THDM_II_weinberg_angle.hpp"
...
#define CLASSNAME THDM_II_weinberg_angle
 ...
 */
CLASSNAME::THDM_II_weinberg_angle(
   const THDM_II_mass_eigenstates* model_,
...
void CLASSNAME::set_model(const THDM_II_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * THDM_II_info::normalization_g1;
   const double g2 = MODEL->get_g2() * THDM_II_info::normalization_g2;
