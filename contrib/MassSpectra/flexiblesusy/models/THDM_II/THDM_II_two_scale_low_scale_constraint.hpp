...
#ifndef THDM_II_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define THDM_II_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "THDM_II_low_scale_constraint.hpp"
...
template<>
class THDM_II_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   THDM_II_low_scale_constraint() = default;
   THDM_II_low_scale_constraint(THDM_II<Two_scale>*, const softsusy::QedQcd&);
   virtual ~THDM_II_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "THDM_II low-scale constraint"; }
