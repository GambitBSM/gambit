...
double THDM_II_spectrum_generator<Two_scale>::get_pole_mass_scale() const
{
 ...
 */
void THDM_II_spectrum_generator<Two_scale>::run_except(const softsusy::QedQcd& qedqcd,
                                const THDM_II_input_parameters& input)
{
   ...
   THDM_II_ewsb_solver<Two_scale> ewsb_solver;
   model.set_ewsb_solver(
      std::make_shared<THDM_II_ewsb_solver<Two_scale> >(ewsb_solver));

   THDM_II_susy_scale_constraint<Two_scale> susy_scale_constraint(&model, qedqcd);
   THDM_II_low_scale_constraint<Two_scale>  low_scale_constraint(&model, qedqcd);

   susy_scale_constraint.initialize();
   low_scale_constraint .initialize();

   THDM_II_convergence_tester<Two_scale> convergence_tester(
   ...
   THDM_II_initial_guesser<Two_scale> initial_guesser(&model, qedqcd,
 ...
 */
void THDM_II_spectrum_generator<Two_scale>::write_running_couplings(
   const std::string& filename) const
{
   THDM_II_spectrum_generator_interface<Two_scale>::write_running_couplings(
      filename, get_low_scale(), get_susy_scale());
}

void THDM_II_spectrum_generator<Two_scale>::calculate_spectrum()
{
