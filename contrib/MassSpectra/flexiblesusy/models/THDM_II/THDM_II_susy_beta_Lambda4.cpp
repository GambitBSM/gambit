...
// File generated at Fri 11 May 2018 14:06:37
 ...
 */
double THDM_II_susy_parameters::calc_beta_Lambda4_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda4 = Re(oneOver16PiSqr*(-9*Lambda4*Sqr(g2) + 3*Sqr(g1)*(
      ...
      Lambda4 + 2*Lambda6*Lambda7 + 3*Lambda4*traceYdAdjYd + 6*
 ...
 */
double THDM_II_susy_parameters::calc_beta_Lambda4_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Lambda4 = Re(twoLoop*(-40*Lambda1*Lambda3*Lambda4 - 40*Lambda2*
      ...
      Lambda6*Lambda7 - 12*Lambda1*Lambda4*traceYdAdjYd - 24*Lambda3*Lambda4*
      ...
      traceYdAdjYuYuAdjYdYdAdjYd - 24*traceYdAdjYuYuAdjYuYuAdjYd - 4*Lambda1*
      ...
      *traceYeAdjYe - 4.5*Lambda4*traceYeAdjYeYeAdjYe - 12*Lambda2*Lambda4*
      ...
      (g3) + 64*traceYdAdjYuYuAdjYd*Sqr(g3) + 40*Lambda4*traceYuAdjYu*Sqr(g3) -
      7*Lambda4*Sqr(Lambda1) - 7*Lambda4*Sqr(Lambda2) - 28*Lambda4*Sqr(Lambda3
      ...
      12*traceYuAdjYu*Sqr(Lambda4) - 24*Lambda1*Sqr(Lambda5) - 24*Lambda2*Sqr(
      Lambda5) - 48*Lambda3*Sqr(Lambda5) - 26*Lambda4*Sqr(Lambda5) - 24*
      traceYdAdjYd*Sqr(Lambda5) - 8*traceYeAdjYe*Sqr(Lambda5) - 24*traceYuAdjYu
      *Sqr(Lambda5) - 74*Lambda1*Sqr(Lambda6) - 10*Lambda2*Sqr(Lambda6) - 72*
      Lambda3*Sqr(Lambda6) - 68*Lambda4*Sqr(Lambda6) - 80*Lambda5*Sqr(Lambda6)
      - 60*traceYdAdjYd*Sqr(Lambda6) - 20*traceYeAdjYe*Sqr(Lambda6) - 10*
      Lambda1*Sqr(Lambda7) - 74*Lambda2*Sqr(Lambda7) - 72*Lambda3*Sqr(Lambda7)
      - 68*Lambda4*Sqr(Lambda7) - 80*Lambda5*Sqr(Lambda7) - 60*traceYuAdjYu*Sqr
      (Lambda7) + Sqr(g1)*(4*Lambda1*Lambda4 + 4*Lambda2*Lambda4 + 4*Lambda3*
      Lambda4 + 8*Lambda6*Lambda7 + 2.0833333333333335*Lambda4*traceYdAdjYd +
      1.3333333333333333*traceYdAdjYuYuAdjYd + 6.25*Lambda4*traceYeAdjYe +
      7.083333333333333*Lambda4*traceYuAdjYu - 14*Quad(g2) + (5*Lambda1 + 5*
      Lambda2 + 2*Lambda3 + 12.75*Lambda4 - 9*traceYdAdjYd - 11*traceYeAdjYe -
      21*traceYuAdjYu)*Sqr(g2) + 8*Sqr(Lambda4) + 16*Sqr(Lambda5) + 14*Sqr(
      Lambda6) + 14*Sqr(Lambda7)) + 0.75*Sqr(g2)*(48*Lambda3*Lambda4 + 5*
      Lambda4*(3*traceYdAdjYd + traceYeAdjYe + 3*traceYuAdjYu) + 24*Sqr(Lambda4
      ) + 72*(Sqr(Lambda5) + Sqr(Lambda6) + Sqr(Lambda7)))));
 ...
 */
double THDM_II_susy_parameters::calc_beta_Lambda4_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double THDM_II_susy_parameters::calc_beta_Lambda4_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
