...
// File generated at Tue 31 Jul 2018 21:11:39
...
double THDM_II_susy_parameters::calc_beta_Lambda4_2_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda4 = Re(twoLoop*(-40*Lambda1*Lambda3*Lambda4 - 40*Lambda2*
      ...
      Lambda4*Sqr(Lambda6) - 80*Lambda5*Sqr(Lambda6) - 10*Lambda1*Sqr(Lambda7)
      - 74*Lambda2*Sqr(Lambda7) - 72*Lambda3*Sqr(Lambda7) - 68*Lambda4*Sqr(
      Lambda7) - 80*Lambda5*Sqr(Lambda7) - 60*traceYdAdjYd*Sqr(Lambda7) - 20*
      traceYeAdjYe*Sqr(Lambda7) - 60*traceYuAdjYu*Sqr(Lambda7) + Sqr(g1)*(4*
