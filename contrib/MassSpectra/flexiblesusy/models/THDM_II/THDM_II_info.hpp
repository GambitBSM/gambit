...
namespace THDM_II_info {
   ...
   class THDM_II_particle_names : public Names {
   public:
      virtual ~THDM_II_particle_names() = default;
   ...
   class THDM_II_parameter_names : public Names {
   public:
      virtual ~THDM_II_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const THDM_II_particle_names  particle_names_getter{};
   const THDM_II_parameter_names parameter_names_getter{};
