...
#include "THDM_II_initial_guesser.hpp"
...
/**
 * @class THDM_II_initial_guesser<Two_scale>
 * @brief initial guesser for the THDM_II
 */

template<>
class THDM_II_initial_guesser<Two_scale> : public Initial_guesser {
public:
   THDM_II_initial_guesser(THDM_II<Two_scale>*,
                               const softsusy::QedQcd&,
                               const THDM_II_low_scale_constraint<Two_scale>&,
                               const THDM_II_susy_scale_constraint<Two_scale>&);
   virtual ~THDM_II_initial_guesser() = default;
   virtual void guess() override; ///< initial guess

   void set_running_precision(double p) { running_precision = p; }

private:
   THDM_II<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   THDM_II_low_scale_constraint<Two_scale> low_constraint{};
   THDM_II_susy_scale_constraint<Two_scale> susy_constraint{};
