...
class THDM_I_slha : public Model {
public:
   explicit THDM_I_slha(const THDM_I_input_parameters& input_ = THDM_I_input_parameters());
   explicit THDM_I_slha(const Model&, bool do_convert_masses_to_slha = true);
   THDM_I_slha(const THDM_I_slha&) = default;
   THDM_I_slha(THDM_I_slha&&) = default;
   virtual ~THDM_I_slha() = default;
   THDM_I_slha& operator=(const THDM_I_slha&) = default;
   THDM_I_slha& operator=(THDM_I_slha&&) = default;
   ...
   const THDM_I_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   THDM_I_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   THDM_I_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
THDM_I_slha<Model>::THDM_I_slha(const THDM_I_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
THDM_I_slha<Model>::THDM_I_slha(const Model& model_,
...
template <class Model>
void THDM_I_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void THDM_I_slha<Model>::convert_to_slha()
{
...
template <class Model>
void THDM_I_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void THDM_I_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void THDM_I_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void THDM_I_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void THDM_I_slha<Model>::convert_soft_squared_masses_to_slha()
{

}

template <class Model>
const THDM_I_physical& THDM_I_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
THDM_I_physical& THDM_I_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void THDM_I_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void THDM_I_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const THDM_I_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
