...
const int THDM_I_observables::NUMBER_OF_OBSERVABLES;

THDM_I_observables::THDM_I_observables()
...
Eigen::ArrayXd THDM_I_observables::get() const
{
   Eigen::ArrayXd vec(THDM_I_observables::NUMBER_OF_OBSERVABLES);
...
std::vector<std::string> THDM_I_observables::get_names()
{
   std::vector<std::string> names(THDM_I_observables::NUMBER_OF_OBSERVABLES);
...
void THDM_I_observables::set(const Eigen::ArrayXd& vec)
{
   assert(vec.rows() == THDM_I_observables::NUMBER_OF_OBSERVABLES);
...
THDM_I_observables calculate_observables(const THDM_I_mass_eigenstates& model,
...
THDM_I_observables calculate_observables(const THDM_I_mass_eigenstates& model,
                                              ...
                                              const Physical_input& physical_input)
{
   THDM_I_observables observables;

   THDM_I_effective_couplings effective_couplings(model, qedqcd, physical_input);
