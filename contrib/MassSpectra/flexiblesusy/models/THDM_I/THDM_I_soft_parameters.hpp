...
// File generated at Wed 1 Apr 2020 20:45:23

#ifndef THDM_I_soft_parameters_H
#define THDM_I_soft_parameters_H
...
class THDM_I_soft_parameters : public THDM_I_susy_parameters {
public:
   explicit THDM_I_soft_parameters(const THDM_I_input_parameters& input_ = THDM_I_input_parameters());
   THDM_I_soft_parameters(const THDM_I_susy_parameters& , double M122_, double M112_, double M222_, double v1_, double v2_
);
   THDM_I_soft_parameters(const THDM_I_soft_parameters&) = default;
   THDM_I_soft_parameters(THDM_I_soft_parameters&&) = default;
   virtual ~THDM_I_soft_parameters() = default;
   THDM_I_soft_parameters& operator=(const THDM_I_soft_parameters&) = default;
   THDM_I_soft_parameters& operator=(THDM_I_soft_parameters&&) = default;
   ...
   THDM_I_soft_parameters calc_beta() const;
   THDM_I_soft_parameters calc_beta(int) const;
...
std::ostream& operator<<(std::ostream&, const THDM_I_soft_parameters&);
