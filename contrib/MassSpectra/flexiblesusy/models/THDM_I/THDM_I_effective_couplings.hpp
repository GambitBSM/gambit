...
#ifndef THDM_I_EFFECTIVE_COUPLINGS_H
#define THDM_I_EFFECTIVE_COUPLINGS_H
...
class THDM_I_effective_couplings {
public:
   THDM_I_effective_couplings(const THDM_I_mass_eigenstates&,
   ...
   void set_model(const THDM_I_mass_eigenstates& model_);
