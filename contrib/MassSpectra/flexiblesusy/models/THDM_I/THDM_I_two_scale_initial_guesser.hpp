...
#ifndef THDM_I_TWO_SCALE_INITIAL_GUESSER_H
#define THDM_I_TWO_SCALE_INITIAL_GUESSER_H

#include "THDM_I_initial_guesser.hpp"
...
/**
 * @class THDM_I_initial_guesser<Two_scale>
 * @brief initial guesser for the THDM_I
 */

template<>
class THDM_I_initial_guesser<Two_scale> : public Initial_guesser {
public:
   THDM_I_initial_guesser(THDM_I<Two_scale>*,
                               const softsusy::QedQcd&,
                               const THDM_I_low_scale_constraint<Two_scale>&,
                               const THDM_I_susy_scale_constraint<Two_scale>&);
   virtual ~THDM_I_initial_guesser() = default;
   virtual void guess() override; ///< initial guess

   void set_running_precision(double p) { running_precision = p; }

private:
   THDM_I<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   THDM_I_low_scale_constraint<Two_scale> low_constraint{};
   THDM_I_susy_scale_constraint<Two_scale> susy_constraint{};
