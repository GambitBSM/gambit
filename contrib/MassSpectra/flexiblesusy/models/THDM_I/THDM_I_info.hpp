...
#ifndef THDM_I_INFO_H
#define THDM_I_INFO_H
...
namespace THDM_I_info {
   ...
   class THDM_I_particle_names : public Names {
   public:
      virtual ~THDM_I_particle_names() = default;
   ...
   class THDM_I_parameter_names : public Names {
   public:
      virtual ~THDM_I_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const THDM_I_particle_names  particle_names_getter{};
   const THDM_I_parameter_names parameter_names_getter{};
