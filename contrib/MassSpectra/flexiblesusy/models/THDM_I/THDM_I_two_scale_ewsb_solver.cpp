...
/**
 * @file THDM_I_two_scale_ewsb_solver.cpp
 *
...
#define CLASSNAME THDM_I_ewsb_solver<Two_scale>

/**
 * This method solves the EWSB conditions iteratively, trying several
 * root finding methods until a solution is found.
 */
int CLASSNAME::solve_iteratively(THDM_I_mass_eigenstates& model_to_solve)
{
...
int CLASSNAME::solve_iteratively_with(
   THDM_I_mass_eigenstates& model_to_solve, EWSB_solver* solver, const EWSB_vector_t& x_init)
{
 ...
 * @param solver solver
 */
void CLASSNAME::set_ewsb_solution(THDM_I_mass_eigenstates& model, const EWSB_solver* solver)
{
...
void CLASSNAME::set_best_ewsb_solution(THDM_I_mass_eigenstates& model, It first, It last)
{
...
int CLASSNAME::solve_iteratively_at(THDM_I_mass_eigenstates& model_to_solve, int l)
{
...
int CLASSNAME::solve(THDM_I_mass_eigenstates& model_to_solve)
{
   if (loop_order == 0) {
...
int CLASSNAME::solve_tree_level(THDM_I_mass_eigenstates& model)
{
...
CLASSNAME::EWSB_vector_t CLASSNAME::initial_guess(const THDM_I_mass_eigenstates& model) const
{
...
CLASSNAME::EWSB_vector_t CLASSNAME::tadpole_equations(const THDM_I_mass_eigenstates& model) const
{
 ...
 */
CLASSNAME::EWSB_vector_t CLASSNAME::ewsb_step(const THDM_I_mass_eigenstates& model) const
{
