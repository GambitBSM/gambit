...
#ifndef THDM_I_WEINBERG_ANGLE_H
#define THDM_I_WEINBERG_ANGLE_H
...
public:
   ...
   THDM_I_weinberg_angle(const THDM_I_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const THDM_I_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const THDM_I_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
