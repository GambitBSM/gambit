...
#ifndef THDM_I_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define THDM_I_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "THDM_I_low_scale_constraint.hpp"
...
template<>
class THDM_I_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   THDM_I_low_scale_constraint() = default;
   THDM_I_low_scale_constraint(THDM_I<Two_scale>*, const softsusy::QedQcd&);
   virtual ~THDM_I_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "THDM_I low-scale constraint"; }
