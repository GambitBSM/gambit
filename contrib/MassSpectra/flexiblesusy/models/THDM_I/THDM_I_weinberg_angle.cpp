...
#include "THDM_I_weinberg_angle.hpp"
...
#define CLASSNAME THDM_I_weinberg_angle
 ...
 */
CLASSNAME::THDM_I_weinberg_angle(
   const THDM_I_mass_eigenstates* model_,
...
void CLASSNAME::set_model(const THDM_I_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * THDM_I_info::normalization_g1;
   const double g2 = MODEL->get_g2() * THDM_I_info::normalization_g2;
