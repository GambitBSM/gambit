...
// File generated at Tue 7 Apr 2020 02:31:54
...
double THDM_I_susy_parameters::calc_beta_Lambda5_2_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda5 = Re(twoLoop*(-40*Lambda1*Lambda3*Lambda5 - 40*Lambda2*
      ...
      Lambda5*traceYeAdjYe + 1.5*Lambda5*traceYeAdjYeYeAdjYe - 12*Lambda2*
      ...
      g1) - 28.875*Lambda5*Quad(g2) - 2*Lambda1*Lambda5*Sqr(g1) - 2*Lambda2*
      ...
      *Conj(Lambda6)*(3*Lambda5*(6*Lambda6 + 7*Lambda7) + Conj(Lambda7)*(5*
      ...
      Lambda5*Sqr(g1)*Sqr(g2) + 40*Lambda5*traceYdAdjYd*Sqr(g3) + 40*Lambda5*
      traceYuAdjYu*Sqr(g3) - 7*Lambda5*Sqr(Lambda1) - 7*Lambda5*Sqr(Lambda2) -
      28*Lambda5*Sqr(Lambda3) - 32*Lambda5*Sqr(Lambda4) + 6*Conj(Lambda5)*Sqr(
      Lambda5) + 2*(-37*Lambda1 - 5*Lambda2 - 36*Lambda3 - 38*Lambda4 + 10*Sqr(
      g1) + 27*Sqr(g2))*Sqr(Conj(Lambda6)) - 10*Lambda1*Sqr(Conj(Lambda7)) - 74
      *Lambda2*Sqr(Conj(Lambda7)) - 72*Lambda3*Sqr(Conj(Lambda7)) - 76*Lambda4*
      Sqr(Conj(Lambda7)) - 60*traceYdAdjYd*Sqr(Conj(Lambda7)) - 20*traceYeAdjYe
      *Sqr(Conj(Lambda7)) - 60*traceYuAdjYu*Sqr(Conj(Lambda7)) + 20*Sqr(g1)*Sqr
      (Conj(Lambda7)) + 54*Sqr(g2)*Sqr(Conj(Lambda7))));
