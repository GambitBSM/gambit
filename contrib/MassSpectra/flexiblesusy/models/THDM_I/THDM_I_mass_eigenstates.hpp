...
#define THDM_I_MASS_EIGENSTATES_H
...
class THDM_I_ewsb_solver_interface;
/**
 * @class THDM_I_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class THDM_I_mass_eigenstates : public THDM_I_soft_parameters {
public:
   explicit THDM_I_mass_eigenstates(const THDM_I_input_parameters& input_ = THDM_I_input_parameters());
   THDM_I_mass_eigenstates(const THDM_I_mass_eigenstates&) = default;
   THDM_I_mass_eigenstates(THDM_I_mass_eigenstates&&) = default;
   virtual ~THDM_I_mass_eigenstates() = default;
   THDM_I_mass_eigenstates& operator=(const THDM_I_mass_eigenstates&) = default;
   THDM_I_mass_eigenstates& operator=(THDM_I_mass_eigenstates&&) = default;
   ...
   void set_physical(const THDM_I_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const THDM_I_physical& get_physical() const;
   THDM_I_physical& get_physical();
   const Problems& get_problems() const;
   Problems& get_problems();
   void set_ewsb_solver(const std::shared_ptr<THDM_I_ewsb_solver_interface>&);
...
private:
   ...
   THDM_I_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{THDM_I_info::model_name,
                     &THDM_I_info::particle_names_getter,
                     &THDM_I_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<THDM_I_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const THDM_I_mass_eigenstates&);
