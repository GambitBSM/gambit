...
public:
   ...
   void fill(THDM_I_input_parameters&) const;
   void fill(THDM_I_mass_eigenstates&) const;
   template <class Model> void fill(THDM_I_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const THDM_I_slha<Model>&, const THDM_I_scales&, const THDM_I_observables&);
   void set_input(const THDM_I_input_parameters&);
   ...
   template <class Model> void set_spectrum(const THDM_I_slha<Model>&);
   template <class T> void set_spectrum(const THDM_I<T>&);
   ...
   static void fill_minpar_tuple(THDM_I_input_parameters&, int, double);
   static void fill_extpar_tuple(THDM_I_input_parameters&, int, double);
   static void fill_imminpar_tuple(THDM_I_input_parameters&, int, double);
   static void fill_imextpar_tuple(THDM_I_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const THDM_I_slha<Model>&, const softsusy::QedQcd&, const THDM_I_scales&, const THDM_I_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const THDM_I_slha<Model>&, const softsusy::QedQcd&, const THDM_I_scales&, const THDM_I_observables&);

private:
   SLHA_io slha_io; ///< SLHA io class
   bool print_imaginary_parts_of_majorana_mixings;

   void set_extpar(const THDM_I_input_parameters&);
   void set_imminpar(const THDM_I_input_parameters&);
   void set_imextpar(const THDM_I_input_parameters&);
   void set_minpar(const THDM_I_input_parameters&);
   void set_mass(const THDM_I_physical&, bool);
   void set_mixing_matrices(const THDM_I_physical&, bool);
   template <class Model> void set_model_parameters(const THDM_I_slha<Model>&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(THDM_I_mass_eigenstates&) const;
   void fill_physical(THDM_I_physical&) const;
};
 ...
 */
template <class Model>
void THDM_I_slha_io::fill(THDM_I_slha<Model>& model) const
{
   fill(static_cast<THDM_I_mass_eigenstates&>(model));
   fill_physical(model.get_physical_slha());
}

template <class Model>
void THDM_I_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const THDM_I_slha<Model>& model,
   const softsusy::QedQcd& qedqcd, const THDM_I_scales& scales,
   const THDM_I_observables& observables)
{
   THDM_I_slha_io slha_io;
   const THDM_I_input_parameters& input = model.get_input();
...
template <class Model>
SLHAea::Coll THDM_I_slha_io::fill_slhaea(
   const THDM_I_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const THDM_I_scales& scales, const THDM_I_observables& observables)
{
   SLHAea::Coll slhaea;
   THDM_I_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void THDM_I_slha_io::set_model_parameters(const THDM_I_slha<Model>& model)
{
   {
 ...
 */
template <class Model>
void THDM_I_slha_io::set_extra(
   const THDM_I_slha<Model>& model, const THDM_I_scales& scales,
   const THDM_I_observables& observables)
{
   const THDM_I_physical physical(model.get_physical_slha());
 ...
 */
template <class... Ts>
void THDM_I_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<THDM_I_slha_io> ss(this);
 ...
 */
template <class T>
void THDM_I_slha_io::set_spectrum(const THDM_I<T>& model)
{
   set_spectrum(THDM_I_slha<THDM_I<T> >(model));
}
 ...
 */
template <class Model>
void THDM_I_slha_io::set_spectrum(const THDM_I_slha<Model>& model)
{
   const THDM_I_physical physical(model.get_physical_slha());
