 ...
 */
Eigen::Matrix<double,3,3> THDM_LS_susy_parameters::calc_beta_Yu_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> THDM_LS_susy_parameters::calc_beta_Yu_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Yu = (twoLoop*(Yu*(Lambda3*Lambda4 - 6.75*traceYdAdjYdYdAdjYd +
      ...
      5.625*traceYuAdjYu*Sqr(g2) - 0.75*Sqr(g1)*Sqr(g2) + 20*traceYdAdjYd*Sqr(
      g3) + 20*traceYuAdjYu*Sqr(g3) + 2.111111111111111*Sqr(g1)*Sqr(g3) + 9*Sqr
      (g2)*Sqr(g3) + 1.5*Sqr(Lambda2) + Sqr(Lambda3) + Sqr(Lambda4)) +
      0.020833333333333332*(-43*Sqr(g1) + 3*(60*traceYdAdjYd + 60*traceYuAdjYu
      + 9*Sqr(g2) - 256*Sqr(g3)))*(Yu*Yd.adjoint()*Yd) + 0.020833333333333332*(
      -36*(8*Lambda2 + 9*(traceYdAdjYd + traceYuAdjYu)) + 223*Sqr(g1) + 405*Sqr
 ...
 */
Eigen::Matrix<double,3,3> THDM_LS_susy_parameters::calc_beta_Yu_3_loop(const Susy_traces& susy_traces) const
{
