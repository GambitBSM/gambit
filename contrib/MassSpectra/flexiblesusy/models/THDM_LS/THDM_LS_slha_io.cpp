...
THDM_LS_slha_io::THDM_LS_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void THDM_LS_slha_io::clear()
{
   slha_io.clear();
}

void THDM_LS_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 */
void THDM_LS_slha_io::set_extpar(const THDM_LS_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void THDM_LS_slha_io::set_imminpar(const THDM_LS_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void THDM_LS_slha_io::set_imextpar(const THDM_LS_input_parameters& input)
{
 ...
 */
void THDM_LS_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void THDM_LS_slha_io::set_minpar(const THDM_LS_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void THDM_LS_slha_io::set_input(const THDM_LS_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void THDM_LS_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void THDM_LS_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 */
void THDM_LS_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void THDM_LS_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void THDM_LS_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void THDM_LS_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, THDM_LS_info::model_name)
 ...
 */
void THDM_LS_slha_io::set_mass(const THDM_LS_physical& physical,
 ...
 */
void THDM_LS_slha_io::set_mixing_matrices(const THDM_LS_physical& physical,
 ...
 */
void THDM_LS_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
 ...
 */
double THDM_LS_slha_io::get_parameter_output_scale() const
{
 ...
 */
void THDM_LS_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void THDM_LS_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void THDM_LS_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void THDM_LS_slha_io::fill(THDM_LS_input_parameters& input) const
{
 ...
 */
void THDM_LS_slha_io::fill_drbar_parameters(THDM_LS_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void THDM_LS_slha_io::fill(THDM_LS_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   THDM_LS_physical physical_hk;
 ...
 */
void THDM_LS_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void THDM_LS_slha_io::fill(Spectrum_generator_settings& settings) const
{
   slha_io.fill(settings);
}

void THDM_LS_slha_io::fill_minpar_tuple(THDM_LS_input_parameters& input,
...
void THDM_LS_slha_io::fill_extpar_tuple(THDM_LS_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void THDM_LS_slha_io::fill_imminpar_tuple(THDM_LS_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void THDM_LS_slha_io::fill_imextpar_tuple(THDM_LS_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void THDM_LS_slha_io::fill_physical(THDM_LS_physical& physical) const
{
   {
 ...
 */
double THDM_LS_slha_io::read_scale() const
{
