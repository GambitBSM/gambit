...
#ifndef THDM_LS_WEINBERG_ANGLE_H
#define THDM_LS_WEINBERG_ANGLE_H
...
public:
   ...
   THDM_LS_weinberg_angle(const THDM_LS_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const THDM_LS_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const THDM_LS_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
