...
#define CLASSNAME THDM_LS_weinberg_angle
 ...
 */
CLASSNAME::THDM_LS_weinberg_angle(
...
void CLASSNAME::set_model(const THDM_LS_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * THDM_LS_info::normalization_g1;
   const double g2 = MODEL->get_g2() * THDM_LS_info::normalization_g2;
