...
{
   std::cout <<
      "Usage: run_cmd_line_THDM_LS.x [options]\n"
      "Options:\n"
      "  --Lambda1IN=<value>\n"
      "  --Lambda2IN=<value>\n"
      "  --Lambda3IN=<value>\n"
...
int run_solver(const THDM_LS_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(THDM_LS_slha_io::fill_slhaea(
...
int run(int solver_type, const THDM_LS_input_parameters& input)
{
   int exit_code = 0;
