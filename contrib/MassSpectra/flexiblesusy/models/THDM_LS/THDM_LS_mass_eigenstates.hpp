...
/**
 * @file THDM_LS_mass_eigenstates.hpp
 *
...
#ifndef THDM_LS_MASS_EIGENSTATES_H
#define THDM_LS_MASS_EIGENSTATES_H
...
class THDM_LS_ewsb_solver_interface;
/**
 * @class THDM_LS_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class THDM_LS_mass_eigenstates : public THDM_LS_soft_parameters {
public:
   explicit THDM_LS_mass_eigenstates(const THDM_LS_input_parameters& input_ = THDM_LS_input_parameters());
   THDM_LS_mass_eigenstates(const THDM_LS_mass_eigenstates&) = default;
   THDM_LS_mass_eigenstates(THDM_LS_mass_eigenstates&&) = default;
   virtual ~THDM_LS_mass_eigenstates() = default;
   THDM_LS_mass_eigenstates& operator=(const THDM_LS_mass_eigenstates&) = default;
   THDM_LS_mass_eigenstates& operator=(THDM_LS_mass_eigenstates&&) = default;
   ...
   void set_physical(const THDM_LS_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const THDM_LS_physical& get_physical() const;
   THDM_LS_physical& get_physical();
   const Problems& get_problems() const;
   Problems& get_problems();
   void set_ewsb_solver(const std::shared_ptr<THDM_LS_ewsb_solver_interface>&);
...
private:
   ...
   THDM_LS_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{THDM_LS_info::model_name,
                     &THDM_LS_info::particle_names_getter,
                     &THDM_LS_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<THDM_LS_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const THDM_LS_mass_eigenstates&);
