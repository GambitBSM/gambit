...
#ifndef THDM_LS_susy_parameters_H
#define THDM_LS_susy_parameters_H
...
class THDM_LS_susy_parameters : public Beta_function {
public:
   explicit THDM_LS_susy_parameters(const THDM_LS_input_parameters& input_ = THDM_LS_input_parameters());
   THDM_LS_susy_parameters(double scale_, int loops_, int thresholds_, const THDM_LS_input_parameters& input_, double g1_, double g2_, double g3_, double Lambda6_, double Lambda5_,
   ...
   THDM_LS_susy_parameters(const THDM_LS_susy_parameters&) = default;
   THDM_LS_susy_parameters(THDM_LS_susy_parameters&&) = default;
   virtual ~THDM_LS_susy_parameters() = default;
   THDM_LS_susy_parameters& operator=(const THDM_LS_susy_parameters&) = default;
   THDM_LS_susy_parameters& operator=(THDM_LS_susy_parameters&&) = default;

   virtual Eigen::ArrayXd beta() const override;
   virtual Eigen::ArrayXd get() const override;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&) override;
   const THDM_LS_input_parameters& get_input() const;
   THDM_LS_input_parameters& get_input();
   void set_input_parameters(const THDM_LS_input_parameters&);

   THDM_LS_susy_parameters calc_beta() const;
   THDM_LS_susy_parameters calc_beta(int) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const THDM_LS_susy_parameters&);
