...
// File generated at Tue 7 Apr 2020 14:57:36

/**
 * @file THDM_LS_mass_eigenstates.cpp
 ...
 * parameters.
 *
 * This file was generated at Tue 7 Apr 2020 14:57:36 with FlexibleSUSY
 * 2.0.1 (git commit: unknown) and SARAH 4.13.0 .
 */

#include "THDM_LS_mass_eigenstates.hpp"
#include "THDM_LS_ewsb_solver_interface.hpp"
...
#include "THDM_LS_two_scale_ewsb_solver.hpp"
#endif
...
#define CLASSNAME THDM_LS_mass_eigenstates
...
CLASSNAME::THDM_LS_mass_eigenstates(const THDM_LS_input_parameters& input_)
   : THDM_LS_soft_parameters(input_)
#if defined(ENABLE_TWO_SCALE_SOLVER)
   , ewsb_solver(new THDM_LS_ewsb_solver<Two_scale>())
#endif
{
}
...
const THDM_LS_physical& CLASSNAME::get_physical() const
{
   return physical;
}

THDM_LS_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const THDM_LS_physical& physical_)
{
   physical = physical_;
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<THDM_LS_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
{
   if (!ewsb_solver) {
      throw SetupError("THDM_LS_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("THDM_LS_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("THDM_LS_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }

   VERBOSE_MSG("\t\tSolving THDM_LS EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           "THDM_LS\n"
           "========================================\n";
   THDM_LS_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   if (PHYSICAL(Mhh).tail<2>().minCoeff() < 0.) problems.flag_pole_tachyon(THDM_LS_info::hh);
   if (PHYSICAL(MAh).tail<1>().minCoeff() < 0.) problems.flag_pole_tachyon(THDM_LS_info::Ah);
   if (PHYSICAL(MHm).tail<1>().minCoeff() < 0.) problems.flag_pole_tachyon(THDM_LS_info::Hm);
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   THDM_LS_soft_parameters::run_to(scale, eps);
}
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(THDM_LS_info::hh, eigenvalue_error > precision
      * Abs(Mhh(0)));
#else
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_running_tachyon(THDM_LS_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(THDM_LS_info::Ah, eigenvalue_error > precision
      * Abs(MAh(0)));
#else
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_running_tachyon(THDM_LS_info::Ah);
   }
...
void CLASSNAME::calculate_MHm()
{
   ...
   problems.flag_bad_mass(THDM_LS_info::Hm, eigenvalue_error > precision
      * Abs(MHm(0)));
#else
   ...
   if (MHm.minCoeff() < 0.) {
      problems.flag_running_tachyon(THDM_LS_info::Hm);
   }
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(THDM_LS_info::Fd, eigenvalue_error > precision
      * Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(THDM_LS_info::Fu, eigenvalue_error > precision
      * Abs(MFu(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(THDM_LS_info::Fe, eigenvalue_error > precision
      * Abs(MFe(0)));
#else
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_running_tachyon(THDM_LS_info::VWm);
   }
...
{
   if (!force_output && problems.is_running_tachyon(THDM_LS_info::VZ))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(THDM_LS_info::VZ);
...
{
   if (!force_output && problems.is_running_tachyon(THDM_LS_info::hh))
      return;
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZH;
            ...
            problems.flag_bad_mass(THDM_LS_info::hh,
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(THDM_LS_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(THDM_LS_info::hh);
}

void CLASSNAME::calculate_MAh_pole()
{
   if (!force_output && problems.is_running_tachyon(THDM_LS_info::Ah))
      return;
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZA;
            ...
            problems.flag_bad_mass(THDM_LS_info::Ah,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZA);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(THDM_LS_info::Ah);
   else
      problems.unflag_no_pole_mass_convergence(THDM_LS_info::Ah);
}

void CLASSNAME::calculate_MHm_pole()
{
   if (!force_output && problems.is_running_tachyon(THDM_LS_info::Hm))
      return;
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      Eigen::Matrix<double,2,2> mix_ZP;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZP,
            eigenvalue_error);
         problems.flag_bad_mass(THDM_LS_info::Hm, eigenvalue_error
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      problems.flag_bad_mass(THDM_LS_info::Fd, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      problems.flag_bad_mass(THDM_LS_info::Fu, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      problems.flag_bad_mass(THDM_LS_info::Fe, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
{
   if (!force_output && problems.is_running_tachyon(THDM_LS_info::VWm))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(THDM_LS_info::VWm);
...
std::ostream& operator<<(std::ostream& ostr, const THDM_LS_mass_eigenstates& model)
{
   model.print(ostr);
   return ostr;
}
