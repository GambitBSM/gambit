...
#ifndef THDM_LS_soft_parameters_H
#define THDM_LS_soft_parameters_H
...
class THDM_LS_soft_parameters : public THDM_LS_susy_parameters {
public:
   explicit THDM_LS_soft_parameters(const THDM_LS_input_parameters& input_ = THDM_LS_input_parameters());
   THDM_LS_soft_parameters(const THDM_LS_susy_parameters& , double M122_, double M112_, double M222_, double v1_, double v2_
);
   THDM_LS_soft_parameters(const THDM_LS_soft_parameters&) = default;
   THDM_LS_soft_parameters(THDM_LS_soft_parameters&&) = default;
   virtual ~THDM_LS_soft_parameters() = default;
   THDM_LS_soft_parameters& operator=(const THDM_LS_soft_parameters&) = default;
   THDM_LS_soft_parameters& operator=(THDM_LS_soft_parameters&&) = default;
   ...
   THDM_LS_soft_parameters calc_beta() const;
   THDM_LS_soft_parameters calc_beta(int) const;
...
std::ostream& operator<<(std::ostream&, const THDM_LS_soft_parameters&);
