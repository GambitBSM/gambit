...
// File generated at Tue 7 Apr 2020 14:55:36
...
#define CLASSNAME THDM_LS_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces
#define TRACE_STRUCT_TYPE Susy_traces
#define CALCULATE_TRACES(l) calc_susy_traces(l);

const int THDM_LS_susy_parameters::numberOfParameters;

THDM_LS_susy_parameters::THDM_LS_susy_parameters(const THDM_LS_input_parameters& input_)
   : input(input_)
{
   set_number_of_parameters(numberOfParameters);
}

THDM_LS_susy_parameters::THDM_LS_susy_parameters(
   double scale_, int loops_, int thresholds_,
   const THDM_LS_input_parameters& input_
   ...
   ,3>& Ye_, const Eigen::Matrix<double,3,3>& Yd_
...
Eigen::ArrayXd THDM_LS_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

THDM_LS_susy_parameters THDM_LS_susy_parameters::calc_beta(int loops) const
{
   double beta_g1 = 0.;
   double beta_g2 = 0.;
   double beta_g3 = 0.;
   ...
   return THDM_LS_susy_parameters(get_scale(), loops, get_thresholds(), input,
                    beta_g1, beta_g2, beta_g3, beta_Lambda6, beta_Lambda5, beta_Lambda7, beta_Lambda1, beta_Lambda4, beta_Lambda3, beta_Lambda2, beta_Yu, beta_Ye, beta_Yd);
}

THDM_LS_susy_parameters THDM_LS_susy_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void THDM_LS_susy_parameters::clear()
{
   reset();
   g1 = 0.;
   g2 = 0.;
...
Eigen::ArrayXd THDM_LS_susy_parameters::get() const
{
...
void THDM_LS_susy_parameters::print(std::ostream& ostr) const
{
...
void THDM_LS_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   g1 = pars(0);
   g2 = pars(1);
   g3 = pars(2);
...
const THDM_LS_input_parameters& THDM_LS_susy_parameters::get_input() const
{
   return input;
}

THDM_LS_input_parameters& THDM_LS_susy_parameters::get_input()
{
   return input;
}

void THDM_LS_susy_parameters::set_input_parameters(const THDM_LS_input_parameters& input_)
{
   input = input_;
}

THDM_LS_susy_parameters::Susy_traces THDM_LS_susy_parameters::calc_susy_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const THDM_LS_susy_parameters& susy_pars)
{
