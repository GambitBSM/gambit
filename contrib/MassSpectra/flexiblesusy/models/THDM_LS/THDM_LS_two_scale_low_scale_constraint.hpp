...
#ifndef THDM_LS_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define THDM_LS_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "THDM_LS_low_scale_constraint.hpp"
...
template<>
class THDM_LS_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   THDM_LS_low_scale_constraint() = default;
   THDM_LS_low_scale_constraint(THDM_LS<Two_scale>*, const softsusy::QedQcd&);
   virtual ~THDM_LS_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "THDM_LS low-scale constraint"; }
