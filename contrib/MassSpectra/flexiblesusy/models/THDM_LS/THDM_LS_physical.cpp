 ...
 * to be complex.
 */
void THDM_LS_physical::convert_to_hk()
{
 ...
 * be negative.
 */
void THDM_LS_physical::convert_to_slha()
{

}

Eigen::ArrayXd THDM_LS_physical::get() const
{
...
void THDM_LS_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd THDM_LS_physical::get_masses() const
{
...
void THDM_LS_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MFv(0) = pars(1);
   MFv(1) = pars(2);
...
void THDM_LS_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const THDM_LS_physical& phys_pars)
{
