 ...
 */
double THDM_LS_soft_parameters::calc_beta_M122_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double THDM_LS_soft_parameters::calc_beta_M122_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_M122 = Re(twoLoop*(18*Lambda1*Lambda6*M112 + 12*Lambda3*Lambda6*
      ...
      traceYdAdjYuYuAdjYd + 12*Lambda6*M112*traceYeAdjYe - 2*Lambda3*M122*
      traceYeAdjYe - 4*Lambda4*M122*traceYeAdjYe - 2.25*M122*
 ...
 */
double THDM_LS_soft_parameters::calc_beta_M122_3_loop(const Soft_traces& soft_traces) const
{
