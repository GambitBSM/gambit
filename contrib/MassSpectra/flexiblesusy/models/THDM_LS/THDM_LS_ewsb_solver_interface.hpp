...
/**
 * @file THDM_LS_ewsb_solver_interface.hpp
 *
 * @brief contains interface for EWSB solver
 *
 * This file was generated at Tue 7 Apr 2020 14:57:38 with FlexibleSUSY
 * 2.0.1 (git commit: unknown) and SARAH 4.13.0 .
 */

#ifndef THDM_LS_EWSB_SOLVER_INTERFACE_H
#define THDM_LS_EWSB_SOLVER_INTERFACE_H
...
class THDM_LS_ewsb_solver_interface {
public:
   virtual ~THDM_LS_ewsb_solver_interface() {}
   ...
   virtual int solve(THDM_LS_mass_eigenstates&) = 0;
};
