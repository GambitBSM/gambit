...
// File generated at Tue 7 Apr 2020 14:55:37
 ...
 */
double THDM_LS_susy_parameters::calc_beta_Lambda6_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda6 = Re(oneOver16PiSqr*(12*Lambda1*Lambda6 + 6*Lambda3*
      ...
      Lambda6*traceYdAdjYd + 3*Lambda6*traceYeAdjYe + 3*Lambda6*traceYuAdjYu +
      2*Conj(Lambda5)*(5*Conj(Lambda6) + Conj(Lambda7)) - 3*Lambda6*Sqr(g1) - 9
      *Lambda6*Sqr(g2)));
 ...
 */
double THDM_LS_susy_parameters::calc_beta_Lambda6_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Lambda6 = Re(twoLoop*(-66*Lambda1*Lambda3*Lambda6 - 18*Lambda2*
      ...
      Lambda6*traceYdAdjYuYuAdjYd - 24*Lambda1*Lambda6*traceYeAdjYe - 6*Lambda3
      *Lambda6*traceYeAdjYe - 8*Lambda4*Lambda6*traceYeAdjYe - 0.75*Lambda6*
      ...
      Lambda3*Lambda7*Sqr(g1) + 8*Lambda4*Lambda7*Sqr(g1) + 1.0416666666666667*
      Lambda6*traceYdAdjYd*Sqr(g1) + 9.375*Lambda6*traceYeAdjYe*Sqr(g1) +
      ...
      20*Lambda3 + 22*Lambda4 + 6*traceYdAdjYd + 6*traceYuAdjYu + Sqr(g1)) +
      ...
      *Lambda6*Sqr(g2) + 36*Lambda3*Lambda7*Sqr(g2) + 18*Lambda4*Lambda7*Sqr(g2
      ) + 5.625*Lambda6*traceYdAdjYd*Sqr(g2) + 5.625*Lambda6*traceYeAdjYe*Sqr(
      g2) + 5.625*Lambda6*traceYuAdjYu*Sqr(g2) + 7.25*Lambda6*Sqr(g1)*Sqr(g2) +
      2.5*Lambda7*Sqr(g1)*Sqr(g2) + 20*Lambda6*traceYdAdjYd*Sqr(g3) + 20*
 ...
 */
double THDM_LS_susy_parameters::calc_beta_Lambda6_3_loop(const Susy_traces& susy_traces) const
{
