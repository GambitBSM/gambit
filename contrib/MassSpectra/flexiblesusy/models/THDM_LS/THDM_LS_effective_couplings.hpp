...
#ifndef THDM_LS_EFFECTIVE_COUPLINGS_H
#define THDM_LS_EFFECTIVE_COUPLINGS_H
...
class THDM_LS_effective_couplings {
public:
   THDM_LS_effective_couplings(const THDM_LS_mass_eigenstates&,
   ...
   void set_model(const THDM_LS_mass_eigenstates& model_);
