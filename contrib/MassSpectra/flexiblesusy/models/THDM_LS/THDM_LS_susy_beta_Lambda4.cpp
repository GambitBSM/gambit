...
// File generated at Tue 7 Apr 2020 14:55:40
 ...
 */
double THDM_LS_susy_parameters::calc_beta_Lambda4_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double THDM_LS_susy_parameters::calc_beta_Lambda4_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Lambda4 = Re(twoLoop*(-40*Lambda1*Lambda3*Lambda4 - 40*Lambda2*
      ...
      - 68*Lambda4*AbsSqr(Lambda7) - 60*traceYdAdjYd*AbsSqr(Lambda7) - 60*
      ...
      traceYeAdjYe*Sqr(g1)*Sqr(g2) + 21*traceYuAdjYu*Sqr(g1)*Sqr(g2) + 2*Conj(
      Lambda6)*(-37*Lambda1*Lambda6 - 5*Lambda2*Lambda6 - 36*Lambda3*Lambda6 -
      34*Lambda4*Lambda6 - 5*Lambda1*Lambda7 - 5*Lambda2*Lambda7 - 20*Lambda3*
      Lambda7 - 40*Lambda4*Lambda7 - 3*Lambda7*traceYdAdjYd - 10*Lambda6*
      traceYeAdjYe - Lambda7*traceYeAdjYe - 3*Lambda7*traceYuAdjYu + (7*Lambda6
      + 2*Lambda7)*Sqr(g1) + 27*Lambda6*Sqr(g2)) + 40*Lambda4*traceYdAdjYd*Sqr
      ...
      8*Sqr(g1)*Sqr(Lambda4) + 18*Sqr(g2)*Sqr(Lambda4) - 40*Lambda5*Sqr(Lambda6
      ) - 40*Lambda5*Sqr(Lambda7) - 2*Conj(Lambda5)*(24*Conj(Lambda6)*Conj(
      Lambda7) + Lambda5*(12*Lambda1 + 12*Lambda2 + 24*Lambda3 + 13*Lambda4 +
      12*traceYdAdjYd + 4*traceYeAdjYe + 12*traceYuAdjYu - 8*Sqr(g1) - 27*Sqr(
      g2)) + 20*Sqr(Conj(Lambda6)) + 20*Sqr(Conj(Lambda7)))));
 ...
 */
double THDM_LS_susy_parameters::calc_beta_Lambda4_3_loop(const Susy_traces& susy_traces) const
{
