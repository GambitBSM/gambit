...
/**
 * @file THDM_LS_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Tue 7 Apr 2020 14:57:37

#ifndef THDM_LS_SLHA_H
#define THDM_LS_SLHA_H
...
class THDM_LS_slha : public Model {
public:
   explicit THDM_LS_slha(const THDM_LS_input_parameters& input_ = THDM_LS_input_parameters());
   explicit THDM_LS_slha(const Model&, bool do_convert_masses_to_slha = true);
   THDM_LS_slha(const THDM_LS_slha&) = default;
   THDM_LS_slha(THDM_LS_slha&&) = default;
   virtual ~THDM_LS_slha() = default;
   THDM_LS_slha& operator=(const THDM_LS_slha&) = default;
   THDM_LS_slha& operator=(THDM_LS_slha&&) = default;
   ...
   const THDM_LS_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   THDM_LS_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   THDM_LS_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
THDM_LS_slha<Model>::THDM_LS_slha(const THDM_LS_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
THDM_LS_slha<Model>::THDM_LS_slha(const Model& model_,
...
template <class Model>
void THDM_LS_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void THDM_LS_slha<Model>::convert_to_slha()
{
...
template <class Model>
void THDM_LS_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void THDM_LS_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void THDM_LS_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void THDM_LS_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void THDM_LS_slha<Model>::convert_soft_squared_masses_to_slha()
{

}

template <class Model>
const THDM_LS_physical& THDM_LS_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
THDM_LS_physical& THDM_LS_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void THDM_LS_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void THDM_LS_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const THDM_LS_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
