...
Eigen::ArrayXd THDM_LS_input_parameters::get() const
{
...
void THDM_LS_input_parameters::set(const Eigen::ArrayXd& pars)
{
   Lambda1IN = pars(0);
   Lambda2IN = pars(1);
   Lambda3IN = pars(2);
...
std::ostream& operator<<(std::ostream& ostr, const THDM_LS_input_parameters& input)
{
