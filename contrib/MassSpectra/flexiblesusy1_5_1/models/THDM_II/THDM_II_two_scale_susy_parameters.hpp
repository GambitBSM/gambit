...
#ifndef THDM_II_TWO_SCALE_susy_parameters_H
#define THDM_II_TWO_SCALE_susy_parameters_H
...
public:
   ...
   THDM_II_susy_parameters(double scale_, double loops_, double thresholds_, const THDM_II_input_parameters& input_, double g1_, double g2_, double g3_, double Lambda6_, double Lambda5_,
   ...
   virtual ~THDM_II_susy_parameters() {}
