...
/**
 * @file THDM_II_two_scale_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Wed 29 Mar 2017 15:36:56

#ifndef THDM_II_TWO_SCALE_SLHA_H
#define THDM_II_TWO_SCALE_SLHA_H
...
/**
 * @class THDM_II_slha<Two_scale>
 * @brief model class wrapper in SLHA convention
 */

template<>
class THDM_II_slha<Two_scale> : public THDM_II<Two_scale> {
public:
   explicit THDM_II_slha(const THDM_II_input_parameters& input_ = THDM_II_input_parameters());
   explicit THDM_II_slha(const THDM_II<Two_scale>&, bool do_convert_masses_to_slha = true);
   virtual ~THDM_II_slha();
...
std::ostream& operator<<(std::ostream& ostr, const THDM_II_slha<Two_scale>& model);
