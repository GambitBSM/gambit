...
// File generated at Wed 29 Mar 2017 15:35:43
...
#define CLASSNAME THDM_II_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces
#define TRACE_STRUCT_TYPE Susy_traces
#define CALCULATE_TRACES() calc_susy_traces(TRACE_STRUCT);

const int THDM_II_susy_parameters::numberOfParameters;

THDM_II_susy_parameters::THDM_II_susy_parameters(const THDM_II_input_parameters& input_)
   : Beta_function()
   , g1(0), g2(0), g3(0), Lambda6(0), Lambda5(0), Lambda7(0), Lambda1(0),
   Lambda4(0), Lambda3(0), Lambda2(0), Yd(Eigen::Matrix<double,3,3>::Zero()),
   Ye(Eigen::Matrix<double,3,3>::Zero()), Yu(Eigen::Matrix<double,3,3>::Zero())
...
THDM_II_susy_parameters::THDM_II_susy_parameters(
   double scale_, double loops_, double thresholds_,
   const THDM_II_input_parameters& input_
...
Eigen::ArrayXd THDM_II_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

THDM_II_susy_parameters THDM_II_susy_parameters::calc_beta() const
{
   double beta_g1 = 0.;
   double beta_g2 = 0.;
   double beta_g3 = 0.;
   ...
   return THDM_II_susy_parameters(get_scale(), get_loops(), get_thresholds(), input,
...
void THDM_II_susy_parameters::clear()
{
   reset();
   g1 = 0.;
   g2 = 0.;
...
Eigen::ArrayXd THDM_II_susy_parameters::get() const
{
...
void THDM_II_susy_parameters::print(std::ostream& ostr) const
{
...
void THDM_II_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   g1 = pars(0);
   g2 = pars(1);
   g3 = pars(2);
...
const THDM_II_input_parameters& THDM_II_susy_parameters::get_input() const
{
   return input;
}

THDM_II_input_parameters& THDM_II_susy_parameters::get_input()
{
   return input;
}

void THDM_II_susy_parameters::set_input_parameters(const THDM_II_input_parameters& input_)
{
   input = input_;
}

void THDM_II_susy_parameters::calc_susy_traces(Susy_traces& susy_traces) const
{
   if (get_loops() > 0) {
...
std::ostream& operator<<(std::ostream& ostr, const THDM_II_susy_parameters& susy_pars)
{
