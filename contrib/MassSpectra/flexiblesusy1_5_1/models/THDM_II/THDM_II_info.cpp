...
namespace THDM_II_info {
   ...
   const char* parameter_names[NUMBER_OF_PARAMETERS] = {"g1", "g2", "g3",
      ...
      , "Yd(2,1)", "Yd(2,2)", "Ye(0,0)", "Ye(0,1)", "Ye(0,2)", "Ye(1,0)",
      "Ye(1,1)", "Ye(1,2)", "Ye(2,0)", "Ye(2,1)", "Ye(2,2)", "Yu(0,0)", "Yu(0,1)",
   ...
   const char* input_parameter_names[NUMBER_OF_INPUT_PARAMETERS] = {"Lambda1IN"
      , "Lambda2IN", "Lambda3IN", "Lambda4IN", "Lambda5IN", "Lambda6IN",
      "Lambda7IN", "M122IN", "TanBeta", "Qin", "QEWSB"};

   const char* model_name = "THDM_II";
