    ...
    if hboutput:
        ...
        for i in range(numh0):
            hb += (
               ...
               "hctbl.C_WW[{0}] = (*rHB_S_{2})({1});"
               " // Coupling (h0_{1} W+ W-)\n"
               "hctbl.C_ZZ[{0}] = (*rHB_S_VZ)({1});"
               " // Coupling (h0_{1} Z Z)\n"
            ).format(i, i+1, Wsign)
        ...
        for i in range(numh0):
            for j in range(numh0):
                towrite += (
                        "hctbl.C_hiZ[{0}][{1}] = (*CPL_H_H_Z)({2},{3}).re;"
        ...
        for i in range(numh0):
            for j in range(numA0):
                towrite += (
                    "hctbl.C_hiZ[{0}][{1}] = (*CPL_A_H_Z)({2},{3}).re;"
                        " // Coupling (A0_{4} h0_{3} Z)\n"
                    "hctbl.C_hiZ[{1}][{0}] = (*CPL_A_H_Z)({2},{3}).re;"
