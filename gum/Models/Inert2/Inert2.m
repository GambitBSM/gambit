...
LagNoHC = -(MHD conj[Hd].Hd + MHU conj[Hu].Hu + Lambdaa1/2 conj[Hd].Hd.conj[Hd].Hd + \
		Lambdaa2/2 conj[Hu].Hu.conj[Hu].Hu + Lambdaa3 conj[Hu].Hu.conj[Hd].Hd  + Lambdaa4 conj[Hu].Hd.Hu.conj[Hd]);


LagHC = -(Lambdaa5/2 Hu.Hd.Hu.Hd + Yd Hd.q.d + Ye Hd.l.e - Yu conj[Hd].q.u);
