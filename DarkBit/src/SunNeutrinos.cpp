    ...
    void ANTARES_2022_loglike(double &result)
    {
      ...
      if (anyAreOpen)
      {
        ...
        else if (not (isOpenChannel[0] or isOpenChannel[1]))
        {
          ...
          sigma_digitized = {1.8948e+23, 1.9428e+22, 6.1276e+21, 3.8357e+21, 2.9406e+21, 1.5407e+21, 7.3421e+20, 4.1487e+20, 2.2616e+20, 1.6327e+20, 1.1255e+20, 9.1975e+19, 7.2228e+19};
        }
        else
        {
