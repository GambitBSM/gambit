...
//        }
    ...
    DDCALC_MOD_GETRATES(COSINE_100,152.0, 334.0);
    DDCALC_MOD_GETLOGLIKE(COSINE_100,152.0,334.0);
    DDCALC_MOD_GETBINSIGNAL(COSINE_100,152.0,334.0);
    DDCALC_MOD_GETRATES(ANAIS,152.0, 334.0);
    DDCALC_MOD_GETLOGLIKE(ANAIS,152.0,334.0);
    DDCALC_MOD_GETBINSIGNAL(ANAIS,152.0,334.0);
  }
}
