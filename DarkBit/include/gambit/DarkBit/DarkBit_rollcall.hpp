...
//     LZ_GetBinSignal, (DDCalc, 2.0.0, 2.1.0, 2.2.0), (needs_DDCalc))
  ...
  SET_BACKEND_OPTION(PICO_60_2017, (DDCalc, 1.1.0, 1.2.0, 2.0.0, 2.1.0, 2.2.0, 2.3.0, 3.0.0))
  SET_BACKEND_OPTION(XENON1T_2017, (DDCalc, 1.1.0, 1.2.0, 2.0.0, 2.1.0, 2.2.0, 2.3.0, 3.0.0))
  // Introduced in DDCalc 1.2.0
  SET_BACKEND_OPTION(PandaX_2017, (DDCalc, 1.2.0, 2.0.0, 2.1.0, 2.2.0, 2.3.0, 3.0.0))
  // Introduced in DDCalc 2.0.0
  SET_BACKEND_OPTION(XENON1T_2018, (DDCalc, 2.0.0, 2.1.0, 2.2.0, 2.3.0, 3.0.0))
  SET_BACKEND_OPTION(DARWIN, (DDCalc, 2.0.0, 2.1.0, 2.2.0, 2.3.0, 3.0.0))
  SET_BACKEND_OPTION(DarkSide_50, (DDCalc, 2.0.0, 2.1.0, 2.2.0, 2.3.0, 3.0.0))
  SET_BACKEND_OPTION(CRESST_II, (DDCalc, 2.0.0, 2.1.0, 2.2.0, 2.3.0, 3.0.0))
  SET_BACKEND_OPTION(CDMSlite, (DDCalc, 2.0.0, 2.1.0, 2.2.0, 2.3.0, 3.0.0))
  SET_BACKEND_OPTION(PICO_60, (DDCalc, 2.0.0, 2.1.0, 2.2.0, 2.3.0, 3.0.0))
  SET_BACKEND_OPTION(PICO_500, (DDCalc, 2.0.0, 2.1.0, 2.2.0, 2.3.0, 3.0.0))
  // Introduced in DDCalc 2.0.0 bit later deleted
  SET_BACKEND_OPTION(LZ, (DDCalc, 2.0.0, 2.1.0, 2.2.0))
  // Introduced in DDCalc 2.2.0
  SET_BACKEND_OPTION(CRESST_III, (DDCalc, 2.2.0, 2.3.0, 3.0.0))
  SET_BACKEND_OPTION(DarkSide_50_S2, (DDCalc, 2.2.0, 2.3.0, 3.0.0))
  SET_BACKEND_OPTION(PICO_60_2019, (DDCalc, 2.2.0, 2.3.0, 3.0.0))
  // Introduced in DDCalc 2.3.0
  SET_BACKEND_OPTION(LZ_2022, (DDCalc, 2.3.0, 3.0.0))
  SET_BACKEND_OPTION(PandaX_4T, (DDCalc, 2.3.0, 3.0.0))
